...
ms.locfileid: "82135865"
---
### <a name="obsolete-antiforgery-cors-diagnostics-mvc-and-routing-apis-removed"></a><span data-ttu-id="6ffdc-101">Se han quitado las API Antiforgery, CORS, Diagnostics, MVC y Routing obsoletas</span><span class="sxs-lookup"><span data-stu-id="6ffdc-101">Obsolete Antiforgery, CORS, Diagnostics, MVC, and Routing APIs removed</span></span>

<span data-ttu-id="6ffdc-102">Se han quitado los miembros obsoletos y los modificadores de compatibilidad en ASP.NET Core 2.2.</span><span class="sxs-lookup"><span data-stu-id="6ffdc-102">Obsolete members and compatibility switches in ASP.NET Core 2.2 were removed.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="6ffdc-103">Versión introducida</span><span class="sxs-lookup"><span data-stu-id="6ffdc-103">Version introduced</span></span>

<span data-ttu-id="6ffdc-104">3.0</span><span class="sxs-lookup"><span data-stu-id="6ffdc-104">3.0</span></span>

#### <a name="reason-for-change"></a><span data-ttu-id="6ffdc-105">Motivo del cambio</span><span class="sxs-lookup"><span data-stu-id="6ffdc-105">Reason for change</span></span>

<span data-ttu-id="6ffdc-106">Mejora de la superficie de API a lo largo del tiempo.</span><span class="sxs-lookup"><span data-stu-id="6ffdc-106">Improvement of API surface over time.</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="6ffdc-107">Acción recomendada</span><span class="sxs-lookup"><span data-stu-id="6ffdc-107">Recommended action</span></span>

<span data-ttu-id="6ffdc-108">Aunque el destino es .NET Core 2,2, siga la guía de los mensajes de compilación obsoletos para adoptar nuevas API en su lugar.</span><span class="sxs-lookup"><span data-stu-id="6ffdc-108">While targeting .NET Core 2.2, follow the guidance in the obsolete build messages to adopt new APIs instead.</span></span>

#### <a name="category"></a><span data-ttu-id="6ffdc-109">Categoría</span><span class="sxs-lookup"><span data-stu-id="6ffdc-109">Category</span></span>

<span data-ttu-id="6ffdc-110">ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="6ffdc-110">ASP.NET Core</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="6ffdc-111">API afectadas</span><span class="sxs-lookup"><span data-stu-id="6ffdc-111">Affected APIs</span></span>

<span data-ttu-id="6ffdc-112">Los tipos y miembros siguientes se marcaron como obsoletos para ASP.NET Core 2.1 y 2.2:</span><span class="sxs-lookup"><span data-stu-id="6ffdc-112">The following types and members were marked as obsolete for ASP.NET Core 2.1 and 2.2:</span></span>

<span data-ttu-id="6ffdc-113">**Tipos**</span><span class="sxs-lookup"><span data-stu-id="6ffdc-113">**Types**</span></span>
...
<span data-ttu-id="6ffdc-114">**Constructores**</span><span class="sxs-lookup"><span data-stu-id="6ffdc-114">**Constructors**</span></span>
...
- [<span data-ttu-id="6ffdc-117">Microsoft.AspNetCore.Mvc.Routing.KnownRouteValueConstraint()</span><span class="sxs-lookup"><span data-stu-id="6ffdc-117">Microsoft.AspNetCore.Mvc.Routing.KnownRouteValueConstraint()</span></span>](https://docs.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.routing.knownroutevalueconstraint.-ctor?view=aspnetcore-2.2#Microsoft_AspNetCore_Mvc_Routing_KnownRouteValueConstraint__ctor)
...
<span data-ttu-id="6ffdc-119">**Propiedades**</span><span class="sxs-lookup"><span data-stu-id="6ffdc-119">**Properties**</span></span>
...
<span data-ttu-id="6ffdc-120">**Métodos**</span><span class="sxs-lookup"><span data-stu-id="6ffdc-120">**Methods**</span></span>
