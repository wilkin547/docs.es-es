...
Las API afectadas se marcan con el modificador de acceso [internal](/dotnet/csharp/language-reference/keywords/internal) y ya no se pueden usar en el código fuera de ese ensamblado.
