...
- Si se necesita la compatibilidad con `Encoding.GetEncoding("utf-7", ...)`:
  ...
  Puede volver a habilitarla mediante un modificador de compatibilidad. Este modificador de compatibilidad se puede especificar en el archivo *. csproj* de la aplicación o en un [archivo de configuración en tiempo de ejecución](../../../../docs/core/run-time-config/index.md), como se muestra en los ejemplos siguientes.
