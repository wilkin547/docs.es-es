...
Cree instancias de tipos de struct mediante el operador `new` o el [literal predeterminado](../../../../docs/csharp/language-reference/operators/default.md#default-literal).
