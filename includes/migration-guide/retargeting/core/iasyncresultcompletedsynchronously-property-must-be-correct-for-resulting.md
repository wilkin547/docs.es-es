...
---
### <a name="iasyncresultcompletedsynchronously-property-must-be-correct-for-the-resulting-task-to-complete"></a><span data-ttu-id="6a11c-101">La propiedad IAsyncResult.CompletedSynchronously debe ser correcta para que se complete la tarea resultante</span><span class="sxs-lookup"><span data-stu-id="6a11c-101">IAsyncResult.CompletedSynchronously property must be correct for the resulting task to complete</span></span>

#### <a name="details"></a><span data-ttu-id="6a11c-102">Detalles</span><span class="sxs-lookup"><span data-stu-id="6a11c-102">Details</span></span>

<span data-ttu-id="6a11c-103">Al llamar a TaskFactory.FromAsync, la implementación de la propiedad <xref:System.IAsyncResult.CompletedSynchronously> debe ser correcta para que se complete la tarea resultante.</span><span class="sxs-lookup"><span data-stu-id="6a11c-103">When calling TaskFactory.FromAsync, the implementation of the <xref:System.IAsyncResult.CompletedSynchronously> property must be correct for the resulting task to complete.</span></span> <span data-ttu-id="6a11c-104">Es decir, la propiedad debe devolver true solo si la implementación se completó de manera sincrónica.</span><span class="sxs-lookup"><span data-stu-id="6a11c-104">That is, the property must return true if, and only if, the implementation completed synchronously.</span></span> <span data-ttu-id="6a11c-105">Anteriormente, esta propiedad no se comprobaba.</span><span class="sxs-lookup"><span data-stu-id="6a11c-105">Previously, the property was not checked.</span></span>

#### <a name="suggestion"></a><span data-ttu-id="6a11c-106">Sugerencia</span><span class="sxs-lookup"><span data-stu-id="6a11c-106">Suggestion</span></span>

<span data-ttu-id="6a11c-107">Si las implementaciones de <xref:System.IAsyncResult?displayProperty=fullName> devuelven true para la propiedad <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> solo cuando una tarea se completa de manera sincrónica, no se observará ninguna interrupción.</span><span class="sxs-lookup"><span data-stu-id="6a11c-107">If <xref:System.IAsyncResult?displayProperty=fullName> implementations correctly return true for the <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> property only when a task completed synchronously, then no break will be observed.</span></span> <span data-ttu-id="6a11c-108">Los usuarios deberían revisar las implementaciones de <xref:System.IAsyncResult?displayProperty=fullName> que posean (en caso de poseer alguna) para asegurarse de que evalúan correctamente si una tarea se completó de forma sincrónica o no.</span><span class="sxs-lookup"><span data-stu-id="6a11c-108">Users should review <xref:System.IAsyncResult?displayProperty=fullName> implementations they own (if any) to ensure that they correctly evaluate whether a task completed synchronously or not.</span></span>

| <span data-ttu-id="6a11c-109">NOMBRE</span><span class="sxs-lookup"><span data-stu-id="6a11c-109">Name</span></span>    | <span data-ttu-id="6a11c-110">Valor</span><span class="sxs-lookup"><span data-stu-id="6a11c-110">Value</span></span>       |
|:--------|:------------|
| <span data-ttu-id="6a11c-111">Ámbito</span><span class="sxs-lookup"><span data-stu-id="6a11c-111">Scope</span></span>   | <span data-ttu-id="6a11c-112">Borde</span><span class="sxs-lookup"><span data-stu-id="6a11c-112">Edge</span></span>        |
| <span data-ttu-id="6a11c-113">Versión</span><span class="sxs-lookup"><span data-stu-id="6a11c-113">Version</span></span> | <span data-ttu-id="6a11c-114">4.5</span><span class="sxs-lookup"><span data-stu-id="6a11c-114">4.5</span></span>         |
| <span data-ttu-id="6a11c-115">Tipo</span><span class="sxs-lookup"><span data-stu-id="6a11c-115">Type</span></span>    | <span data-ttu-id="6a11c-116">Redestinación</span><span class="sxs-lookup"><span data-stu-id="6a11c-116">Retargeting</span></span> |

#### <a name="affected-apis"></a><span data-ttu-id="6a11c-117">API afectadas</span><span class="sxs-lookup"><span data-stu-id="6a11c-117">Affected APIs</span></span>
