...
- [Mejora del control de cadenas de búsqueda vacías por parte de LastIndexOf](#lastindexof-has-improved-handling-of-empty-search-strings)
...
- [TextFormatFlags.ModifyString está obsoleto](#textformatflagsmodifystring-is-obsolete)
