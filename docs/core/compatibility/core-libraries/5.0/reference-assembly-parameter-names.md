...
---
# <a name="parameter-names-changed-in-reference-assemblies"></a><span data-ttu-id="4ed60-103">Nombres de parámetros modificados en ensamblados de referencia</span><span class="sxs-lookup"><span data-stu-id="4ed60-103">Parameter names changed in reference assemblies</span></span>

<span data-ttu-id="4ed60-104">Se han cambiado algunos nombres de parámetros de ensamblado de referencia para coincidir con los nombres de parámetro de los ensamblados de implementación.</span><span class="sxs-lookup"><span data-stu-id="4ed60-104">Some reference assembly parameter names have changed to match parameter names in the implementation assemblies.</span></span>

## <a name="change-description"></a><span data-ttu-id="4ed60-105">Descripción del cambio</span><span class="sxs-lookup"><span data-stu-id="4ed60-105">Change description</span></span>

<span data-ttu-id="4ed60-106">En versiones anteriores de .NET, algunos nombres de parámetros de [ensamblado de referencia](../../../../standard/assembly/reference-assemblies.md) son diferentes de sus parámetros correspondientes en el ensamblado de implementación.</span><span class="sxs-lookup"><span data-stu-id="4ed60-106">In previous .NET versions, some [reference assembly](../../../../standard/assembly/reference-assemblies.md) parameter names are different to their corresponding parameters in the implementation assembly.</span></span> <span data-ttu-id="4ed60-107">Esto puede producir problemas al usar argumentos con nombre y reflexión.</span><span class="sxs-lookup"><span data-stu-id="4ed60-107">This can cause problems while using named arguments and reflection.</span></span>

<span data-ttu-id="4ed60-108">En .NET 5, estos nombres de parámetros no coincidentes se han actualizado en los ensamblados de referencia para que coincidan exactamente con los nombres de parámetro correspondientes en los ensamblados de implementación.</span><span class="sxs-lookup"><span data-stu-id="4ed60-108">In .NET 5, these mismatched parameter names were updated in the reference assemblies to exactly match the corresponding parameter names in the implementation assemblies.</span></span>

<span data-ttu-id="4ed60-109">En esta tabla se muestran las API y los nombres de los parámetros que han cambiado.</span><span class="sxs-lookup"><span data-stu-id="4ed60-109">The following table shows the APIs and parameter names that changed.</span></span>

| <span data-ttu-id="4ed60-110">API</span><span class="sxs-lookup"><span data-stu-id="4ed60-110">API</span></span> | <span data-ttu-id="4ed60-111">Nombre del parámetro antiguo</span><span class="sxs-lookup"><span data-stu-id="4ed60-111">Old parameter name</span></span> | <span data-ttu-id="4ed60-112">Nombre del parámetro nuevo</span><span class="sxs-lookup"><span data-stu-id="4ed60-112">New parameter name</span></span> |
| - | - | - |
...
## <a name="reason-for-change"></a><span data-ttu-id="4ed60-113">Motivo del cambio</span><span class="sxs-lookup"><span data-stu-id="4ed60-113">Reason for change</span></span>

<span data-ttu-id="4ed60-114">Los nombres de los parámetros se han cambiado por coherencia y para evitar errores al usar argumentos con nombre y reflexión.</span><span class="sxs-lookup"><span data-stu-id="4ed60-114">The parameter names were changed for consistency and to avoid failures when using named arguments and reflection.</span></span>

## <a name="version-introduced"></a><span data-ttu-id="4ed60-115">Versión introducida</span><span class="sxs-lookup"><span data-stu-id="4ed60-115">Version introduced</span></span>

<span data-ttu-id="4ed60-116">5.0</span><span class="sxs-lookup"><span data-stu-id="4ed60-116">5.0</span></span>

## <a name="recommended-action"></a><span data-ttu-id="4ed60-117">Acción recomendada</span><span class="sxs-lookup"><span data-stu-id="4ed60-117">Recommended action</span></span>

<span data-ttu-id="4ed60-118">Si se produce un error del compilador debido a un cambio de nombre de un parámetro, actualice el nombre del parámetro en consecuencia.</span><span class="sxs-lookup"><span data-stu-id="4ed60-118">If you encounter a compiler error due to a parameter name change, update the parameter name accordingly.</span></span>

## <a name="affected-apis"></a><span data-ttu-id="4ed60-119">API afectadas</span><span class="sxs-lookup"><span data-stu-id="4ed60-119">Affected APIs</span></span>
