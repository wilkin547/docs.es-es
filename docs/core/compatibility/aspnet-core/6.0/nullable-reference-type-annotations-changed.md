...
---
# <a name="nullable-reference-type-annotations-changed"></a><span data-ttu-id="df119-103">Las anotaciones en los tipos de referencia que aceptan valores NULL han cambiado.</span><span class="sxs-lookup"><span data-stu-id="df119-103">Nullable reference type annotations changed</span></span>

<span data-ttu-id="df119-104">_**Esta incidencia representa un trabajo en curso. Todos los cambios importantes en las anotaciones de nulabilidad se agregarán a esta incidencia a lo largo de ASP.NET Core 6.0.**_</span><span class="sxs-lookup"><span data-stu-id="df119-104">_**This issue represents a work-in-progress. All breaking changes to nullability annotations will be aggregated into this issue throughout the course of ASP.NET Core 6.0.**_</span></span>

<span data-ttu-id="df119-105">A partir de ASP.NET Core 5.0, las anotaciones de nulabilidad se han aplicado a partes del código.</span><span class="sxs-lookup"><span data-stu-id="df119-105">Starting in ASP.NET Core 5.0, nullability annotations have been applied to parts of the code.</span></span> <span data-ttu-id="df119-106">Desde el principio de este esfuerzo, [se esperaban errores](https://github.com/dotnet/runtime/blob/main/docs/coding-guidelines/api-guidelines/nullability.md#breaking-change-guidance) en estas anotaciones y es necesario realizar correcciones.</span><span class="sxs-lookup"><span data-stu-id="df119-106">From the outset of this effort, [mistakes were expected](https://github.com/dotnet/runtime/blob/main/docs/coding-guidelines/api-guidelines/nullability.md#breaking-change-guidance) in these annotations and fixes would need to be made.</span></span> <span data-ttu-id="df119-107">En ASP.NET Core 6.0, se están actualizando algunas anotaciones aplicadas previamente.</span><span class="sxs-lookup"><span data-stu-id="df119-107">In ASP.NET Core 6.0, some previously applied annotations are being updated.</span></span> <span data-ttu-id="df119-108">Algunos de estos cambios se consideran cambios importantes en el origen.</span><span class="sxs-lookup"><span data-stu-id="df119-108">Some of these changes are considered source breaking changes.</span></span> <span data-ttu-id="df119-109">Los cambios conducen a que las API sean incompatibles o más restrictivas.</span><span class="sxs-lookup"><span data-stu-id="df119-109">The changes lead to the APIs being incompatible or more restrictive.</span></span> <span data-ttu-id="df119-110">Las API actualizadas pueden producir advertencias en tiempo de compilación cuando se usan en proyectos que tienen habilitados los tipos de referencia que aceptan valores NULL.</span><span class="sxs-lookup"><span data-stu-id="df119-110">The updated APIs may result in build-time warnings when used in projects that have nullable reference types enabled.</span></span>

<span data-ttu-id="df119-111">Para obtener información, vea la incidencia de GitHub [dotnet/aspnetcore#27564](https://github.com/dotnet/aspnetcore/issues/27564).</span><span class="sxs-lookup"><span data-stu-id="df119-111">For discussion, see GitHub issue [dotnet/aspnetcore#27564](https://github.com/dotnet/aspnetcore/issues/27564).</span></span>

## <a name="version-introduced"></a><span data-ttu-id="df119-112">Versión introducida</span><span class="sxs-lookup"><span data-stu-id="df119-112">Version introduced</span></span>

<span data-ttu-id="df119-113">6.0</span><span class="sxs-lookup"><span data-stu-id="df119-113">6.0</span></span>

## <a name="old-behavior"></a><span data-ttu-id="df119-114">Comportamiento anterior</span><span class="sxs-lookup"><span data-stu-id="df119-114">Old behavior</span></span>

<span data-ttu-id="df119-115">Las API afectadas tienen anotaciones de tipo de referencia que aceptan valores NULL incorrectas.</span><span class="sxs-lookup"><span data-stu-id="df119-115">The affected APIs have incorrect nullable reference type annotations.</span></span> <span data-ttu-id="df119-116">Las advertencias de compilación faltan o son incorrectas.</span><span class="sxs-lookup"><span data-stu-id="df119-116">Build warnings are either absent or incorrect.</span></span>

## <a name="new-behavior"></a><span data-ttu-id="df119-117">Comportamiento nuevo</span><span class="sxs-lookup"><span data-stu-id="df119-117">New behavior</span></span>

<span data-ttu-id="df119-118">Se generan nuevas advertencias de compilación.</span><span class="sxs-lookup"><span data-stu-id="df119-118">New build warnings are produced.</span></span> <span data-ttu-id="df119-119">Ya no se generan advertencias de compilación incorrectas para las API afectadas.</span><span class="sxs-lookup"><span data-stu-id="df119-119">Incorrect build warnings are no longer produced for the affected APIs.</span></span>

## <a name="reason-for-change"></a><span data-ttu-id="df119-120">Motivo del cambio</span><span class="sxs-lookup"><span data-stu-id="df119-120">Reason for change</span></span>

<span data-ttu-id="df119-121">Gracias a comentarios y pruebas adicionales, se ha determinado que las anotaciones que aceptan valores NULL de las API afectadas eran inexactas.</span><span class="sxs-lookup"><span data-stu-id="df119-121">Through feedback and further testing, the nullable annotations for the affected APIs were determined to be inaccurate.</span></span> <span data-ttu-id="df119-122">Las anotaciones actualizadas representan ahora correctamente los contratos de nulabilidad de las API.</span><span class="sxs-lookup"><span data-stu-id="df119-122">The updated annotations now correctly represent the nullability contracts for the APIs.</span></span>

## <a name="recommended-action"></a><span data-ttu-id="df119-123">Acción recomendada</span><span class="sxs-lookup"><span data-stu-id="df119-123">Recommended action</span></span>

<span data-ttu-id="df119-124">Actualice el código que llama a estas API para reflejar los contratos de nulabilidad revisados.</span><span class="sxs-lookup"><span data-stu-id="df119-124">Update code calling these APIs to reflect the revised nullability contracts.</span></span>

## <a name="affected-apis"></a><span data-ttu-id="df119-125">API afectadas</span><span class="sxs-lookup"><span data-stu-id="df119-125">Affected APIs</span></span>
...
## <a name="see-also"></a><span data-ttu-id="df119-126">Vea también</span><span class="sxs-lookup"><span data-stu-id="df119-126">See also</span></span>

- [<span data-ttu-id="df119-127">Cambios en las anotaciones de tipos de referencia que aceptan valores NULL en las bibliotecas .NET básicas</span><span class="sxs-lookup"><span data-stu-id="df119-127">Nullable reference type annotation changes in core .NET libraries</span></span>](../../core-libraries/6.0/nullable-ref-type-annotation-changes.md)
