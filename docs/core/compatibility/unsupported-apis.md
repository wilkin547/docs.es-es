...
Las siguientes API siempre producen una excepción <xref:System.PlatformNotSupportedException> cuando se ejecutan en .NET Core en la plataforma especificada.
