...
---
# <a name="migrate-from-net-core-20-to-21"></a>Migrar de .NET Core 2.0 a 2.1

En este artículo se muestran los pasos básicos para migrar la aplicación de .NET Core 2.0 a 2.1. Si está pensando en migrar la aplicación de ASP.NET Core a 2.1, vea [Migrate from ASP.NET Core 2.0 to 2.1](/aspnet/core/migration/20_21) (Migrar de ASP.NET Core 2.0 a 2.1).

Para obtener información general de las nuevas características de .NET Core 2.1, vea [What's new in .NET Core 2.1](../whats-new/dotnet-core-2-1.md) (Novedades de .NET Core 2.1).
...
[Migrate from ASP.NET Core 2.0 to 2.1](/aspnet/core/migration/20_21) (Migrar de ASP.NET Core 2.0 a 2.1)  
