---
title: "Creación de imágenes de Docker de .NET Core | Microsoft Docs"
...
## Optimizaciones de imágenes de Docker
...
## Creación de la aplicación de API web
