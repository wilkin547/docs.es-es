---
title: Tipo de aplicaciones .NET Core
description: Tipo de aplicaciones .NET Core
...
# <a name="net-core-app-types"></a>Tipo de aplicaciones .NET Core

## <a name="content-moved"></a>El contenido se ha movido.
Este contenido se ha combinado y movido al tema [Implementación de aplicaciones .NET Core](deploying/index.md). 
