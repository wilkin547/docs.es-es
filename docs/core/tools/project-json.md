...
Con esto se omiten las advertencias `The variable 'var' is assigned but its value is never used` y `The variable 'var' is assigned but its value is never used`
