...
| Aplicación web de ASP.NET Core                         | `razor`, `webapp`| [C#]          |
...
| Biblioteca de clases de Razor                          | `razorclasslib`  | [C#]          |
...
El comando contiene una lista predeterminada de plantillas. Use `dotnet new -l` para obtener una lista de las plantillas disponibles. En la tabla siguiente se muestran las plantillas que vienen preinstaladas con el SDK de .NET Core 2.0. El lenguaje predeterminado de la plantilla se muestra entre corchetes.
...
El comando contiene una lista predeterminada de plantillas. Use `dotnet new -all` para obtener una lista de las plantillas disponibles. En la tabla siguiente se muestran las plantillas que vienen preinstaladas con el SDK de .NET 1.x. El lenguaje predeterminado de la plantilla se muestra entre corchetes.
