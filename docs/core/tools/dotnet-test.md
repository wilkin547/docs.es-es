...
Para más información sobre RunSettings, consulte [vstest.console.exe: Paso de argumentos RunSettings](https://github.com/Microsoft/vstest-docs/blob/master/docs/RunSettingsArguments.md).
