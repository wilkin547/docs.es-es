...
# <a name="visual-basictabvisual-basic"></a>[Visual Basic](#tab/visual-basic)
   ...
   <a name="visual-studio-program-window-with-breakpoint-setmediadebugging-with-visual-studiovb-setbreakpointpng"></a>![Ventana del programa Visual Studio con el punto de interrupción establecido](./media/debugging-with-visual-studio/vb-setbreakpoint.png)
---
...
# <a name="visual-basictabvisual-basic"></a>[Visual Basic](#tab/visual-basic)
   <a name="visual-studio-application-windowmediadebugging-with-visual-studiovb-breakpng"></a>![Ventana de la aplicación de Visual Studio](./media/debugging-with-visual-studio/vb-break.png)
---
