...
ms.locfileid: "57677804"
---
# <a name="getting-started-with-aspnet-core"></a>Introducción a ASP.NET Core

Para ver tutoriales sobre el desarrollo de aplicaciones web ASP.NET Core, vea los [tutoriales de ASP.NET Core](/aspnet/core/tutorials).
