...
En la tabla siguiente se muestra una lista de versiones de .NET Core actualmente compatibles y las versiones de Windows en las que se admiten. Estas versiones siguen siendo compatibles hasta que la versión de [.NET Core llega al fin del soporte técnico](https://dotnet.microsoft.com/platform/support/policy/dotnet-core) o la versión de [Windows llega al final del ciclo de vida](https://support.microsoft.com/help/13853/windows-lifecycle-fact-sheet).
...
- Cuando una versión de Windows y una versión de .NET Core tienen una marca ✔️, significa que se admite esa combinación de sistema operativo y .NET.

| Sistema operativo                      | .NET Core 2.1 | .NET Core 3.1 | .NET 5 (versión preliminar) |
|-----------------------------|---------------|---------------|----------------|
| ✔️ Windows 10, versión 2004 | ✔️ 2.1        | ✔️ 3.1        | ✔️ 5.0 (versión preliminar) |
| ✔️ Windows 10, versión 1909 | ✔️ 2.1        | ✔️ 3.1        | ✔️ 5.0 (versión preliminar) |
| ✔️ Windows 10, versión 1903 | ✔️ 2.1        | ✔️ 3.1        | ✔️ 5.0 (versión preliminar) |
| ✔️ Windows 10, versión 1809 | ✔️ 2.1        | ✔️ 3.1        | ✔️ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1803 | ✔️ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1709 | ❌ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1703 | ❌ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1607 | ❌ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1511 | ❌ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
| ❌ Windows 10, versión 1507 | ❌ 2.1        | ❌ 3.1        | ❌ 5.0 (versión preliminar) |
...
Ejecuta aplicaciones de escritorio de .NET Core WPF y NET Core de Windows Forms para Windows. Incluye el entorno de ejecución de .NET Core.
...
- [Cómo comprobar que .NET Core ya está instalado](how-to-detect-installed-versions.md?pivots=os-windows).
