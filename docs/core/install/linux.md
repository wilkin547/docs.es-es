...
| ❌ [19.10](linux-ubuntu.md#1910-)       | ✔️ 2.1        | ✔️ 3.1        | ✔️ 5.0 (versión preliminar) |
...
- [Cómo comprobar que .NET Core ya está instalado](how-to-detect-installed-versions.md?pivots=os-linux).
