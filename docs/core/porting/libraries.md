...
En este artículo se supone que usa Visual Studio 2015 o posterior en Windows.  Los bits necesarios para compilar el código de .NET Core no están disponibles en las versiones anteriores de Visual Studio.
...
* [xUnit](https://xunit.github.io/)
   - [Introducción](http://xunit.github.io/docs/getting-started-dnx.html)
