...
> [!WARNING]
> Este tema se aplica a .NET Core Tools RC4. Para la versión .NET Core Tools Preview 2, consulte el tema [dotnet-run](../../tools/dotnet-run.md).
...
Especifica el proyecto que se va a ejecutar. Puede ser una ruta de acceso a un archivo [csproj](csproj.md) o a un directorio que contiene un archivo [csproj](csproj.md). Si no se especifica, se toma como predeterminado el directorio actual. 
