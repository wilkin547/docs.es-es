...
## <a name="simpleSelf"></a> <span data-ttu-id="8d9fe-155">Implementación independiente sin dependencias de terceros</span><span class="sxs-lookup"><span data-stu-id="8d9fe-155">Self-contained deployment without third-party dependencies</span></span>
