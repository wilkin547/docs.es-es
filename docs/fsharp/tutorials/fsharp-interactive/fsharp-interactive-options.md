...
|**--checked**[**+**&#124;**-**]|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
|**--codepage:&lt;int&gt;**|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
|**--crossoptimize**[**+**&#124;**-**]|Habilitar o deshabilitar las optimizaciones entre módulos.|
|**--debug**[**+**&#124;**-**]<br /><br />**--debug:**[**full**&#124;**pdbonly**]<br /><br />**-g**[**+**&#124;**-**]<br /><br />**-g:**[**full**&#124;**pdbonly**]|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
|**--define:&lt;string&gt;**|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
...
|**--lib:&lt;folder-list&gt;**<br /><br />**-I:&lt;folder-list&gt;**|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
...
|**--nowarn:&lt;warning-list&gt;**|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
|**--optimize**[**+**&#124;**-**]|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
...
|**--reference:&lt;filename&gt;**<br /><br />**-r:&lt;filename&gt;**|Igual que el **fsc.exe** opción del compilador. Para obtener más información, consulte [Opciones del compilador](../../language-reference/compiler-options.md).|
