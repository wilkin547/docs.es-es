...
Para obtener más información acerca de las cadenas de conexión EDMX, consulte [las cadenas de conexión](../../../../docs/framework/data/adonet/connection-strings-and-configuration-files.md).
