...
C# 7 introdujo tuplas del lenguaje.  Tuplas en C# son estructuras y son equivalentes a las tuplas de struct en F #.  Si tiene que interoperar con C#, debe usar un struct tuplas.
