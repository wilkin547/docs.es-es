...
C# 7 introdujo tuplas del lenguaje.  Tuplas en estructuras de C# y se y son equivalentes a las tuplas de struct en F #.  Si tiene que interoperar con C# usa tuplas, debe utilizar tuplas de struct.
