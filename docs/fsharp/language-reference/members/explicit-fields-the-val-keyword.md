...
> [!WARNING]
> El espacio de `System.ComponentModel` nombres .NET Framework contiene un atributo con el mismo nombre. Para obtener más información sobre el atributo, vea <xref:System.ComponentModel.DefaultValueAttribute>.
