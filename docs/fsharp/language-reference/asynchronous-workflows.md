...
Primitivas asincrónicas adicionales están disponibles en la [F # PowerTools](http://fsprojects.github.io/VisualFSharpPowerTools/). También puede escribir a sus propios métodos primitivos asincrónicos definiendo una función cuyo cuerpo completo se incluye en un bloque asincrónico.
