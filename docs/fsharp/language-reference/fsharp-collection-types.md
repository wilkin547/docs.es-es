...
---
# <a name="f-collection-types"></a>Tipos de colección de F #
...
## <a name="table-of-collection-types"></a>Tabla de tipos de colección
...
|máx.|O (N)|O (N)|O (N)|-|-|Devuelve el mayor elemento de la colección, comparado mediante el operador [Max](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#max) .|
|Maxby (|O (N)|O (N)|O (N)|-|-|Devuelve el mayor elemento de la colección, en comparación con el uso de [Max](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#max) en el resultado de la función.|
|maxElement (|-|-|-|-|O (log (N))|Devuelve el mayor elemento del conjunto según la ordenación usada para el conjunto.|
|min.|O (N)|O (N)|O (N)|-|-|Devuelve el elemento mínimo de la colección, comparado mediante el operador [min](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#min) .|
|minBy (|O (N)|O (N)|O (N)|-|-|Devuelve el elemento mínimo de la colección, comparado mediante el operador [min](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#min) en el resultado de la función.|
...
|sort|O (N \* log (n)) promedio<br /><br />O (N ^ 2) peor de los casos|O (N \* registro (n))|O (N \* registro (n))|-|-|Ordena la colección por valor de elemento. Los elementos se comparan mediante [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|sortBy|O (N \* log (n)) promedio<br /><br />O (N ^ 2) peor de los casos|O (N \* registro (n))|O (N \* registro (n))|-|-|Ordena la lista especificada mediante el uso de claves que proporciona la proyección especificada. Las claves se comparan mediante [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|Sortinplace (|O (N \* log (n)) promedio<br /><br />O (N ^ 2) peor de los casos|-|-|-|-|Ordena los elementos de una matriz mediante la mutación y el uso de la función de comparación especificada. Los elementos se comparan mediante [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|Sortinplaceby (|O (N \* log (n)) promedio<br /><br />O (N ^ 2) peor de los casos|-|-|-|-|Ordena los elementos de una matriz mediante la mutación y el uso de la proyección especificada para las claves. Los elementos se comparan mediante [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
