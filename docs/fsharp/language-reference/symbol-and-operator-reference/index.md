...
|`:?`|[Expresiones de coincidencia](../match-expressions.md)|<ul><li>Devuelve `true` si el valor coincide con el tipo especificado; de lo contrario, devuelve `false` (operador de prueba de tipo).<br /></li></ul>|
