---
title: 'Archivos de signatura (F #)'
description: 'Obtenga información acerca de cómo usar los archivos de signatura de F # para almacenar información sobre las signaturas públicas de un conjunto de F # elementos del programa, como tipos y espacios de nombres, módulos.'
ms.date: 06/15/2018
