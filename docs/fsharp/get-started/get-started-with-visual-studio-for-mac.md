...
F # y las herramientas de Visual F # se admiten en Visual Studio para Mac IDE.  Para empezar, debe [descargar Visual Studio para Mac](https://aka.ms/vsdownload?utm_source=mscom&utm_campaign=msdocs), si no lo ha hecho ya.  En este artículo usa la 2017 de comunidad de Visual Studio para Mac, pero puede usar F # con la versión de su elección.
