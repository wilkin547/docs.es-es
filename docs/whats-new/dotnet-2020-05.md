...
Novedades de los documentos de .NET para el 2020 de mayo. En este artículo se enumeran algunos de los cambios más importantes de documentación que se han producido durante este período.
...
- Administrador de paquetes de 8 a 8: instalación de .NET Core: adición de instrucciones de instalación para la entrega 8
- Administrador de paquetes de Fedora 32: instalación de .NET Core
...
- [Cómo: localizar una aplicación](/dotnet/desktop/wpf/advanced/how-to-localize-an-application) : correcciones varias
...
: octocat: ¿desea colaborar en los documentos de .NET? Lea nuestra [guía para colaboradores](/contribute/dotnet/dotnet-contribute).
