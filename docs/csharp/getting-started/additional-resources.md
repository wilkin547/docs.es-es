---
title: "Otros recursos para los programadores de Visual C# | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "lenguaje C#, información adicional"
  - "foros [C#]"
  - "Ayuda, recursos de C#"
  - "grupos de noticias [C#]"
  - "Visual C#, recursos adicionales"
  - "Visual C#, información adicional"
...
### En la web  
 [Centro de desarrolladores de Microsoft Visual C\#](http://go.microsoft.com/fwlink/?LinkId=47811)  
...
### Compatibilidad  
 [Archivar errores o realizar sugerencias](http://go.microsoft.com/fwlink/?LinkID=79804)  
...
## Recursos de terceros  
 El sitio web de MSDN proporciona información sobre sitios de otros fabricantes y grupos de noticias de interés.  Para obtener la lista de recursos más actualizada disponible, consulte el [sitio web de la comunidad de C\# en MSDN](http://go.microsoft.com/fwlink/?LinkId=165945).  
  
## Vea también  
 [C\#](../../csharp/csharp.md)   
 [Introducción a Visual C\#](../../csharp/getting-started/getting-started-with-csharp.md)   
 [Personalizar el editor](/visual-studio/ide/customizing-the-editor)   
 [Cómo: Implicarse en la comunidad de desarrolladores](../Topic/How%20to:%20Get%20Involved%20in%20the%20Developer%20Community.md)   
 [Cómo: Enviar comentarios](../Topic/How%20to:%20Send%20Feedback%20About%20Visual%20Studio.md)   
