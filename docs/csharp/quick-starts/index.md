...
La guía de inicio rápido [Cadenas interpoladas](interpolated-strings.yml) muestra cómo insertar una expresión en una cadena más larga. Obtendrá información sobre cómo definir una expresión de interpolación, cómo crear una cadena de resultado de una cadena interpolada que tiene una o varias expresiones de interpolación y cómo controlar el formato, el ancho de columna y la alineación de expresiones incluidas en la cadena de resultados. 
