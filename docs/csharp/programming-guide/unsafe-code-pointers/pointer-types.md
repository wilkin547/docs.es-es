---
title: "Tipos de puntero (Gu&#237;a de programaci&#243;n de C#) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
```  
 ...
 Un puntero no puede señalar a una referencia o a un [struct](../../../csharp/language-reference/keywords/struct.md) que contenga referencias, porque una referencia object puede recolectarse como elemento no utilizado aunque haya un puntero que la señale.  El recolector de elementos no utilizados no realiza un seguimiento de si algún tipo de puntero señala a un objeto.  
