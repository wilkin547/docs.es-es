---
title: "Acceder a atributos mediante reflexión (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="see-also"></a>Vea también  
 ...
 [Attributes (C#)](../../../../csharp/programming-guide/concepts/attributes/index.md)  (Atributos [C#])  
