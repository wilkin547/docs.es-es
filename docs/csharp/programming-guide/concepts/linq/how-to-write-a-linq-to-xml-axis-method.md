---
title: "Cómo: Escribir un método de eje de LINQ to XML (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="example"></a>Ejemplo  
 El siguiente ejemplo usa dos métodos de extensión. El primer método de extensión, `GetXPath`, opera en <xref:System.Xml.Linq.XObject> y devuelve una expresión XPath que, cuando se evalúa, devuelve el nodo o el atributo. El segundo método de extensión, `Find`, opera en <xref:System.Xml.Linq.XElement>. Devuelve una colección de objetos <xref:System.Xml.Linq.XAttribute> y de objetos <xref:System.Xml.Linq.XElement> que contienen algún texto especificado.  
