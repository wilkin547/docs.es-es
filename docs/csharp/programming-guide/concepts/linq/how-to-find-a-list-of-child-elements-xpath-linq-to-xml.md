---
title: "Cómo: Buscar una lista de elementos secundarios (XPath-LINQ to XML (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
En este tema se compara el eje de elementos secundarios de XPath con el eje <xref:System.Xml.Linq.XContainer.Elements%2A> de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].  
