...
|[Cómo: Buscar un elemento secundario (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)|Compara el eje del elemento secundario XPath con el método [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Element%2A>.<br /><br /> La expresión XPath asociada es:`"DeliveryNotes"`.|  
|[How to: Find a List of Child Elements (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md) (Cómo: Buscar una lista de elementos secundarios (XPath-LINQ to XML) [C#])|Compara el eje de los elementos secundarios XPath con el eje [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Elements%2A>.<br /><br /> La expresión XPath asociada es:`"./*"`|  
...
|[Cómo: Buscar elementos de un espacio de nombres (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace-xpath-linq-to-xml.md)|Compara el uso de la clase XPath <xref:System.Xml.XmlNamespaceManager> con la propiedad [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XName.Namespace%2A> de la clase <xref:System.Xml.Linq.XName> para trabajar con espacios de nombres XML.<br /><br /> La expresión XPath asociada es:`"./aw:*"`|  
|[How to: Find Preceding Siblings (XPath-LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md) (Cómo: Buscar elementos anteriores del mismo nivel (XPath-LINQ to XML) [C#])|Compara el eje `preceding-sibling` de XPath con el eje secundario de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XNode.ElementsBeforeSelf%2A?displayProperty=fullName>.<br /><br /> La expresión XPath asociada es:`"preceding-sibling::*"`|  
