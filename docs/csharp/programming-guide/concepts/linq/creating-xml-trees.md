...
|[Analizar XML (C#)](../../../../csharp/programming-guide/concepts/linq/parsing-xml.md)|Muestra cómo analizar XML desde varios orígenes. [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] se superpone a <xref:System.Xml.XmlReader>, que se usa para analizar el código XML.|  
