---
title: "Cómo: Buscar un elemento secundario (XPath-LINQ to XML) (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
En este tema se compara el eje del elemento secundario de XPath con el método <xref:System.Xml.Linq.XContainer.Element%2A> de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].  
