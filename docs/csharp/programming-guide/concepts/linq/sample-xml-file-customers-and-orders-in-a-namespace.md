...
description: Este archivo XML se usa en numerosos ejemplos de la documentación de LINQ to XML. El archivo contiene clientes y pedidos. El XML se encuentra en un espacio de nombres.
ms.date: 07/20/2015
...
ms.locfileid: "87302547"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="58fc4-105">Archivo XML de ejemplo: Clientes y pedidos en un espacio de nombres</span><span class="sxs-lookup"><span data-stu-id="58fc4-105">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="58fc4-106">El siguiente archivo XML se usa en numerosos ejemplos de la documentación de [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].</span><span class="sxs-lookup"><span data-stu-id="58fc4-106">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="58fc4-107">Este archivo contiene clientes y pedidos.</span><span class="sxs-lookup"><span data-stu-id="58fc4-107">This file contains customers and orders.</span></span> <span data-ttu-id="58fc4-108">El XML se encuentra en un espacio de nombres.</span><span class="sxs-lookup"><span data-stu-id="58fc4-108">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="58fc4-109">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="58fc4-109">CustomersOrdersInNamespace.xml</span></span>  
