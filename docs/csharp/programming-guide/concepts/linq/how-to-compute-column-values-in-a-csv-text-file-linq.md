---
title: "Cómo: Calcular valores de columna en un archivo de texto CSV (LINQ) (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-compute-column-values-in-a-csv-text-file-linq-c"></a>Cómo: Calcular valores de columna en un archivo de texto CSV (LINQ) (C#)
