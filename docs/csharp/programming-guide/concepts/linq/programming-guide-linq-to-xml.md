---
title: "Guía de programación (LINQ to XML) (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="who-should-read-this-documentation"></a>A quiénes va destinada esta documentación  
 Esta documentación se dirige a aquellos desarrolladores que ya conocen C# y algunos aspectos básicos de [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)].  
  
 El objetivo de esta documentación es facilitar el uso de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] a todo tipo de desarrolladores. [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] hace que la programación XML sea más sencilla. No necesita ser un experto desarrollador para utilizarla.  
  
 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] se basa principalmente en clases genéricas. Por tanto, es muy importante que comprenda cómo se utilizan las clases genéricas. Más aún, resultaría de utilidad que estuviera familiarizado con los delegados que se declaran como tipos parametrizados. Si no está familiarizado con las clases genéricas de C#, vea [Clases genéricas](../../../../csharp/programming-guide/generics/generic-classes.md).  
...
|[Modificar árboles XML (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/modifying-xml-trees-linq-to-xml.md)|Al igual que el Modelo de objetos de documento (DOM), [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] le permite modificar un árbol XML directamente.|  
