...
En este tema se compara [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] con las siguientes tecnologías XML: <xref:System.Xml.XmlReader>, XSLT, MSXML y XmlLite. Esta información puede ayudarle a decidir la tecnología que utilizará.  
...
## <a name="linq-to-xml-vs-xmlreader"></a>LINQ to XML frente a XmlReader  
 ...
 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] se implementa sobre <xref:System.Xml.XmlReader> y ambos están estrechamente integrados. Pero también se puede usar <xref:System.Xml.XmlReader> de forma independiente.  
  
 Por ejemplo, supongamos que está creando un servicio Web que analizará cientos de documentos XML por segundo y los documentos tienen la misma estructura, lo que significa que solo tiene que escribir una implementación de código para analizar el XML. En ese caso, probablemente quiera usar <xref:System.Xml.XmlReader> de forma independiente.  
