...
Debido a la [ejecución diferida](../linq/deferred-execution-example.md) con LINQ, se llama a <xref:System.Linq.Enumerable.ToList%2A?displayProperty=nameWithType> para iniciar cada tarea.
