...
## <a name="example"></a>Ejemplo  
 En el ejemplo siguiente se muestra cómo comparar cadenas de la manera más recomendable mediante los métodos <xref:System.String?displayProperty=fullName> que toman una enumeración <xref:System.StringComparison>. Observe que aquí no se usan los métodos de instancia <xref:System.String.CompareTo%2A?displayProperty=fullName>, ya que ninguna de las sobrecargas toma un parámetro <xref:System.StringComparison>.  
...
## <a name="see-also"></a>Vea también  
 ...
 [Comparación de cadenas](http://msdn.microsoft.com/library/977dc094-fe19-4955-98ec-d2294d04a4ba)   
