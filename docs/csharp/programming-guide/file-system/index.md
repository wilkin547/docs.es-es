...
|[Cómo: Creación de un archivo o una carpeta](../../../csharp/programming-guide/file-system/how-to-create-a-file-or-folder.md)|Muestra cómo crear un archivo o una carpeta nuevos.|  
...
|[Cómo: Escribir en un archivo de texto](../../../csharp/programming-guide/file-system/how-to-write-to-a-text-file.md)|Muestra cómo escribir en un archivo de texto.|  
