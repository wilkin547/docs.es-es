...
## <a name="see-also"></a>Vea también  
 ...
 [Visual Studio 2008 ejemplos de C# (vea ejemplos de consultas LINQ archivos y el programa XQuery)](http://code.msdn.microsoft.com/Visual-Studio-2008-C-d295cdba)  
