...
4. En la pestaña **Examinar**, vaya a la carpeta donde están instaladas las bibliotecas de IronPython. Por ejemplo, C:\Archivos de programa\IronPython 2.6 para .NET Framework 4.0. Seleccione las bibliotecas **IronPython.dll**, **IronPython.Modules.dll**, **Microsoft.Scripting.dll** y **Microsoft.Dynamic.dll**. Haga clic en **Aceptar**.
