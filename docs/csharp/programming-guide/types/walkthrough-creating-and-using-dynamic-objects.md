...
Necesita [IronPython](http://ironpython.net/) para .NET completar este tutorial. Vaya a sus [página de descarga](http://ironpython.net/download/) para obtener la versión más reciente.
