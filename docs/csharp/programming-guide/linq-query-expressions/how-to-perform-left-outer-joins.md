---
title: "C&#243;mo: Realizar operaciones de combinaci&#243;n externa izquierda (Gu&#237;a de programaci&#243;n de C#) | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "combinaciones externa izquierda [LINQ en C#]"
  - "combinaciones [C#], externas izquierdas"
...
Una combinación externa izquierda es una combinación en la que se devuelve un resultado para cada elemento de la primera colección, independientemente de si éste tiene elementos correlacionados en la segunda colección.  Puede utilizar [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq_md.md)] para realizar una combinación externa izquierda llamando al método de <xref:System.Linq.Enumerable.DefaultIfEmpty%2A> en los resultados de una combinación agrupada.  
...
-   Cree un nuevo proyecto de aplicación de consola en [!INCLUDE[vs_current_short](../../../csharp/programming-guide/classes-and-structs/includes/vs_current_short_md.md)].  
