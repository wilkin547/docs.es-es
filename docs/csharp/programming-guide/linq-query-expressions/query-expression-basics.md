...
> [!NOTE]
>  En la documentación de [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq-md.md)], las variables que almacenan una consulta incluyen la palabra "query" como parte de sus nombres.  Las variables que almacenan un resultado real no incluyen "query" en sus nombres.  
