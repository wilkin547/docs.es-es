...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "argumentos [C#], línea de comandos"
  - "lenguaje C#, argumentos de la línea de comandos"
  - "línea de comandos [C#], argumentos"
  - "argumentos de la línea de comandos [C#], Main (método)"
  - "Main (método) [C#]"
