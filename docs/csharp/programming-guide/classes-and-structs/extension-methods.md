...
description: En C#, los métodos de extensión permiten agregar métodos a los tipos existentes sin crear un tipo derivado, recompilar o modificar de otra manera el tipo original.
ms.date: 03/19/2020
helpviewer_keywords:
