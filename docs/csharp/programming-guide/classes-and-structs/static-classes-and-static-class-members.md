...
description: En C# no se pueden crear instancias de las clases abstractas. Para acceder a los miembros de una clase estática, debe usar el nombre de la propia clase.
ms.date: 07/20/2015
helpviewer_keywords:
...
> [!NOTE]
> Para crear una clase no estática que solo permita la creación de una instancia de sí misma, vea [Implementing Singleton in C#](/previous-versions/msp-n-p/ff650316(v=pandp.10)) (Implementar un singleton en C#).  
