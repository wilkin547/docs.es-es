...
Un método asincrónico no puede declarar ningún parámetro [ref](https://msdn.microsoft.com/library/14akc2c7.aspx) ni [out](https://msdn.microsoft.com/library/t3c3bfhx.aspx), pero puede llamar a métodos que tienen estos parámetros.
