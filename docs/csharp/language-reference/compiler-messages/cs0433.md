...
El tipo TypeName1 existe tanto en TypeName2 como en TypeName3  
 ...
 Para resolver este error, use la característica de alias de la opción del compilador ([**References**](../compiler-options/inputs.md#references)) o no haga referencia a uno de los ensamblados.  
