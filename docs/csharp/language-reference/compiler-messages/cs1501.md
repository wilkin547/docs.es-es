...
---
# <a name="compiler-error-cs1501"></a>Error del compilador CS1501
Ninguna sobrecarga para el método "method" acepta argumentos "number"  
  
 Se ha realizado una llamada a un método de clase, pero ninguna definición del método toma el número especificado de argumentos.  
  
## <a name="example"></a>Ejemplo  
 El ejemplo siguiente genera la advertencia CS1501.  
