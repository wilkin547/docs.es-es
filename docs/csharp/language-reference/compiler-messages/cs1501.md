...
Ninguna sobrecarga para el método 'método' acepta 'número' argumentos  
 ...
 Se realizó una llamada a un método de clase, pero ninguna definición de método toma el número especificado de argumentos.  
  
## Ejemplo  
 El ejemplo siguiente genera el error CS1501.  
