...
Una conversión con el operador [as](../../language-reference/operators/type-testing-and-cast.md#as-operator) se permite mediante herencia, conversiones de referencia y conversiones boxing.
