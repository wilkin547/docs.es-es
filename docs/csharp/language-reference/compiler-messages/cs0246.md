---
title: Compiler Error CS0246 (Error del compilador CS0246) | Microsoft Docs
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
