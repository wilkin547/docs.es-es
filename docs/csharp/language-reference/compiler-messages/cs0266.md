...
No se puede convertir implícitamente el tipo "type1" en "type2". Existe una conversión explícita (compruebe si le falta una conversión)  
 ...
 Este error se produce cuando el código intenta convertir entre dos tipos que no se pueden convertir implícitamente, pero donde hay una conversión explícita. Para más información, vea [Conversiones de tipos](../../programming-guide/types/casting-and-type-conversions.md).  
