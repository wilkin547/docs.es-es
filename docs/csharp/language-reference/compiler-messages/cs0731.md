...
---
# <a name="compiler-error-cs0731"></a>Error del compilador CS0731
El reenviador del tipo 'type' en el ensamblado 'assembly' crea un ciclo  
  
 Este error solo puede aparecer con metadatos importados formados incorrectamente. No puede aparecer solo con código fuente C#.  
  
## <a name="example"></a>Ejemplo  
 En el ejemplo siguiente se genera la advertencia CS0731. El ejemplo consta de tres archivos:  
 ...
 En primer lugar, compile los archivos .IL como bibliotecas y, después, compile el código .cs haciendo referencia a los dos archivos.  
