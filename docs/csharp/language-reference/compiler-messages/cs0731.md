...
El reenviador del tipo 'tipo' en el ensamblado 'ensamblado' crea un ciclo  
 ...
 Este error sólo puede aparecer con metadatos importados formados incorrectamente.  No puede aparecer sólo con código fuente C\#.  
  
## Ejemplo  
 El ejemplo siguiente genera el error CS0731.  El ejemplo consta de tres archivos:  
 ...
 En primer lugar, compile los archivos .IL como bibliotecas y, a continuación, compile el código .cs haciendo referencia a los dos archivos.  
