...
- Ocultando la propiedad de la clase base agregando la palabra clave [new](../../../csharp/language-reference/keywords/new-modifier.md) en una propiedad de una clase derivada.  
