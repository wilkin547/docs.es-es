...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="f6b7b-102">Error del compilador CS0015</span><span class="sxs-lookup"><span data-stu-id="f6b7b-102">Compiler Error CS0015</span></span>
<span data-ttu-id="f6b7b-103">El nombre del tipo "type" es demasiado largo</span><span class="sxs-lookup"><span data-stu-id="f6b7b-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="f6b7b-104">El nombre completo de un tipo definido por el usuario debe tener menos de 1024 caracteres, incluidos los puntos.</span><span class="sxs-lookup"><span data-stu-id="f6b7b-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="f6b7b-105">En el ejemplo siguiente se genera el error CS0015:</span><span class="sxs-lookup"><span data-stu-id="f6b7b-105">The following sample generates CS0015:</span></span>  
