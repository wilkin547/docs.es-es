---
title: Error del compilador CS0015 | Microsoft Docs
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
---
# <a name="compiler-error-cs0015"></a>Error del compilador CS0015
El nombre del tipo "type" es demasiado largo  
  
 El nombre completo de un tipo definido por el usuario debe tener menos de 1024 caracteres, incluidos los puntos.  
  
 En el ejemplo siguiente se genera el error CS0015:  
