...
'class' no es una clase de atributos  
 ...
 Se ha intentado usar una clase sin atributos en un bloque de atributos. Todos los tipos de atributos tienen que heredarse desde <xref:System.Attribute?displayProperty=fullName>.  
