...
'member' está obsoleto: 'text'  
 ...
 Se ha marcado un miembro de clase con el atributo `Obsolete`, de manera que se emitirá una advertencia cuando se haga referencia al miembro de clase. Para obtener más información, vea [Atributos comunes](http://msdn.microsoft.com/library/2f48a7ec-9683-4899-a1d2-a08be8fc558b).  
