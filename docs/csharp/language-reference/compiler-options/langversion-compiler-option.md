...
|Opción|Significado|  
|------------|-------------|  
|default|El compilador acepta toda la sintaxis de lenguaje válida de la última versión principal que puede admitir. <sup id="TDefault">[Valor predeterminado](#FDefault)</sup>| 
