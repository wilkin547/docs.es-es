...
Genera sumas de comprobación de los archivos de código fuente para ayudar en la depuración de páginas [!INCLUDE[vstecasp](../../../csharp/language-reference/preprocessor-directives/includes/vstecasp-md.md)].  
