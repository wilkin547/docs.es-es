...
|[var](../../../csharp/language-reference/keywords/var.md)|[when (condición de filtro)](when.md)|[where (restricción de tipo genérico)](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|[where (cláusula de consulta)](../../../csharp/language-reference/keywords/where-clause.md)|  
