...
La palabra clave `internal` es un [modificador de acceso](../../../csharp/language-reference/keywords/access-modifiers.md) para tipos y miembros de tipo. 
 ...
 > Esta página cubre el modificador de acceso `internal`. La palabra clave `internal` también es parte del modificador de acceso [ `protected internal` ](./protected-internal.md).
...
```  
// Assembly1_a.cs  
// Compilar con: /reference:Assembly1.dll  
class TestAccess   
{  
   static void Main()   
   {  
