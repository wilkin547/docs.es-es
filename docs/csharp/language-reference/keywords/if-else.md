...
```  
 ...
 Aparecerá `Result2` si la condición `(m > 10)` se evalúa como false.  
...
## Vea también  
 ...
 [if\-else \(Instrucción\) \(C\+\+\)](/visual-cpp/cpp/if-else-statement-cpp)   
