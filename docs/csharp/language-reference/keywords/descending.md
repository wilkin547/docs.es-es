...
La palabra clave contextual `descending` se usa en la [cláusula orderby](./orderby-clause.md) en expresiones de consulta para especificar que el criterio de ordenación es de mayor a menor.

## <a name="example"></a>Ejemplo

En el ejemplo siguiente se muestra el uso de `descending` en una [cláusula orderby](./orderby-clause.md).
