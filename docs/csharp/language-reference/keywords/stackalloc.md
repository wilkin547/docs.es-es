...
Como implica tipos de puntero, `stackalloc` requiere un contexto [unsafe](unsafe.md). Para obtener más información, vea [Unsafe Code and Pointers](../../programming-guide/unsafe-code-pointers/index.md) (Código no seguro y punteros [Guía de programación de C#]).
