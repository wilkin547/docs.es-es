...
## <a name="remarks"></a>Comentarios  
 ...
 Los tipos definidos por el usuario pueden sobrecargar los operadores `-` unarios y `-` binarios. Para más información, vea [Operador (Referencia de C#)](../../../csharp/language-reference/keywords/operator.md).  
