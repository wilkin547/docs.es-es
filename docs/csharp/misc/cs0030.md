...
No se puede convertir el tipo 'type' a 'type'  
 ...
 Debe proporcionar rutinas de conversión para poder admitir ciertas sobrecargas de operador. Para obtener más información, consulta [Operadores de conversión](../../csharp/programming-guide/statements-expressions-operators/conversion-operators.md).  
