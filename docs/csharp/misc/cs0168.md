---
title: Compilador advertencia (nivel 3) CS0168 | Documentos de Microsoft
ms.date: 2016-12-21
ms.prod: .net
...
La variable 'var' se declara, pero nunca se utiliza

El compilador emite una advertencia de nivel tres al declarar una variable, pero no lo utilice.
  
El ejemplo siguiente genera una advertencia CS0168:  
