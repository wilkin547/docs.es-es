...
La declaración del método de una sobrecarga del operador debe seguir ciertas instrucciones. Para obtener más información, consulte [la sobrecarga de operadores](../../csharp/language-reference/operators/operator-overloading.md).
