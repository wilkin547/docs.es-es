...
El parámetro de un operador unario debe ser el tipo contenedor  
 ...
 La declaración del método de una sobrecarga del operador debe seguir ciertas instrucciones. Para obtener más información, vea [Operadores sobrecargables](../../csharp/programming-guide/statements-expressions-operators/overloadable-operators.md) y [Operator Overloading Sample](http://msdn.microsoft.com/en-us/1c6b4610-0a49-4532-8fa7-f694cfc65743).  
