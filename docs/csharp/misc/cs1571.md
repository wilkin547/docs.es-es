...
El comentario XML en 'construcción' tiene una etiqueta de parámetro duplicada para 'parámetro'.  
 ...
 Al usar la opción de compilador [/doc](../language-reference/compiler-options/doc-compiler-option.md) , se hallaron múltiples comentarios para el mismo parámetro de método. Quite una de las líneas duplicadas.  
