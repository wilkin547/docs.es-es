...
- Agregue una referencia al ensamblado que tenga la coclase (la mayoría de las veces, la interfaz y la coclase deben estar en el mismo ensamblado). Vea [/reference](../language-reference/compiler-options/reference-compiler-option.md) o [Agregar cuadro de diálogo de referencia](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) para obtener información.  
