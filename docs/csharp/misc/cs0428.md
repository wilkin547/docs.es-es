...
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="efcc5-102">Error del compilador CS0428</span><span class="sxs-lookup"><span data-stu-id="efcc5-102">Compiler Error CS0428</span></span>
<span data-ttu-id="efcc5-103">No se puede convertir el grupo de métodos 'Identificador' al tipo no delegado 'tipo'.</span><span class="sxs-lookup"><span data-stu-id="efcc5-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="efcc5-104">¿Ha pensado invocar el método?</span><span class="sxs-lookup"><span data-stu-id="efcc5-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="efcc5-105">Este error se produce al convertir a un grupo de métodos en un tipo no delegado o al tratar de invocar un método sin el uso de paréntesis.</span><span class="sxs-lookup"><span data-stu-id="efcc5-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="efcc5-106">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="efcc5-106">Example</span></span>  
 <span data-ttu-id="efcc5-107">El ejemplo siguiente genera la advertencia CS0428:</span><span class="sxs-lookup"><span data-stu-id="efcc5-107">The following sample generates CS0428:</span></span>  
