...
'attribute modifier' no es una ubicación de atributo reconocida. Todos los atributos de este bloque se omitirán.  
 ...
 Se especificó un modificador de atributo no válido. Vea [Destinos de atributo](http://msdn.microsoft.com/en-us/59a261f0-1cfb-4aa5-b610-6b735389882c) para más información.  
