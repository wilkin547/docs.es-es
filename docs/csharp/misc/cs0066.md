...
'evento': el evento debe ser de tipo delegado  
 ...
 La palabra clave event requiere un tipo [delegate](../../csharp/language-reference/keywords/delegate.md). Para obtener más información, vea [Eventos](../../csharp/programming-guide/events/index.md) y [Delegados](../../csharp/programming-guide/delegates/index.md).  
