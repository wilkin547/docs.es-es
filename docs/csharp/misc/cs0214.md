...
Los punteros y los búferes de tamaño fijo solo se pueden utilizar en un contexto no seguro  
 ...
 Solo se pueden usar punteros con la palabra clave [unsafe](../../csharp/language-reference/keywords/unsafe.md) . Para obtener más información, vea [Unsafe Code and Pointers](../../csharp/programming-guide/unsafe-code-pointers/index.md) (Código no seguro y punteros [Guía de programación de C#]).  
