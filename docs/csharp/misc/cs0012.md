...
```  
 ...
 Se puede resolver el error CS0012 compilando con `/reference:cs0012b.dll;cs0012a.dll`, o en Visual Studio mediante el [Add Reference Dialog Box](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) para agregar una referencia a cs0012a.dll además de cs0012b.dll.
