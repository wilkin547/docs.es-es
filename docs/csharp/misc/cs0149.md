...
Se espera un nombre de método  
 ...
 Al crear un [delegado](../language-reference/keywords/delegate.md), especifique un método. Para obtener más información, vea [Delegados (Guía de programación de C#)](../programming-guide/delegates/index.md).  
