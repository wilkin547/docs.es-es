...
La clase base o la 'clase' de interfaz del ensamblado 'ensamblado' a la que hace referencia el tipo 'tipo' no se ha podido resolver.  
 ...
 Para obtener más información, consulte [cuadro de diálogo Agregar referencia](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) y [/Reference (opciones del compilador de C#)](../../csharp/language-reference/compiler-options/reference-compiler-option.md).  
...
## <a name="see-also"></a>Vea también  
 [Agregar cuadro de diálogo de referencia](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)  
