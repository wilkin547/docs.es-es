...
La clase base o la 'clase' de interfaz del ensamblado 'ensamblado' a la que hace referencia el tipo 'tipo' no se ha podido resolver.  
 ...
 Para obtener más información, vea [cuadro de diálogo Agregar referencia](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) y [/Reference (C# opciones del compilador)](../language-reference/compiler-options/reference-compiler-option.md).  
