...
'field declaration': no se permiten inicializadores de campo de instancia en structs  
 ...
 No se puede inicializar un campo de instancia de un [struct](../language-reference/keywords/struct.md). Los campos de tipos de valor se inicializarán a sus valores predeterminados y los campos de tipo de referencia se inicializarán a `null`.  
