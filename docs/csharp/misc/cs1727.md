---
title: Error del compilador CS1727 | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
No se puede enviar el informe de errores automáticamente sin autorización. Visite '' para autorizar su envío.  
 ...
 El sitio Web indicado en el texto del error explica cómo habilitar automática informes de errores de [!INCLUDE[vsprvslong](../../csharp/misc/includes/vsprvslong_md.md)] herramientas de línea de comandos.  
