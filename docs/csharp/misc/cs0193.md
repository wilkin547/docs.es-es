...
El \* o -> operador debe aplicarse a un puntero  
  
El \* o -> operador se usa con un tipo no puntero. Para obtener más información, vea [Tipos de puntero](../../csharp/programming-guide/unsafe-code-pointers/pointer-types.md).  
