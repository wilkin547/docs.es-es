...
El tipo 'type' de 'assembly' está en conflicto con el tipo importado 'type2' de 'assembly'. Uso del tipo definido en 'assembly'.  
 ...
 Esta advertencia se emite cuando un tipo de un archivo de código fuente (file_2) está en conflicto con un tipo importado de file_1. El compilador usa el del archivo de origen.  
