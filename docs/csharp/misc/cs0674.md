...
No use 'System.ParamArrayAttribute'. Use la palabra clave 'params' en su lugar.  
 ...
 El compilador de C\# no permite el uso de <xref:System.ParamArrayAttribute?displayProperty=fullName>; use [params](../../csharp/language-reference/keywords/params.md) en su lugar.  
