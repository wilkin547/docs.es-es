...
description: "Ejecución de árboles de expresión"
...
Ahora, al ejecutar el delegado devuelto por este método, se producirá una excepción `ObjecctDisposedException` en el punto de ejecución.
