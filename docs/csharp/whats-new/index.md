...
* [C# 7](csharp-7.md):
    - En esta página se describen las características que se han agregado en C# 7. Estas características se agregaron a [Visual Studio 2017](https://www.visualstudio.com/vs/whatsnew/) y [.NET Core 1.0](../../core/whats-new/index.md) y versiones posteriores.
