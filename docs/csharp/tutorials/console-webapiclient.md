...
La versión debe coincidir ahora con la versión terminada que se encuentra [aquí](https://github.com/dotnet/docs/tree/master/samples/csharp/getting-started/console-webapiclient).
