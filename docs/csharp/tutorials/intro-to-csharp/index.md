...
- [En la experiencia de Microsoft Learn](https://docs.microsoft.com/learn/paths/csharp-first-steps/): esta ruta de aprendizaje contiene varios módulos en los que se exponen los conceptos básicos de C#.
