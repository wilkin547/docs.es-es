...
## <a name="see-also"></a>Vea también  
 ...
 [Standard Query Operators Overview (C#)](../programming-guide/concepts/linq/standard-query-operators-overview.md) (Información general sobre operadores de consulta estándar (C#))
