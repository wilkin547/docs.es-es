...
## <a name="example"></a><span data-ttu-id="461c4-108">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="461c4-108">Example</span></span>  
 <span data-ttu-id="461c4-109">Esta consulta crea una combinación agrupada y luego ordena los grupos según el elemento categoría, que todavía está en el ámbito.</span><span class="sxs-lookup"><span data-stu-id="461c4-109">This query creates a group join, and then sorts the groups based on the category element, which is still in scope.</span></span> <span data-ttu-id="461c4-110">Dentro del inicializador de tipo anónimo, una subconsulta ordena todos los elementos coincidentes de la secuencia de productos.</span><span class="sxs-lookup"><span data-stu-id="461c4-110">Inside the anonymous type initializer, a sub-query orders all the matching elements from the products sequence.</span></span>  
  
 [!code-csharp[csProgGuideLINQ#81](../../../samples/snippets/csharp/concepts/linq/how-to-order-the-results-of-a-join-clause_1.cs)]  
 
## <a name="see-also"></a><span data-ttu-id="461c4-111">Vea también</span><span class="sxs-lookup"><span data-stu-id="461c4-111">See also</span></span>  
 [<span data-ttu-id="461c4-112">Expresiones de consulta LINQ</span><span class="sxs-lookup"><span data-stu-id="461c4-112">LINQ query expressions</span></span>](index.md)  
 [<span data-ttu-id="461c4-113">orderby (cláusula)</span><span class="sxs-lookup"><span data-stu-id="461c4-113">orderby clause</span></span>](../language-reference/keywords/orderby-clause.md)  
 [<span data-ttu-id="461c4-114">join (cláusula)</span><span class="sxs-lookup"><span data-stu-id="461c4-114">join clause</span></span>](../language-reference/keywords/join-clause.md) 
