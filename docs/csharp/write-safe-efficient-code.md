...
Como no quiere que los autores de llamada modifiquen el origen, debe devolver el valor según su `readonly ref`:
...
En el sitio de llamada, los autores de dicha llamada eligen utilizar la propiedad `Origin` como `readonly ref` o como valor:
