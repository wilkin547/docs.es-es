---
title: "El patrón de eventos estándar de .NET"
description: "El patrón de eventos estándar de .NET"
...
# <a name="the-standard-net-event-pattern"></a>El patrón de eventos estándar de .NET
