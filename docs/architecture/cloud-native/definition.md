...
Detenga lo que está haciendo y el texto 10 de sus compañeros. Pídales que definan el término "Cloud Native". Buena oportunidad obtendrá ocho respuestas diferentes. Curiosamente, seis meses a partir de ahora, a medida que evolucionan las prácticas y tecnologías nativas en la nube, así que su definición.
...
Una arquitectura de microservicios mueve el sistema de la comunicación en proceso a la red. En un entorno distribuido, ¿qué hará cuando el servicio B no responda a una llamada del servicio a? ¿Qué ocurre cuando el servicio C deja de estar disponible temporalmente y otros servicios que lo llaman y reducen el rendimiento del sistema?
...
> *Factor \#2 especifica que "cada microservicio aísla y empaqueta sus propias dependencias, y adopta los cambios sin afectar a todo el sistema".*
