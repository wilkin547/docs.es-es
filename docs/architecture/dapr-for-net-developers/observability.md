...
### <a name="distributed-tracing"></a><span data-ttu-id="4f1ac-168">Seguimiento distribuido</span><span class="sxs-lookup"><span data-stu-id="4f1ac-168">Distributed tracing</span></span>
...
#### <a name="use-a-jaeger-or-new-relic-monitoring-back-end"></a><span data-ttu-id="4f1ac-238">Usar un back-end de supervisión de Jaeger o nuevo Relic</span><span class="sxs-lookup"><span data-stu-id="4f1ac-238">Use a Jaeger or New Relic monitoring back end</span></span>
...
#### <a name="service-discovery"></a><span data-ttu-id="4f1ac-264">Detección de servicios</span><span class="sxs-lookup"><span data-stu-id="4f1ac-264">Service discovery</span></span>
...
### <a name="health-status"></a><span data-ttu-id="4f1ac-362">Estado de mantenimiento</span><span class="sxs-lookup"><span data-stu-id="4f1ac-362">Health status</span></span>
...
### <a name="dapr-dashboard"></a><span data-ttu-id="4f1ac-389">Panel de DAPR</span><span class="sxs-lookup"><span data-stu-id="4f1ac-389">Dapr dashboard</span></span>
...
### <a name="custom-health-dashboard"></a><span data-ttu-id="4f1ac-418">Panel de estado personalizado</span><span class="sxs-lookup"><span data-stu-id="4f1ac-418">Custom health dashboard</span></span>
...
### <a name="application-insights"></a><span data-ttu-id="4f1ac-434">Application Insights</span><span class="sxs-lookup"><span data-stu-id="4f1ac-434">Application Insights</span></span>
...
<span data-ttu-id="4f1ac-446">Necesitará un recortedor de telemetría que ingesta la telemetría y la publique en el back-end de supervisión.</span><span class="sxs-lookup"><span data-stu-id="4f1ac-446">You'll need a telemetry scraper that ingests telemetry and publishes it to the monitoring back end.</span></span>
...
- [<span data-ttu-id="4f1ac-455">Contexto de seguimiento W3C</span><span class="sxs-lookup"><span data-stu-id="4f1ac-455">W3C Trace Context</span></span>](https://www.w3.org/TR/trace-context/)
- [<span data-ttu-id="4f1ac-456">Jaeger</span><span class="sxs-lookup"><span data-stu-id="4f1ac-456">Jaeger</span></span>](https://www.jaegertracing.io/)
- [<span data-ttu-id="4f1ac-457">New Relic</span><span class="sxs-lookup"><span data-stu-id="4f1ac-457">New Relic</span></span>](https://newrelic.com/)
- [<span data-ttu-id="4f1ac-458">Prometheus</span><span class="sxs-lookup"><span data-stu-id="4f1ac-458">Prometheus</span></span>](https://prometheus.io/)
- [<span data-ttu-id="4f1ac-459">Grafana</span><span class="sxs-lookup"><span data-stu-id="4f1ac-459">Grafana</span></span>](https://grafana.com/grafana/)
- [<span data-ttu-id="4f1ac-460">Abrir el SDK de telemetría para .NET</span><span class="sxs-lookup"><span data-stu-id="4f1ac-460">Open Telemetry SDK for .NET</span></span>](https://opentelemetry.io/docs/net/)
- [<span data-ttu-id="4f1ac-461">Fluentd</span><span class="sxs-lookup"><span data-stu-id="4f1ac-461">Fluentd</span></span>](https://www.fluentd.org/)
- [<span data-ttu-id="4f1ac-462">Pila de ELK</span><span class="sxs-lookup"><span data-stu-id="4f1ac-462">ELK stack</span></span>](https://www.elastic.co/elastic-stack)
- [<span data-ttu-id="4f1ac-463">Próx</span><span class="sxs-lookup"><span data-stu-id="4f1ac-463">Seq</span></span>](https://datalust.co/seq)
- [<span data-ttu-id="4f1ac-464">Serilog</span><span class="sxs-lookup"><span data-stu-id="4f1ac-464">Serilog</span></span>](https://serilog.net/)

> [!div class="step-by-step"]
> <span data-ttu-id="4f1ac-465">[Anterior](bindings.md)
> [Siguiente](secrets.md)</span><span class="sxs-lookup"><span data-stu-id="4f1ac-465">[Previous](bindings.md)
