...
- <span data-ttu-id="8eaf4-114"><xref:System.IDisposable> se implementa en la clase.</span><span class="sxs-lookup"><span data-stu-id="8eaf4-114"><xref:System.IDisposable> is reimplemented in the class.</span></span>
