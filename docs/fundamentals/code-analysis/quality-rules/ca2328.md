...
Esta regla se desencadena cuando las dos condiciones siguientes pueden ser ciertas para una [Newtonsoft.Json.JsonSerializerSettings](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) Nombr:
