...
## <a name="example-violation"></a><span data-ttu-id="b4d8c-139">Ejemplo de infracción</span><span class="sxs-lookup"><span data-stu-id="b4d8c-139">Example violation</span></span>
