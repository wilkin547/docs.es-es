...
[¿Qué es F#](what-is-fsharp.md) describe qué es el lenguaje F# y la programación es agradable ya que mediante ejemplos de código breve. Es recomendable si está familiizao con F#
