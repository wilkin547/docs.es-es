...
### [Uso de interpolación de cadenas](csharp/tutorials/string-interpolation.md)
...
### [Interoperabilidad nativa](csharp/programming-guide/interop/interoperability.md)
...
#### [Convenciones de código de C#](csharp/programming-guide/inside-a-program/coding-conventions.md)
...
##### [Cómo: Definir constantes en C#](csharp/programming-guide/classes-and-structs/how-to-define-constants.md)
...
##### [Cómo: Declarar y usar propiedades de lectura y escritura](csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties.md)
##### [Propiedades autoimplementadas](csharp/programming-guide/classes-and-structs/auto-implemented-properties.md)
##### [Cómo: Implementar una clase ligera con propiedades autoimplementadas](csharp/programming-guide/classes-and-structs/how-to-implement-a-lightweight-class-with-auto-implemented-properties.md)
...
###### [Cómo: Implementar e invocar un método de extensión personalizado](csharp/programming-guide/classes-and-structs/how-to-implement-and-call-a-custom-extension-method.md)
###### [Cómo: Crear un método nuevo para una enumeración](csharp/programming-guide/classes-and-structs/how-to-create-a-new-method-for-an-enumeration.md)
...
##### [Cómo: Inicializar un objeto usando un inicializador de objeto](csharp/programming-guide/classes-and-structs/how-to-initialize-objects-by-using-an-object-initializer.md)
##### [Cómo: Inicializar un diccionario con un inicializador de colección](csharp/programming-guide/classes-and-structs/how-to-initialize-a-dictionary-with-a-collection-initializer.md)
...
##### [Cómo: Devolver subconjuntos de propiedades de elementos en una consulta](csharp/programming-guide/classes-and-structs/how-to-return-subsets-of-element-properties-in-a-query.md)
...
#### [Cómo: Combinar delegados (delegados de multidifusión) (Guía de programación de C#)](csharp/programming-guide/delegates/how-to-combine-delegates-multicast-delegates.md)
...
#### [Cómo: Detectar excepciones no compatibles con CLS](csharp/programming-guide/exceptions/how-to-catch-a-non-cls-exception.md)
### [Registro y sistema de archivos](csharp/programming-guide/file-system/file-system-and-the-registry.md)
#### [Cómo: Recorrer en iteración un árbol de directorio](csharp/programming-guide/file-system/how-to-iterate-through-a-directory-tree.md)
#### [Cómo: Obtener información sobre archivos, carpetas y unidades ](csharp/programming-guide/file-system/how-to-get-information-about-files-folders-and-drives.md)
#### [Cómo: Crear archivos o carpetas](csharp/programming-guide/file-system/how-to-create-a-file-or-folder.md)
...
#### [Cómo: Escribir en un archivo texto](csharp/programming-guide/file-system/how-to-write-to-a-text-file.md)
#### [Cómo: Leer de un archivo de texto](csharp/programming-guide/file-system/how-to-read-from-a-text-file.md)
#### [Cómo: Leer un archivo de texto línea a línea (Visual C#)](csharp/programming-guide/file-system/how-to-read-a-text-file-one-line-at-a-time.md)
#### [Cómo: Crear una clave en el Registro (Visual C#)](csharp/programming-guide/file-system/how-to-create-a-key-in-the-registry.md)
### [Genéricos](csharp/programming-guide/generics/index.md)
...
#### [Genéricos y matrices](csharp/programming-guide/generics/generics-and-arrays.md)
#### [Delegados genéricos](csharp/programming-guide/generics/generic-delegates.md)
#### [Palabra clave predeterminada en código genérico](csharp/programming-guide/generics/default-keyword-in-generic-code.md)
...
#### [Genéricos y atributos](csharp/programming-guide/generics/generics-and-attributes.md)
...
#### [Tutorial: Programación de Office (C# y Visual Basic)](csharp/programming-guide/interop/walkthrough-office-programming.md)
#### [Clase COM de ejemplo](csharp/programming-guide/interop/example-com-class.md)

### [Expresiones de consulta LINQ](csharp/programming-guide/linq-query-expressions/index.md)
#### [Conceptos básicos de las expresiones de consultas](csharp/programming-guide/linq-query-expressions/query-expression-basics.md)
#### [Cómo: Escribir consultas con LINQ en C#](csharp/programming-guide/linq-query-expressions/how-to-write-linq-queries.md)
#### [Cómo: Consultar una colección de objetos](csharp/programming-guide/linq-query-expressions/how-to-query-a-collection-of-objects.md)
#### [Cómo: Devolver una consulta de un método](csharp/programming-guide/linq-query-expressions/how-to-return-a-query-from-a-method.md)
#### [Cómo: Almacenar los resultados de una consulta en la memoria](csharp/programming-guide/linq-query-expressions/how-to-store-the-results-of-a-query-in-memory.md)
...
#### [Cómo: Agrupar resultados por claves contiguas](csharp/programming-guide/linq-query-expressions/how-to-group-results-by-contiguous-keys.md)
...
#### [Cómo: Controlar valores Null en expresiones de consultas](csharp/programming-guide/linq-query-expressions/how-to-handle-null-values-in-query-expressions.md)
...
#### [Cómo: Convertir con seguridad de bool? en bool](csharp/programming-guide/nullable-types/how-to-safely-cast-from-bool-to-bool.md)
### [Conceptos de programación](csharp/programming-guide/concepts/index.md)
#### [Ensamblados y Caché global de ensamblados](csharp/programming-guide/concepts/assemblies-gac/index.md)
##### [Ensamblados de confianza](csharp/programming-guide/concepts/assemblies-gac/friend-assemblies.md)
###### [Crear ensamblados de confianza no firmados](csharp/programming-guide/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md)
###### [Crear ensamblados de confianza firmados](csharp/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md)
##### [Crear y utilizar ensamblados mediante la línea de comandos](csharp/programming-guide/concepts/assemblies-gac/how-to-create-and-use-assemblies-using-the-command-line.md)
##### [Determinar si un archivo es un ensamblado](csharp/programming-guide/concepts/assemblies-gac/how-to-determine-if-a-file-is-an-assembly.md)
##### [Cargar y descargar ensamblados](csharp/programming-guide/concepts/assemblies-gac/how-to-load-and-unload-assemblies.md)
##### [Compartir un ensamblado con otras aplicaciones](csharp/programming-guide/concepts/assemblies-gac/how-to-share-an-assembly-with-other-applications.md)
##### [Tutorial: Incrustar los tipos de los ensamblados administrados en Visual Studio](csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio.md)
##### [Tutorial: Incrustar información de tipos de los ensamblados de Microsoft Office en Visual Studio](csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-type-information-from-microsoft-office-assemblies.md)
#### [Programación asincrónica con Async y Await](csharp/programming-guide/concepts/async/asynchronous-programming-with-async-and-await.md)
...
##### [Cómo: Ampliar el tutorial de Async usando Task.WhenAll](csharp/programming-guide/concepts/async/how-to-extend-the-async-walkthrough-by-using-task-whenall.md)
##### [Cómo: Hacer varias solicitudes web en paralelo utilizando Async y Await](csharp/programming-guide/concepts/async/how-to-make-multiple-web-requests-in-parallel-by-using-async-and-await.md)
##### [Tipos de valor devueltos de Async](csharp/programming-guide/concepts/async/async-return-types.md)
##### [Flujo de control en programas Async](csharp/programming-guide/concepts/async/control-flow-in-async-programs.md)
##### [Ajustar una aplicación asincrónica](csharp/programming-guide/concepts/async/fine-tuning-your-async-application.md)
###### [Cancelar una tarea asincrónica o una lista de tareas](csharp/programming-guide/concepts/async/cancel-an-async-task-or-a-list-of-tasks.md)
###### [Cancelar tareas asincrónicas tras un período de tiempo](csharp/programming-guide/concepts/async/cancel-async-tasks-after-a-period-of-time.md)
###### [Cancelar las tareas asincrónicas restantes cuando se completa una](csharp/programming-guide/concepts/async/cancel-remaining-async-tasks-after-one-is-complete.md)
###### [Iniciar varias tareas asincrónicas y procesarlas a medida que se completan](csharp/programming-guide/concepts/async/start-multiple-async-tasks-and-process-them-as-they-complete.md)
##### [Control de cómo volver a entrar en aplicaciones asincrónicas](csharp/programming-guide/concepts/async/handling-reentrancy-in-async-apps.md)
##### [Uso de Async en acceso a archivos](csharp/programming-guide/concepts/async/using-async-for-file-access.md)
#### [Atributos](csharp/programming-guide/concepts/attributes/index.md)
##### [Creación de atributos personalizados](csharp/programming-guide/concepts/attributes/creating-custom-attributes.md)
###### [AttributeUsage](csharp/programming-guide/concepts/attributes/attributeusage.md)
##### [Acceso a atributos mediante reflexión](csharp/programming-guide/concepts/attributes/accessing-attributes-by-using-reflection.md)
##### [Cómo: Crear una unión de C/C++ mediante atributos](csharp/programming-guide/concepts/attributes/how-to-create-a-c-cpp-union-by-using-attributes.md)
##### [Atributos comunes](csharp/programming-guide/concepts/attributes/common-attributes.md)
#### [Información del agente de llamada](csharp/programming-guide/concepts/caller-information.md)
#### [Colecciones](csharp/programming-guide/concepts/collections.md)
#### [Covarianza y contravarianza](csharp/programming-guide/concepts/covariance-contravariance/index.md)
##### [Varianza en interfaces genéricas](csharp/programming-guide/concepts/covariance-contravariance/variance-in-generic-interfaces.md)
###### [Creación de interfaces genéricas variantes](csharp/programming-guide/concepts/covariance-contravariance/creating-variant-generic-interfaces.md)
###### [Uso de la varianza en interfaces para colecciones genéricas](csharp/programming-guide/concepts/covariance-contravariance/using-variance-in-interfaces-for-generic-collections.md)
...
#### [Árboles de expresión](csharp/programming-guide/concepts/expression-trees/index.md)
##### [Ejecutar árboles de expresión](csharp/programming-guide/concepts/expression-trees/how-to-execute-expression-trees.md)
##### [Modificar árboles de expresión](csharp/programming-guide/concepts/expression-trees/how-to-modify-expression-trees.md)
##### [Usar árboles de expresión para crear consultas dinámicas](csharp/programming-guide/concepts/expression-trees/how-to-use-expression-trees-to-build-dynamic-queries.md)
##### [Depuración de árboles de expresiones en Visual Studio](csharp/programming-guide/concepts/expression-trees/debugging-expression-trees-in-visual-studio.md)
#### [Iteradores](csharp/programming-guide/concepts/iterators.md)
#### [Language-Integrated Query (LINQ)](csharp/programming-guide/concepts/linq/index.md)
##### [Introducción a LINQ](csharp/programming-guide/concepts/linq/introduction-to-linq.md)
##### [Introducción a LINQ en C#](csharp/programming-guide/concepts/linq/getting-started-with-linq.md)
###### [Introducción a las consultas LINQ](csharp/programming-guide/concepts/linq/introduction-to-linq-queries.md)
###### [LINQ y tipos genéricos](csharp/programming-guide/concepts/linq/linq-and-generic-types.md)
###### [Operaciones básicas de consulta LINQ](csharp/programming-guide/concepts/linq/basic-linq-query-operations.md)
###### [Transformaciones de datos con LINQ](csharp/programming-guide/concepts/linq/data-transformations-with-linq.md)
...
###### [Tutorial: Escribir consultas en C# (LINQ)](csharp/programming-guide/concepts/linq/walkthrough-writing-queries-linq.md)
...
###### [Clasificación de operadores de consulta estándar por modo de ejecución](csharp/programming-guide/concepts/linq/classification-of-standard-query-operators-by-manner-of-execution.md)
###### [Ordenación de datos](csharp/programming-guide/concepts/linq/sorting-data.md)
###### [Operaciones Set](csharp/programming-guide/concepts/linq/set-operations.md)
###### [Filtrado de datos](csharp/programming-guide/concepts/linq/filtering-data.md)
###### [Operaciones cuantificadoras](csharp/programming-guide/concepts/linq/quantifier-operations.md)
###### [Operaciones de proyección](csharp/programming-guide/concepts/linq/projection-operations.md)
###### [Realización de particiones de datos](csharp/programming-guide/concepts/linq/partitioning-data.md)
###### [Operaciones de combinación](csharp/programming-guide/concepts/linq/join-operations.md)
###### [Agrupación de datos](csharp/programming-guide/concepts/linq/grouping-data.md)
###### [Operaciones de generación](csharp/programming-guide/concepts/linq/generation-operations.md)
###### [Operaciones de igualdad](csharp/programming-guide/concepts/linq/equality-operations.md)
###### [Operaciones de elementos](csharp/programming-guide/concepts/linq/element-operations.md)
###### [Conversión de tipos de datos](csharp/programming-guide/concepts/linq/converting-data-types.md)
###### [Operaciones de concatenación](csharp/programming-guide/concepts/linq/concatenation-operations.md)
###### [Operaciones de agregación](csharp/programming-guide/concepts/linq/aggregation-operations.md)
##### [LINQ to Objects](csharp/programming-guide/concepts/linq/linq-to-objects.md)
###### [LINQ y cadenas](csharp/programming-guide/concepts/linq/linq-and-strings.md)
####### [Realizar un recuento de las repeticiones de una palabra en una cadena (LINQ)](csharp/programming-guide/concepts/linq/how-to-count-occurrences-of-a-word-in-a-string-linq.md)
####### [Buscar frases que contengan un conjunto especificado de palabras (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-sentences-that-contain-a-specified-set-of-words-linq.md)
####### [Buscar caracteres en una cadena (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-characters-in-a-string-linq.md)
####### [Combinar consultas LINQ con expresiones regulares](csharp/programming-guide/concepts/linq/how-to-combine-linq-queries-with-regular-expressions.md)
####### [Buscar la diferencia de conjuntos entre dos listas (LINQ)](csharp/programming-guide/concepts/linq/how-to-find-the-set-difference-between-two-lists-linq.md)
####### [Ordenar o filtrar datos de texto por palabra o campo (LINQ)](csharp/programming-guide/concepts/linq/how-to-sort-or-filter-text-data-by-any-word-or-field-linq.md)
####### [Reordenar los campos de un archivo delimitado (LINQ)](csharp/programming-guide/concepts/linq/how-to-reorder-the-fields-of-a-delimited-file-linq.md)
####### [Combinar y comparar colecciones de cadenas (LINQ)](csharp/programming-guide/concepts/linq/how-to-combine-and-compare-string-collections-linq.md)
####### [Rellenar colecciones de objetos de varios orígenes (LINQ)](csharp/programming-guide/concepts/linq/how-to-populate-object-collections-from-multiple-sources-linq.md)
####### [Dividir un archivo en varios mediante el uso de grupos (LINQ)](csharp/programming-guide/concepts/linq/how-to-split-a-file-into-many-files-by-using-groups-linq.md)
####### [Combinar contenido de archivos no similares (LINQ)](csharp/programming-guide/concepts/linq/how-to-join-content-from-dissimilar-files-linq.md)
####### [Calcular valores de columna en un archivo de texto CSV (LINQ)](csharp/programming-guide/concepts/linq/how-to-compute-column-values-in-a-csv-text-file-linq.md)
###### [LINQ y reflexión](csharp/programming-guide/concepts/linq/linq-and-reflection.md)
####### [Consultar los metadatos de un ensamblado con reflexión (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-an-assembly-s-metadata-with-reflection-linq.md)
###### [LINQ y directorios de archivos](csharp/programming-guide/concepts/linq/linq-and-file-directories.md)
####### [Buscar archivos con un nombre o atributo especificados](csharp/programming-guide/concepts/linq/how-to-query-for-files-with-a-specified-attribute-or-name.md)
####### [Agrupar archivos por extensión (LINQ)](csharp/programming-guide/concepts/linq/how-to-group-files-by-extension-linq.md)
####### [Buscar el número total de bytes en un conjunto de carpetas (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-the-total-number-of-bytes-in-a-set-of-folders-linq.md)
####### [Comparar el contenido de dos carpetas (LINQ)](csharp/programming-guide/concepts/linq/how-to-compare-the-contents-of-two-folders-linq.md)
####### [Buscar el archivo o archivos de mayor tamaño en un árbol de directorios (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree-linq.md)
####### [Buscar archivos duplicados en un árbol de directorios (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)
####### [Consultar el contenido de los archivos de una carpeta (LINQ)](csharp/programming-guide/concepts/linq/how-to-query-the-contents-of-files-in-a-folder-lin.md)
###### [Consultar un objeto ArrayList con LINQ](csharp/programming-guide/concepts/linq/how-to-query-an-arraylist-with-linq.md)
###### [Agregar métodos personalizados para las consultas LINQ](csharp/programming-guide/concepts/linq/how-to-add-custom-methods-for-linq-queries.md)
...
####### [Información general de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-overview.md)
####### [LINQ to XML frente a DOM](csharp/programming-guide/concepts/linq/linq-to-xml-vs-dom.md)
...
###### [Guía de programación (LINQ to XML)](csharp/programming-guide/concepts/linq/programming-guide-linq-to-xml.md)
####### [Información general sobre la programación de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-programming-overview.md)
######## [Programación funcional frente a programación basada en procedimientos (LINQ to XML)](csharp/programming-guide/concepts/linq/functional-vs-procedural-programming-linq-to-xml.md)
######## [Información general sobre las clases de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-classes-overview.md)
######## [Información general de la clase XElement](csharp/programming-guide/concepts/linq/xelement-class-overview.md)
######## [Información general de la clase XAttribute](csharp/programming-guide/concepts/linq/xattribute-class-overview.md)
######## [Información general de la clase XDocument](csharp/programming-guide/concepts/linq/xdocument-class-overview.md)
######## [Compilar ejemplos de LINQ to XML](csharp/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)
####### [Crear árboles XML](csharp/programming-guide/concepts/linq/creating-xml-trees.md)
######## [Construcción funcional (LINQ to XML)](csharp/programming-guide/concepts/linq/functional-construction-linq-to-xml.md)
######## [Crear árboles XML en C# (LINQ to XML)](csharp/programming-guide/concepts/linq/creating-xml-trees-linq-to-xml-2.md)
######## [Diferencias entre clonar y adjuntar](csharp/programming-guide/concepts/linq/cloning-vs-attaching.md)
######## [Analizar XML](csharp/programming-guide/concepts/linq/parsing-xml.md)
######### [Analizar una cadena](csharp/programming-guide/concepts/linq/how-to-parse-a-string.md)
######### [Cargar un documento XML desde un archivo](csharp/programming-guide/concepts/linq/how-to-load-xml-from-a-file.md)
######### [Mantener un espacio en blanco al cargar o analizar XML](csharp/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml1.md)
######### [Detectar errores de análisis](csharp/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)
######### [Crear un árbol a partir de un objeto XmlReader](csharp/programming-guide/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)
######### [Hacer streaming de fragmentos XML desde un objeto XmlReader](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-from-an-xmlreader.md)
######## [Rellenar un árbol XML con un objeto XmlWriter (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)
######## [Validar con XSD (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-validate-using-xsd-linq-to-xml.md)
######## [Contenido válido de objetos XElement y XDocument](csharp/programming-guide/concepts/linq/valid-content-of-xelement-and-xdocument-objects3.md)
####### [Trabajar con espacios de nombres XML](csharp/programming-guide/concepts/linq/working-with-xml-namespaces.md)
######## [Información general sobre los espacios de nombres (LINQ to XML)](csharp/programming-guide/concepts/linq/namespaces-overview-linq-to-xml.md)
######## [Crear un documento con espacios de nombres (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-create-a-document-with-namespaces-linq-to-xml.md)
######## [Controlar prefijos de espacio de nombres (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)
######## [Ámbito del espacio de nombres predeterminado de C#](csharp/programming-guide/concepts/linq/scope-of-default-namespaces.md)
######## [Escribir consultas de XML en espacios de nombres](csharp/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)
####### [Serializar árboles XML](csharp/programming-guide/concepts/linq/serializing-xml-trees.md)
######## [Mantener un espacio en blanco al serializar](csharp/programming-guide/concepts/linq/preserving-white-space-while-serializing.md)
######## [Serializar con una declaración XML](csharp/programming-guide/concepts/linq/serializing-with-an-xml-declaration.md)
######## [Serializar en archivos, escritores de texto y escritores XML](csharp/programming-guide/concepts/linq/serializing-to-files-textwriters-and-xmlwriters.md)
######## [Serializar en un objeto XmlReader (invocando XSLT)](csharp/programming-guide/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)
####### [Ejes de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes.md)
######## [Información general de los ejes de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-axes-overview.md)
######## [Recuperar una colección de elementos (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-elements-linq-to-xml.md)
######## [Recuperar el valor de un elemento (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-the-value-of-an-element-linq-to-xml.md)
######## [Filtrar por nombres de elemento (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-element-names-linq-to-xml.md)
######## [Encadenar llamadas de métodos de eje (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-chain-axis-method-calls-linq-to-xml.md)
######## [Recuperar un único elemento secundario (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)
######## [Recuperar una colección de atributos (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-attributes-linq-to-xml.md)
######## [Recuperar un único atributo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-a-single-attribute-linq-to-xml.md)
######## [Recuperar el valor de un atributo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-retrieve-the-value-of-an-attribute-linq-to-xml.md)
######## [Recuperar el valor superficial de un elemento](csharp/programming-guide/concepts/linq/how-to-retrieve-the-shallow-value-of-an-element.md)
####### [Consultar árboles XML](csharp/programming-guide/concepts/linq/querying-xml-trees.md)
######## [Consultas básicas (LINQ to XML)](csharp/programming-guide/concepts/linq/basic-queries-linq-to-xml.md)
######### [Buscar un elemento con un atributo específico](csharp/programming-guide/concepts/linq/how-to-find-an-element-with-a-specific-attribute.md)
######### [Buscar un elemento con un elemento secundario específico](csharp/programming-guide/concepts/linq/how-to-find-an-element-with-a-specific-child-element.md)
######### [Diferencias entre realizar consultas de un XDocument y de un XElement](csharp/programming-guide/concepts/linq/querying-an-xdocument-vs-querying-an-xelement.md)
######### [Buscar descendientes con un nombre de elemento específico](csharp/programming-guide/concepts/linq/how-to-find-descendants-with-a-specific-element-name.md)
######### [Buscar un único descendiente utilizando el método Descendants](csharp/programming-guide/concepts/linq/how-to-find-a-single-descendant-using-the-descendants-method.md)
######### [Escribir consultas con filtrado complejo](csharp/programming-guide/concepts/linq/how-to-write-queries-with-complex-filtering.md)
######### [Filtrar por un elemento opcional](csharp/programming-guide/concepts/linq/how-to-filter-on-an-optional-element.md)
######### [Buscar todos los nodos de un espacio de nombres](csharp/programming-guide/concepts/linq/how-to-find-all-nodes-in-a-namespace.md)
######### [Ordenar elementos](csharp/programming-guide/concepts/linq/how-to-sort-elements.md)
######### [Ordenar elementos en varias claves](csharp/programming-guide/concepts/linq/how-to-sort-elements-on-multiple-keys.md)
######### [Calcular valores intermedios](csharp/programming-guide/concepts/linq/how-to-calculate-intermediate-values.md)
######### [Escribir una consulta que busca elementos en función del contexto](csharp/programming-guide/concepts/linq/how-to-write-a-query-that-finds-elements-based-on-context.md)
######### [Depurar conjuntos de resultados de consulta vacíos](csharp/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)
######## [Proyecciones y transformaciones (LINQ to XML)](csharp/programming-guide/concepts/linq/projections-and-transformations-linq-to-xml.md)
######### [Trabajar con diccionarios usando LINQ to XML](csharp/programming-guide/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)
######### [Transformar la forma de un árbol XML](csharp/programming-guide/concepts/linq/how-to-transform-the-shape-of-an-xml-tree.md)
######### [Controlar el tipo de una proyección](csharp/programming-guide/concepts/linq/how-to-control-the-type-of-a-projection.md)
######### [Proyectar un nuevo tipo (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-project-a-new-type-linq-to-xml.md)
######### [Proyectar un gráfico de objetos](csharp/programming-guide/concepts/linq/how-to-project-an-object-graph.md)
######### [Proyectar un tipo anónimo](csharp/programming-guide/concepts/linq/how-to-project-an-anonymous-type.md)
######### [Generar archivos de texto a partir de XML](csharp/programming-guide/concepts/linq/how-to-generate-text-files-from-xml.md)
######### [Generar XML a partir de archivos CSV](csharp/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)
######## [Técnicas de consulta avanzadas (LINQ to XML)](csharp/programming-guide/concepts/linq/advanced-query-techniques-linq-to-xml.md)
######### [Combinar dos colecciones (LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-join-two-collections-linq-to-xml.md)
######### [Crear una jerarquía utilizando la agrupación](csharp/programming-guide/concepts/linq/how-to-create-hierarchy-using-grouping.md)
######### [Consultar LINQ to XML utilizando XPath](csharp/programming-guide/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)
######### [Escribir un método de eje de LINQ to XML](csharp/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)
######### [Realizar transformaciones de streaming de texto en XML](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transformations-of-text-to-xml.md)
######### [Mostrar todos los nodos de un árbol](csharp/programming-guide/concepts/linq/how-to-list-all-nodes-in-a-tree.md)
######### [Recuperar párrafos de un documento de Office Open XML](csharp/programming-guide/concepts/linq/how-to-retrieve-paragraphs-from-an-office-open-xml-document.md)
######### [Modificar un documento de Office Open XML](csharp/programming-guide/concepts/linq/how-to-modify-an-office-open-xml-document.md)
######### [Rellenar un árbol XML desde el sistema de archivos](csharp/programming-guide/concepts/linq/how-to-populate-an-xml-tree-from-the-file-system.md)
######## [LINQ to XML para usuarios de XPath](csharp/programming-guide/concepts/linq/linq-to-xml-for-xpath-users.md)
######### [Comparación de XPath y LINQ to XML](csharp/programming-guide/concepts/linq/comparison-of-xpath-and-linq-to-xml.md)
######### [Buscar un elemento secundario (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)
######### [Buscar una lista de elementos secundarios (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md)
######### [Buscar el elemento raíz (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-the-root-element-xpath-linq-to-xml.md)
######### [Buscar elementos descendientes (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-descendant-elements-xpath-linq-to-xml.md)
######### [Filtrar por un atributo (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-filter-on-an-attribute-xpath-linq-to-xml.md)
######### [Buscar elementos relacionados (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-related-elements-xpath-linq-to-xml.md)
######### [Buscar elementos de un espacio de nombres (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-elements-in-a-namespace-xpath-linq-to-xml.md)
######### [Buscar nodos anteriores del mismo nivel (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)
######### [Buscar descendientes de un elemento secundario (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-descendants-of-a-child-element-xpath-linq-to-xml.md)
######### [Buscar la unión de dos rutas de acceso a ubicaciones (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-a-union-of-two-location-paths-xpath-linq-to-xml.md)
######### [Buscar nodos del mismo nivel (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-sibling-nodes-xpath-linq-to-xml.md)
######### [Buscar un atributo del elemento principal (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-an-attribute-of-the-parent-xpath-linq-to-xml.md)
######### [Buscar atributos de nodos del mismo nivel con un nombre específico (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-attributes-of-siblings-with-a-specific-name-xpath-linq-to-xml.md)
######### [Buscar elementos con un atributo específico (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-elements-with-a-specific-attribute-xpath-linq-to-xml.md)
######### [Buscar elementos secundarios en función de la posición (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-child-elements-based-on-position-xpath-linq-to-xml.md)
######### [Buscar el nodo inmediatamente anterior del mismo nivel (XPath-LINQ to XML)](csharp/programming-guide/concepts/linq/how-to-find-the-immediate-preceding-sibling-xpath-linq-to-xml.md)
######## [Transformaciones funcionales puras de XML](csharp/programming-guide/concepts/linq/pure-functional-transformations-of-xml.md)
######### [Introducción a las transformaciones funcionales puras](csharp/programming-guide/concepts/linq/introduction-to-pure-functional-transformations.md)
########## [Conceptos y terminología (Transformación funcional)](csharp/programming-guide/concepts/linq/concepts-and-terminology-functional-transformation.md)
########## [Diferencias entre la programación funcional y programación imperativa](csharp/programming-guide/concepts/linq/functional-programming-vs-imperative-programming.md)
########## [Refactorizar en funciones puras](csharp/programming-guide/concepts/linq/refactoring-into-pure-functions.md)
########## [Aplicabilidad de la transformación funcional](csharp/programming-guide/concepts/linq/applicability-of-functional-transformation.md)
########## [Transformación funcional de XML](csharp/programming-guide/concepts/linq/functional-transformation-of-xml.md)
######### [Tutorial: Encadenar consultas juntas](csharp/programming-guide/concepts/linq/tutorial-chaining-queries-together.md)
########## [Ejecución y evaluación diferidas en LINQ to XML](csharp/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)
########## [Ejemplo de ejecución diferida](csharp/programming-guide/concepts/linq/deferred-execution-example.md)
########## [Ejemplo de encadenamiento de consultas](csharp/programming-guide/concepts/linq/chaining-queries-example.md)
########## [Materialización intermedia](csharp/programming-guide/concepts/linq/intermediate-materialization.md)
########## [Encadenar juntos operadores de consulta estándar](csharp/programming-guide/concepts/linq/chaining-standard-query-operators-together.md)
...
########## [Forma de documentos de WordprocessingML](csharp/programming-guide/concepts/linq/shape-of-wordprocessingml-documents.md)
########## [Crear el documento de origen de Office Open XML](csharp/programming-guide/concepts/linq/creating-the-source-office-open-xml-document.md)
########## [Buscar el estilo de párrafo predeterminado](csharp/programming-guide/concepts/linq/finding-the-default-paragraph-style.md)
########## [Recuperar los párrafos y sus estilos](csharp/programming-guide/concepts/linq/retrieving-the-paragraphs-and-their-styles.md)
########## [Recuperar el texto de los párrafos](csharp/programming-guide/concepts/linq/retrieving-the-text-of-the-paragraphs.md)
########## [Refactorizar utilizando un método de extensión](csharp/programming-guide/concepts/linq/refactoring-using-an-extension-method.md)
########## [Refactorizar utilizando una función pura](csharp/programming-guide/concepts/linq/refactoring-using-a-pure-function.md)
########## [Proyectar XML en una forma distinta](csharp/programming-guide/concepts/linq/projecting-xml-in-a-different-shape.md)
########## [Buscar texto en documentos de Word](csharp/programming-guide/concepts/linq/finding-text-in-word-documents.md)
########## [Detalles de los documentos de WordprocessingML de Office Open XML](csharp/programming-guide/concepts/linq/details-of-office-open-xml-wordprocessingml-documents.md)
########### [Documento de WordprocessingML con estilos](csharp/programming-guide/concepts/linq/wordprocessingml-document-with-styles.md)
########### [Componente de estilo de un documento de WordprocessingML](csharp/programming-guide/concepts/linq/style-part-of-a-wordprocessingml-document.md)
########### [Ejemplo que da como resultado partes de un documento de Office Open XML](csharp/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)
####### [Modificar árboles XML (LINQ to XML)](csharp/programming-guide/concepts/linq/modifying-xml-trees-linq-to-xml.md)
######## [Diferencias entre la modificación del árbol XML en memoria y construcción funcional (LINQ to XML)](csharp/programming-guide/concepts/linq/in-memory-xml-tree-modification-vs-functional-construction-linq-to-xml.md)
######## [Agregar elementos, atributos y nodos a un árbol XML](csharp/programming-guide/concepts/linq/adding-elements-attributes-and-nodes-to-an-xml-tree.md)
######## [Modificar elementos, atributos y nodos de un árbol XML](csharp/programming-guide/concepts/linq/modifying-elements-attributes-and-nodes-in-an-xml-tree.md)
######## [Quitar elementos, atributos y nodos de un árbol XML](csharp/programming-guide/concepts/linq/removing-elements-attributes-and-nodes-from-an-xml-tree.md)
######## [Mantener pares nombre/valor](csharp/programming-guide/concepts/linq/maintaining-name-value-pairs.md)
######## [Cambiar el espacio de nombres de todo un árbol XML](csharp/programming-guide/concepts/linq/how-to-change-the-namespace-for-an-entire-xml-tree.md)
####### [Rendimiento (LINQ to XML)](csharp/programming-guide/concepts/linq/performance-linq-to-xml.md)
######## [Rendimiento de consultas encadenadas (LINQ to XML)](csharp/programming-guide/concepts/linq/performance-of-chained-queries-linq-to-xml.md)
######## [Objetos XName y XNamespace atomizados (LINQ to XML)](csharp/programming-guide/concepts/linq/atomized-xname-and-xnamespace-objects-linq-to-xml.md)
######## [Atomización previa de objetos XName (LINQ to XML)](csharp/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)
######## [Consultas compiladas estáticamente (LINQ to XML)](csharp/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)
####### [Programación avanzada de LINQ to XML](csharp/programming-guide/concepts/linq/advanced-linq-to-xml-programming.md)
######## [Anotaciones de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-annotations.md)
######## [Eventos de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-events.md)
######## [Programar con nodos](csharp/programming-guide/concepts/linq/programming-with-nodes.md)
######## [Errores en códigos declarativos/imperativos mixtos (LINQ to XML)](csharp/programming-guide/concepts/linq/mixed-declarative-code-imperative-code-bugs-linq-to-xml.md)
######## [Hacer streaming de fragmentos XML con acceso a la información del encabezado](csharp/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)
######## [Realizar una transformación de streaming de documentos XML grandes](csharp/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)
######## [Leer y escribir un documento codificado](csharp/programming-guide/concepts/linq/how-to-read-and-write-an-encoded-document.md)
######## [Usar XSLT para transformar un árbol XML](csharp/programming-guide/concepts/linq/using-xslt-to-transform-an-xml-tree.md)
######## [Usar anotaciones para transformar árboles LINQ to XML en un estilo XSLT](csharp/programming-guide/concepts/linq/how-to-use-annotations-to-transform-linq-to-xml-trees-in-an-xslt-style.md)
######## [Serializar gráficos de objeto que contienen objetos XElement](csharp/programming-guide/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)
######### [Serializar con XmlSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)
######### [Serializar con DataContractSerializer](csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)
####### [Seguridad de LINQ to XML](csharp/programming-guide/concepts/linq/linq-to-xml-security.md)
####### [Documentos XML de ejemplo (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
######## [Archivo XML de ejemplo: Pedido de compra común (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml-1.md)
######## [Archivo XML de ejemplo: Pedido de compra común en un espacio de nombres](csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)
######## [Archivo XML de ejemplo: Varios pedidos de compra (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md)
######## [Archivo XML de ejemplo: Varios pedidos de compra en un espacio de nombres](csharp/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)
######## [Archivo XML de ejemplo: Configuración de prueba (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-linq-to-xml.md)
######## [Archivo XML de ejemplo: Configuración de prueba en un espacio de nombres](csharp/programming-guide/concepts/linq/sample-xml-file-test-configuration-in-a-namespace1.md)
######## [Archivo XML de ejemplo: Clientes y pedidos (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-linq-to-xml-2.md)
######## [Archivo XSD de ejemplo: Clientes y pedidos](csharp/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders1.md)
######## [Archivo XML de ejemplo: Clientes y pedidos en un espacio de nombres](csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)
######## [Archivo XML de ejemplo: Datos numéricos (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-linq-to-xml.md)
######## [Archivo XML de ejemplo: Datos numéricos de un espacio de nombres](csharp/programming-guide/concepts/linq/sample-xml-file-numerical-data-in-a-namespace.md)
######## [Archivo XML de ejemplo: Libros (LINQ to XML)](csharp/programming-guide/concepts/linq/sample-xml-file-books-linq-to-xml.md)
######## [Archivo XML de ejemplo: Pedidos de compra consolidados](csharp/programming-guide/concepts/linq/sample-xml-file-consolidated-purchase-orders.md)
###### [Referencia (LINQ to XML)](csharp/programming-guide/concepts/linq/reference-linq-to-xml.md)
##### [LINQ to ADO.NET (Página de portal)](csharp/programming-guide/concepts/linq/linq-to-adonet-portal-page.md)
##### [Habilitar un origen de datos para realizar consultas LINQ](csharp/programming-guide/concepts/linq/enabling-a-data-source-for-linq-querying1.md)
##### [Características de IDE de Visual Studio y herramientas para LINQ](csharp/programming-guide/concepts/linq/visual-studio-ide-and-tools-support-for-linq.md)
#### [Programación orientada a objetos](csharp/programming-guide/concepts/object-oriented-programming.md)
...
##### [Escribir objetos de datos en un archivo XML](csharp/programming-guide/concepts/serialization/how-to-write-object-data-to-an-xml-file.md)
##### [Leer objetos de datos de un archivo XML](csharp/programming-guide/concepts/serialization/how-to-read-object-data-from-an-xml-file.md)
##### [Tutorial: Conservar un objeto en Visual Studio](csharp/programming-guide/concepts/serialization/walkthrough-persisting-an-object-in-visual-studio.md)
#### [Subprocesamiento](csharp/programming-guide/concepts/threading/index.md)
##### [Aplicaciones multiproceso](csharp/programming-guide/concepts/threading/multithreaded-applications.md)
##### [Parámetros y valores devueltos para procedimientos multiproceso](csharp/programming-guide/concepts/threading/parameters-and-return-values-for-multithreaded-procedures.md)
##### [Tutorial: Multithreading con el componente BackgroundWorker](csharp/programming-guide/concepts/threading/walkthrough-multithreading-with-the-backgroundworker-component.md)
##### [Sincronización de subprocesos](csharp/programming-guide/concepts/threading/thread-synchronization.md)
##### [Temporizadores de subprocesos](csharp/programming-guide/concepts/threading/thread-timers.md)
##### [Agrupación de subprocesos](csharp/programming-guide/concepts/threading/thread-pooling.md)
###### [Utilizar un grupo de subprocesos](csharp/programming-guide/concepts/threading/how-to-use-a-thread-pool.md)
...
###### [Cómo: Usar expresiones lambda en una consulta](csharp/programming-guide/statements-expressions-operators/how-to-use-lambda-expressions-in-a-query.md)
###### [Cómo: Usar expresiones lambda fuera de LINQ](csharp/programming-guide/statements-expressions-operators/how-to-use-lambda-expressions-outside-linq.md)
...
##### [Cómo: Definir la igualdad de valores para un tipo](csharp/programming-guide/statements-expressions-operators/how-to-define-value-equality-for-a-type.md)
##### [Cómo: Probar la igualdad de referencia (Identidad)](csharp/programming-guide/statements-expressions-operators/how-to-test-for-reference-equality-identity.md)
### [Cadenas](csharp/programming-guide/strings/index.md)
#### [Cómo: Concatenar varias cadenas](csharp/programming-guide/strings/how-to-concatenate-multiple-strings.md)
#### [Cómo: Modificar el contenido de cadenas](csharp/programming-guide/strings/how-to-modify-string-contents.md)
#### [Cómo: Comparar cadenas](csharp/programming-guide/strings/how-to-compare-strings.md)
#### [Cómo: Analizar cadenas mediante String.Split](csharp/programming-guide/strings/how-to-parse-strings-using-string-split.md)
#### [Cómo: Buscar cadenas mediante los métodos String](csharp/programming-guide/strings/how-to-search-strings-using-string-methods.md)
#### [Cómo: Buscar cadenas mediante expresiones regulares](csharp/programming-guide/strings/how-to-search-strings-using-regular-expressions.md)
...
#### [Cómo: Convertir una cadena en un valor DateTime](csharp/programming-guide/strings/how-to-convert-a-string-to-a-datetime.md)
#### [Cómo: Convertir entre codificaciones heredadas y Unicode](csharp/programming-guide/strings/how-to-convert-between-legacy-encodings-and-unicode.md)
#### [Cómo: Convertir RTF en texto sin formato](csharp/programming-guide/strings/how-to-convert-rtf-to-plain-text.md)
...
##### [Tutorial: Crear y utilizar objetos dinámicos (C# y Visual Basic)](csharp/programming-guide/types/walkthrough-creating-and-using-dynamic-objects.md)
...
###### [Cómo: Obtener el valor de una variable de puntero](csharp/programming-guide/unsafe-code-pointers/how-to-obtain-the-value-of-a-pointer-variable.md)
###### [Cómo: Obtener la dirección de una variable](csharp/programming-guide/unsafe-code-pointers/how-to-obtain-the-address-of-a-variable.md)
...
####### [Aumentar y disminuir punteros](csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)
####### [Operaciones aritméticas en punteros](csharp/programming-guide/unsafe-code-pointers/arithmetic-operations-on-pointers.md)
####### [Comparación de punteros](csharp/programming-guide/unsafe-code-pointers/pointer-comparison.md)
...
##### [cref, Atributo](csharp/programming-guide/xmldoc/cref-attribute.md)
...
###### [Cadenas interpoladas (referencia de C# y Visual Basic)](csharp/language-reference/keywords/interpolated-strings.md)
...
##### [Instrucciones de selección](csharp/language-reference/keywords/selection-statements.md)
...
##### [nameof (referencia de C# y Visual Basic)](csharp/language-reference/keywords/nameof.md)
#### [Palabras clave para conversiones](csharp/language-reference/keywords/conversion-keywords.md)
...
#### [Palabras clave contextuales](csharp/language-reference/keywords/contextual-keywords.md)
...
##### [where (restricción de tipo genérico)](csharp/language-reference/keywords/where-generic-type-constraint.md)
##### [value](csharp/language-reference/keywords/value.md)
##### [yield](csharp/language-reference/keywords/yield.md)
#### [Palabras clave para consultas](csharp/language-reference/keywords/query-keywords.md)
...
##### [let (cláusula)](csharp/language-reference/keywords/let-clause.md)
...
#### [Operador []](csharp/language-reference/operators/index-operator.md)
...
#### [Operador -](csharp/language-reference/operators/subtraction-operator.md)
#### [Operador *](csharp/language-reference/operators/multiplication-operator.md)
#### [Operador /](csharp/language-reference/operators/division-operator.md)
...
#### [Operador -=](csharp/language-reference/operators/subtraction-assignment-operator.md)
#### [Operador *=](csharp/language-reference/operators/multiplication-assignment-operator.md)
#### [Operador /=](csharp/language-reference/operators/division-assignment-operator.md)
...
#### [Operadores condicionales null (C# y Visual Basic)](csharp/language-reference/operators/null-conditional-operators.md)
...
##### [@ (Opciones del compilador de C#)](csharp/language-reference/compiler-options/response-file-compiler-option.md)
##### [-addmodule (Opciones del compilador de C#)](csharp/language-reference/compiler-options/addmodule-compiler-option.md)
##### [-appconfig (Opciones del compilador de C#)](csharp/language-reference/compiler-options/appconfig-compiler-option.md)
##### [-baseaddress (Opciones del compilador de C#)](csharp/language-reference/compiler-options/baseaddress-compiler-option.md)
##### [-bugreport (Opciones del compilador de C#)](csharp/language-reference/compiler-options/bugreport-compiler-option.md)
##### [-checked (Opciones del compilador de C#)](csharp/language-reference/compiler-options/checked-compiler-option.md)
##### [-codepage (Opciones del compilador de C#)](csharp/language-reference/compiler-options/codepage-compiler-option.md)
##### [-debug (Opciones del compilador de C#)](csharp/language-reference/compiler-options/debug-compiler-option.md)
##### [-define (Opciones del compilador de C#)](csharp/language-reference/compiler-options/define-compiler-option.md)
##### [-delaysign (Opciones del compilador de C#)](csharp/language-reference/compiler-options/delaysign-compiler-option.md)
...
##### [-filealign (Opciones del compilador de C#)](csharp/language-reference/compiler-options/filealign-compiler-option.md)
##### [-fullpaths (Opciones del compilador de C#)](csharp/language-reference/compiler-options/fullpaths-compiler-option.md)
##### [-help, -? (Opciones del compilador de C#)](csharp/language-reference/compiler-options/help-compiler-option.md)
##### [-highentropyva (Opciones del compilador de C#)](csharp/language-reference/compiler-options/highentropyva-compiler-option.md)
##### [-keycontainer (Opciones del compilador de C#)](csharp/language-reference/compiler-options/keycontainer-compiler-option.md)
##### [-keyfile (Opciones del compilador de C#)](csharp/language-reference/compiler-options/keyfile-compiler-option.md)
##### [-langversion (Opciones del compilador de C#)](csharp/language-reference/compiler-options/langversion-compiler-option.md)
##### [-lib (Opciones del compilador de C#)](csharp/language-reference/compiler-options/lib-compiler-option.md)
##### [-link (Opciones del compilador de C#)](csharp/language-reference/compiler-options/link-compiler-option.md)
##### [-linkresource (Opciones del compilador de C#)](csharp/language-reference/compiler-options/linkresource-compiler-option.md)
##### [-main (Opciones del compilador de C#)](csharp/language-reference/compiler-options/main-compiler-option.md)
##### [-moduleassemblyname (Opciones del compilador de C#)](csharp/language-reference/compiler-options/moduleassemblyname-compiler-option.md)
##### [-noconfig (Opciones del compilador de C#)](csharp/language-reference/compiler-options/noconfig-compiler-option.md)
##### [-nologo (Opciones del compilador de C#)](csharp/language-reference/compiler-options/nologo-compiler-option.md)
##### [-nostdlib (Opciones del compilador de C#)](csharp/language-reference/compiler-options/nostdlib-compiler-option.md)
...
##### [-optimize (Opciones del compilador de C#)](csharp/language-reference/compiler-options/optimize-compiler-option.md)
##### [-out (Opciones del compilador de C#)](csharp/language-reference/compiler-options/out-compiler-option.md)
##### [-pdb (Opciones del compilador de C#)](csharp/language-reference/compiler-options/pdb-compiler-option.md)
##### [-platform (Opciones del compilador de C#)](csharp/language-reference/compiler-options/platform-compiler-option.md)
##### [-preferreduilang (Opciones del compilador de C#)](csharp/language-reference/compiler-options/preferreduilang-compiler-option.md)
##### [-recurse (Opciones del compilador de C#)](csharp/language-reference/compiler-options/recurse-compiler-option.md)
##### [-reference (Opciones del compilador de C#)](csharp/language-reference/compiler-options/reference-compiler-option.md)
##### [-resource (Opciones del compilador de C#)](csharp/language-reference/compiler-options/resource-compiler-option.md)
...
###### [-target:appcontainerexe (Opciones del compilador de C#)](csharp/language-reference/compiler-options/target-appcontainerexe-compiler-option.md)
###### [-target:exe (Opciones del compilador de C#)](csharp/language-reference/compiler-options/target-exe-compiler-option.md)
###### [-target:library (Opciones del compilador de C#)](csharp/language-reference/compiler-options/target-library-compiler-option.md)
...
###### [-target:winmdobj (Opciones del compilador de C#)](csharp/language-reference/compiler-options/target-winmdobj-compiler-option.md)
##### [-unsafe (Opciones del compilador de C#)](csharp/language-reference/compiler-options/unsafe-compiler-option.md)
##### [-utf8output (Opciones del compilador de C#)](csharp/language-reference/compiler-options/utf8output-compiler-option.md)
##### [-warn (Opciones del compilador de C#)](csharp/language-reference/compiler-options/warn-compiler-option.md)
##### [-warnaserror (Opciones del compilador de C#)](csharp/language-reference/compiler-options/warnaserror-compiler-option.md)
##### [-win32icon (Opciones del compilador de C#)](csharp/language-reference/compiler-options/win32icon-compiler-option.md)
...
#### [Error del compilador CS0001](csharp/language-reference/compiler-messages/cs0001.md)
#### [Error del compilador CS0006](csharp/language-reference/compiler-messages/cs0006.md)
#### [Error del compilador CS0007](csharp/language-reference/compiler-messages/cs0007.md)
#### [Error del compilador CS0015](csharp/language-reference/compiler-messages/cs0015.md)
#### [Error del compilador CS0016](csharp/language-reference/compiler-messages/cs0016.md)
#### [Error del compilador CS0019](csharp/language-reference/compiler-messages/cs0019.md)
#### [Error del compilador CS0029](csharp/language-reference/compiler-messages/cs0029.md)
#### [Error del compilador CS0034](csharp/language-reference/compiler-messages/cs0034.md)
#### [Error del compilador CS0038](csharp/language-reference/compiler-messages/cs0038.md)
#### [Error del compilador CS0039](csharp/language-reference/compiler-messages/cs0039.md)
#### [Error del compilador CS0050](csharp/language-reference/compiler-messages/cs0050.md)
#### [Error del compilador CS0051](csharp/language-reference/compiler-messages/cs0051.md)
#### [Error del compilador CS0052](csharp/language-reference/compiler-messages/cs0052.md)
#### [Error del compilador CS0071](csharp/language-reference/compiler-messages/cs0071.md)
#### [Error del compilador CS0103](csharp/language-reference/compiler-messages/cs0103.md)
#### [Error del compilador CS0106](csharp/language-reference/compiler-messages/cs0106.md)
#### [Error del compilador CS0115](csharp/language-reference/compiler-messages/cs0115.md)
#### [Error del compilador CS0116](csharp/language-reference/compiler-messages/cs0116.md)
#### [Error del compilador CS0120](csharp/language-reference/compiler-messages/cs0120.md)
#### [Error del compilador CS0122](csharp/language-reference/compiler-messages/cs0122.md)
#### [Error del compilador CS0134](csharp/language-reference/compiler-messages/cs0134.md)
#### [Error del compilador CS0151](csharp/language-reference/compiler-messages/cs0151.md)
#### [Error del compilador CS0163](csharp/language-reference/compiler-messages/cs0163.md)
#### [Error del compilador CS0165](csharp/language-reference/compiler-messages/cs0165.md)
#### [Error del compilador CS0173](csharp/language-reference/compiler-messages/cs0173.md)
#### [Error del compilador CS0178](csharp/language-reference/compiler-messages/cs0178.md)
#### [Error del compilador CS0188](csharp/language-reference/compiler-messages/cs0188.md)
#### [Error del compilador CS0201](csharp/language-reference/compiler-messages/cs0201.md)
#### [Error del compilador CS0229](csharp/language-reference/compiler-messages/cs0229.md)
#### [Error del compilador CS0233](csharp/language-reference/compiler-messages/cs0233.md)
#### [Error del compilador CS0234](csharp/language-reference/compiler-messages/cs0234.md)
#### [Error del compilador CS0246](csharp/language-reference/compiler-messages/cs0246.md)
#### [Error del compilador CS0260](csharp/language-reference/compiler-messages/cs0260.md)
#### [Error del compilador CS0266](csharp/language-reference/compiler-messages/cs0266.md)
#### [Error del compilador CS0269](csharp/language-reference/compiler-messages/cs0269.md)
#### [Error del compilador CS0270](csharp/language-reference/compiler-messages/cs0270.md)
#### [Error del compilador CS0304](csharp/language-reference/compiler-messages/cs0304.md)
#### [Error del compilador CS0310](csharp/language-reference/compiler-messages/cs0310.md)
#### [Error del compilador CS0311](csharp/language-reference/compiler-messages/cs0311.md)
#### [Error del compilador CS0413](csharp/language-reference/compiler-messages/cs0413.md)
#### [Error del compilador CS0417](csharp/language-reference/compiler-messages/cs0417.md)
#### [Error del compilador CS0433](csharp/language-reference/compiler-messages/cs0433.md)
#### [Error del compilador CS0445](csharp/language-reference/compiler-messages/cs0445.md)
#### [Error del compilador CS0446](csharp/language-reference/compiler-messages/cs0446.md)
#### [Error del compilador CS0504](csharp/language-reference/compiler-messages/cs0504.md)
#### [Error del compilador CS0507](csharp/language-reference/compiler-messages/cs0507.md)
#### [Error del compilador CS0518](csharp/language-reference/compiler-messages/cs0518.md)
#### [Error del compilador CS0523](csharp/language-reference/compiler-messages/cs0523.md)
#### [Error del compilador CS0545](csharp/language-reference/compiler-messages/cs0545.md)
#### [Error del compilador CS0552](csharp/language-reference/compiler-messages/cs0552.md)
#### [Error del compilador CS0563](csharp/language-reference/compiler-messages/cs0563.md)
#### [Error del compilador CS0570](csharp/language-reference/compiler-messages/cs0570.md)
#### [Error del compilador CS0571](csharp/language-reference/compiler-messages/cs0571.md)
#### [Error del compilador CS0579](csharp/language-reference/compiler-messages/cs0579.md)
#### [Error del compilador CS0592](csharp/language-reference/compiler-messages/cs0592.md)
#### [Error del compilador CS0616](csharp/language-reference/compiler-messages/cs0616.md)
#### [Error del compilador CS0650](csharp/language-reference/compiler-messages/cs0650.md)
#### [Error del compilador CS0686](csharp/language-reference/compiler-messages/cs0686.md)
#### [Error del compilador CS0702](csharp/language-reference/compiler-messages/cs0702.md)
#### [Error del compilador CS0703](csharp/language-reference/compiler-messages/cs0703.md)
#### [Error del compilador CS0731](csharp/language-reference/compiler-messages/cs0731.md)
#### [Error del compilador CS0826](csharp/language-reference/compiler-messages/cs0826.md)
#### [Error del compilador CS0834](csharp/language-reference/compiler-messages/cs0834.md)
#### [Error del compilador CS0840](csharp/language-reference/compiler-messages/cs0840.md)
#### [Error del compilador CS0843](csharp/language-reference/compiler-messages/cs0843.md)
#### [Error del compilador CS0845](csharp/language-reference/compiler-messages/cs0845.md)
#### [Error del compilador CS1001](csharp/language-reference/compiler-messages/cs1001.md)
#### [Error del compilador CS1009](csharp/language-reference/compiler-messages/cs1009.md)
#### [Error del compilador CS1018](csharp/language-reference/compiler-messages/cs1018.md)
#### [Error del compilador CS1019](csharp/language-reference/compiler-messages/cs1019.md)
#### [Error del compilador CS1026](csharp/language-reference/compiler-messages/cs1026.md)
#### [Error del compilador CS1029](csharp/language-reference/compiler-messages/cs1029.md)
#### [Error del compilador CS1061](csharp/language-reference/compiler-messages/cs1061.md)
#### [Error del compilador CS1112](csharp/language-reference/compiler-messages/cs1112.md)
#### [Error del compilador CS1501](csharp/language-reference/compiler-messages/cs1501.md)
#### [Error del compilador CS1502](csharp/language-reference/compiler-messages/cs1502.md)
#### [Error del compilador CS1519](csharp/language-reference/compiler-messages/cs1519.md)
#### [Error del compilador CS1540](csharp/language-reference/compiler-messages/cs1540.md)
#### [Error del compilador CS1546](csharp/language-reference/compiler-messages/cs1546.md)
#### [Error del compilador CS1548](csharp/language-reference/compiler-messages/cs1548.md)
#### [Error del compilador CS1564](csharp/language-reference/compiler-messages/cs1564.md)
#### [Error del compilador CS1567](csharp/language-reference/compiler-messages/cs1567.md)
#### [Error del compilador CS1579](csharp/language-reference/compiler-messages/cs1579.md)
#### [Error del compilador CS1612](csharp/language-reference/compiler-messages/cs1612.md)
#### [Error del compilador CS1614](csharp/language-reference/compiler-messages/cs1614.md)
#### [Error del compilador CS1640](csharp/language-reference/compiler-messages/cs1640.md)
#### [Error del compilador CS1644](csharp/language-reference/compiler-messages/cs1644.md)
#### [Error del compilador CS1656](csharp/language-reference/compiler-messages/cs1656.md)
#### [Error del compilador CS1674](csharp/language-reference/compiler-messages/cs1674.md)
#### [Error del compilador CS1703](csharp/language-reference/compiler-messages/cs1703.md)
#### [Error del compilador CS1704](csharp/language-reference/compiler-messages/cs1704.md)
#### [Error del compilador CS1705](csharp/language-reference/compiler-messages/cs1705.md)
#### [Error del compilador CS1708](csharp/language-reference/compiler-messages/cs1708.md)
#### [Error del compilador CS1716](csharp/language-reference/compiler-messages/cs1716.md)
#### [Error del compilador CS1721](csharp/language-reference/compiler-messages/cs1721.md)
#### [Error del compilador CS1726](csharp/language-reference/compiler-messages/cs1726.md)
#### [Error del compilador CS1729](csharp/language-reference/compiler-messages/cs1729.md)
#### [Error del compilador CS1919](csharp/language-reference/compiler-messages/cs1919.md)
#### [Error del compilador CS1921](csharp/language-reference/compiler-messages/cs1921.md)
#### [Error del compilador CS1926](csharp/language-reference/compiler-messages/cs1926.md)
#### [Error del compilador CS1933](csharp/language-reference/compiler-messages/cs1933.md)
#### [Error del compilador CS1936](csharp/language-reference/compiler-messages/cs1936.md)
#### [Error del compilador CS1941](csharp/language-reference/compiler-messages/cs1941.md)
#### [Error del compilador CS1942](csharp/language-reference/compiler-messages/cs1942.md)
#### [Error del compilador CS1943](csharp/language-reference/compiler-messages/cs1943.md)
#### [Error del compilador CS1946](csharp/language-reference/compiler-messages/cs1946.md)
#### [Error del compilador CS2032](csharp/language-reference/compiler-messages/cs2032.md)
#### [Advertencia del compilador (nivel 1) CS0420](csharp/language-reference/compiler-messages/cs0420.md)
#### [Advertencia del compilador (nivel 1) CS0465](csharp/language-reference/compiler-messages/cs0465.md)
#### [Advertencia del compilador (nivel 1) CS1058](csharp/language-reference/compiler-messages/cs1058.md)
#### [Advertencia del compilador (nivel 1) CS1060](csharp/language-reference/compiler-messages/cs1060.md)
#### [Advertencia del compilador (nivel 1) CS1598](csharp/language-reference/compiler-messages/cs1598.md)
#### [Advertencia del compilador (nivel 1) CS1607](csharp/language-reference/compiler-messages/cs1607.md)
#### [Advertencia del compilador (nivel 1) CS1616](csharp/language-reference/compiler-messages/cs1616.md)
#### [Advertencia del compilador (nivel 1) CS1658](csharp/language-reference/compiler-messages/cs1658.md)
#### [Advertencia del compilador (nivel 1) CS1683](csharp/language-reference/compiler-messages/cs1683.md)
#### [Advertencia del compilador (nivel 1) CS1685](csharp/language-reference/compiler-messages/cs1685.md)
#### [Advertencia del compilador (nivel 1) CS1690](csharp/language-reference/compiler-messages/cs1690.md)
#### [Advertencia del compilador (nivel 1) CS1691](csharp/language-reference/compiler-messages/cs1691.md)
#### [Advertencia del compilador (nivel 1) CS1699](csharp/language-reference/compiler-messages/cs1699.md)
#### [Advertencia del compilador (nivel 1) CS1762](csharp/language-reference/compiler-messages/cs1762.md)
#### [Advertencia del compilador (nivel 1) CS1956](csharp/language-reference/compiler-messages/cs1956.md)
#### [Advertencia del compilador (nivel 1) CS3003](csharp/language-reference/compiler-messages/cs3003.md)
#### [Advertencia del compilador (nivel 1) CS3007](csharp/language-reference/compiler-messages/cs3007.md)
#### [Advertencia del compilador (nivel 1) CS3009](csharp/language-reference/compiler-messages/cs3009.md)
#### [Advertencia del compilador (nivel 1) CS4014](csharp/language-reference/compiler-messages/cs4014.md)
#### [Advertencia del compilador (nivel 2) CS0108](csharp/language-reference/compiler-messages/cs0108.md)
#### [Advertencia del compilador (nivel 2) CS0467](csharp/language-reference/compiler-messages/cs0467.md)
#### [Advertencia del compilador (nivel 2) CS0618](csharp/language-reference/compiler-messages/cs0618.md)
#### [Advertencia del compilador (nivel 2) CS1701](csharp/language-reference/compiler-messages/cs1701.md)
#### [Advertencia del compilador (nivel 3) CS0675](csharp/language-reference/compiler-messages/cs0675.md)
#### [Advertencia del compilador (nivel 3) CS1700](csharp/language-reference/compiler-messages/cs1700.md)
#### [Advertencia del compilador (nivel 4) CS0429](csharp/language-reference/compiler-messages/cs0429.md)
#### [Advertencia del compilador (nivel 4) CS1591](csharp/language-reference/compiler-messages/cs1591.md)
#### [Advertencia del compilador (nivel 4) CS1610](csharp/language-reference/compiler-messages/cs1610.md)
...
####### [Cómo buscar el archivo o archivos de mayor tamaño en un árbol de directorios (LINQ)](visual-basic/programming-guide/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree.md)
...
######### [Cómo: Buscar un elemento secundario (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)
######### [Cómo: Buscar una lista de elementos secundarios (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md)
######### [Cómo: Buscar el elemento raíz (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-the-root-element-xpath-linq-to-xml.md)
######### [Cómo: Buscar elementos descendientes (XPath-LINQ to XML)](visual-basic/programming-guide/concepts/linq/how-to-find-descendant-elements-xpath-linq-to-xml.md)
