...
### [Microservicios de .NET. Architecture for Containerized .NET Applications](standard/microservices-architecture/) (Microservicios de .NET: Arquitectura para aplicaciones .NET en contenedor)
### [Aplicaciones sin servidor: arquitectura, patrones e implementación de Azure](standard/serverless-architecture/)
## [Guía de la biblioteca de código abierto](standard/library-guidance/)
...
## [Analizadores](standard/analyzers/index.md)
### [Analizador de API](standard/analyzers/api-analyzer.md)
### [Portability Analyzer](standard/analyzers/portability-analyzer.md)
### [Analizador de marco](standard/analyzers/framework-analyzer.md)
## [Control y generación de excepciones](standard/exceptions/)
## [Ensamblados de .NET](standard/assembly/index.md)
### [Formato de archivo de ensamblado .NET](standard/assembly/file-format.md)
### [Cómo: Usar y depurar la descargabilidad de ensamblado en .NET Core](standard/assembly/unloadability-howto.md)
...
## [Procesamiento paralelo, simultaneidad y asincrónico](standard/parallel-processing-and-concurrency.md)
...
### [Directrices de uso de memoria <T> e intervalo<T>](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [Interoperabilidad nativa](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [Serialización de tipos](standard/native-interop/type-marshalling.md)
### [Personalización de la serialización de estructuras](standard/native-interop/customize-struct-marshalling.md)
### [Personalización de la serialización de parámetros](standard/native-interop/customize-parameter-marshalling.md)
### [Guía de interoperabilidad](standard/native-interop/best-practices.md)
### [Juegos de caracteres y serialización](standard/native-interop/charset.md)
...
### [Depuración de la aplicación Hola mundo de .NET Core en C# o Visual Basic con Visual Studio 2017](core/tutorials/debugging-with-visual-studio.md)
### [Publicación de la aplicación Hola mundo con Visual Studio 2017](core/tutorials/publishing-with-visual-studio.md)
### [Creación de una biblioteca de clases de .NET Standard con C# y .NET Core en Visual Studio 2017](core/tutorials/library-with-visual-studio.md)
### [Creación de una biblioteca de clases de .NET Standard con Visual Basic y .NET Core en Visual Studio 2017](core/tutorials/vb-library-with-visual-studio.md)
### [Prueba de una biblioteca de clases de .NET Standard con .NET Core en Visual Studio 2017](core/tutorials/testing-library-with-visual-studio.md)
...
### [Novedades de .NET Core 3.0](core/whats-new/dotnet-core-3-0.md)
### [Novedades de .NET Core 2.2](core/whats-new/dotnet-core-2-2.md)
...
## Migración
### [.NET Core 2.0 a 2.1](core/migration/20-21.md)
### [Migración desde project.json](core/migration/index.md)
...
### [Inclusión en contenedores de una aplicación de .NET Core](core/docker/docker-basics-dotnet-core.md)
### [Uso de imágenes base de Docker](core/docker/building-net-docker-images.md)
...
### [Procedimientos recomendados para las pruebas unitarias](core/testing/unit-testing-best-practices.md)
...
### [Selección de la versión de .NET Core](core/versions/selection.md)
### [Eliminación de runtimes y SDK obsoletos](core/versions/remove-runtime-sdk-versions.md)
...
#### [Crear una herramienta global](core/tools/global-tools-how-to-create.md)
...
### [Habilitación de la finalización con tabulación](core/tools/enable-tab-autocomplete.md)
...
### [Tecnologías de .NET Framework no disponibles para .NET Core](core/porting/net-framework-tech-unavailable.md)
...
### [Herramientas útiles para la migración a .NET Core](core/porting/tools.md)
### [Uso del paquete de compatibilidad de Windows](core/porting/windows-compat-pack.md)
### [Proyectos de Windows Forms de puerto](core/porting/winforms.md)
...
### [Introducción a C#](csharp/tutorials/intro-to-csharp/index.md)
#### [Hola mundo](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [Números en C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [Bifurcaciones y bucles](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [Interpolación de cadenas](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [Colecciones de listas](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [Trabajar en su entorno local](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [Números en C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [Bifurcaciones y bucles](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
##### [Interpolación de cadenas](csharp/tutorials/intro-to-csharp/interpolated-strings-local.md)
##### [Colecciones de listas](csharp/tutorials/intro-to-csharp/arrays-and-collections.md)
##### [Introducción a las clases](csharp/tutorials/intro-to-csharp/introduction-to-classes.md)
...
### [Ampliación de capacidades de datos con la coincidencia de patrones](csharp/tutorials/pattern-matching.md)
...
### [Interpolación de cadenas](csharp/tutorials/string-interpolation.md)
### [Uso de atributos](csharp/tutorials/attributes.md)
...
### [C# 8.0 (versión preliminar 2)](csharp/whats-new/csharp-8.md)
...
### [Consideraciones sobre versiones y actualizaciones](csharp/whats-new/version-update-considerations.md)
<!-- End What's New -->
## Conceptos de C#
...
### [Tipos de referencia que aceptan valores null](csharp/nullable-references.md)
...
### [Escribir código seguro y eficaz](csharp/write-safe-efficient-code.md)
...
### [Conversión segura mediante coincidencia de patrones, operadores is y as](csharp/how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)
...
### [Instalación de F#](fsharp/get-started/install-fsharp.md)
### [Empezar a trabajar con F# en Visual Studio](fsharp/get-started/get-started-visual-studio.md)
### [Empezar a trabajar con F# en Visual Studio para Mac](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [Empezar a trabajar con F# en Visual Studio Code e Ionide](fsharp/get-started/get-started-vscode.md)
### [Empezar a trabajar con F# mediante la CLI de .NET Core](fsharp/get-started/get-started-command-line.md)

## [¿Qué es F#?](fsharp/what-is-fsharp.md)
...
#### [Funciones de primera clase](fsharp/introduction-to-functional-programming/first-class-functions.md)
...
### [Segmentos](fsharp/language-reference/slices.md)
### [Opciones](fsharp/language-reference/options.md)
### [Opciones de valores](fsharp/language-reference/value-options.md)
...
#### [Campos explícitos: `val`Palabra clave](fsharp/language-reference/members/explicit-fields-the-val-keyword.md)
...
### [Archivo de signatura](fsharp/language-reference/signature-files.md)
...
### [Expresiones diferidas](fsharp/language-reference/lazy-expressions.md)
...
##### [Cómo: Llamar a un servicio Web de forma asincrónica](visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)
...
### [Personalización de proyectos y extensión de My con Visual Basic](visual-basic/developing-apps/customizing-extending-my/index.md)
...
### [Covarianza y contravarianza](visual-basic/programming-guide/concepts/covariance-contravariance/index.md)
...
##### [Cómo: Convertir un objeto en otro tipo](visual-basic/programming-guide/language-features/data-types/how-to-convert-an-object-to-another-type.md)
...
### [Cómo: Hacer referencia a objetos COM](visual-basic/programming-guide/com-interop/how-to-reference-com-objects.md)
...
### [Tutorial: Crear objetos COM](visual-basic/programming-guide/com-interop/walkthrough-creating-com-objects.md)
...
### [Resumen del tipo de seguimiento](visual-basic/language-reference/data-types/index.md)
...
#### [La operación solicitada no está disponible (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
## Información general
### [¿Qué es ML.NET?](machine-learning/what-is-mldotnet.md)
### [Conceptos de entrenamiento de modelos](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Recomendación de película (recomendación)](machine-learning/tutorials/movie-recommmendation.md)
## [Guías de procedimientos](machine-learning/how-to-guides/index.md)
### Preparar los datos
#### [Aplicación de ingeniería de características categóricas](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [Aplicación de ingeniería de características textuales](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [Carga de datos con muchas columnas](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [Carga de datos de varios archivos](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
...
#### [Determinación de la importancia de características del modelo con PFI](machine-learning/how-to-guides/determine-global-feature-importance-in-model.md)
...
#### [Publicación de un modelo en Web API](machine-learning/how-to-guides/serve-model-web-api-ml-net.md)
### Infer.NET
#### [Programación probabilística con Infer.NET](machine-learning/how-to-guides/matchup-app-infer-net.md)
## Referencia
### [Referencia de API](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
...
### [Transformaciones de datos](machine-learning/resources/transforms.md)
