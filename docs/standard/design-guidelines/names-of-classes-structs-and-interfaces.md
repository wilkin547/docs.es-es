...
|`IDictionary` <br /> `IDictionary<TKey,TValue>`|**✓ DO** agregar el sufijo "Diccionario". Tenga en cuenta que `IDictionary` es un tipo específico de la colección, pero esta instrucción tiene prioridad sobre la instrucción de colecciones más general que sigue.|  
