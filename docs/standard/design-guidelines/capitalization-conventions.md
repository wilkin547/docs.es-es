 ...
 **X DO NOT** se supone que todos los lenguajes de programación distinguen entre mayúsculas y minúsculas. pero no lo son. Los nombres no pueden diferir solo en mayúsculas y minúsculas.  
