 ...
 **✓ DO** aplicar una petición de vínculo a <xref:System.Runtime.Serialization.ISerializable.GetObjectData%2A?displayProperty=nameWithType> implementación. Esto garantiza que solo totalmente de confianza principal y el serializador en tiempo de ejecución tienen acceso al miembro.  
