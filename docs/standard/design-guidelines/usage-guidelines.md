...
La interfaz de <xref:System.IDisposable?displayProperty=nameWithType> no se trata en esta sección, pero se describe en la sección [patrón Dispose](../garbage-collection/implementing-dispose.md) .
