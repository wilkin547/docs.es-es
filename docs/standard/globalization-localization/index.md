...
helpviewer_keywords: 
  ...
  - "globalización [.NET Framework], codificar"
  - "aplicaciones internacionales [.NET Framework]"
  - "internacionalización"
  - "desarrollo de aplicaciones multilingüe"
...
-   Da como resultado aplicaciones localizadas que son más estables y tienen menos errores.  
 ...
 Para obtener más información, vea el [Centro de desarrolladores Go Global](http://go.microsoft.com/fwlink/?LinkId=235015).  
