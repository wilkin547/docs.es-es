...
En este artículo se muestra cómo migrar desde [Newtonsoft.Json](https://www.newtonsoft.com/json) a <xref:System.Text.Json>.
...
| Característica de Newtonsoft.Json                               | Equivalente de System.Text.Json |
|-------------------------------------------------------|-----------------------------|
