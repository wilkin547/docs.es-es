...
A continuación se describe el contenido del archivo de entrada, _HeadCount.xml*, que se va a validar:
...
A continuación se describe el contenido del archivo de esquema XDR, *HeadCount.xdr*, sobre el que se va realizar la validación:
