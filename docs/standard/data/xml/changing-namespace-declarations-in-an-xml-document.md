...
```  
 ...
 Del mismo modo, si agrega un atributo de `xmlns` diferente al elemento de `doc` como se indica a continuación, el elemento de `test` todavía tiene `123`**NamespaceURI** .  
