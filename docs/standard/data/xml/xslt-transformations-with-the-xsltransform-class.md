...
## <a name="overview"></a>Información general  
 ![Arquitectura de transformación de XSLT](../../../../docs/standard/data/xml/media/xslttransformationswithxsltransformclass.gif "xsltTransformationsWithXslTransformClass")  
