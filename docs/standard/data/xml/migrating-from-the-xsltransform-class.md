---
title: "Migraci&#243;n desde la clase XslTransform | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
## Seguridad  
 ...
 Para obtener más información, consulta [Consideraciones de seguridad de XSLT](../../../../docs/standard/data/xml/xslt-security-considerations.md).  
...
### Comportamiento discrecional  
 La recomendación de la versión 1.0 de las transformaciones XLT \(XSLT\) del W3C incluye áreas en las que el proveedor de las implementaciones puede decidir cómo controlar una situación.  Estas áreas se consideran comportamientos discrecionales.  Existen numerosas áreas en las que <xref:System.Xml.Xsl.XslCompiledTransform> se comporta de manera distinta a la clase <xref:System.Xml.Xsl.XslTransform>.  Para obtener más información, consulta [Errores XSLT recuperables](../../../../docs/standard/data/xml/recoverable-xslt-errors.md).  
...
-   msxsl:node\-set: <xref:System.Xml.Xsl.XslTransform> requiere que el argumento de la función [Función node\-set](http://msdn.microsoft.com/es-es/87b6b3f4-16f4-4fa3-8103-d62a679ac2a7) sea un fragmento del árbol resultante.  La clase <xref:System.Xml.Xsl.XslCompiledTransform> no tiene este requerimiento.  
  
-   msxsl:version: está función la admite <xref:System.Xml.Xsl.XslCompiledTransform>.  
  
-   Funciones de extensión de XPath: ahora, se admiten las funciones [Función ms:string\-compare](http://msdn.microsoft.com/es-es/20616b82-9e27-444c-b714-4f1e09b73aee), [Función ms:utc](http://msdn.microsoft.com/es-es/ef26fc88-84c6-4fb9-9c3b-f2f5264b864f), [Función ms:namespace\-uri](http://msdn.microsoft.com/es-es/91f9cabf-ab93-4dbe-9c12-e6a75214f4c7), [Función ms:local\-name](http://msdn.microsoft.com/es-es/10ed60a1-17a9-4d74-8b98-7940ac97c0b5), [Función ms:number](http://msdn.microsoft.com/es-es/b94fc08e-1f31-4f48-b1a8-6d78c1b5d954), [Función ms:format\-date](http://msdn.microsoft.com/es-es/51f35609-89a9-4098-a166-88bf01300bf5) y [Función ms:format\-time](http://msdn.microsoft.com/es-es/e5c2df2d-e8fb-4a8f-bfc0-db84ea12a5d5).  
