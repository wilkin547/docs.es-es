...
|Tipo de nodo DOM|Object|Description|  
|-------------------|------------|-----------------|  
...
|EndElement|Se devuelve cuando **XmlReader** llega al final de un elemento.<br /><br /> XML de ejemplo: **\</item>**<br /><br /> Para obtener más información, consulta <xref:System.Xml.XmlNodeType>.|  
|EndEntity|Se devuelve cuando **XmlReader** llega al final del reemplazo de la entidad como resultado de una llamada a <xref:System.Xml.XmlReader.ResolveEntity%2A>. Para obtener más información, consulta <xref:System.Xml.XmlNodeType>.|  
