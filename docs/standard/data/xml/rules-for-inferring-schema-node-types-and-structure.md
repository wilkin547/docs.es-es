...
6. <span data-ttu-id="2d4ba-112">Elemento con una secuencia de elementos secundarios y atributos</span><span class="sxs-lookup"><span data-stu-id="2d4ba-112">Element with a sequence of child elements and attributes</span></span>  
...
### <a name="empty-element"></a><span data-ttu-id="2d4ba-124">Elemento vacío</span><span class="sxs-lookup"><span data-stu-id="2d4ba-124">Empty Element</span></span>  
 ...
 <span data-ttu-id="2d4ba-127">Para más información sobre el proceso de deducción de esquema, vea [Deducción de esquemas a partir de documentos XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="2d4ba-127">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
...
|<span data-ttu-id="2d4ba-140">XML</span><span class="sxs-lookup"><span data-stu-id="2d4ba-140">XML</span></span>|<span data-ttu-id="2d4ba-141">Schema</span><span class="sxs-lookup"><span data-stu-id="2d4ba-141">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-of-child-elements"></a><span data-ttu-id="2d4ba-142">Elemento con una secuencia de elementos secundarios</span><span class="sxs-lookup"><span data-stu-id="2d4ba-142">Element with a Sequence of Child Elements</span></span>  

 <span data-ttu-id="2d4ba-143">La siguiente tabla muestra la entrada XML en el método <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> y el esquema XML generado.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-143">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="2d4ba-144">Los elementos en negrita muestran el esquema deducido para un elemento con una secuencia de elementos secundarios.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-144">The bolded elements show the schema inferred for an element with a sequence of child elements.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="2d4ba-145">Incluso si un elemento solo tiene un elemento secundario, se trata todavía como secuencia.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-145">Even if an element has only one child element, it is still treated as a sequence.</span></span>  
  
 <span data-ttu-id="2d4ba-146">Para más información sobre el proceso de deducción de esquema, vea [Deducción de esquemas a partir de documentos XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="2d4ba-146">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="2d4ba-147">XML</span><span class="sxs-lookup"><span data-stu-id="2d4ba-147">XML</span></span>|<span data-ttu-id="2d4ba-148">Schema</span><span class="sxs-lookup"><span data-stu-id="2d4ba-148">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-of-child-elements-and-attributes"></a><span data-ttu-id="2d4ba-149">Elemento con una secuencia de elementos secundarios y atributos</span><span class="sxs-lookup"><span data-stu-id="2d4ba-149">Element with a Sequence of Child Elements and Attributes</span></span>  

 <span data-ttu-id="2d4ba-150">La siguiente tabla muestra la entrada XML en el método <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> y el esquema XML generado.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-150">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="2d4ba-151">Los elementos en negrita muestran el esquema deducido para un elemento con una secuencia de elementos secundarios y atributos.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-151">The bolded elements show the schema inferred for an element with a sequence of child elements and attributes.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="2d4ba-152">Incluso si un elemento solo tiene un elemento secundario, se trata todavía como secuencia.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-152">Even if an element has only one child element, it is still treated as a sequence.</span></span>  
  
 <span data-ttu-id="2d4ba-153">Para más información sobre el proceso de deducción de esquema, vea [Deducción de esquemas a partir de documentos XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="2d4ba-153">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="2d4ba-154">XML</span><span class="sxs-lookup"><span data-stu-id="2d4ba-154">XML</span></span>|<span data-ttu-id="2d4ba-155">Schema</span><span class="sxs-lookup"><span data-stu-id="2d4ba-155">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-and-choices-of-child-elements"></a><span data-ttu-id="2d4ba-156">Elemento con una secuencia y opciones de elementos secundarios</span><span class="sxs-lookup"><span data-stu-id="2d4ba-156">Element with a Sequence and Choices of Child Elements</span></span>  

 <span data-ttu-id="2d4ba-157">La siguiente tabla muestra la entrada XML en el método <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> y el esquema XML generado.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-157">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="2d4ba-158">Los elementos en negrita muestran el esquema deducido para un elemento con una secuencia y opción de elementos secundarios.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-158">The bolded elements show the schema inferred for an element with a sequence and choice of child elements.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="2d4ba-159">El atributo `maxOccurs` del elemento `xs:choice` se establece en `"unbounded"` en el esquema deducido.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-159">The `maxOccurs` attribute of the `xs:choice` element is set to `"unbounded"` in the inferred schema.</span></span>  
  
 <span data-ttu-id="2d4ba-160">Para más información sobre el proceso de deducción de esquema, vea [Deducción de esquemas a partir de documentos XML](inferring-schemas-from-xml-documents.md).</span><span class="sxs-lookup"><span data-stu-id="2d4ba-160">For more information about the schema inference process, see [Inferring Schemas from XML Documents](inferring-schemas-from-xml-documents.md).</span></span>  
  
|<span data-ttu-id="2d4ba-161">XML</span><span class="sxs-lookup"><span data-stu-id="2d4ba-161">XML</span></span>|<span data-ttu-id="2d4ba-162">Schema</span><span class="sxs-lookup"><span data-stu-id="2d4ba-162">Schema</span></span>|  
|---------|------------|  
...
### <a name="element-with-a-sequence-and-choice-of-child-elements-and-attributes"></a><span data-ttu-id="2d4ba-163">Elemento con una secuencia y opción de elementos secundarios y atributos</span><span class="sxs-lookup"><span data-stu-id="2d4ba-163">Element with a Sequence and Choice of Child Elements and Attributes</span></span>  

 <span data-ttu-id="2d4ba-164">La siguiente tabla muestra la entrada XML en el método <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> y el esquema XML generado.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-164">The following table shows the XML input to the <xref:System.Xml.Schema.XmlSchemaInference.InferSchema%2A> method, and the XML schema generated.</span></span> <span data-ttu-id="2d4ba-165">Los elementos en negrita muestran el esquema deducido para un elemento con una secuencia y opción de elementos secundarios y atributos.</span><span class="sxs-lookup"><span data-stu-id="2d4ba-165">The bolded elements show the schema inferred for an element with a sequence and choice of child elements and attributes.</span></span>  
...
### <a name="mixed-content"></a><span data-ttu-id="2d4ba-178">Contenido mixto</span><span class="sxs-lookup"><span data-stu-id="2d4ba-178">Mixed Content</span></span>  
...
- [<span data-ttu-id="2d4ba-204">Reglas para deducir tipos simples</span><span class="sxs-lookup"><span data-stu-id="2d4ba-204">Rules for Inferring Simple Types</span></span>](rules-for-inferring-simple-types.md)
