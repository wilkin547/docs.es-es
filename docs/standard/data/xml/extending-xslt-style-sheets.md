...
## <a name="in-this-section"></a>Esta sección  
 [Objetos de extensión de XSLT](../../../../docs/standard/data/xml/xslt-extension-objects.md)  
 Describe el uso de la clase <xref:System.Xml.Xsl.XsltArgumentList> para procesar objetos de extensión XSLT.  
  
 [Parámetros XSLT](../../../../docs/standard/data/xml/xslt-parameters.md)  
 Describe el uso de la clase <xref:System.Xml.Xsl.XsltArgumentList> para procesar parámetros XSLT.  
  
 [Bloques de scripts con msxsl:script](../../../../docs/standard/data/xml/script-blocks-using-msxsl-script.md)  
