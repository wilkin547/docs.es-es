...
## <a name="string-uri"></a>Identificador URI de cadena  
 ...
 Para obtener más información, consulte [resolver externo recursos durante el procesamiento XSLT](../../../../docs/standard/data/xml/resolving-external-resources-during-xslt-processing.md).  
