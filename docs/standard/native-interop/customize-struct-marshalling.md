...
**✔️ USE**  solo use `LayoutKind.Explicit` en la serialización cuando la estructura nativa tiene un diseño explícito, como una unión.
...
## <a name="customizing-boolean-field-marshalling"></a>Personalización de la serialización de campos booleanos
...
## <a name="customizing-array-field-marshalling"></a>Personalización de la serialización de campos de matriz
...
## <a name="customizing-string-field-marshalling"></a>Personalización de la serialización de campos de cadena
...
## <a name="customizing-decimal-field-marshalling"></a>Personalización de la serialización de campos de decimal
...
## <a name="marshalling-systemobjects"></a>Serialización de `System.Object`
