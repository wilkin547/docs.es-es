...
> **Lisa Guthrie**, p. M. senior, equipo de Visual Studio Tools, Microsoft  
...
| Aplicaciones implementadas en las máquinas virtuales de Azure | Aplicaciones de N niveles o monolítica implementadas en Azure App Service, instancia de contenedor de Azure (ACI), las máquinas virtuales con contenedores o AKS (Azure Kubernetes Service) | Microservicios en contenedores en Azure Kubernetes Service (AKS) o microservicios sin servidor basadas en funciones de Azure. |
| **Destino de datos** |
