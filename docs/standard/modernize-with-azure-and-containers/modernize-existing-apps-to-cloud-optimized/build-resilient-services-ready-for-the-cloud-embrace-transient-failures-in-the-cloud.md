...
Dado que los clientes y servicios son procesos independientes, es posible que un servicio no pueda responder de manera oportuna a solicitud del cliente. El servicio podría estar sobrecargado y responder con lentitud a las solicitudes, o podría no ser accesible durante un breve tiempo debido a problemas de red.
...
Al implementar los reintentos HTTP y los disyuntores, la recomendación para .NET es usar el [Polly](https://github.com/App-vNext/Polly) biblioteca, que tiene como destino .NET Framework 4.0, .NET Framework 4.5 y .NET 1.1 estándar, que incluye compatibilidad con .NET Core.
