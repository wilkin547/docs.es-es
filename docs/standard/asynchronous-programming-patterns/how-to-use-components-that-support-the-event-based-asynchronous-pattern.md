...
---
# <a name="how-to-use-components-that-support-the-event-based-asynchronous-pattern"></a>Procedimiento para usar componentes que admitan el modelo asincrónico basado en eventos
