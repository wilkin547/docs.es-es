...
|<xref:System.Linq.ParallelEnumerable.Select%2A> \(indizado\)|Resultados ordenados|Resultados no ordenados.|  
|<xref:System.Linq.ParallelEnumerable.SelectMany%2A>|Resultados ordenados.|Resultados no ordenados|  
|<xref:System.Linq.ParallelEnumerable.SelectMany%2A> \(indizado\)|Resultados ordenados.|Resultados no ordenados.|  
...
|<xref:System.Linq.ParallelEnumerable.Where%2A> \(indizado\)|Resultados ordenados|Resultados no ordenados|  
