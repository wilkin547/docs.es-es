...
```  
 ...
 Para obtener más información acerca de cómo usar expresiones lambda, vea [expresiones Lambda en PLINQ y TPL](../../../docs/standard/parallel-programming/lambda-expressions-in-plinq-and-tpl.md).  
