...
|El subproceso llama <xref:System.Threading.Thread.Sleep%2A?displayProperty=nameWithType>.|<xref:System.Threading.ThreadState.WaitSleepJoin>|  
|El subproceso llama <xref:System.Threading.Monitor.Wait%2A?displayProperty=nameWithType> en otro objeto.|<xref:System.Threading.ThreadState.WaitSleepJoin>|  
|El subproceso llama <xref:System.Threading.Thread.Join%2A?displayProperty=nameWithType> en otro subproceso.|<xref:System.Threading.ThreadState.WaitSleepJoin>|  
...
|El subproceso responde a una <xref:System.Threading.Thread.Suspend%2A?displayProperty=nameWithType> solicitud.|<xref:System.Threading.ThreadState.Suspended>|  
...
|El subproceso responde a una <xref:System.Threading.Thread.Abort%2A?displayProperty=nameWithType>.|<xref:System.Threading.ThreadState.Aborted>y después <xref:System.Threading.ThreadState.Stopped>|  
...
```  
 ...
 A menudo, los subprocesos están en más de un estado en un momento dado. Por ejemplo, si un subproceso está bloqueado en un <xref:System.Threading.Monitor.Wait%2A?displayProperty=nameWithType> llamada y otro subproceso llama <xref:System.Threading.Thread.Abort%2A> en el mismo subproceso, el subproceso estará en ambos el <xref:System.Threading.ThreadState.WaitSleepJoin> y <xref:System.Threading.ThreadState.AbortRequested> Estados al mismo tiempo. En ese caso, en cuanto el subproceso vuelva de la llamada a <xref:System.Threading.Monitor.Wait%2A> o se interrumpa, recibirá una excepción <xref:System.Threading.ThreadAbortException>.  
