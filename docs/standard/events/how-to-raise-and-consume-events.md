---
title: "C&#243;mo: Provocar y utilizar eventos | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "eventos [.NET Framework], provocar"
  - "eventos [.NET Framework], ejemplos"
  - "generar eventos"
...
En los ejemplos de este tema se muestra cómo trabajar con eventos.  Se incluyen ejemplos del delegado <xref:System.EventHandler>, el delegado <xref:System.EventHandler%601> y un delegado personalizado, para ilustrar eventos con y sin datos.  
 ...
 En los ejemplos se usan los conceptos descritos en el tema [Eventos](../../../docs/standard/events/index.md).  
