---
title: "Tipos de las colecciones Hashtable y Dictionary | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "colecciones [.NET Framework], Hashtable (tipo de colección)"
  - "agrupar datos en colecciones, Hashtable (tipo de colección)"
  - "hash (función)"
  - "hash (tablas)"
  - "Hashtable (clase), agrupar datos en colecciones"
  - "Hashtable (tipo de colección)"
