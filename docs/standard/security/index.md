...
## <a name="in-this-section"></a>En esta sección  
 ...
 Proporciona una visión general de servicios criptográficos proporcionados por .NET. Esta sección es de interés para desarrolladores.  
  
 [Instrucciones de codificación segura](../../../docs/standard/security/secure-coding-guidelines.md)  
 Se describen algunas de las prácticas recomendadas para crear aplicaciones .NET confiables. Esta sección es de interés para desarrolladores.  
...
[Cambios de seguridad](../../../docs/framework/security/security-changes.md) describe los cambios importantes en el sistema de seguridad de .NET Framework.
