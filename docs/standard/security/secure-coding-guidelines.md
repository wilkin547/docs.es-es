...
- No utilice la [AllowPartiallyTrustedCaller](xref:System.Security.AllowPartiallyTrustedCallersAttribute) atributo (APTCA).
...
## <a name="security-neutral-code"></a>Código neutral respecto a seguridad
...
|[Seguridad basada en roles](role-based-security.md)|Describe la seguridad basada en roles de .NET en detalle y se proporcionan instrucciones para su uso en el código.|
