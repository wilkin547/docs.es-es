---
title: "Proceso de ejecuci&#243;n administrada | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  ...
  - "código, proceso de ejecución administrada"
  - "tiempo de ejecución, proceso de ejecución administrada"
  - "compilar código fuente, proceso de ejecución administrada"
  - "proceso de ejecución administrada"
  - "Common Language Runtime, proceso de ejecución administrada"
...
-   [Ngen.exe \(Native Image Generator\)](../../docs/framework/tools/ngen-exe-native-image-generator.md) de .NET Framework.  
