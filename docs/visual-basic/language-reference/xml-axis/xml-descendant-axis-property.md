...
## Comentarios  
 ...
 El compilador de [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] convierte las propiedades de eje descendiente en llamadas al método <xref:System.Xml.Linq.XContainer.Descendants%2A>.  
