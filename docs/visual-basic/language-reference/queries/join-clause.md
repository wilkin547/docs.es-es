...
`collection`  
Obligatorio. Colección que se va a combinar con la colección identificada en el lado izquierdo del operador `Join`. Una cláusula `Join` se puede anidar en otra cláusula `Join` o en una cláusula `Group Join`.
