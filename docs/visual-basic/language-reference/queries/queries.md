---
title: Consultas (Visual Basic) | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]permite crear [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext_md.md)] expresiones en el código.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe el `Order By` cláusula, que especifica el criterio de ordenación para las columnas en una consulta.  
