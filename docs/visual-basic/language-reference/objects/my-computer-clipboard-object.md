...
> [!NOTE]
>  También puede utilizar métodos de la <xref:System.Windows.Forms.Clipboard?displayProperty=nameWithType> clase para manipular el Portapapeles.  
