...
## <a name="remarks"></a>Comentarios  
 Para obtener información acerca de los métodos y propiedades de la `My.Computer.FileSystem.SpecialDirectories` de objetos, consulte <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>.  
