---
title: TextFieldParser (objeto) | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
## <a name="remarks"></a>Comentarios  
 Para obtener información acerca de los métodos y propiedades de la `TextFieldParser` objeto, vea <xref:Microsoft.VisualBasic.FileIO.TextFieldParser>.</xref:Microsoft.VisualBasic.FileIO.TextFieldParser>  
 ...
 **Clase:**<xref:Microsoft.VisualBasic.FileIO.TextFieldParser></xref:Microsoft.VisualBasic.FileIO.TextFieldParser>  
