---
title: My.Application.Log (objeto) | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
## <a name="remarks"></a>Comentarios  
 Para obtener información acerca de los métodos y propiedades de la `My.Application.Log` objeto, vea <xref:Microsoft.VisualBasic.Logging.Log>.</xref:Microsoft.VisualBasic.Logging.Log>  
...
> [!NOTE]
>  También puede usar clases de .NET Framework para registrar información desde la aplicación. Para obtener más información, consulte [seguimiento e instrumentación de aplicaciones](http://msdn.microsoft.com/library/773b6fc4-9013-4322-b728-5dec7a72e743).  
  
## <a name="requirements"></a>Requisitos  
 **Namespace:**<xref:Microsoft.VisualBasic.Logging></xref:Microsoft.VisualBasic.Logging>  
  
 **Clase:**<xref:Microsoft.VisualBasic.Logging.Log></xref:Microsoft.VisualBasic.Logging.Log>  
