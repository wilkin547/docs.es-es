...
## <a name="remarks"></a>Comentarios  
 Para obtener información acerca de los métodos y propiedades de la `My.Computer.Registry` de objetos, consulte <xref:Microsoft.VisualBasic.MyServices.RegistryProxy>.  
...
> [!NOTE]
>  También se puede manipular el registro mediante el uso de métodos de la <xref:Microsoft.Win32.Registry?displayProperty=nameWithType> clase.  
