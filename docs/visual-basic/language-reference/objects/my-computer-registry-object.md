---
title: My.Computer.Registry (objeto) | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
## <a name="remarks"></a>Comentarios  
 Para obtener información acerca de los métodos y propiedades de la `My.Computer.Registry` objeto, vea <xref:Microsoft.VisualBasic.MyServices.RegistryProxy>.</xref:Microsoft.VisualBasic.MyServices.RegistryProxy>  
...
> [!NOTE]
>  También puede manipular el registro mediante métodos de la <xref:Microsoft.Win32.Registry?displayProperty=fullName>clase.</xref:Microsoft.Win32.Registry?displayProperty=fullName>  
  
## <a name="requirements"></a>Requisitos  
 **Namespace:**<xref:Microsoft.VisualBasic.MyServices></xref:Microsoft.VisualBasic.MyServices>  
  
 **Clase:** <xref:Microsoft.VisualBasic.MyServices.RegistryProxy>(proporciona acceso a <xref:Microsoft.Win32.Registry>)</xref:Microsoft.Win32.Registry> </xref:Microsoft.VisualBasic.MyServices.RegistryProxy>  
