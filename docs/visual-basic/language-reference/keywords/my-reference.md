...
|Obtener acceso a los registros de aplicación.|`My.Application.Log` (<xref:Microsoft.VisualBasic.ApplicationServices.ApplicationBase.Log%2A>)|  
|Obtener acceso a la solicitud web actual.|[My.Request (objeto)](../../../visual-basic/language-reference/objects/my-request-object.md)|  
|Obtener acceso a elementos de recurso.|[My.Resources (objeto)](../../../visual-basic/language-reference/objects/my-resources-object.md)|  
