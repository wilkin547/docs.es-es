...
|Calcular el tipo de interés.|<xref:Microsoft.VisualBasic.Financial.Rate%2A>|  
|Calcular la tasa interna de retorno.|<xref:Microsoft.VisualBasic.Financial.IRR%2A>, <xref:Microsoft.VisualBasic.Financial.MIRR%2A>|  
|Calcular el número de períodos.|<xref:Microsoft.VisualBasic.Financial.NPer%2A>|  
