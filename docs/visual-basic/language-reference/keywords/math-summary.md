...
Las palabras clave del lenguaje [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] y los miembros de las bibliotecas en tiempo de ejecución están organizados por uso y propósito.  
