---
title: "Resumen de manipulaciones de cadenas (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
helpviewer_keywords: 
  - "manipular cadenas"
  - "funciones de cadena"
  - "cadenas [Visual Basic], manipular"
...
manager: "wpickett"
---
# Resumen de manipulaciones de cadenas (Visual Basic)
...
|Invertir una cadena.|<xref:Microsoft.VisualBasic.Strings.InStrRev%2A>, <xref:Microsoft.VisualBasic.Strings.StrReverse%2A>|  
|Convertir en mayúsculas o minúsculas.|<xref:Microsoft.VisualBasic.Strings.Format%2A>, <xref:Microsoft.VisualBasic.Strings.LCase%2A>, <xref:Microsoft.VisualBasic.Strings.UCase%2A>|  
|Crear una cadena de caracteres repetidos.|<xref:Microsoft.VisualBasic.Strings.Space%2A>, <xref:Microsoft.VisualBasic.Strings.StrDup%2A>|  
