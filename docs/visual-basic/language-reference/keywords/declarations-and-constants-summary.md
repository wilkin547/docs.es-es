---
title: "Resumen de constantes y declaraciones (Visual Basic) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.suite: ""
ms.technology: 
...
helpviewer_keywords: 
  - "constantes"
  - "declaraciones, elementos del lenguaje Visual Basic"
  - "declarar constantes, palabras clave"
...
|------------|---------------------------|  
|Asignar un valor.|[Get](../../../visual-basic/language-reference/statements/get-statement.md), [Property](../../../visual-basic/language-reference/statements/property-statement.md)|  
