...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="c46ef-102">Miembros de la biblioteca en tiempo de ejecución de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="c46ef-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="c46ef-103">El `Microsoft.VisualBasic` espacio de nombres contiene clases, módulos, constantes y enumeraciones que constituyen la biblioteca en tiempo de ejecución de Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="c46ef-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="c46ef-104">Estos miembros de la biblioteca proporcionan procedimientos, propiedades y valores constantes que puede utilizar en el código.</span><span class="sxs-lookup"><span data-stu-id="c46ef-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="c46ef-105">Cada módulo y clase representan una categoría determinada de funcionalidad.</span><span class="sxs-lookup"><span data-stu-id="c46ef-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="c46ef-106">Clase Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="c46ef-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="c46ef-107">Clase Microsoft.VisualBasic.ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="c46ef-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="c46ef-108">Clase Microsoft.VisualBasic.ControlChars</span><span class="sxs-lookup"><span data-stu-id="c46ef-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="c46ef-109">Clase Microsoft.VisualBasic.Constants</span><span class="sxs-lookup"><span data-stu-id="c46ef-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="c46ef-110">Módulo Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="c46ef-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="c46ef-111">Módulo Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="c46ef-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="c46ef-112">Clase Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="c46ef-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="c46ef-113">Módulo Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="c46ef-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="c46ef-114">Módulo Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="c46ef-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="c46ef-115">Módulo Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="c46ef-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="c46ef-116">Clase Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="c46ef-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="c46ef-117">Módulo Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="c46ef-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="c46ef-118">Módulo Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="c46ef-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="c46ef-119">Clase Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="c46ef-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="c46ef-120">Módulo Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="c46ef-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="c46ef-121">Clase Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="c46ef-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="c46ef-122">Clase Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="c46ef-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="c46ef-123">Módulo Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="c46ef-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="c46ef-124">Microsoft.VisualBasic constantes y enumeraciones</span><span class="sxs-lookup"><span data-stu-id="c46ef-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="c46ef-125">El `Microsoft.VisualBasic` espacio de nombres proporciona constantes y enumeraciones como parte de la biblioteca de tiempo de ejecución de Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="c46ef-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="c46ef-126">Puede utilizar estos valores constantes en el código.</span><span class="sxs-lookup"><span data-stu-id="c46ef-126">You can use these constant values in your code.</span></span> <span data-ttu-id="c46ef-127">Cada enumeración representa una categoría determinada de funcionalidad.</span><span class="sxs-lookup"><span data-stu-id="c46ef-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="c46ef-128">Para obtener más información, consulte [constantes y enumeraciones](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="c46ef-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="c46ef-129">Vea también</span><span class="sxs-lookup"><span data-stu-id="c46ef-129">See Also</span></span>  
 [<span data-ttu-id="c46ef-130">Constantes y enumeraciones</span><span class="sxs-lookup"><span data-stu-id="c46ef-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="c46ef-131">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="c46ef-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
