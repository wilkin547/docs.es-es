...
Especifica que un argumento se pasa de manera que el procedimiento llamado puede cambiar el valor de una variable subyacente del argumento en el código de llamada.  
