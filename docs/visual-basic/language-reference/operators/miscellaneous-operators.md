---
title: Operadores variados (Visual Basic) | Documentos de Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
---
# <a name="miscellaneous-operators-visual-basic"></a>Operadores variados (Visual Basic)
Los siguientes son operadores varios definidos en [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
