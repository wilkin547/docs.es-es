...
## <a name="result"></a>Resultado  
 El resultado es el cociente entero de `expression1` dividido por `expression2`, que descarta cualquier resto y solo conserva la parte entera. Esto se conoce como *truncamiento*.  
...
## <a name="attempted-division-by-zero"></a>División intentada por cero  
 Si `expression2` se evalúa como cero, el operador `\` produce una excepción @no__t 2. Esto es así para todos los tipos de datos numéricos de los operandos.  
