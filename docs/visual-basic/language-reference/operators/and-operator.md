...
## <a name="parts"></a>Elementos  
 `result`  
 Requerido. Cualquier `Boolean` o expresión numérica. Para la comparación booleana, `result` es la conjunción lógica de dos `Boolean` valores. Para las operaciones bit a bit, `result` es un valor numérico que representa la conjunción bit a bit de dos patrones de bits numéricos.  
