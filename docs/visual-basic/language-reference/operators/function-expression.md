...
## Ejemplo  
 Las expresiones lambda están debajo de muchos de los operadores de consulta de [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext_md.md)] y se pueden utilizar explícitamente en consultas basadas en método.  En el ejemplo siguiente se muestra una consulta [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq_md.md)] típica, seguida por la traducción de la consulta al formato de método.  
