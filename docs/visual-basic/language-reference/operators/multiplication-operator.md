...
|Cualquier expresión es un tipo de datos de punto flotante (`Single` o [Double](../../../visual-basic/language-reference/data-types/double-data-type.md)) pero no ambos `Single` (tenga en cuenta `Decimal` no es un tipo de datos de punto flotante)|`Double`|  
