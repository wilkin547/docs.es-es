...
|---|---|
|`argument1`|Requerido. `Boolean`Operador Determines which of the other arguments to evaluate and return.|
|`argument2`|Requerido. `Object`Operador Evaluated and returned if `argument1` evaluates to `True`.|
|`argument3`|Requerido. `Object`Operador Evaluated and returned if `argument1` evaluates to `False` or if `argument1` is a [Nullable](../../../visual-basic/programming-guide/language-features/data-types/nullable-value-types.md)`Boolean` variable that evaluates to [Nothing](../../../visual-basic/language-reference/nothing.md).|
...
|Término|de esquema JSON|
|---|---|
|`argument2`|Requerido. `Object`Operador Must be a reference or nullable type. Evaluated and returned when it evaluates to anything other than `Nothing`.|
|`argument3`|Requerido. `Object`Operador Evaluated and returned if `argument2` evaluates to `Nothing`.|
