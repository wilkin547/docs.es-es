...
ms.locfileid: "58829985"
---
# <a name="logicalbitwise-operators-visual-basic"></a>Operadores lógicos y bit a bit (Visual Basic)
Estos son los operadores lógicos y bit a bit definidos en Visual Basic.  
