...
## <a name="remarks"></a>Observaciones  
 ...
 Cada elemento de la lista se especifica con un `<item>` bloque. Al crear una lista de definiciones, debe especificar `term` y `description` . Sin embargo, para una tabla, una lista con viñetas o una lista numerada, solo tiene que proporcionar una entrada para `description` .  
  
 Una lista o una tabla puede tener tantos `<item>` bloques como sea necesario.  
