...
## <a name="remarks"></a>Comentarios  
 Use la etiqueta `<remarks>` para agregar información sobre un tipo, complementando la información especificada con [\<summary >](../../../visual-basic/language-reference/xmldoc/summary.md).  
