...
|Término|Definición|  
|---|---|  
|`expression`|Obligatorio. Una expresión que se pueda convertir implícitamente al tipo de la función de iterador o `Get` descriptor de acceso que contiene la instrucción `Yield`.|  
