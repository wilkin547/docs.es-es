...
4.  Asegúrese de que no ha intentado cambiar un proyecto de [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] dentro de una base de datos o documento.  
