...
-   Si es posible, utilice un argumento de llamada del mismo tipo que el parámetro de procedimiento, de forma que [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] no necesite realizar ninguna conversión.  
