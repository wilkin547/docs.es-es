...
No se proporcionó un `WithEvents` variable en su `Handles` cláusula. El `Handles` palabra clave al final de una declaración de procedimiento hace que controle los eventos generados por una variable de objeto declarada con la `WithEvents` palabra clave.  
