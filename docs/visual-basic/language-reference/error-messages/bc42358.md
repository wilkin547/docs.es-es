...
---
# <a name="because-this-call-is-not-awaited-execution-of-the-current-method-continues-before-the-call-is-completed"></a>Dado que no se espera esta llamada, la ejecución del método actual continúa antes de que se complete la llamada.
