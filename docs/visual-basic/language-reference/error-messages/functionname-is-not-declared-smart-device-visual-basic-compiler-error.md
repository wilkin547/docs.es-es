...
---
# <a name="functionname-is-not-declared-smart-devicevisual-basic-compiler-error"></a>' \<functionname> ' no se declaró (error del compilador de Smart Device/Visual Basic)
