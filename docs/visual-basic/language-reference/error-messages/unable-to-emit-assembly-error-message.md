...
3. Abra [visual studio símbolo del sistema para desarrolladores o Visual Studio Developer PowerShell](/visualstudio/ide/reference/command-prompt-powershell).
