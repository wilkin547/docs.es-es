...
## <a name="arguments"></a>Argumentos  
 `response_file`  
 Requerido. Un archivo que se enumera las opciones del compilador o archivos de código fuente para compilar. Ponga el nombre de archivo entre comillas ("") si contiene un espacio.  
