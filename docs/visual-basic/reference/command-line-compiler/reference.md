...
-   Se invoca un campo, una propiedad, un evento o un método que tiene un tipo de valor devuelto o un tipo de parámetro del Ensamblado B.  
 ...
 El archivo de respuesta Vbc.rsp, que hace referencia a los ensamblados utilizados comúnmente en [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort-md.md)], es el predeterminado.  Utilice `/noconfig` si no desea que el compilador utilice Vbc.rsp.  
