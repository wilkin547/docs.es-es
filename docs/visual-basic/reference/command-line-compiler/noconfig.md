...
Especifica que el compilador no debe hacer referencia automáticamente a los ensamblados de [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort_md.md)] de uso habitual ni importar los espacios de nombres `System` y `Microsoft.VisualBasic`.  
