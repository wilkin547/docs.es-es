...
## <a name="arguments"></a>Argumentos  
 `+` &#124; `-`  
 Opcional. The default for this option is `-utf8output-`, which means compiler output does not use UTF-8 encoding. Especificar `-utf8output` es lo mismo que especificar `-utf8output+`.  
