---
title: "Opciones del compilador de Visual Basic, por orden alfab&#233;tico | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.reviewer: ""
ms.suite: ""
...
|`/additionalfile`|Enumera los archivos adicionales que no afectan directamente a la generación de código, pero que los analizadores pueden usar para generar errores o advertencias.|  
