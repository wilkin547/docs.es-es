...
ms.locfileid: "44042249"
---
# <a name="visual-basic-power-packs-controls"></a>Controles de Visual Basic Power Packs

Power Packs de Visual Basic son controles adicionales de Windows Forms. No se incluyen en Visual Studio.  También puede [descargarlos](https://go.microsoft.com/fwlink/?LinkId=321343), pero se proporcionan como-es, sin soporte técnico.  
