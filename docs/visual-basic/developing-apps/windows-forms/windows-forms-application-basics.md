...
-   [Controles de formularios Windows Forms](../../../framework/winforms/controls/index.md). Colección de temas que detalla el uso de controles de formularios Windows Forms.  
...
|En|Vea|  
|--------|---------|  
|Use la <xref:System.Windows.Forms.BindingSource> componente|[Cómo: Enlazar controles de Windows Forms con el componente BindingSource mediante el Diseñador](../../../framework/winforms/controls/bind-wf-controls-with-the-bindingsource.md)|  
