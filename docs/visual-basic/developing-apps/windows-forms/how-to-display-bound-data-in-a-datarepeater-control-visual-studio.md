...
---
# <a name="how-to-display-bound-data-in-a-datarepeater-control-visual-studio"></a>Procedimiento Mostrar los datos enlazados en un Control DataRepeater (Visual Studio)
