...
|En|Vea|  
|--------|---------|  
|Cree una nueva aplicación de Windows Forms con Visual Studio|[Tutorial: Crear un formulario de Windows Simple](http://msdn.microsoft.com/library/2d9daec0-0543-41d0-acb1-964f685bddbb)|  
