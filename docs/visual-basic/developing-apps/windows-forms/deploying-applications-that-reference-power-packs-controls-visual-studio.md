...
## Instalar los controles de Power Packs como requisito previo  
 ...
 Al instalar [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs_md.md)] en el equipo de desarrollo, se agrega un arranque de Power Packs al directorio de arranque de [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs_md.md)].  Este paquete está disponible cuando se siguen los procedimientos para agregar los requisitos previos para la implementación de [!INCLUDE[ndptecclick](../../../visual-basic/developing-apps/printing/includes/ndptecclick_md.md)] o Windows Installer.  
