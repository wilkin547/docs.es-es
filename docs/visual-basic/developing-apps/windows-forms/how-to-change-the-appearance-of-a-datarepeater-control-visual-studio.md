...
---
# <a name="how-to-change-the-appearance-of-a-datarepeater-control-visual-studio"></a>Procedimiento Cambiar la apariencia de un Control DataRepeater (Visual Studio)
...
## <a name="example"></a>Ejemplo  
 Algunas personalizaciones comunes para la <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> control incluye la visualización de las filas en colores alternos y cambiar el color de un campo según una condición. El ejemplo siguiente muestra cómo realizar estas personalizaciones. En este ejemplo se supone que tiene un <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> control que está enlazado a la tabla Products en la base de datos Northwind.  
 ...
 Tenga en cuenta que ambos estas personalizaciones, debe proporcionar código para establecer las propiedades para ambos lados de la condición. Si no especifica la `Else` condición, verá resultados inesperados en tiempo de ejecución.  
