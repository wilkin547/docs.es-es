...
## <a name="in-this-section"></a>En esta sección  
 ...
 Presenta y explica el control `DataRepeater` .  
 ...
 Muestra cómo usar el control `DataRepeater` para presentar datos desde un origen de datos.  
 ...
 Muestra cómo usar el control `DataRepeater` para presentar datos adicionales.  
 ...
 Muestra cómo cambiar la orientación de un control `DataRepeater` .  
 ...
 Muestra cómo personalizar un control `DataRepeater` en tiempo de diseño y en tiempo de ejecución.  
 ...
 Muestra cómo controlar los indicadores de selección en un control `DataRepeater` .  
 ...
 Muestra cómo impedir que los usuarios agreguen o eliminen elementos en un control `DataRepeater` .  
 ...
 Muestra cómo implementar funcionalidad de búsqueda en un control `DataRepeater` .  
 ...
 Muestra cómo visualizar registros relacionados mediante dos controles `DataRepeater` .  
 ...
 Proporciona una demostración íntegra del uso de un control `DataRepeater` .  
 ...
 Describe posibles problemas y sus soluciones.  
