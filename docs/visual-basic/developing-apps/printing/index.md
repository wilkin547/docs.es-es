...
## <a name="in-this-section"></a>En esta sección  
 ...
 Proporciona información general sobre el `PrintForm` componente que permite imprimir el contenido de un formulario.  
  
 [Imprimir un formulario desplazable](../../../visual-basic/developing-apps/printing/how-to-print-a-scrollable-form.md)  
 Explica cómo imprimir un formulario con desplazamiento mediante el uso de la `PrintForm` componente.  
 ...
 Se explica cómo imprimir áreas el cliente y el cliente que no sea de un formulario mediante el `PrintForm` componente.  
 ...
 Se explica cómo imprimir el área cliente de un formulario mediante el `PrintForm` componente.  
 ...
 Se explica cómo imprimir un formulario básico mediante el `PrintForm` componente.  
 ...
 Se explica cómo implementar el `PrintForm` componente junto con una aplicación.  
