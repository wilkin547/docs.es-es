---
title: Imprimir y crear informes (Visual Basic)
ms.date: 07/20/2015
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Proporciona información general sobre la `PrintForm` componente que permite imprimir el contenido de un formulario.  
  
 [Imprimir un formulario desplazable](../../../visual-basic/developing-apps/printing/how-to-print-a-scrollable-form.md)  
 Explica cómo imprimir un formulario con desplazamiento mediante el `PrintForm` componente.  
 ...
 Explica cómo imprimir áreas el cliente y no cliente de un formulario mediante la `PrintForm` componente.  
 ...
 Explica cómo imprimir el área de cliente de un formulario mediante la `PrintForm` componente.  
 ...
 Explica cómo imprimir un formulario básico mediante la `PrintForm` componente.  
 ...
 Se describe cómo implementar el `PrintForm` componente junto con una aplicación.  
