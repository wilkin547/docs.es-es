...
|Llamar de manera asincrónica a un servicio Web y controlar un evento cuando finaliza|[Llamar a un servicio web de forma asincrónica](../../../visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)|  
