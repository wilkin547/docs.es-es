...
9. Cambie el valor de la `value` atributo "Información".  
    ...
    > [!NOTE]
    >  El `DefaultSwitch` Cambiar configuración controla sólo `My.Application.Log`. No cambia la [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)] <xref:System.Diagnostics.Trace?displayProperty=fullName> y <xref:System.Diagnostics.Debug?displayProperty=fullName> se comportan las clases.  
