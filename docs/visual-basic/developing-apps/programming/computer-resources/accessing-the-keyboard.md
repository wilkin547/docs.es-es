---
title: "Acceso al teclado (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
helpviewer_keywords: 
  - "CapsLock (propiedad)"
  - "teclados, obtener acceso [Visual Basic]"
  - "pulsaciones de teclas"
  - "My.Computer.Keyboard (objeto), tareas"
...
## Tareas  
 Esta tabla muestra tareas asociadas con el objeto `My.Computer.Keyboard` e indica temas que muestran cómo realizar cada tarea.  
...
|Determine si BLOQ NUM está activado|<xref:Microsoft.VisualBasic.Devices.Keyboard.NumLock%2A>|  
|Determinar si BLOQ DESPL está activado|<xref:Microsoft.VisualBasic.Devices.Keyboard.ScrollLock%2A>|  
|Iniciar una aplicación y enviarle pulsaciones de tecla|[Cómo: Iniciar una aplicación y enviarle pulsaciones de teclas \(Visual Basic\)](../../../../visual-basic/developing-apps/programming/computer-resources/how-to-start-an-application-and-send-it-keystrokes.md)|  
