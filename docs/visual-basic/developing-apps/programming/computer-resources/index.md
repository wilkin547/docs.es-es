---
title: "Acceso a los recursos del equipo (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
helpviewer_keywords: 
  - "recursos del equipo"
  - "recursos del equipo, obtener acceso"
  - "My.Computer (objeto), tareas"
...
El objeto `My.Computer` es uno de los tres objetos centrales de `My` que proporcionan acceso a información y funcionalidad de uso frecuente.  `My.Computer` proporciona los métodos, propiedades y eventos para obtener acceso al equipo donde se ejecuta la aplicación.  Entre sus objetos se incluyen:  
  
-   <xref:Microsoft.VisualBasic.Devices.Audio>  
  
-   Portapapeles \(<xref:Microsoft.VisualBasic.MyServices.ClipboardProxy>\)  
...
## En esta sección  
 ...
 [Acceso al mouse \(ratón\)](../../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-mouse.md)  
 ...
 Muestra las tareas asociadas a `My.Computer.Registry`, como leer datos de las claves del Registro o escribir datos en las claves del Registro.