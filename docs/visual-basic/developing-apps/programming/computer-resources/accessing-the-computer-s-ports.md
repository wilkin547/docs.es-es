---
title: "Acceso a los puertos del equipo (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "My.Computer.Ports (objeto), tareas"
  - "puertos serie"
...
manager: "wpickett"
---
# Acceso a los puertos del equipo (Visual Basic)
...
## En esta sección  
 ...
 Describe cómo usar [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)] al realizar operaciones a través de los puertos.  
...
## Referencia  
 ...
 Describe el método `OpenSerialPort`, que crea y abre un objeto <xref:System.IO.Ports.SerialPort?displayProperty=fullName>.  
  
## Secciones relacionadas  
 <xref:System.IO.Ports.SerialPort>  
 Describe la clase de .NET Framework <xref:System.IO.Ports.SerialPort>.