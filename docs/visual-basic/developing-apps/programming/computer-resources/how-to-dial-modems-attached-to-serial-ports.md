...
En este tema se describe cómo utilizar `My.Computer.Ports` para marcar en un módem en [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
