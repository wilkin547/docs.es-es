...
3.  En el cuadro **Nombre**, escriba `FileExplorer` para establecer el nombre del proyecto y, a continuación, haga clic en **Aceptar**.  
     ...
     [!INCLUDE[vsprvs](../../../../csharp/includes/vsprvs-md.md)] agregará el proyecto al **Explorador de soluciones** y se abrirá el Diseñador de Windows Forms.  
