...
## En esta sección  
 ...
 Muestra cómo utilizar el objeto [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] para manipular archivos y carpetas.  
