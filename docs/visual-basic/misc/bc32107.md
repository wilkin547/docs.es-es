...
Una lista de restricciones incluye la [(Visual Basic) de la clase](../../visual-basic/language-reference/statements/class-statement.md) restricción y el nombre de una clase definida.  
