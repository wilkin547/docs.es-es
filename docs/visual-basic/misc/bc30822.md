...
2.  Use la palabra clave [Nothing](../../visual-basic/language-reference/nothing.md) para las asignaciones y comparaciones al usar variables de objeto. En el siguiente ejemplo se muestra cómo hacerlo.  
