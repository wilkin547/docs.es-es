...
Se usa un parámetro de tipo como operando para [IsNot Operator](../../visual-basic/language-reference/operators/isnot-operator.md) cuando el parámetro de tipo está definido sin la palabra clave [Class (Visual Basic)](http://msdn.microsoft.com/en-us/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) o un nombre de clase específico en su lista de restricciones.  
