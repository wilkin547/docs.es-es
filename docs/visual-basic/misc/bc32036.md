...
Una clase derivada no declara un constructor y [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] no puede generar uno porque no puede determinar a qué constructor de clase base debe llamar.  
