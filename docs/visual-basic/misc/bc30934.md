...
Una expresión usada para un argumento de atributo evalúa un tipo de datos distinto del parámetro de atributo correspondiente, y [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] no admite la conversión al tipo requerido para los argumentos de atributo.  
