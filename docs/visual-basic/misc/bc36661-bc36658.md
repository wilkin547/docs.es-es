...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-methodname-defined-in-typename-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>Tipos de datos de los parámetros de tipo del método de extensión '\<methodname >' definido en 'typename' no se pueden inferir de estos argumentos porque no se convierten en el mismo tipo
