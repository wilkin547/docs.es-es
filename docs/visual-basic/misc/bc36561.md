...
---
# <a name="extension-method-methodname-has-type-constraints-that-can-never-be-satisfied"></a>Método de extensión '\<methodname >' tiene restricciones de tipo que se pueden cumplir nunca
