...
---
# <a name="extension-method-ltmethodnamegt-has-type-constraints-that-can-never-be-satisfied"></a>Método de extensión '&lt;methodname&gt;' tiene restricciones de tipo que se pueden cumplir nunca
