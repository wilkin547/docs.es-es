...
---
# <a name="at-least-one-parameter-type-of-this-binary-operator-must-be-the-containing-type-lttypenamegt"></a>Al menos un tipo de parámetro de este operador binario debe ser el tipo contenedor '&lt;typename&gt;'
