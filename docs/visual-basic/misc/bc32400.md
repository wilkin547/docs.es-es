...
Error de inicialización de una clase. Una posible causa es una instalación de [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)] dañada.  
...
2.  Reinstale [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)] y vuelva a compilar el programa.  
