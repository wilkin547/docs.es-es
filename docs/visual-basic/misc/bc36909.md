...
---
# <a name="cannot-infer-a-data-type-for-variablename-because-the-array-dimensions-do-not-match"></a>No se puede inferir un tipo de datos para '\<NombreDeVariable >' porque las dimensiones de matriz no coinciden
