...
---
# <a name="array-initializer-cannot-be-specified-for-a-non-constant-dimension-use-the-empty-initializer-3939"></a>No se puede especificar un inicializador de matriz para una dimensión no constante; Utilice el inicializador vacío &#39; {} &#39;
