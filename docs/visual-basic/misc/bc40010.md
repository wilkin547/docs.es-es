...
La herramienta ALink, que ejecuta el compilador [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], notifica un error al generar el ensamblado. Las causas posibles son las siguientes:  
