...
La primera instrucción de este 'Sub New' debe ser una llamada a 'MyBase.New' o 'MyClass.New' porque la clase base '\<base\>' de '\<derivada\>' tiene más de un 'Sub New' accesible al que se puede llamar sin argumentos.  
 ...
 Un constructor de clase no suministra una llamada a un constructor de clase base, y [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] no puede proporcionar una llamada implícita porque no puede determinar qué constructor de clase base debe llamar.  
