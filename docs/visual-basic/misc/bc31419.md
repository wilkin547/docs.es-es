...
---
# <a name="isnot-requires-operands-that-have-reference-types-but-this-operand-has-the-value-type-lttypenamegt"></a>'IsNot' requiere operandos que tienen tipos de referencia, pero este operando tiene el tipo de valor '&lt;typename&gt;'.
