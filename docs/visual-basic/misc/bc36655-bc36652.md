...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>Tipos de datos de los parámetros de tipo del método de extensión '&lt;methodname&gt;'definido en'&lt;typename&gt;' no se puede inferir de estos argumentos porque hay más de un tipo posible
