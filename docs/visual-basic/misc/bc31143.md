...
---
# <a name="method-ltmethodnamegt-does-not-have-a-signature-compatible-with-delegate-ltdelegatenamegt"></a>Método '&lt;methodname&gt;' no tiene una firma compatible con el delegado &lt;'nombredelegado'.&gt;
