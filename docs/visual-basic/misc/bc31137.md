...
---
# <a name="raiseevent-method-must-have-the-same-signature-as-the-containing-events-delegate-type-signature"></a>El método ' RaiseEvent ' debe tener la misma firma que el tipo delegado '\<Signature > ' del evento que lo contiene.
