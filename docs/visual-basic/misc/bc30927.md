...
---
# <a name="mustoverride-cannot-be-specified-on-ltprocedurenamegt-because-it-is-in-a-partial-type-that-is-declared-notinheritable-in-another-partial-definition"></a>'MustOverride' no puede especificarse en '&lt;NombreDeProcedimiento&gt;' porque está en un tipo parcial que se declaró como 'NotInheritable' en otra definición parcial
