...
`Option Strict On` no permite conversiones implícitas de '`<type1>`'para'`<type2>`'; el tipo de colección de Visual Basic 6.0 no es compatible con el tipo de colección de .NET Framework.
