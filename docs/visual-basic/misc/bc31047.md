...
Normalmente, este error del compilador `Protected` se produce cuando se aplica el modificador de acceso a una clase no anidada. Por ejemplo:
...
Dado `Protected` que es un modificador de acceso de miembro, solo se puede aplicar a un miembro de clase, como una propiedad, un método o una clase anidada.
