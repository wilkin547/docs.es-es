...
'\(' inesperado. No se permiten matrices de tipos genéricos sin instancias.  
 ...
 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] no puede compilar una matriz a menos que sea un tipo de datos específico. No puede usar un parámetro de tipo de datos de un tipo genérico como el tipo de datos de una matriz.  
