...
---
# <a name="non-cls-compliant-mustoverride-member-is-not-allowed-in-a-cls-compliant-ltclassnamegt"></a>No se permite el miembro 'MustOverride' que no son compatibles con CLS en un conforme a CLS &lt;classname&gt;
