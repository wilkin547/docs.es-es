...
1.  Realice operaciones de archivo mediante los miembros de las funciones de tiempo de ejecución `System.IO`, `FileSystemObject` y [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
