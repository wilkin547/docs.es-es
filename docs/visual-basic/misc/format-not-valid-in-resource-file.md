---
title: "Formato no válido en archivo de recursos | Documentos de Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Un archivo de recursos en el proyecto no sigue el formato estándar para un archivo de recursos de Windows o hay una discrepancia entre el archivo de recursos y el [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] proyecto.  
