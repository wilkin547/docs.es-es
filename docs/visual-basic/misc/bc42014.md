...
---
# <a name="baseinterfacenamemembername-from-implements-derivedinterfacename-is-already-implemented-by-the-base-class-baseclassname-re-implementation-of-type-assumed"></a>'\<nombredeinterfazbase >. membername > ' from ' \<implementa nombredeinterfazderivada > ' ya está implementado por la clase base '\<nombreclasebase > '. \< Se supone que se \<ha vuelto a implementar el tipo >
