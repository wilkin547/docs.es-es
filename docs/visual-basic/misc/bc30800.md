---
title: "Argumentos de método deben ir entre paréntesis | Documentos de Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Las reglas que rigen las llamadas a procedimiento son más sencillas en las versiones más recientes de [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]. Todos los argumentos se deben incluir entre paréntesis.  
