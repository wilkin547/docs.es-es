...
-   Si es posible, use valores del mismo tipo de datos, de modo que [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] no tengan que realizar ninguna conversión.  
