...
---
# <a name="anonymous-type-property-propertyname-cannot-be-used-in-the-definition-of-a-lambda-expression-within-the-same-initialization-list"></a>Propiedad de tipo anónimo '\<propertyname >' no se puede usar en la definición de una expresión lambda en la misma lista de inicialización
