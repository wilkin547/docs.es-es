...
Un bloque de atributos `COMClassAttribute` se usa junto con un atributo que no se aplica a objetos COM. Una posible causa es una combinación de [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort-md.md)] y atributos COM.  
