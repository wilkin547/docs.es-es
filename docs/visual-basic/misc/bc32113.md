...
---
# <a name="type-parameter-lttypeparameternamegt-cannot-be-constrained-to-itself-lterrormessagegt"></a>Parámetro de tipo '&lt;typeparametername&gt;' no se puede restringir a sí mismo: '&lt;errormessage&gt;'
