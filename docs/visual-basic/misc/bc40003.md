---
title: '&lt;tipo1&gt; &quot;&lt;membername&gt;&quot; prevalece sobre un miembro puede sobrecargar declarado en la base de &lt;type2&gt; &quot;&lt;classname&gt;&quot; | Documentos de Microsoft'
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="lttype1gt-39ltmembernamegt39-shadows-an-overloadable-member-declared-in-the-base-lttype2gt-39ltclassnamegt39"></a>&lt;tipo1&gt; '&lt;membername&gt;' prevalece sobre un miembro puede sobrecargar declarado en la base de &lt;type2&gt; '&lt;classname&gt;'
\<tipo1 > '\<membername >' prevalece sobre un miembro puede sobrecargar declarado en la base de \<type2 > '\<classname >. Si quiere sobrecargar el método base, este método se debe declarar 'Overloads'.  
  
 Una clase derivada define un procedimiento `Function` o `Sub` o una `Property` con el mismo nombre que un procedimiento o una propiedad definido en la clase base. Dado que los procedimientos y las propiedades son miembros sobrecargables, la clase derivada puede sobrecargar o sombrear el miembro de clase base. Sin embargo, el código de la clase derivada no especifica ni [sobrecargas](../../visual-basic/language-reference/modifiers/overloads.md) o [sombras](../../visual-basic/language-reference/modifiers/shadows.md) en la declaración. En ausencia de una palabra clave, el compilador supone `Shadows`.  
