...
Un ensamblado está marcado como `<CLSCompliant(True)>`, pero el nombre del espacio de nombres raíz comienza con un carácter de subrayado (`_`).  
 ...
 Un elemento de programación puede contener uno o más caracteres de subrayado, pero to sea compatible con la [independencia del lenguaje y componentes independientes del lenguaje](https://msdn.microsoft.com/library/12a7a7h3) (CLS), no debe comenzar con un carácter de subrayado. Vea [Declared Element Names](../../visual-basic/programming-guide/language-features/declared-elements/declared-element-names.md).  
