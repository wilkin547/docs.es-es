---
title: "Las instrucciones &quot;Using&quot; no son válidas en la ventana Inmediato | Documentos de Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="39using39-statements-are-not-valid-in-the-immediate-window"></a>Las instrucciones 'Using' no son válidas en la ventana Inmediato
`Using`instrucciones sólo pueden usarse en código fuente.  
