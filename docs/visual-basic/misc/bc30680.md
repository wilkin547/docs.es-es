...
`#Region` permite especificar que un bloque de código se expanda o contraiga cuando se use la característica de esquematización del Editor de código de [!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)]. El inicio y fin de las instrucciones `#Region` deben estar en el mismo bloque de código.  
