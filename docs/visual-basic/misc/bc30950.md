...
---
# <a name="no-accessible-method-procedurename-has-a--signature-compatible-with-delegate-delegatenamesuberrorlist"></a>Ningún método accesible '\<NombreDeProcedimiento >' tiene una firma compatible con el delegado '\<nombredelegado >':\<sublistadeerrores >
