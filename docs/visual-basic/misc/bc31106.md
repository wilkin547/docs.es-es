...
- [Filtrar para declarar una propiedad con niveles de acceso mixtos](../../visual-basic/programming-guide/language-features/procedures/how-to-declare-a-property-with-mixed-access-levels.md)
