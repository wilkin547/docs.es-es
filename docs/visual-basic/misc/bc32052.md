...
Se utiliza un parámetro de tipo como operando para el [operador Is](../../visual-basic/language-reference/operators/is-operator.md) cuando el parámetro de tipo está definido sin la [(Visual Basic) de la clase](https://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) palabra clave o un nombre de clase específico en su lista de restricciones.  
