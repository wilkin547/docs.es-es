...
Ya no se admite el evento 'Class\_Initialize'. Use 'Sub New' para inicializar una clase.  
 ...
 El evento `Class_Initialize` de versiones anteriores de [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] se sustituyó por constructores de clase.  
