...
Una lista de restricciones incluye la [estructura (Visual Basic)](../../visual-basic/language-reference/statements/structure-statement.md) restricción y el nombre de una clase definida.  
