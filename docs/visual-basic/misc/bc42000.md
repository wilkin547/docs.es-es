...
---
# <a name="lttypegt-ltmethodnamegt-conflicts-with-other-members-of-the-same-name-across-the-inheritance-hierarchy-and-so-should-be-declared-shadows"></a>&lt;tipo&gt; '&lt;methodname&gt;' entra en conflicto con otros miembros del mismo nombre en la jerarquía de herencia de modo que se debe declarar como 'Shadows'
