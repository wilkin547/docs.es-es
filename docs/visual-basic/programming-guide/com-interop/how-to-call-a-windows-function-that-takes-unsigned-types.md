...
2. En la instrucción `Declare`, use `UInteger`, `ULong`, `UShort`o `Byte` según corresponda para cada parámetro con un tipo sin signo.
...
4. Declare las constantes necesarias en el código. Muchas constantes de Windows son valores sin signo de 32 bits y debe declarar estas `As UInteger`.
