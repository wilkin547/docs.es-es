...
- [Cómo: Agregar controles ActiveX a formularios Windows Forms](/dotnet/desktop/winforms/controls/how-to-add-activex-controls-to-windows-forms)
...
- [Consideraciones al alojar un control ActiveX en Windows Forms](/dotnet/desktop/winforms/controls/considerations-when-hosting-an-activex-control-on-a-windows-form)
