...
## <a name="in-this-section"></a>En esta sección  
 ...
 [La atomización previa de objetos XName (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)  
