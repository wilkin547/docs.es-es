...
---
# <a name="how-to-stream-xml-fragments-from-an-xmlreader-visual-basic"></a>Procedimiento Stream streaming de fragmentos XML desde un objeto XmlReader (Visual Basic)
