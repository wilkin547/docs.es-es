...
En este tema se proporciona una breve introducción a las expresiones [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext_md.md)] en Visual Basic y algunos de los tipos de operaciones que suelen realizarse en las consultas.  Para obtener más información, vea los temas siguientes:  
...
## Especificar el origen de datos \(From\)  
 En una consulta [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq_md.md)], el primer paso es especificar el origen de datos que se desea consultar.  Por consiguiente, la cláusula de `From` en una consulta incluye siempre primero. Vea operadores seleccionar y calcula el resultado basándose en el tipo de origen.  
