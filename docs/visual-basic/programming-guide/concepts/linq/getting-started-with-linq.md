...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe las tres etapas al escribir una consulta LINQ básica: obtener el origen de datos, escribir la consulta y ejecutar la consulta.  
 ...
 Describe las características del lenguaje Visual Basic que admiten LINQ, tales como tipos anónimos e inferencia.  
 ...
 Describe cómo los tipos de datos se conservan o transforman cuando se escriben y se ejecutan las consultas.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Incluye una visión general de las consultas en LINQ y proporciona vínculos a recursos adicionales.  
 ...
 Proporciona una introducción general a LINQ to DataSet.  
  
 [LINQ to SQL](https://msdn.microsoft.com/library/bb386976)  
 Explica el LINQ a la tecnología SQL y proporciona vínculos a temas que le ayudarán a usan LINQ to SQL.  
  
 [IDE de Visual Studio y herramientas para LINQ (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/visual-studio-ide-and-tools-support-for-linq.md)  
 ...
 Incluye vínculos a temas que explican cómo utilizar LINQ to XML, que proporciona capacidades de modificación de documento en memoria de Document Object Model (DOM) y admite expresiones de consulta LINQ.  
  
 [Language-Integrated Query (LINQ) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/index.md)  
 Proporciona vínculos a temas que explican las tecnologías LINQ.  
