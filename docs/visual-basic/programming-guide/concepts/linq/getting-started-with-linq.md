...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe las características del lenguaje Visual Basic que admiten LINQ, como los tipos anónimos y la inferencia de tipo.  
 ...
 Describe cómo los tipos de datos se conservan o transforman cuando las consultas se escriben y se ejecuta.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Describe herramientas que están disponibles en el entorno de Visual Studio para diseñar, codificar y depurar aplicaciones habilitadas para LINQ.  
