...
---
# <a name="how-to-write-a-query-that-finds-elements-based-on-context-visual-basic"></a>Cómo: escribir una consulta que busca elementos en función del contexto (Visual Basic)
