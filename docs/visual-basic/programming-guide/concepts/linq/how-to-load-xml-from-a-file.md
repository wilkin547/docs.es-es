---
title: "Cómo: cargar XML desde un archivo (Visual Basic) | Documentos de Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Este tema muestra cómo cargar XML desde un identificador URI mediante el <xref:System.Xml.Linq.XElement.Load%2A?displayProperty=fullName>método.</xref:System.Xml.Linq.XElement.Load%2A?displayProperty=fullName>  
