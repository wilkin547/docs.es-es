...
---
# <a name="how-to-find-an-element-with-a-specific-child-element-visual-basic"></a>Filtrar Buscar un elemento con un elemento secundario específico (Visual Basic)
