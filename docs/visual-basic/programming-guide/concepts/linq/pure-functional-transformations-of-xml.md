---
title: Transformaciones funcionales puras de XML (Visual Basic) | Documentos de Microsoft
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
En esta sección se proporciona un tutorial de transformación funcional para XML. Incluye explicaciones de los conceptos y las construcciones del lenguaje principales que debe comprender para usar las transformaciones funcionales, y ejemplos de uso de transformaciones funcionales para manipular un documento XML. Aunque este tutorial proporciona ejemplos de código de LINQ to XML, todos los conceptos subyacentes también se aplican a otras tecnologías de LINQ.  
 ...
 El [Tutorial: manipular contenido en un documento WordprocessingML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/tutorial-manipulating-content-in-a-wordprocessingml-document.md) tutorial proporciona una serie de ejemplos, cada edificio en el anterior. Esos ejemplos demuestran el enfoque de transformación funcional pura para manipular XML.  
  
 Este tutorial asume un conocimiento práctico de Visual Basic. En este tutorial no se proporciona la semántica detallada de las construcciones del lenguaje, pero se proporcionan vínculos a documentación del lenguaje según corresponda.  
...
|[Tutorial: Deferred ejecución (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/tutorial-deferred-execution.md)|Describe la evaluación diferida y la ejecución aplazada en detalle.|  
