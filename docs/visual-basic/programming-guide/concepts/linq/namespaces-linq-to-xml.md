---
title: Espacios de nombres en Visual Basic (LINQ to XML) | Documentos de Microsoft
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="namespaces-in-visual-basic-linq-to-xml"></a>Espacios de nombres en Visual Basic (LINQ to XML)
