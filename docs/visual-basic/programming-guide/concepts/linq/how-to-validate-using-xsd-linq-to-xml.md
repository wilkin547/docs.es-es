...
## <a name="example"></a>Ejemplo  
 ...
 Este ejemplo utiliza el siguiente esquema XSD: [Archivo XSD de ejemplo: Los clientes y pedidos](../../../../visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md).  
