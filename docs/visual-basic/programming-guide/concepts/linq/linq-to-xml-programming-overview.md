...
|[Cómo: compilar ejemplos XML (Visual Basic) de LINQ to](../../../../visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|Contiene el `Imports` instrucciones que son necesarias para compilar los ejemplos de LINQ to XML.|  
