...
> [!NOTE]
>  El [!INCLUDE[linq_adonet](~/includes/linq-adonet-md.md)] documentación se encuentra en la sección ADO.NET del SDK de .NET Framework: [LINQ and ADO.NET](../../../../framework/data/adonet/linq-and-ado-net.md).
