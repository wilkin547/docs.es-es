...
---
# <a name="how-to-find-the-immediate-preceding-sibling-xpath-linq-to-xml-visual-basic"></a>Cómo: buscar el inmediatamente anterior del mismo nivel (XPath-LINQ to XML) (Visual Basic)
