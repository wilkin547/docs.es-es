---
title: "Cómo: generar XML desde archivos CSV (Visual Basic) | Documentos de Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-generate-xml-from-csv-files-visual-basic"></a>Cómo: generar XML desde archivos CSV (Visual Basic)
