...
---
# <a name="advanced-query-techniques-linq-to-xml-visual-basic"></a>Técnicas de consulta avanzadas (LINQ to XML) (Visual Basic)
...
|[Cómo: consultar LINQ to XML mediante XPath (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)|Muestra cómo recuperar las recopilaciones basadas en consultas XPath.|  
|[Cómo: escribir un método de eje de LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)|Muestra cómo escribir un método de eje de [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].|  
|[Cómo: Mostrar todos los nodos de un árbol (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-list-all-nodes-in-a-tree.md)|Presenta un método de utilidad que enumera todos los nodos de un árbol XML. Esto es útil para el código de depuración que modifica un árbol XML.|  
