...
---
# <a name="how-to-query-for-the-total-number-of-bytes-in-a-set-of-folders-linq-visual-basic"></a>Cómo: Consultar el número total de bytes en un conjunto de carpetas (LINQ) (Visual Basic)
