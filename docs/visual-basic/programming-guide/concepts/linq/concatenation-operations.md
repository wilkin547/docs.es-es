---
title: "Operaciones de concatenación (Visual Basic) | Documentos de Microsoft"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Concatenación hace referencia a la operación de anexar una secuencia a otra.  
 ...
 La siguiente ilustración muestra una operación de concatenación de dos secuencias de caracteres.  
  
 ![Gráfico mostrando la concatenación de dos secuencias. ](../../../../csharp/programming-guide/concepts/linq/media/concat.png "Concat")  
  
 Los métodos de operador de consulta estándar que realizan la concatenación se enumeran en la sección siguiente.  
  
## <a name="methods"></a>Métodos  
  
|Nombre del método|Descripción|Sintaxis de expresiones de consulta de Visual Basic|Más información|  
|-----------------|-----------------|------------------------------------------|----------------------|  
|Concat|Concatena dos secuencias para formar una secuencia.|No es aplicable.|<xref:System.Linq.Enumerable.Concat%2A?displayProperty=fullName></xref:System.Linq.Enumerable.Concat%2A?displayProperty=fullName><br /><br /> <xref:System.Linq.Queryable.Concat%2A?displayProperty=fullName></xref:System.Linq.Queryable.Concat%2A?displayProperty=fullName>|  
