...
---
# <a name="how-to-query-for-duplicate-files-in-a-directory-tree-linq-visual-basic"></a>Filtrar Buscar archivos duplicados en un árbol de directorios (LINQ) (Visual Basic)
