...
|[Cómo: Buscar todos los nodos de un espacio de nombres (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-find-all-nodes-in-a-namespace.md)|Muestra cómo encontrar todos los nodos que se encuentren en un espacio de nombres en particular.|  
