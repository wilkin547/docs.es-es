...
---
# <a name="how-to-split-a-file-into-many-files-by-using-groups-linq-visual-basic"></a>Procedimiento Dividir un archivo en varios archivos mediante el uso de grupos (LINQ) (Visual Basic)
