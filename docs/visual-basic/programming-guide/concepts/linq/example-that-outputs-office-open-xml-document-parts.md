...
---
# <a name="example-that-outputs-office-open-xml-document-parts-visual-basic"></a>Ejemplo que da como resultado partes de documento de Office Open XML (Visual Basic)
