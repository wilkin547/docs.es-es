...
---
# <a name="how-to-query-an-assemblys-metadata-with-reflection-linq-visual-basic"></a>Filtrar Consultar los metadatos de un ensamblado con reflexión (LINQ) (Visual Basic)
