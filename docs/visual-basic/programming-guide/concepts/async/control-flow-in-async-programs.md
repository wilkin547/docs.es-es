...
En la imagen siguiente se muestra el flujo de control de `client.GetStringAsync` a la asignación a `getStringTask` y de la creación de `getStringTask` a la aplicación de un operador Await.
