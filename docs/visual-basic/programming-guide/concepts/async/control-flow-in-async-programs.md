...
En la imagen siguiente se muestra el flujo de `client.GetStringAsync` control desde hasta la `getStringTask` asignación hasta la creación de `getStringTask` a la aplicación de un operador Await.
