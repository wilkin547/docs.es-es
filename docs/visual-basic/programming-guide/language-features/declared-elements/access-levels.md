...
Solo se puede usar `Private` en un nivel de módulo. This means you can declare a private element inside a module, class, or structure, but not at the level of a source file or namespace, inside an interface, or in a procedure.
...
|---------------------|--------------------------|-----------------------------------------------------|----------------------------------------------------------------|
|`Public`|Unrestricted:<br /><br /> Any code that can see a public element can access it|Interfaces<br /><br /> Módulos<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Structure members<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Source file<br /><br /> Espacio de nombres<br /><br /> Interfaz<br /><br /> Module<br /><br /> Clase<br /><br /> Estructura|
|`Protected`|Derivational:<br /><br /> Code in the class that declares a protected element, or a class derived from it, can access the element|Interfaces<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Clase|
|`Friend`|Ensamblado:<br /><br /> Code in the assembly that declares a friend element can access it|Interfaces<br /><br /> Módulos<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Structure members<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Source file<br /><br /> Espacio de nombres<br /><br /> Interfaz<br /><br /> Module<br /><br /> Clase<br /><br /> Estructura|
|`Protected` `Friend`|Union of `Protected` and `Friend`:<br /><br /> Code in the same class or the same assembly as a protected friend element, or within any class derived from the element's class, can access it|Interfaces<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Clase|
|`Private`|Declaration context:<br /><br /> Code in the type that declares a private element, including code within contained types, can access the element|Interfaces<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Structure members<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Module<br /><br /> Clase<br /><br /> Estructura|
|`Private Protected`|Code in the class that declares a private protected element, or code in a derived class found in the same assembly as the bas class.|Interfaces<br /><br /> Clases<br /><br /> Estructuras<br /><br /> Procedimientos<br /><br /> Propiedades<br /><br /> Member variables<br /><br /> Constantes<br /><br /> Enumeraciones<br /><br /> Events<br /><br /> External declarations<br /><br /> Delegados|Clase|
