...
-   Combine uno o más literales, constantes y variables numéricos en una expresión numérica.  El ejemplo siguiente muestra algunas expresiones numéricas válidas.  
     ...
     Observe que una expresión numérica no forma una instrucción de [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] completa por sí misma.  Debe utilizar la expresión como parte de una instrucción completa.  
