...
## Funciones del clasificador de objetos  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] proporciona funciones que devuelven información de la referencia a que remite una variable `Object`, como se muestra en la tabla siguiente.  
