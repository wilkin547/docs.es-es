...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] proporciona varios tipos de datos que no están orientados a números o caracteres.  En lugar de ello, tratan con datos especializados como valores de tipo sí\/no, valores de fecha y hora, y direcciones de objetos.  
