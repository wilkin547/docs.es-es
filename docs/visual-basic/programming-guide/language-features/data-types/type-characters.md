...
|Identifier type character|Tipo de datos|Ejemplo|  
|-------------------------------|---------------|-------------|  
|`%`|`Integer`|`Dim L%`|  
|`&`|`Long`|`Dim M&`|  
...
|Textual form of literal|Default data type|Ejemplo|  
|-----------------------------|-----------------------|-------------|  
...
|Literal type character|Tipo de datos|Ejemplo|  
|----------------------------|---------------|-------------|  
|`S`|`Short`|`I = 347S`|
|`I`|`Integer`|`J = 347I`|
|`L`|`Long`|`K = 347L`|
...
|Number base|Prefijo|Valid digit values|Ejemplo|
|-----------------|------------|------------------------|-------------|
