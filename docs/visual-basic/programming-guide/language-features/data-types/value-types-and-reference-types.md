...
-   Delegados  
 ...
 Una clase es un *tipo de referencia*.  Por este motivo, los tipos de referencia como `Object` y `String` son admitidos por clases de [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)].  Observe que cada matriz es un tipo de referencia, aunque sus miembros sean tipos de valor.  
