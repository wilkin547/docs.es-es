...
Una *conversión implícita* no requiere ninguna sintaxis especial en el código fuente.  En el ejemplo siguiente, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] convierte el valor de `k` implícitamente en un valor de punto flotante de precisión sencilla antes de asignarlo a `q`.  
