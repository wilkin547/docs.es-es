...
Para permitir que los nombres de elementos de tupla interred, debe definir la versión del compilador de Visual Basic para usar en su proyecto de Visual Basic (\*.vbproj) archivo: 
