...
A *recursiva* procedimiento es aquella que se llama a sí mismo. En general, esto no es la manera más eficaz escribir [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] código.  
