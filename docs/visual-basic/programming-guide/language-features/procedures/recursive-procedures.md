...
Un procedimiento *recursivo* es aquél que se llama a sí mismo.  En general, esta no suele ser la manera más eficaz de escribir código en [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
