...
Un procedimiento de operador es una serie de [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] instrucciones que definen el comportamiento de un operador estándar (como `*`, `<>`, o `And`) en una clase o estructura que ha definido. También se denomina *sobrecarga de operadores*.  
...
## <a name="when-to-define-operator-procedures"></a>Cuándo se debe definir procedimientos de operadores  
 ...
 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]sólo define operadores en sus tipos de datos fundamentales. Puede definir el comportamiento de un operador cuando uno o ambos operandos son del tipo de dicha clase o estructura.  
