...
Cuando el compilador de [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] encuentra una llamada a un procedimiento que está definido en varias versiones sobrecargadas, debe decidir a qué sobrecarga tiene que llamar.  Para ello, sigue estos pasos:  
