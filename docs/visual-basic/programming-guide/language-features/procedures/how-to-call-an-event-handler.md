...
4.  Cuando se produce el evento, [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] llama automáticamente a la `Sub` procedimiento. El código puede usar un `RaiseEvent` instrucción que se va a hacer que se produzca el evento.  
...
3.  Cuando se produce el evento, [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] llama automáticamente a la `Sub` procedimiento. El código puede usar un `RaiseEvent` instrucción que se va a hacer que se produzca el evento.  
