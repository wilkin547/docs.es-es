...
## <a name="property-definitions-that-require-standard-syntax"></a>Definiciones de propiedades que requieren sintaxis estándar  
 Las propiedades implementadas automáticamente son fáciles de usar y admiten muchos escenarios de programación. Sin embargo, hay situaciones en las que no puede utilizar una propiedad implementada automáticamente y en su lugar debe usar el estándar, o *expandido*, sintaxis de la propiedad.  
