...
1.  En la declaración del procedimiento, especifique [ByVal](../../../../visual-basic/language-reference/modifiers/byval.md) en el parámetro que se corresponda con el argumento.  
     ...
     En el código de llamada, incluya el argumento entre paréntesis en la lista de argumentos.  Esto hace que [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] transfiera el argumento por valor, aun cuando el parámetro correspondiente especifique `ByRef`.  
