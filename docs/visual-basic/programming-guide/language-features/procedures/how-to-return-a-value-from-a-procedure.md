...
2.  Al ejecutar una instrucción `Exit Function` o `End Function`, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] devuelve el valor asignado más recientemente al nombre del procedimiento.  
