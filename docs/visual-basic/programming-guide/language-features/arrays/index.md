...
- [Elementos de la matriz en una matriz sencilla](#array-elements-in-a-simple-array)  
...
##  <a name="iterating-through-an-array"></a>Recorrer en iteración una matriz  
 ...
 En el ejemplo siguiente se usa un [For Each... Instrucción Next](../../../../visual-basic/language-reference/statements/for-each-next-statement.md)para recorrer en iteración una matriz unidimensional y una matriz bidimensional.  
