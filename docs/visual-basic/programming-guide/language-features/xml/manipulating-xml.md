---
title: "Manipular XML en Visual Basic | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
ms.prod: ".net"
ms.reviewer: ""
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "LINQ to XML [Visual Basic], manipular XML"
  - "código de Visual Basic, XML"
  - "XML [Visual Basic], manipular"
...
Puede usar *literales XML* para cargar XML desde un origen externo, como una cadena, un archivo o una secuencia.  A continuación, podrá usar [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] para manipular el código XML y [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext-md.md)] para consultarlo.  
...
## En esta sección  
 ...
 Muestra cómo se carga XML en un objeto <xref:System.Xml.Linq.XDocument> o <xref:System.Xml.Linq.XElement> desde un archivo de texto, una cadena o una secuencia.  
 ...
 Muestra cómo se transforma el contenido de un objeto <xref:System.Xml.Linq.XDocument> en un nuevo documento XML.  
  
 [Cómo: Modificar literales XML](../../../../visual-basic/programming-guide/language-features/xml/how-to-modify-xml-literals.md)  
 Muestra cómo se modifican los elementos, atributos y valores en un literal XML.  
...
## Secciones relacionadas  
 ...
 Muestra cómo se obtiene acceso a las distintas partes de un elemento o documento XML en Visual Basic.  
