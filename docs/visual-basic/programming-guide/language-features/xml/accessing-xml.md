...
|Property description|Ejemplo|Descripción|  
|--------------------------|-------------|-----------------|  
...
|*valor*|`contacts...<name>.Value`|Gets the string representation of the first object in the sequence, or `Nothing` if the sequence is empty.|  
