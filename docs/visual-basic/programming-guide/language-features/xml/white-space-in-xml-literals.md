...
El compilador de [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] incorpora únicamente los caracteres de espacio en blanco significativos de un literal XML cuando crea un objeto de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].  No se incorporan los caracteres de espacio en blanco no significativos.  
...
-   Cuando están en una expresión incrustada para el contenido de texto de un elemento.  
 ...
 De lo contrario, el compilador considera los caracteres de espacio en blanco como no significativos y no los incluye en el objeto de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] del literal.  
