---
title: "C&#243;mo: Declarar y usar prefijos de espacio de nombres XML (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
ms.prod: ".net"
ms.reviewer: ""
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "LINQ to XML [Visual Basic], prefijos de espacio de nombres XML"
  - "prefijos de espacio de nombres XML [Visual Basic]"
...
---
# C&#243;mo: Declarar y usar prefijos de espacio de nombres XML (Visual Basic)
[!INCLUDE[vs2017banner](../../../../visual-basic/developing-apps/includes/vs2017banner.md)]

En este ejemplo se muestra cómo importar el prefijo de espacio de nombres XML `ns` y usarlo en los literales XML y propiedades de eje XML.  
