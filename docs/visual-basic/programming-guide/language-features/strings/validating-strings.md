---
title: Validar cadenas en Visual Basic | Documentos de Microsoft
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Esta sección describe cómo validar cadenas en [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Utilizar expresiones regulares con el Control MaskedTextBox en Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/using-regular-expressions-with-the-maskedtextbox-control.md)  
 Se muestra cómo convertir las expresiones regulares simples para trabajar con el <xref:System.Windows.Forms.MaskedTextBox>control.</xref:System.Windows.Forms.MaskedTextBox>  
