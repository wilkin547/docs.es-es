...
|Masking element|Descripción|Regular expression element|  
|---------------------|-----------------|--------------------------------|  
...
|&|Carácter. Entry required.|[\p{Ll}\p{Lu}\p{Lt}\p{Lm}\p{Lo}]|  
|C|Carácter. Entry optional.|[\p{Ll}\p{Lu}\p{Lt}\p{Lm}\p{Lo}]?|  
|A|Alphanumeric. Entry optional.|\W|  
|.|Culture-appropriate decimal placeholder.|No está disponible.|  
|, se almacenan|Culture-appropriate thousands placeholder.|No está disponible.|  
|:|Culture-appropriate time separator.|No está disponible.|  
|/|Culture-appropriate date separator.|No está disponible.|  
|$|Culture-appropriate currency symbol.|No está disponible.|  
|\<|Converts all characters that follow to lowercase.|No está disponible.|  
|>|Converts all characters that follow to uppercase.|No está disponible.|  
|&#124;|Undoes a previous shift up or shift down.|No está disponible.|  
