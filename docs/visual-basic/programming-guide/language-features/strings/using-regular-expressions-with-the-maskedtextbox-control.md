...
## Descripción del idioma de enmascarado  
 El lenguaje de enmascaramiento estándar de <xref:System.Windows.Forms.MaskedTextBox> se basa en el que usa el control `Masked Edit` de [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 6.0 y debe resultarle familiar a los usuarios que migren desde esa plataforma.  
