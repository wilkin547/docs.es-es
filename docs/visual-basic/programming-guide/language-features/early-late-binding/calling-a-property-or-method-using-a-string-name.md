 ...
 *Resultado* \= `CallByName`\(*Objeto*, *nombreDeProcedimiento*, *tipoDeLlamada*, *Argumentos*\(\)\)  
 ...
 Puede utilizar `CallByName` con clases en la solución actual, pero se utiliza más frecuentemente para obtener acceso a objetos COM o a objetos de ensamblados de [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)].  
