...
2.  Seleccione Aplicación para Windows de la lista de plantillas del proyecto de [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] para mostrar el nuevo proyecto.  
