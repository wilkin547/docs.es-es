...
-   A diferencia de los lenguajes que permiten la herencia múltiple, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] solamente permite la herencia simple en las clases; es decir, las clases derivadas solo pueden tener una clase base.  Aunque no se permite la herencia múltiple en las clases, éstas pueden implementar múltiples interfaces, lo que permite lograr de manera eficaz los mismos fines.  
...
## Modificadores de herencia  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] presenta las siguientes instrucciones y modificadores de nivel de clase para ofrecer compatibilidad con la herencia:  
