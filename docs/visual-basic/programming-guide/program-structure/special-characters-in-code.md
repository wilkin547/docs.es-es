...
## <a name="concatenation"></a>Concatenación  
 Use el `&` operador para la *concatenación*o vincule cadenas. No lo confunda con el `+` operador, que suma los valores numéricos. Si usa el `+` operador para concatenar al trabajar con valores numéricos, puede obtener resultados incorrectos. El ejemplo siguiente demuestra este patrón.  
