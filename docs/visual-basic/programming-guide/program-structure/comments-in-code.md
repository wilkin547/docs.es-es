...
Cuando lea ejemplos de código, encontrará el símbolo de comentario \(`'`\).  Este símbolo solicita al compilador de [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] que pase por alto el texto que aparece a continuación o el *comentario*.  Los comentarios son notas cortas explicativas que se agregan al código para aportar mayor información a las personas que lo lean.  
