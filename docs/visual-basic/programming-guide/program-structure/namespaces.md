...
## <a name="fully-qualified-names"></a><span data-ttu-id="6db11-122">nombres completos</span><span class="sxs-lookup"><span data-stu-id="6db11-122">Fully Qualified Names</span></span>  
