...
`Me`, `My`, `MyBase` y `MyClass` en [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] tienen nombres similares pero finalidades diferentes.  En esta tema se describe cada una de estas entidades para distinguirlas.  
