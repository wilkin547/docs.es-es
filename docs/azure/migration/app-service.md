...
El modo de compatibilidad con IIS5 no se admite. En Azure App Service, cada aplicación web y todas sus aplicaciones dependientes se ejecutan en el mismo proceso de trabajo con un conjunto específico de [grupos de aplicaciones](https://technet.microsoft.com/library/cc735247(v=WS.10).aspx).
