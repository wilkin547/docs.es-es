...
- Cree una máquina virtual para la aplicación ASP.NET en Azure con una de las siguientes opciones:
  ...
  - [Migración de una máquina virtual VMWare local existente](https://docs.microsoft.com/azure/migrate/tutorial-migrate-vmware)
  - [Migración de una máquina virtual Hyper-V local existente](https://docs.microsoft.com/azure/migrate/tutorial-migrate-hyper-v)
...
Elija el tamaño y el tipo de máquina virtual más adecuados para la carga de trabajo. Para más información, vea [Tamaños de las máquinas virtuales Windows en Azure](https://docs.microsoft.com/azure/virtual-machines/windows/sizes).
