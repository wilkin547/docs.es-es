...
-   [Cómo: recuperar información del cuadro de diálogo selectivamente mediante múltiples propiedades](https://msdn.microsoft.com/library/56taefba\(v=vs.110\))  
  
-   [Cómo: recuperar información del formulario primario de un cuadro de diálogo](https://msdn.microsoft.com/library/k70t19bb\(v=vs.110\))  
  
-   [Entrada del usuario a los cuadros de diálogo](https://msdn.microsoft.com/library/1s9ws53w\(v=vs.110\))  
  
-   [Cómo: recuperar el resultado de los cuadros de diálogo](https://msdn.microsoft.com/library/40x40td1\(v=vs.110\))  
  
-   [Tutorial: Recuperar la información del cuadro de diálogo colectivamente mediante objetos](https://msdn.microsoft.com/library/cakx2hdw\(v=vs.110\))  
  
-   [Cómo: cerrar cuadros de diálogo y conservar la entrada del usuario](https://msdn.microsoft.com/library/65ad5907\(v=vs.110\))  
  
-   [Cómo: crear cuadros de diálogo en tiempo de diseño](https://msdn.microsoft.com/library/55cz5x2c\(v=vs.110\))  
  
-   [Cómo: mostrar cuadros de mensaje](https://msdn.microsoft.com/library/3tt9e94f\(v=vs.110\))  
