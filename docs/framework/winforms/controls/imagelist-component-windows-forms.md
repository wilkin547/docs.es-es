...
---
# <a name="imagelist-component-windows-forms"></a>ImageList (Componente, Windows Forms)
...
## <a name="in-this-section"></a>Esta sección  
 ...
 Consulte también [Cómo: agregar o quitar imágenes de ImageList con el diseñador](how-to-add-or-remove-imagelist-images-with-the-designer.md).  
