...
<xref:System.Windows.Forms.ToolStrip> los controles presentan el espacio de compartido integrado (uso compartido del espacio horizontal o vertical dentro del área de herramientas cuando se acopla) utilizando el <xref:System.Windows.Forms.ToolStripContainer>.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Filtrar para agregar un control ToolStripContainer a un formulario](how-to-add-a-toolstripcontainer-to-a-form.md)  
 ...
 [Filtrar para agregar un control a un ToolStripContentPanel](how-to-add-a-control-to-a-toolstripcontentpanel.md)  
