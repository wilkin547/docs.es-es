...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Cómo: Agregar mejoras a ToolStripMenuItems](../../../../docs/framework/winforms/controls/how-to-add-enhancements-to-toolstripmenuitems.md)  
 ...
 [Cómo: Anexar un elemento MenuStrip a una ventana primaria MDI](../../../../docs/framework/winforms/controls/how-to-append-a-menustrip-to-an-mdi-parent-window-windows-forms.md)  
 ...
 [Cómo: Quitar un elemento ToolStripMenuItem de un menú desplegable MDI](../../../../docs/framework/winforms/controls/how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms.md)  
 ...
 [Cómo: Configuración de la comprobación de MenuStrip los márgenes e imagen](../../../../docs/framework/winforms/controls/how-to-configure-menustrip-check-margins-and-image-margins.md)  
 ...
 [Cómo: Mostrar los botones de opción en un control MenuStrip](../../../../docs/framework/winforms/controls/how-to-display-option-buttons-in-a-menustrip-windows-forms.md)  
