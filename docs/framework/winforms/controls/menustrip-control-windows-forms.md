...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Cómo: Configuración de la comprobación de MenuStrip los márgenes e imagen](how-to-configure-menustrip-check-margins-and-image-margins.md)  
 ...
 [Cómo: Mostrar los botones de opción en un control MenuStrip](how-to-display-option-buttons-in-a-menustrip-windows-forms.md)  
