...
1. Establezca la propiedad <xref:System.Windows.Forms.RichTextBox.Text%2A> en una cadena que incluya una dirección URL válida (por ejemplo, "http://www.microsoft.com/").
