...
---
# <a name="how-to-display-subitems-in-columns-with-the-windows-forms-listview-control"></a>Cómo: Mostrar subelementos en columnas con el control ListView de Windows Forms
