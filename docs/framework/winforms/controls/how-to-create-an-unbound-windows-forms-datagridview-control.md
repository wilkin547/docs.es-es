...
---
# <a name="how-to-create-an-unbound-windows-forms-datagridview-control"></a>Procedimiento Crear un Control DataGridView de formularios de Windows independiente
