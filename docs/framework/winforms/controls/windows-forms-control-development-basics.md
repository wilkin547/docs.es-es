...
-   Creación de un control que no se combina ni extender los controles existentes.  
     ...
     En este escenario, derive el control de la clase base <xref:System.Windows.Forms.Control>. Puede agregar, así como invalidar las propiedades, métodos y eventos de la clase base. Para empezar, vea [Cómo: Desarrollar un Control de formularios de Windows Simple](../../../../docs/framework/winforms/controls/how-to-develop-a-simple-windows-forms-control.md).  
