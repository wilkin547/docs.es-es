...
---
# <a name="how-to-access-objects-bound-to-windows-forms-datagridview-rows"></a>Filtrar para obtener acceso a objetos enlazados a filas DataGridView de formularios Windows Forms
