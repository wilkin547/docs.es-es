...
---
# <a name="how-to-position-a-toolstripitem-on-a-toolstrip"></a>Cómo: Situar un control ToolStripItem en un control ToolStrip
...
### <a name="to-move-or-add-a-toolstripitem-to-the-left-side-of-a-toolstrip"></a>Para mover o agregar un elemento ToolStripItem a la izquierda de un control ToolStrip  
...
### <a name="to-move-or-add-a-toolstripitem-to-the-right-side-of-a-toolstrip"></a>Para mover o agregar un elemento ToolStripItem a la derecha de un control ToolStrip  
