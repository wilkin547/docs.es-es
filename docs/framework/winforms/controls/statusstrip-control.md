...
## <a name="in-this-section"></a>En esta sección  
 [Información general del control StatusStrip](../../../../docs/framework/winforms/controls/statusstrip-control-overview.md)  
 ...
 Consulte también [Editor de colección de elementos StatusStrip](https://msdn.microsoft.com/library/ms233631\(v=vs.110\)), [Editor de colección de elementos StatusStrip](https://msdn.microsoft.com/library/ms233642\(v=vs.110\)).  
