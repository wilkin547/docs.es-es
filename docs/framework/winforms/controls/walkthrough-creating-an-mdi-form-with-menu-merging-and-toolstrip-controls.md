...
1. En Visual Studio, cree un proyecto de aplicación de Windows denominado **MDI** (**archivo** > **New** > **proyecto**  >  **Visual C#**  o **Visual Basic** > **escritorio clásico de**  >   **Aplicación de Windows Forms**).
...
## <a name="add-toolstrip-support"></a>Agregar compatibilidad de ToolStrip
