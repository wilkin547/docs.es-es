...
En este tema se explica el significado y el uso de la lista de errores de tiempo de diseño que aparece en Visual Studio cuando no se puede cargar el Diseñador de Windows Forms. Si esta lista de errores aparece, no debe interpretarse como un error del diseñador, sino como una ayuda para corregir errores en el código.
