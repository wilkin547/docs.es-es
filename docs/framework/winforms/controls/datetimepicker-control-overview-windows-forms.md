...
## <a name="key-properties"></a>Propiedades clave  
 Si lo desea la <xref:System.Windows.Forms.DateTimePicker> para que aparezca como un control para seleccionar o modificar los tiempos en lugar de fechas, establezca la <xref:System.Windows.Forms.DateTimePicker.ShowUpDown%2A> propiedad `true` y el <xref:System.Windows.Forms.DateTimePicker.Format%2A> propiedad <xref:System.Windows.Forms.DateTimePickerFormat.Time>. Para obtener más información, vea [Cómo: Mostrar la hora con el Control DateTimePicker](../../../../docs/framework/winforms/controls/how-to-display-time-with-the-datetimepicker-control.md).  
