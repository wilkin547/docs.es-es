...
1. En Visual Studio, cree un nuevo proyecto de biblioteca de controles de Windows denominado `StackViewLibrary`.
...
## <a name="design-the-stackview-control"></a>Diseñar el control StackView
...
## <a name="handle-events"></a>Controlar eventos
...
## <a name="define-icons"></a>Definir los iconos
...
## <a name="implement-a-custom-renderer"></a>Implementar a un representador personalizado
...
## <a name="test-the-stackview-control"></a>Probar el control StackView
