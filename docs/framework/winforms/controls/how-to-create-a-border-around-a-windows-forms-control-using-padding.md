...
---
# <a name="how-to-create-a-border-around-a-windows-forms-control-using-padding"></a>Procedimiento Crear un borde alrededor de un formulario Windows Forms con relleno de Control
