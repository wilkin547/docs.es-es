---
title: "DataGridView (Control, formularios Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "conjuntos de datos [Windows Forms], mostrar en el control DataGridView"
  - "conjuntos de datos [Windows Forms], interfaz de usuario"
  - "controles de cuadrícula [Windows Forms]"
  - "tablas [Windows Forms]"
  - "datos en formato de tabla, mostrar en Windows Forms"
...
## En esta sección  
 ...
 Consulte también [Utilizar el Diseñador con el control DataGridView de Windows Forms](http://msdn.microsoft.com/library/ms171593%20\(v=vs.110\)).  
