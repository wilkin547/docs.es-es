...
## <a name="snap-all-controls-to-the-grid"></a>Ajustar todos los controles a la cuadrícula
...
## <a name="align-controls-using-snaplines"></a>Alinear controles mediante las guías de alineación
