...
---
# <a name="how-to-add-and-remove-nodes-with-the-windows-forms-treeview-control-using-the-designer"></a>Procedimiento Agregar y quitar nodos con el Control TreeView de Windows Forms mediante el diseñador
