...
---
# <a name="how-to-implement-two-way-communication-between-dhtml-code-and-client-application-code"></a>Filtrar Implementar la comunicación bidireccional entre código DHTML y código de la aplicación cliente
