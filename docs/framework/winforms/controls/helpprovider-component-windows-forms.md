...
## <a name="in-this-section"></a>En esta sección  
 ...
 Vea [sistemas de ayuda en aplicaciones de Windows Forms](../../../../docs/framework/winforms/advanced/help-systems-in-windows-forms-applications.md).  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Consulte también [sistemas de ayuda en aplicaciones de Windows Forms](http://msdn.microsoft.com/library/55dct0a1\(v=vs.110\)).
