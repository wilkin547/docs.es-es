...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Cómo: Reproducir un sonido incrustado en un recurso desde un formulario de Windows](../../../../docs/framework/winforms/controls/how-to-play-a-sound-embedded-in-a-resource-from-a-windows-form.md)  
