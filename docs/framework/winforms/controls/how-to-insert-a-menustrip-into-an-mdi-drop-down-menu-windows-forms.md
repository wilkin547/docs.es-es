...
---
# <a name="how-to-insert-a-menustrip-into-an-mdi-drop-down-menu-windows-forms"></a>Filtrar Insertar un elemento MenuStrip en un menú de lista desplegable MDI (formularios Windows Forms)
