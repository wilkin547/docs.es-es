...
---
# <a name="how-to-use-the-spring-property-interactively-in-a-statusstrip"></a>Procedimiento Utilizar la propiedad Spring de manera interactiva en un control StatusStrip
