...
## <a name="add-a-component-to-a-windows-form"></a>Agregar un componente a un formulario de Windows
...
## <a name="add-a-component-to-a-windows-form-programmatically"></a>Agregar un componente a un formulario Windows Forms mediante programación
