...
La posición precisa de los controles del formulario es de alta prioridad para muchas aplicaciones. El <xref:System.Windows.Forms?displayProperty=nameWithType> espacio de nombres proporciona muchas herramientas de diseño para lograr esto.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe la <xref:System.Windows.Forms.Control.Margin%2A> y <xref:System.Windows.Forms.Control.Padding%2A> propiedades y sus funciones de diseño.  
 ...
 [Crear un borde alrededor de un control de formularios Windows Forms con relleno](../../../../docs/framework/winforms/controls/how-to-create-a-border-around-a-windows-forms-control-using-padding.md)  
 Muestra cómo utilizar el <xref:System.Windows.Forms.Control.Padding%2A> propiedad para describir un control.  
  
 [Implementar un motor de diseño personalizado](../../../../docs/framework/winforms/controls/how-to-implement-a-custom-layout-engine.md)  
