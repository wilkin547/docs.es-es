...
---
# <a name="how-to-enable-column-reordering-in-the-windows-forms-datagridview-control"></a>Filtrar Habilitar la reordenación de columnas en el Control DataGridView de Windows Forms
