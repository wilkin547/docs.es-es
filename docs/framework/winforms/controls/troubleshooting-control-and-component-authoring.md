...
---
# <a name="troubleshoot-control-and-component-authoring"></a>Solucionar problemas de control y creación de componentes
...
Si el control se deriva de la <xref:System.Windows.Forms.UserControl> clase, puede depurar su comportamiento en tiempo de ejecución con el contenedor de prueba. Para obtener más información, vea [Cómo: Pruebe el comportamiento en tiempo de ejecución de un](how-to-test-the-run-time-behavior-of-a-usercontrol.md)control UserControl.
