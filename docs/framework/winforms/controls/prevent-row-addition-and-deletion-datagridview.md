...
---
# <a name="how-to-prevent-row-addition-and-deletion-in-the-windows-forms-datagridview-control"></a>Filtrar Impedir la adición de fila y eliminación en el Control DataGridView de Windows Forms
