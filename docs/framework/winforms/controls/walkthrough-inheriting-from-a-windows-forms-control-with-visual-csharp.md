...
5.  Busque la `class` línea de instrucción, `public partial class ValueButton`y cambie el tipo del que este control hereda de <xref:System.Windows.Forms.UserControl> a <xref:System.Windows.Forms.Button>. Esto permite al control heredado heredar toda la funcionalidad de la <xref:System.Windows.Forms.Button> control.  
