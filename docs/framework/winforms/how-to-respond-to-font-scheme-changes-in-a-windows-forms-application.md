...
---
# <a name="how-to-respond-to-font-scheme-changes-in-a-windows-forms-application"></a>Procedimiento Responder a los cambios de esquema de fuentes en una aplicación de Windows Forms
...
1.  Cree el formulario y agregue los controles que desee a él. Para obtener más información, vea [Cómo: Crear una aplicación de Windows Forms desde la línea de comandos](../../../docs/framework/winforms/how-to-create-a-windows-forms-application-from-the-command-line.md) y [controles que se utilizan en Windows Forms](../../../docs/framework/winforms/controls/controls-to-use-on-windows-forms.md).  
