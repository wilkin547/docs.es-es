...
## <a name="in-this-section"></a>En esta sección  
 [Cambiar el tamaño de Windows Forms](~/docs/framework/winforms/how-to-resize-windows-forms.md)  
 ...
 Explica la compatibilidad con formularios Windows Forms valores altos de PPP y escalado dinámico. 
...
## <a name="related-sections"></a>Secciones relacionadas  
 [Cambiar la apariencia de formularios Windows Forms](~/docs/framework/winforms/changing-the-appearance-of-windows-forms.md)  
