...
En los temas siguientes se describe ClickOnce, una tecnología que se usa para implementar fácilmente aplicaciones Windows Forms en equipos cliente.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Presenta varias opciones para implementar aplicaciones ClickOnce.  
  
 [Elegir una estrategia de actualización de ClickOnce](/visualstudio/deployment/choosing-a-clickonce-update-strategy)  
 Presenta varias opciones para actualizar las aplicaciones ClickOnce.  
  
 [Proteger las aplicaciones ClickOnce](/visualstudio/deployment/securing-clickonce-applications)  
 Explica las implicaciones de seguridad de la implementación ClickOnce.  
  
 [Solucionar problemas en implementaciones ClickOnce](/visualstudio/deployment/troubleshooting-clickonce-deployments)  
 Describe varios problemas que pueden producirse al implementar aplicaciones ClickOnce y documenta los mensajes de error de nivel superior que puede generar ClickOnce.  
  
 [ClickOnce y la configuración de la aplicación](/visualstudio/deployment/clickonce-and-application-settings)  
 Describe cómo funciona la implementación ClickOnce con la configuración de la aplicación, que almacena la configuración de la aplicación y del usuario para su posterior recuperación.  
 ...
 Describe una característica ClickOnce que permite a las aplicaciones de confianza ejecutarse con un nivel de permiso superior en los equipos cliente.  
 ...
 Muestra cómo usar las herramientas de línea de comandos y SDK para implementar una aplicación ClickOnce sin usar Visual Studio.  
 ...
 Muestra cómo configurar una aplicación ClickOnce mediante herramientas de SDK, para comprobar una ubicación diferente para las nuevas versiones de una aplicación.  
 ...
 Muestra cómo recuperar los parámetros de la dirección URL usada para ejecutar una aplicación ClickOnce.  
  
 [Información general sobre la memoria caché de ClickOnce](/visualstudio/deployment/clickonce-cache-overview)  
 Describe la memoria caché que se usa para almacenar las aplicaciones ClickOnce en el equipo local.  
 ...
 Describe cómo obtener acceso a los archivos de datos locales y los orígenes de datos remotos desde una aplicación ClickOnce.  
 ...
 Muestra cómo marcar un archivo para que esté disponible en el directorio de datos de ClickOnce.  
