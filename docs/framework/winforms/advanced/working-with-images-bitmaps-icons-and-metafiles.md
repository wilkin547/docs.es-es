...
GDI + proporciona el `Bitmap` clase para trabajar con imágenes de trama y `Metafile` clase para trabajar con imágenes vectoriales. Las clases `Bitmap` y `Metafile` heredan de la clase `Image`.  
