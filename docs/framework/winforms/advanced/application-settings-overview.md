---
title: "Introducci&#243;n a la configuraci&#243;n de la aplicaci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "configuración de la aplicación [Windows Forms], acerca de la configuración de la aplicación"
  - "propiedades dinámicas"
  - "preferencias del usuario, seguimiento"
...
## ¿Qué es Configuración de la aplicación?  
...
## Limitaciones de Configuración de la aplicación  
...
## Vea también  
 ...
 [Administrar la configuración de la aplicación \(.NET\)](../Topic/Managing%20Application%20Settings%20\(.NET\).md)   
