...
Las rutas de acceso se crean mediante la combinación de líneas, rectángulos y curvas simples. Recuerde que en el [información general sobre gráficos de Vector](../../../../docs/framework/winforms/advanced/vector-graphics-overview.md) que los siguientes bloques de creación básicos han demostrado para ser útiles para dibujar imágenes:  
