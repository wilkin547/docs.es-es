...
ms.locfileid: "33524708"
---
# <a name="lines-curves-and-shapes"></a>Líneas, curvas y formas
La parte de gráficos vectoriales [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] se utiliza para dibujar líneas, curvas y para dibujar y rellenar formas.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Define arcos y elipses e identifica las clases necesarias para obtenerlas.  
  
 [Polígonos en GDI+](../../../../docs/framework/winforms/advanced/polygons-in-gdi.md)  
 Define polígonos e identifica las clases necesarias para obtenerlas.  
  
 [Curvas spline cardinales en GDI+](../../../../docs/framework/winforms/advanced/cardinal-splines-in-gdi.md)  
 Define curvas spline cardinales e identifica las clases necesarias para obtenerlas.  
  
 [Curvas spline de Bézier en GDI+](../../../../docs/framework/winforms/advanced/bezier-splines-in-gdi.md)  
 Define curvas spline de Bézier e identifica las clases necesarias para obtenerlas.  
  
 [Trazados de gráficos en GDI+](../../../../docs/framework/winforms/advanced/graphics-paths-in-gdi.md)  
 Describe las rutas de acceso y cómo crear y obtenerlas.  
 ...
 Define las curvas abiertas y cerradas y cómo dibujar y rellenarlo.  
 ...
 Define el suavizado de contorno y cómo usar el suavizado de contorno al dibujar líneas y curvas.
