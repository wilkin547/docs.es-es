...
> [!NOTE]
>  En el ejemplo siguiente, el tamaño de la imagen es 75 × 75 y el tamaño de la elipse es 150 × 250. Dado que la imagen es menor que la elipse que va a rellenar, la elipse se coloca en mosaico con la imagen. Se alcanza la disposición en mosaico, que la imagen se repite hasta que el límite de la forma horizontalmente y verticalmente. Para obtener más información acerca de la segmentación, vea [Cómo: Una forma con una imagen en mosaico](../../../../docs/framework/winforms/advanced/how-to-tile-a-shape-with-an-image.md).  
