---
title: "C&#243;mo: Crear formularios principales MDI | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
4.  Presione **F5** para ejecutar la aplicación.  Para más información acerca de cómo crear ventanas secundarias de MDI que funcionen dentro del formulario primario MDI, consulte [Cómo: Crear formularios MDI secundarios](../../../../docs/framework/winforms/advanced/how-to-create-mdi-child-forms.md).  
