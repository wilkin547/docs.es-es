...
## <a name="antialiasing"></a>suavizado de contorno  
 ...
 ![Suavizado de contorno de una línea](../../../../docs/framework/winforms/advanced/media/aboutgdip02-art34.gif "AboutGdip02_Art34")  
...
- [Cómo: Usa suavizado de contorno con texto](../../../../docs/framework/winforms/advanced/how-to-use-antialiasing-with-text.md)
