...
[.NET Framework 4.6](https://dotnet.microsoft.com/download/dotnet-framework/net46) es compatible con las aplicaciones desarrolladas para .NET Framework 4.0 a 4.6.
