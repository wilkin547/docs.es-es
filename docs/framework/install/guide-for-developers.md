...
|**4.5.1**|[Paquete de desarrollador de Microsoft .NET Framework 4.5.1](https://go.microsoft.com/fwlink/?LinkId=324213)<br /><br /> Para uso con Visual Studio 2013, Visual Studio 2012 u otros IDE|[Página de descarga del instalador web de la versión 4.5.1](https://go.microsoft.com/fwlink/p/?LinkId=310158)<br /><br /> [Página de descarga del instalador sin conexión de la versión 4.5.1](https://go.microsoft.com/fwlink/p/?LinkId=310159)|**Incluido en:**<br /> <br/>Windows 8.1<br /> Windows Server 2012 R2<br /> [Visual Studio 2013](https://my.visualstudio.com/Downloads?q=visual%20studio%202013)<br /><br /> **También se puede instalar en:**<br /><br/> Windows 8 y versiones anteriores<br /> [!INCLUDE[winserver8](../../../includes/winserver8-md.md)] y versiones anteriores<br />(para obtener una lista completa, vea los [requisitos del sistema](../get-started/system-requirements.md))|
|**4.5**|Incluido en Visual Studio 2012<br /><br /> También está disponible como parte de Windows 8 SDK|[Página de descarga del instalador web de la versión 4.5](https://go.microsoft.com/fwlink/p/?LinkId=245484)|**Incluido en:** <br/><br /> Windows 8<br /> [!INCLUDE[winserver8](../../../includes/winserver8-md.md)]<br /> [Visual Studio 2012](https://my.visualstudio.com/Downloads?q=visual%20studio%202012)<br /><br /> **También se puede instalar en:**<br/><br /> Windows 7 y versiones anteriores<br /> Windows Server 2008 SP2 y versiones anteriores<br />(para obtener una lista completa, vea los [requisitos del sistema](../get-started/system-requirements.md))|
