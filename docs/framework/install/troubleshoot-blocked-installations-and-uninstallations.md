...
Al ejecutar el [instalador web o sin conexión](../../../docs/framework/install/guide-for-developers.md) para el .NET Framework 4.5 o versiones posteriores, puede producirse un problema que impida o bloquee la instalación de .NET Framework. En la tabla siguiente se enumeran los posibles problemas de bloqueo y se incluyen vínculos a información sobre solución de problemas.
...
> [!IMPORTANT]
> Dado que las versiones 4.x de .NET Framework son actualizaciones en contexto, no se puede instalar una versión anterior de .NET Framework 4.x en un sistema que ya tiene instalada una versión posterior. Por ejemplo, en un sistema con Windows 10 otoño creadores de actualización, no se puede instalar .NET Framework 4.6.2, puesto que .NET Framework 4.7.1 está preinstalada con el sistema operativo.
...
En esta tabla, 4.5. *x* hace referencia a .NET Framework 4.5 y sus versiones secundarias, 4.5.1 y 4.5.2, 4.6. *x* hace referencia a la versión 4.6 de .NET Framework y sus versiones secundarias, 4.6.1 y 4.6.2 y 4.7. *x* hace referencia a la 4.7 de .NET Framework y su versión de punto, 4.7.1.
...
|.NET Framework 4.5*.x*/4.6*.x*/4,7*.x* redistribuible no se aplica a este sistema operativo. Descargue .NET Framework 4.5*.x*/4.6*.x*/4,7*.x* para su sistema operativo desde Microsoft Download Center.|Es podrán que esté intentando instalar el [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, o 4.7.1 en una plataforma que no se admite o que haya elegido el paquete de instalación que no incluye los componentes de todos los sistemas operativos compatibles. Vuelve a ejecutar la instalación mediante el instalador sin conexión ([4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493), [4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706), [4.6](http://go.microsoft.com/fwlink/p/?LinkId=528233), [4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744), para [ 4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604), para [4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306)), o para [4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090). Para obtener más información, consulte la [guía de instalación](../../../docs/framework/install/guide-for-developers.md) y los [requisitos del sistema](../../../docs/framework/get-started/system-requirements.md) para los sistemas operativos compatibles.|  
...
|.NET framework 4.5*.x*/4.6*.x*/4,7*.x* no se ha instalado porque se ha dañado el almacén de componentes.|Consulte el artículo [Corregir errores de corrupción de Windows con la herramienta DISM o System Update Readiness](https://support.microsoft.com/en-us/kb/947821) para obtener más información.|  
...
1. En la columna nombre, busque el [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1 descargar nombres, según la versión está instalando y elimine estas entradas. Para obtener información sobre los nombres de las descargas, consulte el artículo [Instalación de .NET Framework para desarrolladores](../../../docs/framework/install/guide-for-developers.md).

1. Vuelva a ejecutar al instalador de .NET Framework para la versión 4.5, 4.5.1, 4.5.2 o 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1.
