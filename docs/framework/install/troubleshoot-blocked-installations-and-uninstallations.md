...
En esta tabla, 4.5.*x* hace referencia a .NET Framework 4.5 y sus versiones secundarias, 4.5.1 y 4.5.2; 4.6.*x* hace referencia a .NET Framework 4.6 y sus versiones secundarias, 4.6.1 y 4.6.2; y 4.7.*x* hace referencia a .NET Framework 4.7 y su versión secundaria 4.7.1.
...
|El paquete redistribuible de .NET Framework 4.5*.x*/4.6*.x*/4.7*.x* no se aplica a este sistema operativo. Descargue .NET Framework 4.5*.x*/4.6*.x*/4.7*.x* para su sistema operativo desde el Centro de descarga de Microsoft.|Es posible que esté intentando instalar [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1 en una plataforma no compatible o que haya elegido un paquete de instalación que no incluye los componentes para todos los sistemas operativos compatibles. Vuelva a ejecutar la instalación mediante el instalador sin conexión ([para 4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493), [para 4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706), [para 4.6](http://go.microsoft.com/fwlink/p/?LinkId=528233), [para 4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744), para [4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604), para [4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306)) o para [4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090). Para obtener más información, consulte la [guía de instalación](../../../docs/framework/install/guide-for-developers.md) y los [requisitos del sistema](../../../docs/framework/get-started/system-requirements.md) para los sistemas operativos compatibles.|  
...
|No se ha instalado .NET framework 4.5*.x*/4.6*.x*/4.7*.x* debido a que el almacén de componentes está dañado.|Consulte el artículo [Corregir errores de corrupción de Windows con la herramienta DISM o System Update Readiness](https://support.microsoft.com/en-us/kb/947821) para obtener más información.|  
...
1. En la columna Nombre, busque los nombres de las descargas de [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1, según la versión que vaya a instalar, y elimine estas entradas. Para obtener información sobre los nombres de las descargas, consulte el artículo [Instalación de .NET Framework para desarrolladores](../../../docs/framework/install/guide-for-developers.md).

1. Vuelva a ejecutar el instalador de .NET Framework para la versión 4.5, 4.5.1, 4.5.2 o 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1.
