...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "implementación de aplicaciones .NET Framework, ubicar ensamblados"
  - "app.config (archivos), ubicaciones de ensamblados"
  - "archivos de configuración de la aplicación, ubicar ensamblados"
  - "ensamblados [.NET Framework], ubicación"
  - "implementar aplicaciones [.NET Framework], ubicaciones de ensamblados"
  - "ubicar ensamblados"
...
> [!NOTE]
>  Para revertir al comportamiento de .NET Framework versiones 1.0 y 1.1, que no almacenaban en caché los errores de enlace, incluya [\<disableCachingBindingFailures\> \(Elemento\)](../../../docs/framework/configure-apps/file-schema/runtime/disablecachingbindingfailures-element.md) en el archivo de configuración.  
  
<a name="step3"></a>   
## Paso 3: Comprobar la memoria caché global de ensamblados  
...
#### Sondear los directorios de base de la aplicación y de referencia cultural  
...
#### Sondear con el atributo privatePath  
