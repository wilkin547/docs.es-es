...
En este tema se proporciona información a los desarrolladores que quieren instalar [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, [!INCLUDE[net_v46](../../../includes/net-v46-md.md)], 4.6.1, 4.6.2 o .NET Framework 4.7 con sus aplicaciones.
...
> [!NOTE]
> La frase "[!INCLUDE[net_v45](../../../includes/net-v45-md.md)] y sus versiones secundarias" hace referencia a [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 y 4.7.

- [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2 y 4.7 son actualizaciones en contexto de [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], lo que significa que usan la misma versión de tiempo de ejecución, pero las versiones de ensamblado se actualizan e incluyen nuevos tipos y miembros.

- [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] y sus versiones secundarias se compilan de forma incremental en [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]. Al instalar [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 o 4.7 en un sistema que tiene instalado [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)], los ensamblados de la versión 4 se reemplazan por versiones más recientes.
...
```
 ...
 Para determinar si la versión de lanzamiento final de un paquete de idioma está instalada para [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 o 4.7, compruebe el valor DWORD de la clave RELEASE descrita en la sección anterior, [Detectar .NET Framework](#detect_net).
...
## <a name="uninstalling-the-net-framework"></a>Desinstalar .NET Framework
 A partir de [!INCLUDE[win8](../../../includes/win8-md.md)], puede desinstalar [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 o 4.7 mediante **Activar o desactivar las características de Windows** en el Panel de control. En versiones anteriores de Windows, puede desinstalar [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 o 4.7 mediante **Agregar o quitar programas** en el Panel de control.

> [!IMPORTANT]
> Con Windows 7 y los sistemas operativos anteriores, al desinstalar [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2 o 4.7, los archivos de [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] no se restauran y, si se desinstala [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], los archivos de [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] no se restauran. Si desea volver a la versión anterior, debe reinstalarla, así como todas sus actualizaciones.
