...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "implementación de aplicaciones .NET Framework"
  - ".NET Framework, implementar"
  - "implementar aplicaciones [.NET Framework]"
  - "implementar aplicaciones [.NET Framework], distribución"
  - "implementar aplicaciones [.NET Framework], características"
  - "implementar aplicaciones [.NET Framework], empaquetar"
...
-   Información general para el instalador y la implementación:  
    ...
    -   Opciones del instalador:  
        ...
        -   [Instalador web](../../../docs/framework/install/guide-for-developers.md#choices)  
  
        -   [Instalador sin conexión](../../../docs/framework/install/guide-for-developers.md#choices)  
    ...
    -   [Solucionar problemas de instalaciones de .NET Framework bloqueadas](../../../docs/framework/install/troubleshoot-blocked-installations-and-uninstallations.md)  
...
-   Para obtener información general, consulte el [Blog de .NET Framework](http://go.microsoft.com/fwlink/p/?LinkId=254977)  
...
### Ubicación de instalación  
 Para determinar la ubicación donde se van a implementar los ensamblados de la aplicación de modo que los encuentre el runtime, vea [Cómo el motor en tiempo de ejecución ubica ensamblados](../../../docs/framework/deployment/how-the-runtime-locates-assemblies.md).  
...
|[Implementar aplicaciones, servicios y componentes](../Topic/Deploying%20Applications,%20Services,%20and%20Components.md)|Describe las opciones de implementación de Visual Studio e incluye instrucciones para publicar una aplicación mediante las tecnologías ClickOnce y Windows Installer.|  
|[Publicar aplicaciones ClickOnce](../Topic/Publishing%20ClickOnce%20Applications.md)|Describe cómo empaquetar una aplicación de Windows Forms e implementarla con ClickOnce en los equipos cliente en una red.|  
