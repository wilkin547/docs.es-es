...
## <a name="wpf-specifics"></a>Especificaciones de WPF  
 El equipo de ingeniería de @no__t 0 aplica y extiende el SDL, la combinación de lo que incluye los siguientes aspectos clave:  
...
- **API prohibidas**: Busca en el código fuente para identificar el uso accidental de funciones que son conocidas para causar problemas de seguridad, como `strcpy`. Una vez identificadas, estas funciones se reemplazan por alternativas más seguras.  
...
- **Regresión de problemas de seguridad de otros productos**: Si procede, se prueban los problemas de seguridad de productos relacionados. Por ejemplo, se han identificado las variantes adecuadas de aproximadamente 60 problemas de seguridad para Internet Explorer y se ha intentado su aplicabilidad en [!INCLUDE[TLA2#tla_winclient](../../../includes/tla2sharptla-winclient-md.md)].  
