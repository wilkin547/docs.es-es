...
En este tema se supone que sabe cómo crear un nuevo <xref:System.Windows.Controls.ControlTemplate> para un control existente, está familiarizado con lo que son los elementos de un contrato de control y comprende los conceptos descritos en [creación de una plantilla para un control](../../../desktop-wpf/themes/how-to-create-apply-template.md).
