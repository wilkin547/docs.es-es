...
---
# <a name="how-to-use-triggers-to-style-selected-items-in-a-listview"></a>Procedimiento Utilizar desencadenadores para aplicar un estilo a los elementos seleccionados en un control ListView
