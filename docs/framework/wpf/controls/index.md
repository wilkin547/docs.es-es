...
### <a name="creating-a-style-for-a-control"></a>Crear un estilo para un control  
 ...
 También puede aplicar un estilo solo a determinados controles de un tipo específico mediante la asignación de una clave al estilo y especifique esa clave en el `Style` propiedad del control.  Para obtener más información sobre los estilos, consulte [aplicar estilos y plantillas](../../../../docs/framework/wpf/controls/styling-and-templating.md).  
