...
## <a name="statusbar-parts"></a>Partes de StatusBar  
 El <xref:System.Windows.Controls.Primitives.StatusBar> control no tiene los elementos con nombre.  
  
## <a name="statusbar-states"></a>Estados de StatusBar  
 La tabla siguiente enumera los estados visuales para el <xref:System.Windows.Controls.Primitives.StatusBar> control.  
...
## <a name="statusbaritem-parts"></a>StatusBarItem partes  
 El <xref:System.Windows.Controls.Primitives.StatusBarItem> control no tiene los elementos con nombre.  
  
## <a name="statusbar-states"></a>Estados de StatusBar  
 La tabla siguiente enumera los estados visuales para el <xref:System.Windows.Controls.Primitives.StatusBarItem> control.  
...
## <a name="statusbar-controltemplate-example"></a>Ejemplo de ControlTemplate de StatusBar  
 En el ejemplo siguiente se muestra cómo definir un <xref:System.Windows.Controls.ControlTemplate> para el <xref:System.Windows.Controls.Primitives.StatusBar> control.  
