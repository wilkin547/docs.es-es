 ...
 **Cómo crear un control GridSplitter que se superponga al borde de una columna**  
 ...
 Un <xref:System.Windows.Controls.GridSplitter> que no tiene su propia columna puede estar ocultado por otros controles en el <xref:System.Windows.Controls.Grid>. Para más información sobre cómo evitar este problema, vea [Asegurarse de que un GridSplitter es visible](../../../../docs/framework/wpf/controls/how-to-make-sure-that-a-gridsplitter-is-visible.md).  
