...
---
# <a name="how-to-use-templates-to-style-a-listview-that-uses-gridview"></a>Filtrar Utilizar plantillas para aplicar un estilo a un control ListView que utiliza un modo GridView
