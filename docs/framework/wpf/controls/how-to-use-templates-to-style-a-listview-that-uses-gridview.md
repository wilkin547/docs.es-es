...
---
# <a name="how-to-use-templates-to-style-a-listview-that-uses-gridview"></a>Filtrar Usar plantillas para aplicar un estilo a un control ListView que usa un modo GridView
