...
En este ejemplo se muestra cómo recortar una imagen mediante <xref:System.Windows.Media.Imaging.CroppedBitmap>.  
 ...
 <xref:System.Windows.Media.Imaging.CroppedBitmap> se utiliza principalmente al codificar una versión recortada de una imagen para guardarla en un archivo. Para recortar una imagen para fines de presentación, vea el [crear una región de recorte](https://msdn.microsoft.com/library/56e4bed6-78d7-4292-b917-d72d0b3e4376) tema.  
...
## <a name="see-also"></a>Vea también  
 [Creación de una región de recorte](https://msdn.microsoft.com/library/56e4bed6-78d7-4292-b917-d72d0b3e4376)
