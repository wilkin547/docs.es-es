...
---
# <a name="how-to-rotate-an-image"></a>Cómo: Girar una imagen
Este ejemplo muestra cómo girar una imagen 90 grados mediante el uso de un <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> propiedad de un <xref:System.Windows.Media.Imaging.BitmapImage>.  
