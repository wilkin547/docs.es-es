...
---
# <a name="how-to-rotate-an-image"></a>Procedimiento Girar una imagen
En este ejemplo se muestra cómo girar una imagen 90 grados utilizando un <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> propiedad de un <xref:System.Windows.Media.Imaging.BitmapImage>.  
