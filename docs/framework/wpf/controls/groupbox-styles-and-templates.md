...
## <a name="groupbox-parts"></a>GroupBox partes  
 El <xref:System.Windows.Controls.GroupBox> control no tiene los elementos con nombre.  
  
<a name="groupbox_states"></a>   
## <a name="groupbox-states"></a>Estados de GroupBox  
 La tabla siguiente enumera los estados visuales para el <xref:System.Windows.Controls.GroupBox> control.  
...
## <a name="groupbox-controltemplate-example"></a>Ejemplo de ControlTemplate de GroupBox  
 En el ejemplo siguiente se muestra cómo definir un <xref:System.Windows.Controls.ControlTemplate> para el <xref:System.Windows.Controls.GroupBox> control.  
