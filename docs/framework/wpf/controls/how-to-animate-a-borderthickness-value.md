...
Este ejemplo muestra cómo animar los cambios en el grosor de un borde utilizando la <xref:System.Windows.Media.Animation.ThicknessAnimation> clase.  
  
## <a name="example"></a>Ejemplo  
 En el ejemplo siguiente se anima el grosor de un borde utilizando <xref:System.Windows.Media.Animation.ThicknessAnimation>. El ejemplo se utiliza la <xref:System.Windows.Controls.Border.BorderThickness%2A> propiedad de <xref:System.Windows.Controls.Border>.  
