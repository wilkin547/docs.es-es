...
## <a name="xaml-support-in-net-4"></a>Compatibilidad con XAML en .NET 4  
 Los espacios de nombres siguientes contienen tipos del ensamblado System. Xaml. System. Xaml proporciona compatibilidad con el lenguaje XAML común para marcos como WPF que se basan en .NET Framework 4.  
