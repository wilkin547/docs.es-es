...
Los vínculos siguientes hacen referencia a espacios de nombres que contienen [!INCLUDE[TLA#tla_winclient](../../../includes/tlasharptla-winclient-md.md)] API.  
...
## <a name="xaml-support-in-net-4"></a>Compatibilidad con XAML en .NET 4  
 Los siguientes espacios de nombres contienen tipos del ensamblado System.Xaml. System.Xaml proporciona compatibilidad con common language XAML para los marcos como WPF que se basan en .NET Framework 4.  
