...
---
# <a name="how-to-bind-to-an-adonet-data-source"></a>Procedimiento Enlazar a un origen de datos de ADO.NET

En este ejemplo se muestra cómo enlazar un [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] <xref:System.Windows.Controls.ListBox> control a una versión de ADO.NET `DataSet`.
