...
Tenga en cuenta que si no proporciona un <xref:System.Windows.Controls.Validation.ErrorTemplate%2A> personalizado, aparece la plantilla de error predeterminada para proporcionar información visual al usuario cuando se produce un error de validación. Vea "Validación de datos" en [Información sobre el enlace de datos](data-binding-overview.md) para obtener más información. Además, [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] proporciona una regla de validación incorporada que selecciona las excepciones que se producen durante la actualización de la propiedad del origen de enlace. Para obtener más información, vea <xref:System.Windows.Controls.ExceptionValidationRule>.
