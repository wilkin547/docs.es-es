...
## <a name="painting-with-a-brush"></a>Pintar con un pincel  
 Un <xref:System.Windows.Media.Brush> "pinta" un área con su salida. Pinceles diferentes tienen distintos tipos de salida. Algunos pinceles pintan un área con un color sólido, otras personas con un degradado, el patrón, la imagen o el dibujo. En la siguiente ilustración se muestra ejemplos de cada uno de los diferentes <xref:System.Windows.Media.Brush> tipos.  
  
 ![Tipos de valores de Brush](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-brushtypes.jpg "graphicsmm_brushtypes")  
Ejemplos de pincel  
  
 La mayoría de objetos visuales permiten especificar cómo está pintando. En la tabla siguiente se enumera algunos comunes objetos y propiedades con el que puede utilizar un <xref:System.Windows.Media.Brush>.  
  
|Clase|Propiedades del pincel|  
|-----------|----------------------|  
...
|<xref:System.Windows.Controls.TextBlock>|<xref:System.Windows.Controls.TextBlock.Background%2A>|  
 ...
 Las siguientes secciones describen los diferentes <xref:System.Windows.Media.Brush> tipos y proporcionan un ejemplo de cada uno.  
  
<a name="paintwithsolidcolorbrush"></a>   
## <a name="paint-with-a-solid-color"></a>Pintar con un Color sólido  
 A <xref:System.Windows.Media.SolidColorBrush> pinta un área con un sólido <xref:System.Windows.Media.Color>. Hay varias maneras de especificar el <xref:System.Windows.Media.SolidColorBrush.Color%2A> de un <xref:System.Windows.Media.SolidColorBrush>: por ejemplo, puede especificar sus canales alfabéticos, rojos, azul y verde o utilice uno de los colores predefinidos proporcionados por el <xref:System.Windows.Media.Colors> clase.  
  
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.SolidColorBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
Rectángulo pintado mediante SolidColorBrush  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.SolidColorBrush> de clases, consulte [pintar con colores sólidos y degradados información general sobre](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
  
<a name="paintwithlineargradientbrush"></a>   
## <a name="paint-with-a-linear-gradient"></a>Pintar con un degradado lineal  
 Un <xref:System.Windows.Media.LinearGradientBrush> pinta un área con un degradado lineal. Un degradado lineal mezcla dos o más colores a lo largo de una línea, el eje de degradado. Usa <xref:System.Windows.Media.GradientStop> objetos para especificar los colores de degradado y sus posiciones.  
  
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.LinearGradientBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
Rectángulo pintado mediante LinearGradientBrush  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.LinearGradientBrush> de clases, consulte [pintar con colores sólidos y degradados información general sobre](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
  
<a name="paintwithradialgradientbrush"></a>   
## <a name="paint-with-a-radial-gradient"></a>Pintar con un degradado Radial  
 Un <xref:System.Windows.Media.RadialGradientBrush> pinta un área con un degradado radial. Un degradado radial mezcla dos o más colores a lo largo de un círculo. Al igual que con la <xref:System.Windows.Media.LinearGradientBrush> (clase), utilice <xref:System.Windows.Media.GradientStop> objetos para especificar los colores de degradado y sus posiciones.  
  
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.RadialGradientBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
Rectángulo pintado mediante RadialGradientBrush  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.RadialGradientBrush> de clases, consulte [pintar con colores sólidos y degradados información general sobre](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md).  
...
## <a name="paint-with-an-image"></a>Pintar con una imagen  
 ...
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.ImageBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
## <a name="paint-with-a-drawing"></a>Pintar con un dibujo  
 A <xref:System.Windows.Media.DrawingBrush> pinta un área con un <xref:System.Windows.Media.Drawing>. Un <xref:System.Windows.Media.Drawing> puede contener formas, imágenes, texto y multimedia.  
  
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.DrawingBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
Rectángulo pintado mediante DrawingBrush  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.DrawingBrush> de clases, consulte [pintar con imágenes, gráficos y objetos visuales](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md).  
  
<a name="paintwithvisual"></a>   
## <a name="paint-with-a-visual"></a>Pintar con un objeto Visual  
 A <xref:System.Windows.Media.VisualBrush> pinta un área con un <xref:System.Windows.Media.Visual> objeto. Ejemplos de objetos visuales <xref:System.Windows.Controls.Button>, <xref:System.Windows.Controls.Page>, y <xref:System.Windows.Controls.MediaElement>. Un <xref:System.Windows.Media.VisualBrush> también permite proyectar el contenido de una parte de la aplicación en otra área; resulta muy útil para crear efectos de reflexión y ampliar partes de la pantalla.  
  
 En el ejemplo siguiente se usa un <xref:System.Windows.Media.VisualBrush> para pintar el <xref:System.Windows.Shapes.Shape.Fill%2A> de un <xref:System.Windows.Shapes.Rectangle>. En la siguiente ilustración muestra el rectángulo pintado.  
...
Rectángulo pintado mediante VisualBrush  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.VisualBrush> de clases, consulte [pintar con imágenes, gráficos y objetos visuales](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md).  
...
-   Para obtener una lista de pinceles del sistema disponibles, consulte la <xref:System.Windows.SystemColors> clase. Para obtener un ejemplo, vea [pintar un área con un pincel del sistema](../../../../docs/framework/wpf/graphics-multimedia/how-to-paint-an-area-with-a-system-brush.md).  
...
> [!NOTE]
>  Resulta más eficaz para cambiar el valor de opacidad de un pincel diferente cambiar la opacidad de un elemento completo mediante su <xref:System.Windows.UIElement.Opacity%2A?displayProperty=nameWithType> propiedad.  
  
 Puede girar, escalar, sesgar y traducir el contenido del pincel mediante su <xref:System.Windows.Media.Brush.Transform%2A> o <xref:System.Windows.Media.Brush.RelativeTransform%2A> propiedades. Para obtener más información, consulte [Brush Transformation Overview](../../../../docs/framework/wpf/graphics-multimedia/brush-transformation-overview.md).  
...
### <a name="freezable-features"></a>Características de los objetos Freezable  
 Puesto que hereda de la <xref:System.Windows.Freezable> (clase), el <xref:System.Windows.Media.Brush> clase proporciona varias características especiales: <xref:System.Windows.Media.Brush> objetos se pueden declarar como [recursos](../../../../docs/framework/wpf/advanced/xaml-resources.md), compartirse entre varios objetos y clonar. Además, todos los <xref:System.Windows.Media.Brush> tipos excepto <xref:System.Windows.Media.VisualBrush> puede hacerse de sólo lectura para mejorar el rendimiento y convertirse seguros para subprocesos.  
  
 Para obtener más información acerca de las diferentes características proporcionadas por <xref:System.Windows.Freezable> los objetos, vea [Freezable Objects Overview](../../../../docs/framework/wpf/advanced/freezable-objects-overview.md).  
