...
|**Valor máximo de muestreo múltiple**|Especifica el grado de muestreo múltiple para alisar contenido 3D.|  
...
|`HKEY_CURRENT_USER\SOFTWARE\Microsoft\Avalon.Graphics\MaxMultisampleType`|DWORD|  
 ...
 El **valor máximo de muestreo Multimuestra** permite ajustar la cantidad máxima de suavizado de contorno del contenido 3D. Use este nivel para deshabilitar el suavizado de contorno 3D en Windows Vista.  
  
 El **valor máximo de muestreo múltiple** es un valor DWORD comprendido entre 0 y 16. Un valor de 0 especifica que se debe deshabilitar el suavizado de contorno Multimuestra de contenido 3D y un valor de 16 intentará usar un suavizado de contorno de muestreo Multimuestra, si es compatible con la tarjeta de vídeo. Tenga en cuenta que el establecimiento de este valor de clave del registro en los equipos que usan controladores XPDM hará que las aplicaciones usen una gran cantidad de memoria de vídeo adicional, disminuya el rendimiento de la representación 3D y tenga el potencial de introducir errores de representación y problemas de estabilidad.  
