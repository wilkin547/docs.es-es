---
title: Filtrar Pintar un área con un objeto visual
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
---
# <a name="how-to-paint-an-area-with-a-visual"></a>Filtrar Pintar un área con un objeto visual
...
## <a name="example"></a>Ejemplo  
 ...
 Para obtener más información acerca de <xref:System.Windows.Media.VisualBrush> y ejemplos adicionales, vea el [pintar con imágenes, dibujos y elementos visuales](painting-with-images-drawings-and-visuals.md) información general.  
