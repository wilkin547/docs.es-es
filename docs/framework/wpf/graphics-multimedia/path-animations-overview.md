...
## <a name="prerequisites"></a>Requisitos previos  
 ...
 Dado que utiliza un <xref:System.Windows.Media.PathGeometry> objeto para definir una animación de la ruta de acceso, también debe estar familiarizado con <xref:System.Windows.Media.PathGeometry> y los diferentes tipos de <xref:System.Windows.Media.PathSegment> objetos. Para obtener más información, consulte el [información general sobre geometría](../../../../docs/framework/wpf/graphics-multimedia/geometry-overview.md).  
  
<a name="what_is_a_path_animation"></a>   
## <a name="what-is-a-path-animation"></a>¿Qué es una animación de trazado?  
 Una animación de la ruta de acceso es un tipo de <xref:System.Windows.Media.Animation.AnimationTimeline> que usa un <xref:System.Windows.Media.PathGeometry> como entrada. En lugar de establecer un desde a, o por propiedad (como lo haría para un From/To/By animación) o con fotogramas clave (tal y como se utiliza para una animación de fotogramas clave), define un trazado geométrico y usarla para definir la `PathGeometry` propiedad de la animación de la ruta de acceso. A medida que la animación de trazado avanza, lee la información de x, de y y del ángulo del trazado y usa esa información para generar la salida.  
 ...
 Para obtener más información acerca de la sintaxis de ruta de acceso que se utiliza en el [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] ejemplo, consulte el [sintaxis de ruta de acceso de marcado](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md) información general. Para obtener un ejemplo completo, vea [Path Animation Sample](http://go.microsoft.com/fwlink/?LinkID=160028).  
  
 Puede aplicar una animación de la ruta de acceso a una propiedad mediante un <xref:System.Windows.Media.Animation.Storyboard> en [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] y de código o mediante el <xref:System.Windows.Media.Animation.Animatable.BeginAnimation%2A> método en el código. También puede usar una animación de la ruta de acceso para crear un <xref:System.Windows.Media.Animation.AnimationClock> y aplicarla a una o varias propiedades. Para obtener más información sobre los distintos métodos para aplicar animaciones, consulte [Property Animation Techniques Overview](../../../../docs/framework/wpf/graphics-multimedia/property-animation-techniques-overview.md).  
...
## <a name="path-animation-types"></a>Tipos de animación de trazado  
 ...
 Las clases de animación de ruta de acceso que pertenecen a la <xref:System.Windows.Media.Animation> espacio de nombres y utilizan la convención de nomenclatura siguiente:  
...
|<xref:System.Windows.Point>|<xref:System.Windows.Media.Animation.PointAnimationUsingPath>|[Animación de un objeto a lo largo de un trazado (animación en punto)](../../../../docs/framework/wpf/graphics-multimedia/how-to-animate-an-object-along-a-path-point-animation.md)|  
 ...
 A <xref:System.Windows.Media.Animation.PointAnimationUsingPath> genera <xref:System.Windows.Point> valores de las coordenadas x e y-de su <xref:System.Windows.Media.Animation.PointAnimationUsingPath.PathGeometry%2A>. Mediante el uso de un <xref:System.Windows.Media.Animation.PointAnimationUsingPath> para animar una propiedad que toma <xref:System.Windows.Point> valores, puede mover un objeto a lo largo de una ruta de acceso. Un <xref:System.Windows.Media.Animation.PointAnimationUsingPath> no se pueden girar objetos.  
...
## <a name="path-animation-input"></a>Entrada de animación de trazado  
 Cada clase de animación de ruta de acceso proporciona una <xref:System.Windows.Media.PathGeometry> propiedad para especificar su entrada. La ruta de acceso animación usa la <xref:System.Windows.Media.PathGeometry> para generar sus valores de salida. La <xref:System.Windows.Media.PathGeometry> clase le permite describir varias figuras complejas que se componen de arcos, curvas y líneas.  
  
 La esencia de una <xref:System.Windows.Media.PathGeometry> es una colección de <xref:System.Windows.Media.PathFigure> objetos, estos objetos se denominan así porque cada figura describe una forma discreta en el <xref:System.Windows.Media.PathGeometry>. Cada <xref:System.Windows.Media.PathFigure> consta de uno o varios <xref:System.Windows.Media.PathSegment> objetos, cada uno de los cuales describe un segmento de la figura.  
...
|<xref:System.Windows.Media.QuadraticBezierSegment>|Crea una curva Bézier cuadrática.|  
 ...
 En [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)], también puede usar una sintaxis abreviada especial para establecer el <xref:System.Windows.Media.PathGeometry.Figures%2A> propiedad de un <xref:System.Windows.Media.PathGeometry>. Para obtener más información, consulte [sintaxis de ruta de acceso de marcado](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md) información general.  
  
 Para obtener más información acerca de la sintaxis de ruta de acceso que se utiliza en el [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] ejemplo, consulte el [sintaxis de ruta de acceso de marcado](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md) información general.  
