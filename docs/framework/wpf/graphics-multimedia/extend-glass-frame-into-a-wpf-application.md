...
Este tema muestra cómo extender el [!INCLUDE[TLA#tla_winvista](../../../../includes/tlasharptla-winvista-md.md)] marco glass en el área de cliente de una aplicación de Windows Presentation Foundation (WPF).  
