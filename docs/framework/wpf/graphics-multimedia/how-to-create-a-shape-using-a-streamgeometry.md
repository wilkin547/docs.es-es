...
---
# <a name="how-to-create-a-shape-using-a-streamgeometry"></a>Procedimiento Crear una forma utilizando StreamGeometry
...
## <a name="example"></a>Ejemplo  
 ...
 Para obtener más información acerca de <xref:System.Windows.Media.StreamGeometry> sintaxis de atributo, vea el [sintaxis de marcado de trazados](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md) página.  
