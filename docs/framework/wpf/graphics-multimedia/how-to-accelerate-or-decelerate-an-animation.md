...
## <a name="example"></a>Ejemplo  
 ...
 Se ha omitido el código en este ejemplo. Para el código completo, vea el [ejemplo de comportamiento de control de tiempo de animación](https://go.microsoft.com/fwlink/?LinkID=159970).
