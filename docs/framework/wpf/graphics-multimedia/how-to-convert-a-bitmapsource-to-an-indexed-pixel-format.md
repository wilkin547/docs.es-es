---
title: 'Cómo: Convertir un elemento BitmapSource en un formato de píxeles indizado'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="4dd42-102">Cómo: Convertir un elemento BitmapSource en un formato de píxeles indizado</span><span class="sxs-lookup"><span data-stu-id="4dd42-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="4dd42-103">Este ejemplo muestra cómo convertir un <xref:System.Windows.Media.Imaging.BitmapSource> a un formato de píxeles indizado.</span><span class="sxs-lookup"><span data-stu-id="4dd42-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="4dd42-104">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="4dd42-104">Example</span></span>  
