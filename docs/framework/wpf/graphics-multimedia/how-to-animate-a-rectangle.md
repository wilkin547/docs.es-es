...
## <a name="example"></a>Ejemplo  
 En el ejemplo siguiente se usa una instancia de la <xref:System.Windows.Media.Animation.RectAnimation> clase se va a animar el <xref:System.Windows.Media.RectangleGeometry.Rect%2A> propiedad de un <xref:System.Windows.Media.RectangleGeometry>, que anima los cambios de tamaño y posición del rectángulo.  
