...
## <a name="common-transformation-properties"></a>Propiedades de transformación comunes  
 Una manera de transformar un objeto consiste en declarar adecuado <xref:System.Windows.Media.Transform> escriba y aplicarlo a la propiedad de transformación del objeto. Los diferentes tipos de objetos tienen distintos tipos de propiedades de transformación. En la siguiente tabla se enumeran varios tipos de [!INCLUDE[TLA#tla_wpf](../../../../includes/tlasharptla-wpf-md.md)] utilizados comúnmente, y sus propiedades de transformación.  
