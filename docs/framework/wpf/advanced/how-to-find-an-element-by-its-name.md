...
---
# <a name="how-to-find-an-element-by-its-name"></a><span data-ttu-id="7702f-102">Procedimiento Buscar un elemento por su nombre</span><span class="sxs-lookup"><span data-stu-id="7702f-102">How to: Find an Element by Its Name</span></span>
<span data-ttu-id="7702f-103">En este ejemplo se describe cómo usar el <xref:System.Windows.FrameworkElement.FindName%2A> método para buscar un elemento por su <xref:System.Windows.FrameworkElement.Name%2A> valor.</span><span class="sxs-lookup"><span data-stu-id="7702f-103">This example describes how to use the <xref:System.Windows.FrameworkElement.FindName%2A> method to find an element by its <xref:System.Windows.FrameworkElement.Name%2A> value.</span></span>  
  
## <a name="example"></a><span data-ttu-id="7702f-104">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="7702f-104">Example</span></span>  
 <span data-ttu-id="7702f-105">En este ejemplo, el método para buscar un elemento determinado por su nombre se escribe como el controlador de eventos de un botón.</span><span class="sxs-lookup"><span data-stu-id="7702f-105">In this example, the method to find a particular element by its name is written as the event handler of a button.</span></span> <span data-ttu-id="7702f-106">`stackPanel` es el <xref:System.Windows.FrameworkElement.Name%2A> de la raíz <xref:System.Windows.FrameworkElement> que se está buscando, y el método de ejemplo, a continuación, indica visualmente el elemento encontrado convirtiéndola como <xref:System.Windows.Controls.TextBlock> y cambiar uno de los <xref:System.Windows.Controls.TextBlock> visible [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] propiedades.</span><span class="sxs-lookup"><span data-stu-id="7702f-106">`stackPanel` is the <xref:System.Windows.FrameworkElement.Name%2A> of the root <xref:System.Windows.FrameworkElement> being searched, and the example method then visually indicates the found element by casting it as <xref:System.Windows.Controls.TextBlock> and changing one of the <xref:System.Windows.Controls.TextBlock> visible [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] properties.</span></span>  
