...
Para obtener una lista de código completo de las tareas ilustradas en este tutorial, vea [asignar propiedades mediante el ejemplo del Control ElementHost](http://go.microsoft.com/fwlink/?LinkID=160018).
