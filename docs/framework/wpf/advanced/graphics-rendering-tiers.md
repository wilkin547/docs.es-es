...
- **Nivel de representación 0** Sin aceleración de hardware gráfico. Todas las características de gráficos utilizan la aceleración de software. El nivel de versión de DirectX es anterior a la versión 9,0.  
...
|Sombreador de vértices|Ningún requisito.|El nivel de versión debe ser mayor o igual que 2,0.|  
|Unidades de texturas múltiples|Ningún requisito.|El número de unidades debe ser mayor o igual que 4.|  
...
### <a name="directx-diagnostic-tool"></a>Herramienta de diagnóstico de DirectX  
 La herramienta de diagnóstico de DirectX, Dxdiag. exe, está diseñada para ayudarle a solucionar problemas relacionados con DirectX. La carpeta de instalación predeterminada de la herramienta de diagnóstico de DirectX es:  
