...
## <a name="how-to-collect-stylus-point-data-and-create-ink-strokes"></a>Cómo: recopilar datos de puntos de lápiz y crear trazos de tinta  
...
## <a name="how-to-enable-your-control-to-accept-input-from-the-mouse"></a>Cómo: habilitar el Control y aceptar la entrada del mouse  
