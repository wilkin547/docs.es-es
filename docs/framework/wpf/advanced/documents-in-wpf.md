 ...
 **Nota:** Para obtener más información sobre las características de documento de flujo y cómo crearlos, vea [Flow Document Overview](../../../../docs/framework/wpf/advanced/flow-document-overview.md).  
