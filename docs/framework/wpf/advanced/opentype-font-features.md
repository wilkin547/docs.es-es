...
En este tema se proporciona información general sobre algunas de las características clave de la tecnología [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)]de fuentes OpenType en.  
  
<a name="overview"></a>   
## <a name="opentype-font-format"></a>Formato de fuente OpenType  
 El formato de fuente OpenType es una extensión del [!INCLUDE[TLA#tla_truetype](../../../../includes/tlasharptla-truetype-md.md)] formato de fuente, lo que agrega compatibilidad con los datos de fuentes PostScript. [!INCLUDE[TLA#tla_ms](../../../../includes/tlasharptla-ms-md.md)] Y Adobe Corporation desarrollaron conjuntamente el formato de fuente OpenType. Las fuentes OpenType y los servicios del sistema operativo que admiten fuentes OpenType proporcionan a los usuarios una forma sencilla de instalar y usar fuentes, [!INCLUDE[TLA2#tla_truetype](../../../../includes/tla2sharptla-truetype-md.md)] independientemente de que las fuentes contengan contornos o CFF (PostScript).  
...
- Información explícita de script y lenguaje que contiene la fuente, para que una aplicación de procesamiento de textos pueda ajustar su comportamiento en consecuencia.  
 ...
 El resto de esta información general presenta la amplitud y flexibilidad de algunas de las características OpenType visualmente interesantes que se exponen mediante las propiedades <xref:System.Windows.Documents.Typography> del objeto. Para obtener más información sobre este objeto, consulte [Clase de tipografía](#typography_class).  
...
### <a name="superscripts-and-subscripts"></a>Superíndices y subíndices  
 La <xref:System.Windows.Documents.Typography.Variants%2A> propiedad permite establecer los valores de superíndice y subíndice para una fuente OpenType.  
 ...
 En el ejemplo de marcación siguiente se muestra cómo definir superíndices para la fuente Palatino Linotype mediante las propiedades del <xref:System.Windows.Documents.Typography> objeto.  
 ...
 En el ejemplo de marcación siguiente se muestra cómo definir los subíndices para la fuente Palatino Linotype mediante las propiedades <xref:System.Windows.Documents.Typography> del objeto.  
...
### <a name="decorative-uses-of-superscripts-and-subscripts"></a>Usos decorativos de superíndices y subíndices  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen los superíndices y subíndices de una fuente <xref:System.Windows.Documents.Typography> mediante las propiedades del objeto.  
...
## <a name="capitals"></a>Mayúsculas  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen las mayúsculas para la fuente pescadero <xref:System.Windows.Documents.Typography> mediante las propiedades del objeto. Cuando se usa el formato "SmallCaps", se omite cualquier letra mayúscula inicial.  
...
### <a name="titling-capitals"></a>Mayúsculas de título  
 ...
 ![Texto que usa mayúsculas de título OpenType](./media/opentype-font-features/opentype-titling-capitals.gif "Texto que usa mayúsculas de título OpenType")  
  
 En el ejemplo de marcación siguiente se muestra cómo definir mayúsculas de título para la fuente pescadero mediante las <xref:System.Windows.Documents.Typography> propiedades del objeto.  
...
### <a name="capital-spacing"></a>Espaciado de mayúsculas  
 ...
 En el ejemplo de marcación siguiente se muestra cómo definir el espaciado de mayúsculas para la fuente <xref:System.Windows.Documents.Typography> pescadero mediante las propiedades del objeto.  
...
- **Ligaduras históricas**. Diseñadas para ser históricas y no específicamente para la legibilidad.  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen los glifos de ligadura estándar para la fuente <xref:System.Windows.Documents.Typography> Pericles mediante las propiedades del objeto.  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen los glifos de ligadura discrecional para la fuente Pericles <xref:System.Windows.Documents.Typography> mediante las propiedades del objeto.  
  
 [!code-xaml[OpenTypeFontSamples#5](~/samples/snippets/csharp/VS_Snippets_Wpf/OpenTypeFontSamples/CS/PageOne.xaml#5)]  
  
 De forma predeterminada, las fuentes [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] OpenType de habilitan las ligaduras estándar. Por ejemplo, si usa la fuente Palatino Linotype, las ligaduras estándar "fi", "ff" y "fl" aparecen como un glifo de caracteres combinados. Observe que el par de caracteres de cada ligadura estándar se toca entre sí.  
...
## <a name="swashes"></a>Caracteres floreados  
 ...
 ![Texto que usa glifos estándar OpenType y floreados](./media/opentype-font-features/opentype-standard-swash-glyphs.gif "Texto que usa glifos estándar OpenType y floreados")  
 ...
 ![Texto que usa caracteres floreados OpenType](./media/opentype-font-features/opentype-swashes.gif "Texto que usa caracteres floreados OpenType")  
  
 En el ejemplo de marcación siguiente se muestra cómo se definen los caracteres floreados para una <xref:System.Windows.Documents.Typography> fuente mediante las propiedades del objeto.  
...
### <a name="contextual-swashes"></a>Caracteres floreados contextuales  
 ...
 ![Texto que usa caracteres floreados contextuales OpenType](./media/opentype-font-features/opentype-contextual-swashes.gif "Texto que usa caracteres floreados contextuales OpenType")  
  
 En el ejemplo de marcación siguiente se muestra cómo definir un carácter decorativo contextual para la fuente <xref:System.Windows.Documents.Typography> pescadero mediante las propiedades del objeto.  
...
## <a name="alternates"></a>Alternativas  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen los glifos alternativos de estilo para la fuente <xref:System.Windows.Documents.Typography> Pericles mediante las propiedades del objeto.  
...
### <a name="random-contextual-alternates"></a>Alternativas contextuales aleatorias  
 ...
 En el ejemplo de marcación siguiente se muestra cómo definir alternativas contextuales aleatorias para la fuente Lindsey <xref:System.Windows.Documents.Typography> mediante las propiedades del objeto.  
...
### <a name="historical-forms"></a>Formas históricas  
 ...
 En el ejemplo de marcación siguiente se muestra cómo definir los formatos históricos de la fuente Palatino Linotype mediante las propiedades <xref:System.Windows.Documents.Typography> del objeto.  
...
### <a name="fractions"></a>Fracciones  
 ...
 ![Texto que usa fracciones con barra diagonal y apilada OpenType](./media/opentype-font-features/opentype-slashed-stacked-fractions.gif "Texto que usa fracciones con barra diagonal y apilada OpenType")  
   
 En el ejemplo de marcación siguiente se muestra cómo se definen los estilos de fracción para la fuente Palatino Linotype mediante <xref:System.Windows.Documents.Typography> las propiedades del objeto.  
...
### <a name="old-style-numerals"></a>Números de estilo antiguo  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen los números de estilo antiguo para la fuente Palatino Linotype mediante las <xref:System.Windows.Documents.Typography> propiedades del objeto.  
...
### <a name="proportional-and-tabular-figures"></a>Cifras proporcionales y tabulares  
 ...
 ![Texto que usa figuras tabulares de & proporcional OpenType](./media/opentype-font-features/opentype-proportional-tabular-figures.gif "Texto que usa figuras tabulares y proporcionales OpenType")  
    
 En el ejemplo de marcación siguiente se muestra cómo definir figuras proporcionales y tabulares para la fuente Miramonte <xref:System.Windows.Documents.Typography> mediante las propiedades del objeto.  
...
### <a name="slashed-zero"></a>Cero con barra diagonal  
 ...
 En el ejemplo de marcación siguiente se muestra cómo se definen números cero con barra diagonal para la fuente Miramonte mediante <xref:System.Windows.Documents.Typography> las propiedades del objeto.  
  
 [!code-xaml[OpenTypeFontSamples#OpenTypeFontSnippet15](~/samples/snippets/csharp/VS_Snippets_Wpf/OpenTypeFontSamples/CS/PageOne.xaml#opentypefontsnippet15)]  
  
<a name="typography_class"></a>   
## <a name="typography-class"></a>Clase de tipografía  
 El <xref:System.Windows.Documents.Typography> objeto expone el conjunto de características que admite una fuente OpenType. Al establecer las propiedades de <xref:System.Windows.Documents.Typography> en el marcado, puede crear fácilmente documentos que aprovechen las características de OpenType.  
