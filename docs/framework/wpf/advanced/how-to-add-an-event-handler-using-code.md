...
-   Use el `Handles` palabra clave como parte de la definición de controlador de eventos. Esta técnica no se muestra aquí; consulte [Visual Basic y control de eventos de WPF](../../../../docs/framework/wpf/advanced/visual-basic-and-wpf-event-handling.md).  
