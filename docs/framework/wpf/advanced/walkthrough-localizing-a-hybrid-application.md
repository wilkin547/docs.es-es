...
1.  Cree un proyecto de aplicación WPF denominado `LocalizingWpfInWf`. Para más información, consulte [Cómo: Crear un proyecto de aplicación para Windows](http://msdn.microsoft.com/library/b2f93fed-c635-4705-8d0e-cf079a264efa).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Tutorial: Adaptar formularios Windows Forms](http://msdn.microsoft.com/library/9a96220d-a19b-4de0-9f48-01e5d82679e5)  
