...
1. En **Explorador de soluciones**, haga doble clic en **SimpleControl. Xaml** para abrirlo en el [!INCLUDE[wpfdesigner_current_short](../../../../includes/wpfdesigner-current-short-md.md)].
