...
## <a name="overview-and-the-dispatcher"></a>Información general y el distribuidor  
 ...
 Históricamente, Windows permite [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] que solo el subproceso que los creó pueda acceder a los elementos. Esto significa que un subproceso en segundo plano a cargo de una tarea de ejecución prolongada no puede actualizar un cuadro de texto cuando finalice. Windows realiza esta comprobación para garantizar la integridad [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] de los componentes. Un cuadro de lista podría tener una apariencia extraña si un subproceso en segundo plano actualiza su contenido durante la presentación.  
