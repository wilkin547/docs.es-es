...
## <a name="improved-quality-and-performance-of-text"></a>Mejora de la calidad y el rendimiento del texto  
 ...
 ![Texto con ClearType y&#45;dirección&#45;alias](../../../../docs/framework/wpf/advanced/media/typographyinwpf02.gif "TypographyInWPF02")  
...
Texto sesgado mediante SkewTransform  
 ...
 ![Captura de pantalla de efecto de giro de texto](../../../../docs/framework/wpf/advanced/media/texteffect01.jpg "TextEffect01")  
...
#### <a name="using-flow-documents"></a>Uso de documentos dinámicos  
 ...
 ![Ejemplo Using OpenType fonts captura de pantalla](../../../../docs/framework/wpf/advanced/media/typographyinwpf-03.png "TypographyInWPF_03")  
...
Ejemplo de pincel de imagen aplicado al trazo y el resaltado  
 ...
 Para obtener más información sobre la <xref:System.Windows.Media.FormattedText> de objetos, consulte [dibujar texto con formato](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md).  
