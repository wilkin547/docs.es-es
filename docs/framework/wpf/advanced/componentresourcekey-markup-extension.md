...
|`targetID`|La clave para el recurso. Cuando se buscan recursos `targetID` será similar a la [Directiva x: Key](../../../../docs/framework/xaml-services/x-key-directive.md) del recurso.|  
