...
Bibliotecas de Windows Presentation Foundation (WPF) exponen varias de las funciones no administradas que están pensados para uso interno únicamente. No deben llamarse desde el código de usuario.  
