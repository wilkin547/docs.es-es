...
- Cree un C# archivo ejecutable para el contenido de[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]y haga referencia a un C++ archivo DLL que contenga el contenido de[!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].
...
6. Implemente una clase administrada que contenga un campo estático para contener una referencia al objeto de contenido de [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]. Esta clase le permite obtener una referencia al objeto de contenido [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] desde el código de [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)], pero lo más importante es evitar que el <xref:System.Windows.Interop.HwndSource> se recopile involuntariamente.
...
> [!NOTE]
> Puede hacer una parte o toda la definición de clase de contenido de [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] para el primer paso en [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] usando la clase parcial predeterminada de la clase de contenido. Para ello, debe crear un ensamblado independiente y hacer referencia a este. Aunque normalmente incluye un objeto <xref:System.Windows.Application> como parte de la compilación de la [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] en un ensamblado, no termina de usar ese <xref:System.Windows.Application> como parte de la interoperación, solo se usan una o varias de las clases raíz para los archivos de [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] a los que hace referencia la aplicación. y hacen referencia a sus clases parciales. El resto del procedimiento es muy similar al descrito anteriormente.
>
...
2. Derive de <xref:System.Windows.Interop.HwndHost> para crear un objeto que contenga el contenido de [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].
...
- En general, mientras que los dispositivos de entrada están en el ámbito de la <xref:System.Windows.Interop.HwndHost> [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] hospedada, los eventos de entrada van directamente a [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].
