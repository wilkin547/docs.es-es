...
## <a name="example"></a>Ejemplo  
 ...
 Los estilos visuales deben usarse de forma coherente en un tema o una interfaz de usuario, el foco en lugar de usar otro diferente para cada elemento puede recibir el foco. Para obtener más información, consulte [aplicar estilo a controles y FocusVisualStyle foco](../../../../docs/framework/wpf/advanced/styling-for-focus-in-controls-and-focusvisualstyle.md).  
