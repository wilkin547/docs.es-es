...
## <a name="example"></a>Ejemplo  
 ...
 El siguiente paso es implementar la <xref:System.Windows.Input.ICommandSource> miembros.  En este ejemplo, las propiedades se implementan como <xref:System.Windows.DependencyProperty> objetos.  Esto permite que las propiedades que se va a usar el enlace de datos.  Para obtener más información sobre la <xref:System.Windows.DependencyProperty> de clases, vea el [información general sobre las propiedades de dependencia](../../../../docs/framework/wpf/advanced/dependency-properties-overview.md).  Para obtener más información sobre el enlace de datos, vea el [Data Binding Overview](../../../../docs/framework/wpf/data/data-binding-overview.md).  
