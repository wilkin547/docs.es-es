...
<a name="introduction"></a> El [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] subsistema proporciona una potente [!INCLUDE[TLA#tla_api](../../../../includes/tlasharptla-api-md.md)] para obtener los datos desde una variedad de dispositivos, incluido el mouse, el teclado, el táctil y el lápiz. En este tema se describen los servicios que proporciona [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] y se explica la arquitectura de los sistemas de entrada.  
