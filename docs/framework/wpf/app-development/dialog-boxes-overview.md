...
> [!NOTE]
>  <xref:Microsoft.Win32.OpenFileDialog> puede utilizarse para recuperar los nombres de archivo de manera segura por aplicaciones que se ejecutan con confianza parcial (vea [seguridad](../../../../docs/framework/wpf/security-wpf.md)).  
