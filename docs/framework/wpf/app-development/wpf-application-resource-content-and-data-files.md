...
- El archivo de datos de la aplicación debe ser localizable (vea [WPF Globalization and Localization Overview](../advanced/wpf-globalization-and-localization-overview.md)).  
