...
## <a name="implementing-the-contract-pipeline-segment"></a>Implementar el segmento de canalización del contrato  
 Un método debe definirse mediante el contrato para devolver una interfaz de usuario y su valor devuelto debe ser del tipo <xref:System.AddIn.Contract.INativeHandleContract>. Lo demuestra el método `GetAddInUI` del contrato de `IWPFAddInContract` en el código siguiente.  
...
## <a name="implementing-the-add-in"></a>Implementar el complemento  
 ...
 La implementación de `IWPFAddInView.GetAddInUI` por parte del complemento simplemente tiene que devolver una nueva instancia de `AddInUI`, tal y como se muestra en el código siguiente.  
