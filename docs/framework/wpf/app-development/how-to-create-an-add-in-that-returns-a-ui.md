...
-   Conocimiento de las extensiones WPF para el complemento de modelo de .NET Framework, que puede encontrarse aquí: [Información general sobre complementos WPF](../../../../docs/framework/wpf/app-development/wpf-add-ins-overview.md).  
