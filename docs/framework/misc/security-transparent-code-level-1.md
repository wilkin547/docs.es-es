...
## Modelo de transparencia de nivel 1  
...
-   El código transparente en seguridad no puede realizar acciones <xref:System.Security.Permissions.SecurityAction>.  
...
-   Cualquier código no seguro \(no comprobable\) que deba ejecutarse en código transparente en seguridad hace una demanda completa para el permiso de seguridad <xref:System.Security.Permissions.SecurityPermissionFlag>.  
...
## Ejemplos de transparencia de seguridad  
