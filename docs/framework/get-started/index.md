...
1.  Instale la versión de .NET Framework que será el destino de su aplicación. La versión de producción más reciente es [.NET Framework 4.6.1](http://go.microsoft.com/fwlink/?LinkId=671729). Hay paquetes adicionales de .NET Framework que se publican fuera de banda. Para obtener información acerca de estos paquetes, vea [.NET Framework y versiones fuera de banda](../../../docs/framework/get-started/the-net-framework-and-out-of-band-releases.md).  
  
2.  Seleccione el lenguaje o los lenguajes de .NET Framework que utilizará para desarrollar las aplicaciones. Hay varios lenguajes disponibles, incluido Visual Basic, C\#, Visual F\# y C\+\+ en Microsoft. \(Un lenguaje de programación que permita desarrollar aplicaciones de .NET Framework cumple las [especificaciones de Common Language Infrastructure \(CLI\)](http://go.microsoft.com/fwlink/?LinkId=199862).\) Para obtener una lista de los lenguajes de programación disponibles, vea [Lenguajes de Visual Studio](http://go.microsoft.com/fwlink/?LinkId=199863).  
...
3.  Seleccione e instale el entorno de desarrollo que utilizará para crear aplicaciones y que admita el lenguaje o los lenguajes de programación elegidos. El entorno de desarrollo integrado de Microsoft para las aplicaciones de .NET Framework es [Visual Studio](http://go.microsoft.com/fwlink/?LinkId=325532). Está disponible en diversas ediciones comerciales y gratuitas.  
 ...
 Para obtener más información sobre el desarrollo de aplicaciones destinadas a .NET Framework, vea [Guía de desarrollo](../../../docs/framework/development-guide.md).  
...
## Vea también  
 [.NET Framework 4.5 y 4.6](../Topic/.NET%20Framework%204.6%20and%204.5.md)   
