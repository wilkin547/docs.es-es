...
helpviewer_keywords: 
  ...
  - "Common Language Runtime, acerca de"
  - "Common Language Runtime, información general"
...
> [!NOTE]
>  Para obtener una introducción general a .NET Framework para usuarios y desarrolladores, consulte [Introducción](../../../docs/framework/get-started/index.md).  Para descargar .NET Framework, consulte [Guía de instalación](../../../docs/framework/install/guide-for-developers.md).  
...
-   Aplicaciones de ASP.NET  Consulte [Aplicaciones web con ASP.NET](../../../docs/framework/develop-web-apps-with-aspnet.md).  
  
-   Servicios de Windows.  Consulte [Introduction to Windows Service Applications](../../../docs/framework/windows-services/introduction-to-windows-service-applications.md).  
  
-   Aplicaciones orientadas a servicios utilizando Windows Communication Foundation \(WCF\).  Consulte [Aplicaciones orientadas a servicios con WCF](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)  
  
-   Aplicaciones habilitadas para el flujo de trabajo utilizando Windows Workflow Foundation \(WF\).  Consulte [Building Workflows in the .NET Framework](http://msdn.microsoft.com/es-es/cbf3880f-dc7b-466d-b808-1109b1223f4a).  
