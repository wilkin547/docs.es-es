...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "Generación y edición de manifiestos (herramienta)"
  - "Mage.exe"
...
```  
 ...
 Debe firmar los manifiestos de implementación y de aplicación antes de implementar la aplicación. Para obtener instrucciones sobre la firma de manifiestos, consulte [Información general sobre la implementación de aplicaciones de confianza](../Topic/Trusted%20Application%20Deployment%20Overview.md).  
