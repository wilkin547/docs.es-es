...
```  
 ...
 Para aplicaciones de la [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)]:  
...
|`-ExeConfig` \<*nombreDeArchivo*\>|Especifica el archivo de configuración que el escenario usa para proporcionar la información de versión y del cargador.|  
...
## Uso de Mpgo.exe desde Visual Studio  
 Puede ejecutar Mpgo.exe desde Visual Studio \[consulte el artículo [Cómo: Especificar eventos de compilación \(C\#\)](../Topic/How%20to:%20Specify%20Build%20Events%20\(C%23\).md)\] con las restricciones siguientes:  
