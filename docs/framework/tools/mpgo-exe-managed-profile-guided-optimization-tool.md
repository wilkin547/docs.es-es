...
## <a name="using-mpgoexe-from-visual-studio"></a>Uso de Mpgo.exe desde Visual Studio  
 Puede ejecutar Mpgo.exe desde Visual Studio (vea el artículo [Cómo: Especificar eventos de compilación (C#)](/visualstudio/ide/how-to-specify-build-events-csharp)) con las restricciones siguientes:  
