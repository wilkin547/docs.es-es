...
<span data-ttu-id="9c6df-108">En el símbolo del sistema, escriba lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="9c6df-108">At the command prompt, type the following:</span></span>
