...
- <xref:System.Composition.Hosting.Core?displayProperty=nameWithType> proporciona los tipos MEF utilizados internamente por el motor de composición.  
 ...
 Para obtener más información sobre .NET para aplicaciones de la tienda Windows 8. x y una lista de espacios de nombres y tipos que contiene, consulte [información general de .net para aplicaciones de la tienda Windows](https://docs.microsoft.com/previous-versions/br230302(v=vs.110)).
