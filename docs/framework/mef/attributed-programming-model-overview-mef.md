---
title: "Informaci&#243;n general del modelo de programaci&#243;n con atributos (MEF) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "modelo de programación con atributos [MEF]"
  - "MEF, modelo de programación con atributos"
...
---
# Informaci&#243;n general del modelo de programaci&#243;n con atributos (MEF)
...
## Conceptos básicos sobre importaciones y exportaciones  
...
### Importaciones de requisito previo  
 ...
 Cada parte solo puede tener un constructor para uso por parte del motor de composición. No proporcionar ningún constructor predeterminado y ningún atributo `ImportingConstructor`, o proporcionar más de un atributo `ImportingConstructor`, generará un error.  
...
## Herencia de las importaciones y exportaciones  
...
```  
 ...
 Esta clase define un atributo personalizado denominado `MyAttribute` con tipo de contrato `IMyData` y algunos metadatos denominados `MyMetadata`. Se considera que todas las propiedades de una clase marcadas con el atributo `MetadataAttribute` son metadatos definidos en el atributo personalizado. Las dos declaraciones siguientes son equivalentes.  
...
## Vea también  
 [Vídeo de Channel 9: Abrir las aplicaciones con Managed Extensibility Framework](http://channel9.msdn.com/events/TechEd/NorthAmerica/2009/DTL328)   
 [Vídeo de Channel 9: Managed Extensibility Framework \(MEF\) 2.0](http://channel9.msdn.com/posts/NET-45-Oleg-Lvovitch-and-Kevin-Ransom-Managed-Extensibility-Framework-MEF-20)