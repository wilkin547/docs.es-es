...
|`tdSerializable`|<span data-ttu-id="00202-129">Especifica que el tipo es serializable.</span><span class="sxs-lookup"><span data-stu-id="00202-129">Specifies that the type is serializable.</span></span>|  
