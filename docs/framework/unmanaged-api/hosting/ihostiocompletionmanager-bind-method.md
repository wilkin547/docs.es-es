...
Enlaza el identificador especificado con un puerto de finalización de E/S que se ha creado por una llamada anterior a [CreateIoCompletionPort](../../../../docs/framework/unmanaged-api/hosting/ihostiocompletionmanager-createiocompletionport-method.md).  
...
#### <a name="parameters"></a>Parámetros  
 `hPort`  
 [in] El puerto de terminación de E/S que se va a enlazar `hHandle`. Si el valor de `hPort` es null, `hHandle` está enlazado al puerto de finalización de E/S predeterminado.  
...
## <a name="remarks"></a>Comentarios  
 Un puerto de finalización de E/S se crea mediante una llamada a `CreateIoCompletionPort`. CLR llama `Bind` para enlazar un identificador a ese puerto.  
