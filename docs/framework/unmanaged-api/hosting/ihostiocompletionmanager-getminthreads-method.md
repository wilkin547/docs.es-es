...
## <a name="remarks"></a>Comentarios  
 Un host podría desear el control exclusivo sobre el número de subprocesos asignados para atender las solicitudes de E/S, por motivos de implementación, rendimiento o escalabilidad. Por este motivo, no es necesario implementar el host `GetMinThreads`. En este caso, el host debe devolver E_NOTIMPL desde este método.  
