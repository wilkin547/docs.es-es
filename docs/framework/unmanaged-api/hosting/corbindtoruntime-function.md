...
#### <a name="parameters"></a>Parámetros  
 ...
 Si el llamador especifica NULL como valor para `pwszVersion`, se carga la versión más reciente del runtime. Pasar null no impide al host ningún control sobre el que se carga la versión del runtime. Aunque este planteamiento puede ser apropiado en algunos escenarios, se recomienda encarecidamente que el host proponga cargar una versión específica.  
