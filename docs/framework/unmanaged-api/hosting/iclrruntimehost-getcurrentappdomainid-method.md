...
## <a name="remarks"></a>Comentarios  
 El `pdwAppDomainId` parámetro se establece en el valor de la <xref:System.AppDomain.Id%2A> propiedad de la <xref:System.AppDomain> en que se está ejecutando el subproceso actual.  
