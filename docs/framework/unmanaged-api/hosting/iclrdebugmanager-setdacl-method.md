...
## <a name="parameters"></a>Parámetros  
 `pacl`  
 [in] Un puntero a la lista de Control de acceso (ACL).  
...
- [GetDacl (método)](../../../../docs/framework/unmanaged-api/hosting/iclrdebugmanager-getdacl-method.md)
