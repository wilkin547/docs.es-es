...
ms.locfileid: "73133708"
---
# <a name="net-framework-4-hosting-global-static-functions"></a>Funciones estáticas globales de hospedaje de .NET Framework 4
El .NET Framework 4 introduce un nuevo método exportado en MSCorEE. dll: [CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md).  
