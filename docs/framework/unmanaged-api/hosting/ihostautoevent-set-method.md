...
Establece la instancia de [IHostAutoEvent](../../../../docs/framework/unmanaged-api/hosting/ihostautoevent-interface.md) actual en un estado señalado.  
...
|HRESULT|Descripción|  
|-------------|-----------------|  
|S_OK|`Set` devolvió correctamente.|  
