...
## <a name="remarks"></a>Comentarios  
 CLR llama `SuspensionEnding` a después de que realiza una recolección de elementos no utilizados, para informar al host de que el subproceso está reanudando la ejecución.  
