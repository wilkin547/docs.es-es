...
|Método|Descripción|  
|------------|-----------------|  
|[Método Get](../../../../docs/framework/unmanaged-api/hosting/iclrreferenceassemblyenum-get-method.md)|Obtiene la identidad del ensamblado en el índice proporcionado.|  
