...
> [!IMPORTANT]
> Tres métodos `ICLRDebugManager`, `BeginConnection`, `SetConnectionTasks` y `EndConnection`dependen unos de otros. Se les debe llamar en el orden especificado para que funcionen según lo previsto.  
