...
ms.locfileid: "67766612"
---
# <a name="iceefilegen-class"></a><span data-ttu-id="1890c-102">ICeeFileGen (Clase)</span><span class="sxs-lookup"><span data-stu-id="1890c-102">ICeeFileGen Class</span></span>
<span data-ttu-id="1890c-103">Proporciona funcionalidad para crear un archivo ejecutable portable (PE) nativo.</span><span class="sxs-lookup"><span data-stu-id="1890c-103">Provides functionality for creating a native portable executable (PE) file.</span></span> <span data-ttu-id="1890c-104">La interfaz se usará normalmente los compiladores para generar su resultado compilado ejecutable.</span><span class="sxs-lookup"><span data-stu-id="1890c-104">The interface will typically be used by compilers to generate their compiled output executable.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="1890c-105">`ICeeFileGen` admite la infraestructura de .NET Framework y no está pensado para utilizarse directamente desde el código.</span><span class="sxs-lookup"><span data-stu-id="1890c-105">`ICeeFileGen` supports the .NET Framework infrastructure and is not intended to be used directly from your code.</span></span>  
  
 <span data-ttu-id="1890c-106">Esta interfaz está desusada y se quitará en futuras versiones.</span><span class="sxs-lookup"><span data-stu-id="1890c-106">This interface has been deprecated and will be removed in a future release.</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="1890c-107">Sintaxis</span><span class="sxs-lookup"><span data-stu-id="1890c-107">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="1890c-108">Requisitos</span><span class="sxs-lookup"><span data-stu-id="1890c-108">Requirements</span></span>  
 <span data-ttu-id="1890c-109">**Plataformas:** Consulte [Requisitos del sistema](../../../../docs/framework/get-started/system-requirements.md).</span><span class="sxs-lookup"><span data-stu-id="1890c-109">**Platforms:** See [System Requirements](../../../../docs/framework/get-started/system-requirements.md).</span></span>  
  
 <span data-ttu-id="1890c-110">**Encabezado**: ICeeFileGen.h</span><span class="sxs-lookup"><span data-stu-id="1890c-110">**Header:** ICeeFileGen.h</span></span>  
  
 <span data-ttu-id="1890c-111">**Versión de .NET framework:** 1.0</span><span class="sxs-lookup"><span data-stu-id="1890c-111">**.NET Framework Version:** 1.0</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="1890c-112">Vea también</span><span class="sxs-lookup"><span data-stu-id="1890c-112">See also</span></span>

- [<span data-ttu-id="1890c-113">Interfaces de hospedaje</span><span class="sxs-lookup"><span data-stu-id="1890c-113">Hosting Interfaces</span></span>](../../../../docs/framework/unmanaged-api/hosting/hosting-interfaces.md)
