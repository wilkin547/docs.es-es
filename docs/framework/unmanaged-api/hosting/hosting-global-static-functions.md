...
ms.locfileid: "61775224"
---
# <a name="hosting-global-static-functions"></a>Funciones estáticas globales para hospedaje
Esta sección describen las funciones de hospedaje no administradas usadas por la API de hospedaje de .NET Framework.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe las funciones incluidas en .NET Framework 4.  
  
 [Funciones de hospedaje de CLR en desuso](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)  
 Describe las funciones incluidas en .NET Framework 1.1 y 2.0, que están en desuso en el [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)].  
