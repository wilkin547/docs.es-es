...
## <a name="parameters"></a>Parámetros  
 ...
 `dwNumOfReferences`  
 de Número de elementos de `ppwzAssemblyReferences` .  
  
 `ppReferenceList`  
 enuncia Puntero de interfaz a un `ICLRAssemblyReferenceList` objeto que contiene los datos de identidad del ensamblado para la lista de ensamblados especificada en `ppwzAssemblyReferences` .  
