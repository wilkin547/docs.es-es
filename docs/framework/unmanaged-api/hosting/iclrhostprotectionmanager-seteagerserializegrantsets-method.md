...
---
# <a name="iclrhostprotectionmanagerseteagerserializegrantsets-method"></a>ICLRHostProtectionManager::SetEagerSerializeGrantSets (Método)
...
|HRESULT|Descripción|  
|-------------|-----------------|  
|S_OK|`SetEagerSerializeGrantSets` se devolvió correctamente.|  
