...
## <a name="parameters"></a>Parámetros  
 `policy`  
 de Uno de los valores de [EClrUnhandledException (](../../../../docs/framework/unmanaged-api/hosting/eclrunhandledexception-enumeration.md) , que indica si el CLR o el host establecen el comportamiento.  
  
## <a name="return-value"></a>Valor devuelto  
  
|HRESULT|Descripción|  
|-------------|-----------------|  
|S_OK|`SetUnhandledExceptionPolicy` devolvió correctamente.|  
...
## <a name="remarks"></a>Comentarios  
 De forma predeterminada, el CLR es el controlador final de todas las excepciones no controladas y su comportamiento predeterminado es anular el proceso. El host puede cambiar este comportamiento estableciendo el valor de `policy` en eHostDeterminedPolicy. Este valor permite que el host implemente su propio comportamiento predeterminado, al igual que con las versiones anteriores de CLR.  
