...
## <a name="parameters"></a>Parámetros  
 ...
 `dwLength`  
 de Tamaño, en bytes, del búfer al que apunta `lpBuffer`.  
...
|HRESULT|Descripción|  
|-------------|-----------------|  
|S_OK|`VirtualQuery` devolvió correctamente.|  
...
## <a name="remarks"></a>Comentarios  
 `VirtualQuery` proporciona información sobre un intervalo de páginas en el espacio de direcciones virtuales del proceso de llamada. Esta implementación establece el valor del parámetro `pResult` en el número de bytes devuelto en el búfer de información y devuelve un valor HRESULT. En la función `VirtualQuery` de Win32, el valor devuelto es el tamaño del búfer. Para obtener más información, vea la documentación de la plataforma Windows.  
