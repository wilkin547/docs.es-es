...
Solicita que el Common Language Runtime (CLR) Reserve la tarea que representa la instancia actual de [ICLRTask](../../../../docs/framework/unmanaged-api/hosting/iclrtask-interface.md) y que el tiempo de procesador esté disponible para otras tareas.  
...
|HRESULT|Descripción|  
|-------------|-----------------|  
|S_OK|`YieldTask` devolvió correctamente.|  
