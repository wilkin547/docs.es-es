...
### [.NET framework 4 aloja funciones estáticas globales](net-framework-4-hosting-global-static-functions.md)
...
#### [Función FExecuteInAppDomainCallback](fexecuteinappdomaincallback-function-pointer.md)
...
#### [La función Lpoverlapped_completion_routine](lpoverlapped-completion-routine-function-pointer.md)
#### [La función Lpthread_start_routine](lpthread-start-routine-function-pointer.md)
#### [RunDll32ShimW (función)](rundll32shimw-function.md)
#### [Puntero a función WAITORTIMERCALLBACK](waitortimercallback-function-pointer.md)
