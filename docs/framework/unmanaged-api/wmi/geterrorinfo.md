...
Un puntero a un objeto [IErrorInfo](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-ierrorinfo) si la llamada de función se realiza correctamente, o `null` si se produce un error.
