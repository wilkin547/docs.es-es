...
| `WBEM_FLAG_OWNER_UPDATE` | 0x10000 | Los proveedores de inserciones deben especificar esta `PutClassWmi` marca cuando se llama a para indicar que esta clase ha cambiado. |
...
| `WBEM_E_ALREADY_EXISTS` | 0x80041019 | Se `WBEM_FLAG_CREATE_ONLY` especificó la marca, pero la clase ya existe. |
| `WBEM_E_NOT_FOUND` | 0x80041002 | `WBEM_FLAG_UPDATE_ONLY`se especificó `lFlags`en y no se encontró la clase. |
