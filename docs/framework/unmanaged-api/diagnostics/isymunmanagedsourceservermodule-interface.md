...
|Método|Descripción|  
|------------|-----------------|  
|[GetSourceServerData (método)](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedsourceservermodule-getsourceserverdata-method.md)|Returns the source server data for the module.|  
