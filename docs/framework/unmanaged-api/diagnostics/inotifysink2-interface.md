...
|Método|Descripción|  
|------------|-----------------|  
|[OnSyncCallEnter (método)](../../../../docs/framework/unmanaged-api/diagnostics/inotifysink2-onsynccallenter-method.md)|Se invoca cuando entra en una llamada.|  
...
|[OnSyncCallOut (método)](../../../../docs/framework/unmanaged-api/diagnostics/inotifysink2-onsynccallout-method.md)|Se invoca cuando una llamada está inactiva.|  
|[OnSyncCallReturn (método)](../../../../docs/framework/unmanaged-api/diagnostics/inotifysink2-onsynccallreturn-method.md)|Se invoca cuando una llamada devuelve.|  
