...
## <a name="terminology"></a>Terminología  
 ...
 Tanto los módulos de contenedor como los submódulos se representan mediante objetos de interfaz ICorDebugModule. Sin embargo, el comportamiento de la interfaz es ligeramente diferente en cada caso, como \<x-ref to section> se describe en la sección.  
