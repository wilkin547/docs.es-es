...
## <a name="remarks"></a>Comentarios  
 El método `SetAllThreadsDebugState` puede afectar a los subprocesos que no son visibles a través del [método enumeratethreads (](../../../../docs/framework/unmanaged-api/debugging/icordebugcontroller-enumeratethreads-method.md), por lo que los subprocesos que se suspendieron con el método `SetAllThreadsDebugState` deberán reanudarse con el método `SetAllThreadsDebugState`.  
