...
|Método|Descripción|  
|------------|-----------------|  
|[Método CreateBreakpoint](icordebugmodule-createbreakpoint-method.md)|No implementado.|  
...
|[Método GetFunctionFromRVA](icordebugmodule-getfunctionfromrva-method.md)|No implementado.|  
