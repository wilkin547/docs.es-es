...
Obtiene el tamaño, en bytes, del tipo de puntero que utiliza el proceso de destino. Los servicios de acceso a datos de common language runtime llama a este método.  
