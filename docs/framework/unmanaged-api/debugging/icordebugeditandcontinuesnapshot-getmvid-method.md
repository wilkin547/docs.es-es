---
description: 'Más información sobre: ICorDebugEditAndContinueSnapshot:: Getmvid ((método)'
...
ms.locfileid: "99694791"
---
# <a name="icordebugeditandcontinuesnapshotgetmvid-method"></a>ICorDebugEditAndContinueSnapshot::GetMvid (Método)

`GetMvid` está obsoleto. No llame a este método.  
