...
## <a name="parameters"></a>Parámetros  
 ...
 `ppProcs`  
 enuncia Matriz de estructuras [coreclrdebugprocinfo (](../../../../docs/framework/unmanaged-api/debugging/coreclrdebugprocinfo-structure.md) que representan los procesos que se ejecutan en el equipo remoto.  
