...
---
# <a name="icordebugeval-interface"></a>ICorDebugEval (Interfaz)
...
|Método|Descripción|  
|------------|-----------------|  
|[Abort (método)](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-abort-method.md)|Anula el cálculo que este objeto `ICorDebugEval` está realizando actualmente.|  
...
|[IsActive (método)](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-isactive-method.md)|Obtiene un valor que indica si este objeto `ICorDebugEval` se está ejecutando actualmente.|  
