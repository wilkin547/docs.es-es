...
|Método|Descripción|  
|------------|-----------------|  
|[SetWriteableMetadataUpdateMode (método)](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess7-setwriteablemetadataupdatemode-method.md)|Establece un valor que determina cómo el depurador controla las actualizaciones en memoria de los metadatos dentro del proceso de destino.|  
