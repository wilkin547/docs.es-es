...
|Método|Descripción|  
|------------|-----------------|  
|[Next (método)](icordebugmoduleenum-next-method.md)|Obtiene el número especificado de instancias de `ICorDebugModule` de la enumeración, comenzando en la posición actual.|  
