...
## <a name="remarks"></a>Notas  
 ...
 El número de versión obtenido por el método `GetVersionNumber` puede ser menor que el obtenido por [ICorDebugFunction:: GetCurrentVersionNumber (](icordebugfunction-getcurrentversionnumber-method.md).  
