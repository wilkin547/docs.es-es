...
|Método|Descripción|  
|------------|-----------------|  
|[GetLength (método)](icordebugstringvalue-getlength-method.md)|Obtiene el número de caracteres de la cadena a la que hace referencia este `ICorDebugStringValue`.|  
