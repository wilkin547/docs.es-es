...
---
# <a name="icordebugeditandcontinueerrorinfogettoken-method"></a>ICorDebugEditAndContinueErrorInfo::GetToken (Método)
`GetToken` está obsoleto. No llame a este método.  
