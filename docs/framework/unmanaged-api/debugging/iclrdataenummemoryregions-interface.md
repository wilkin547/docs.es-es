...
|Método|Descripción|  
|------------|-----------------|  
|[EnumMemoryRegions (método)](../../../../docs/framework/unmanaged-api/debugging/iclrdataenummemoryregions-enummemoryregions-method.md)|Enumera áreas específicas de la memoria.|  
