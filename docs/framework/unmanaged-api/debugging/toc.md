...
#### [Request (método)](iclrdatatarget-request-method.md)
...
#### [Método de GetObjectForCCW](icordebugappdomain4-getobjectforccw-method.md)
...
#### [Método de GetLoadedModules](icordebugdatatarget3-getloadedmodules-method.md)
...
#### [Método de EnableExceptionCallbacksOutsideOfMyCode](icordebugprocess8-enableexceptioncallbacksoutsideofmycode-method.md)
...
### [La función Pfn_clrdatacreateinstance](pfn-clrdatacreateinstance-function-pointer.md)
...
### [CodeChunkInfo estructura-1](codechunkinfo-structure.md)
...
#### [Icoreclrdebugtarget (método)](icoreclrdebugtarget-freememory-method.md)
