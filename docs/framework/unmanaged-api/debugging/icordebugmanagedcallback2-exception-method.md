...
#### <a name="parameters"></a>Parámetros  
 ...
 `dwEventType`  
 [in] Un valor de la enumeración CorDebugExceptionCallbackType que especifica el tipo de esta devolución de llamada de excepción.  
...
## <a name="remarks"></a>Comentarios  
 El `Exception` devolución de llamada se denomina en varios puntos durante la fase de búsqueda del proceso de control de excepciones. Es decir, puede llamar más de una vez mientras desenreda una excepción.  
...
|DEBUG_EXCEPTION_CATCH_HANDLER_FOUND|El marco que contiene el controlador catch.|El desplazamiento de lenguaje intermedio (MSIL) de Microsoft del principio del controlador catch.|  
