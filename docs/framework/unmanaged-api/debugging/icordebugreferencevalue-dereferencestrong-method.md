...
ms.locfileid: "73137743"
---
# <a name="icordebugreferencevaluedereferencestrong-method"></a>ICorDebugReferenceValue::DereferenceStrong (Método)
no se ha implementado `DereferenceStrong`. No llame a este método.  
