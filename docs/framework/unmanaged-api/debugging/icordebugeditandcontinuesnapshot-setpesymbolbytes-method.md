...
---
# <a name="icordebugeditandcontinuesnapshotsetpesymbolbytes-method"></a>ICorDebugEditAndContinueSnapshot::SetPESymbolBytes (Método)
`SetPESymbolBytes` está obsoleto. No llame a este método.  
