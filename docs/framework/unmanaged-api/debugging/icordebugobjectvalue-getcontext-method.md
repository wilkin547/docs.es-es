...
ms.locfileid: "61942342"
---
# <a name="icordebugobjectvaluegetcontext-method"></a>ICorDebugObjectValue::GetContext (Método)
`GetContext` no se implementa en esta versión de .NET Framework.  
