...
ms.locfileid: "33431485"
---
# <a name="fusion-structures"></a>Estructuras de fusión
Esta sección describe las estructuras no administradas que utiliza la API de fusión.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Contiene información de desplazamiento para un asociado [IDENTITY_ATTRIBUTE](../../../../docs/framework/unmanaged-api/fusion/identity-attribute-structure.md) estructura.  
