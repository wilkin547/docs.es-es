...
|Método|Descripción|  
|------------|-----------------|  
|[Método GetReference](iinstallreferenceitem-getreference-method.md)|Obtiene un puntero a la `FUSION_INSTALL_REFERENCE` estructura representada por este `IInstallReferenceItem` .|  
