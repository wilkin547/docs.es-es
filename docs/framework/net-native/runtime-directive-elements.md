---
title: "Elementos de directivas en tiempo de ejecuci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
El formato del archivo de directivas de tiempo de ejecución \(rd.xml\) es compatible con los siguientes elementos de directiva de tiempo de ejecución.  Consulte [Referencia del archivo de configuración de directivas en tiempo de ejecución \(rd.xml\)](../../../docs/framework/net-native/runtime-directives-rd-xml-configuration-file-reference.md) para obtener una representación jerárquica.  
 ...
 Si la directiva [\<Type\>](../../../docs/framework/net-native/type-element-net-native.md) que contiene es un atributo, aplica la directiva de tiempo de ejecución a los elementos de código a los que se les aplica dicho atributo.  
