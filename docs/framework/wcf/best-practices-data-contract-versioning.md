---
title: "Procedimientos recomendados: Creaci&#243;n de versiones de contratos de datos | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Procedimientos recomendados [WCF], Versiones de contratos de datos"
  - "contratos de datos"
  - "Contratos de servicio"
  - "Windows Communication Foundation, contratos de datos"
...
En este tema se enumeran los procedimientos recomendados para crear contratos de datos que pueden evolucionar con facilidad con el tiempo.  [!INCLUDE[crabout](../../../includes/crabout-md.md)] los contratos de datos, vea los temas de [Utilización de contratos de datos](../../../docs/framework/wcf/feature-details/using-data-contracts.md).  
  
## Aviso en validación del esquema  
...
## Controlar versiones cuando se requiere la validación del esquema  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] Procedimientos recomendados: [Control de versiones del servicio](../../../docs/framework/wcf/service-versioning.md).  
...
-   Aplique un atributo <xref:System.ServiceModel.ServiceBehaviorAttribute> a su contrato de servicios con la propiedad <xref:System.ServiceModel.ServiceBehaviorAttribute.IgnoreExtensionDataObject%2A> establecida en `true`.  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] los viajes de ida y vuelta \(round trip\), consulte [Contratos de datos compatibles con el reenvío](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md).  
  
## Controlar versiones cuando se requiere la validación del esquema  
 En raras ocasiones se requiere compatibilidad estricta de esquema.  Muchas plataformas toleran elementos adicionales no descritos por un esquema.  Siempre que se tolere, se puede utilizar el conjunto completo de características descrito en [Versiones de contratos de datos](../../../docs/framework/wcf/feature-details/data-contract-versioning.md) y [Contratos de datos compatibles con el reenvío](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md).  A continuación se indican algunas instrucciones recomendadas:  
