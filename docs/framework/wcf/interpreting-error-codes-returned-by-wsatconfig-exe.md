---
title: "Interpretar c&#243;digos de error devueltos por wsatConfig.exe | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Interpretar c&#243;digos de error devueltos por wsatConfig.exe
...
|---------------------|-----------------|---------------------------------------|  
|0|La operación se realizó correctamente|Ninguno|  
|1|Error inesperado|Póngase en contacto con Microsoft|  
...
|20|[!INCLUDE[vstecwinfx](../../../includes/vstecwinfx-md.md)] no está instalado en el equipo remoto o no está instalado correctamente.|Instale [!INCLUDE[vstecwinfx](../../../includes/vstecwinfx-md.md)] en el equipo.|  
...
|22|[!INCLUDE[vstecwinfx](../../../includes/vstecwinfx-md.md)] no está instalado en el equipo remoto o no está instalado correctamente.|Instale [!INCLUDE[vstecwinfx](../../../includes/vstecwinfx-md.md)] en el equipo.|  
...
|31|La opción de línea de comandos `-traceLevel` no es válida.|Corrija la opción de línea de comandos `-traceLevel` para especificar un valor válido de lo siguientes<br /><br /> -   Off<br />-   Error<br />-   Crítico<br />-   Advertencia<br />-   Información<br />-   Detalles<br />-   Todos|  
