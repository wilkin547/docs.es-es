...
-   Ruta de acceso: /mathservice.svc/secureEndpoint  
 ...
 Parte del modelo EPR consiste en que cada referencia de extremo puede llevar algunos parámetros de referencia que agregan información de identificación adicional. En [!INCLUDE[indigo2](../../../includes/indigo2-md.md)], estos parámetros de referencia se modelan como instancias de la clase <xref:System.ServiceModel.Channels.AddressHeader>.  
...
## <a name="defining-endpoint-addresses-in-configuration"></a>Definición de direcciones de puntos de conexión mediante configuración  
 Para definir un punto de conexión en un archivo de configuración, utilice la [ \<extremo >](http://msdn.microsoft.com/en-us/13aa23b7-2f08-4add-8dbf-a99f8127c017) elemento.  
...
## <a name="using-default-endpoints"></a>Usar extremos predeterminados  
