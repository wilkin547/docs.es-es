...
Se trata de la segunda de las seis tareas necesarias para crear un servicio básico de Windows Communication Foundation (WCF) y un cliente que puede llamar al servicio. Para obtener información general de las seis tareas, consulte el [Tutorial de introducción](../../../docs/framework/wcf/getting-started-tutorial.md) tema.
...
Abra el archivo Service1.cs o Service1.vb y agregue el código siguiente:
...
Compile la solución para asegurarse de que no hay ningún error de compilación. Si usa Visual Studio, en el **compilar** menú, seleccione **compilar solución** (o presione **Ctrl**+**MAYÚS** + **B**).

## <a name="next-steps"></a>Pasos siguientes

Ahora, el contrato de servicio se ha creado e implementado. En el paso siguiente, se ejecuta el servicio.
