---
title: "Definici&#243;n y especificaci&#243;n de errores | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Control de errores [WCF], definir"
  - "Control de errores [WCF], especificar"
...
### Marcar operaciones para establecer el contrato de error  
 ...
 El paso siguiente, implementar el contrato de error en su implementación de la operación, se describe en el tema [Envío y recepción de errores](../../../docs/framework/wcf/sending-and-receiving-faults.md).  
...
## Vea también  
 ...
 [Cómo declarar errores en contratos de servicios](../../../docs/framework/wcf/how-to-declare-faults-in-service-contracts.md)   
