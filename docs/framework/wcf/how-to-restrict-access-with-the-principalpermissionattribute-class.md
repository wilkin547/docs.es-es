...
1.  Abra el archivo de código de [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] que contiene el código de contrato de servicio implementado. [!INCLUDE[crabout](../../../includes/crabout-md.md)]implementar un contrato, vea [implementar contratos de servicio](../../../docs/framework/wcf/implementing-service-contracts.md).  
