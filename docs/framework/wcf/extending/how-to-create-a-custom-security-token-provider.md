...
>  Cree un proveedor de tokens personalizado si los tokens proporcionados por el sistema ubicados en el espacio de nombres <xref:System.IdentityModel.Tokens> no coinciden con sus requisitos.  
 ...
 Para obtener más información acerca de las credenciales, vea clases token de administrador, el proveedor y el autenticador de seguridad, el [arquitectura de seguridad](http://msdn.microsoft.com/en-us/16593476-d36a-408d-808c-ae6fd483e28f).  
