...
1. Agregue el tipo de importador al `<extensions>` elemento dentro del [ \<elemento > policyImporters](../../configure-apps/file-schema/wcf/policyimporters.md) en el archivo de configuración del cliente.  
