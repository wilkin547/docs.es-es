...
1.  <span data-ttu-id="2f37f-122">Abra el archivo de configuración para el servicio.</span><span class="sxs-lookup"><span data-stu-id="2f37f-122">Open the configuration file for the service.</span></span>  
