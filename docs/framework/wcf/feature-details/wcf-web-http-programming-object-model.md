...
### <a name="extending-webhttpbehavior"></a>Extender WebHttpBehavior  
 ...
 <xref:System.ServiceModel.Description.WebScriptEnablingBehavior> es un ejemplo de cómo extender <xref:System.ServiceModel.Description.WebHttpBehavior>. <xref:System.ServiceModel.Description.WebScriptEnablingBehavior> permite a los extremos de [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] recibir solicitudes HTTP de un cliente AJAX de ASP.NET basado en explorador. El [servicio AJAX mediante HTTP POST](../../../../docs/framework/wcf/samples/ajax-service-using-http-post.md) es un ejemplo del uso de este punto de extensibilidad.  
