...
## <a name="compatibility"></a>Compatibilidad  
 ...
 El modelo de programación WEB HTTP de WCF no utiliza mensajes basados en SOAP y, por lo tanto, no admite los protocolos WS-*. No obstante, puede exponer el mismo contrato en dos extremos diferentes, uno que use SOAP y otro que no lo haga. Vea [Cómo: exponer un contrato a SOAP y clientes Web](how-to-expose-a-contract-to-soap-and-web-clients.md) para obtener un ejemplo.  
