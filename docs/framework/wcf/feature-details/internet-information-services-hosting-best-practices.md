---
title: "Procedimientos recomendados de hospedaje de Internet Information Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## WCF en escenarios multitarjeta o de varios nombres  
 ...
 Para asegurarse de que el nombre del host correcto aparece en los metadatos de servicio que [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] genera, configure la identidad predeterminada para que el sitio web de IIS que hospeda los servicios de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] utilice un nombre de host explícito.Por ejemplo, los equipos que residen dentro de la granja www.contoso.com deberían utilizar un enlace de sitio de IIS de \*:80:www.contoso.com para HTTP y \*:443:www.contoso.com para HTTPS.  
...
```  
 ...
 Si ha establecido `aspNetCompatibilityEnabled` en `true`, configure el objeto <xref:System.ServiceModel.Activation.ServiceHttpHandlerFactory> tal y como se muestra en el fragmento de código de configuración siguiente.  
...
## Vea también  
 [Service Hosting Samples](http://msdn.microsoft.com/es-es/f703a3f6-0fba-418a-a92f-7ce75ccfa47e)   
