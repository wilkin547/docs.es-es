...
---
# <a name="how-to-use-the-aspnet-authorization-manager-role-provider-with-a-service"></a>Filtrar para usar el proveedor de roles del administrador de autorización de ASP.NET con un servicio
