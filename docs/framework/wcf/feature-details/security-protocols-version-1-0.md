...
|<span data-ttu-id="d9fda-159">AnonymousForCertificate</span><span class="sxs-lookup"><span data-stu-id="d9fda-159">AnonymousForCertificate</span></span>|<span data-ttu-id="d9fda-160">Ninguna</span><span class="sxs-lookup"><span data-stu-id="d9fda-160">None</span></span>|<span data-ttu-id="d9fda-161">X509</span><span class="sxs-lookup"><span data-stu-id="d9fda-161">X509</span></span>|<span data-ttu-id="d9fda-162">Mensaje</span><span class="sxs-lookup"><span data-stu-id="d9fda-162">Message</span></span>|  
...
|<span data-ttu-id="d9fda-233">mssp</span><span class="sxs-lookup"><span data-stu-id="d9fda-233">mssp</span></span>|<http://schemas.xmlsoap.org/ws/2005/07/securitypolicy>|
...
### <a name="13-kerberos-token"></a><span data-ttu-id="d9fda-263">1.3 Token de Kerberos.</span><span class="sxs-lookup"><span data-stu-id="d9fda-263">1.3 Kerberos Token</span></span>  
...
### <a name="21-timestamp"></a><span data-ttu-id="d9fda-275">2.1 Marca de tiempo</span><span class="sxs-lookup"><span data-stu-id="d9fda-275">2.1 TimeStamp</span></span>  
...
### <a name="25-key-derivation"></a><span data-ttu-id="d9fda-286">2.5 Derivación de clave</span><span class="sxs-lookup"><span data-stu-id="d9fda-286">2.5 Key Derivation</span></span>  
...
### <a name="61-transport-protection"></a><span data-ttu-id="d9fda-306">6.1 Protección de transporte</span><span class="sxs-lookup"><span data-stu-id="d9fda-306">6.1 Transport Protection</span></span>  
...
#### <a name="611-usernameovertransport"></a><span data-ttu-id="d9fda-318">6.1.1 UsernameOverTransport</span><span class="sxs-lookup"><span data-stu-id="d9fda-318">6.1.1 UsernameOverTransport</span></span>  
 ...
 <span data-ttu-id="d9fda-322">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-322">Policy</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-323">Diseño del encabezado de seguridad</span><span class="sxs-lookup"><span data-stu-id="d9fda-323">Security Header Layout</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-333">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-333">Response</span></span>  
...
### <a name="62-using-x509-certificates-for-service-authentication"></a><span data-ttu-id="d9fda-365">6.2 Uso de certificados X.509 para la autenticación de servicios</span><span class="sxs-lookup"><span data-stu-id="d9fda-365">6.2 Using X.509 Certificates for Service Authentication</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-383">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-383">Response</span></span>  
...
#### <a name="622-mutualcertificateduplex"></a><span data-ttu-id="d9fda-384">6.2.2 MutualCertificateDuplex</span><span class="sxs-lookup"><span data-stu-id="d9fda-384">6.2.2 MutualCertificateDuplex</span></span>  
 ...
 <span data-ttu-id="d9fda-393">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-393">Encrypt Signature: True</span></span>  
...
#### <a name="623-using-symmetricbinding-with-x509-service-authentication"></a><span data-ttu-id="d9fda-399">6.2.3 Uso de SymmetricBinding con autenticación de servicio X.509</span><span class="sxs-lookup"><span data-stu-id="d9fda-399">6.2.3 Using SymmetricBinding with X.509 Service Authentication</span></span>  
 <span data-ttu-id="d9fda-400">"WSS10" proporcionó compatibilidad limitada para escenarios con tokens de X509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-400">"WSS10" provided limited support for scenarios with X509 tokens.</span></span> <span data-ttu-id="d9fda-401">Por ejemplo, no hubo manera de proporcionar protección de cifrado y firma para los mensajes que solo usan tokens de X509 de servicio.</span><span class="sxs-lookup"><span data-stu-id="d9fda-401">For example, there was no way to provide signature and encryption protection for messages using only service X509 token.</span></span> <span data-ttu-id="d9fda-402">"WSS11" introdujo el uso de EncryptedKey como un token simétrico.</span><span class="sxs-lookup"><span data-stu-id="d9fda-402">"WSS11" introduced the usage of EncryptedKey as a symmetric token.</span></span> <span data-ttu-id="d9fda-403">Ahora una clave temporal cifrada para el certificado X.509 de servicio se podría utilizar para la protección de mensajes de solicitud y respuesta.</span><span class="sxs-lookup"><span data-stu-id="d9fda-403">Now a temporary key encrypted for the service's X.509 certificate could be used for both request and response messages protection.</span></span> <span data-ttu-id="d9fda-404">Los modos de autenticación descritos en la sección 6.4 que se encuentra abajo usan este patrón.</span><span class="sxs-lookup"><span data-stu-id="d9fda-404">The authentication modes described in the section 6.4 below use this pattern.</span></span>  
  
 <span data-ttu-id="d9fda-405">WS-SecurityPolicy describe este patrón utilizando SymmetricBinding con token X509 de servicio como el token de protección.</span><span class="sxs-lookup"><span data-stu-id="d9fda-405">WS-SecurityPolicy describes this pattern using SymmetricBinding with Service X509 token as the protection token.</span></span>  
  
 <span data-ttu-id="d9fda-406">Los modos de autenticación AnonymousForCertificate, UsernameForCertificate, MutualCertificate WSS11 e IssuedTokenForCertificate usan una instancia similar de sp:SymmetricBinding con los siguientes valores de propiedad:</span><span class="sxs-lookup"><span data-stu-id="d9fda-406">Authentication modes AnonymousForCertificate, UsernameForCertificate, MutualCertificate WSS11 and IssuedTokenForCertificate all use a similar instance of sp:SymmetricBinding with the following property values:</span></span>  
  
 <span data-ttu-id="d9fda-407">Token de protección: X509 del servidor certificado, modo de inclusión establecido en .../IncludeToken/Never</span><span class="sxs-lookup"><span data-stu-id="d9fda-407">Protection Token: Server’s X509 Certificate, inclusion mode is set to .../IncludeToken/Never</span></span>  
<span data-ttu-id="d9fda-408">Protección de tokens: False</span><span class="sxs-lookup"><span data-stu-id="d9fda-408">Token Protection: False</span></span>  
  
 <span data-ttu-id="d9fda-409">Encabezado completo y firmas de cuerpo: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-409">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="d9fda-410">Orden de protección: SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="d9fda-410">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="d9fda-411">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-411">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="d9fda-412">Los modos de autenticación anteriores solo difieren en los tokens auxiliares que utilizan.</span><span class="sxs-lookup"><span data-stu-id="d9fda-412">The above authentication modes only differ by the supporting tokens they use.</span></span> <span data-ttu-id="d9fda-413">AnonymousForCertificate no tiene ningún token auxiliar, MutualCertificate WSS 1.1 tiene el certificado X509 de cliente como un token auxiliar de aprobación, UserNameForCertificate tiene un token de nombre de usuario como un token auxiliar firmado e IssuedTokenForCertificate tiene el token emitido como un token auxiliar de aprobación.</span><span class="sxs-lookup"><span data-stu-id="d9fda-413">AnonymousForCertificate does not have any supporting tokens, MutualCertificate WSS 1.1 has the client’s X509 certificate as an endorsing supporting tokens, UserNameForCertificate has a UserName Token as a signed supporting token and IssuedTokenForCertificate has the issued token as an endorsing supporting token.</span></span>  
  
 <span data-ttu-id="d9fda-414">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-414">Policy</span></span>  
  
 <span data-ttu-id="d9fda-415">Enlace simétrico</span><span class="sxs-lookup"><span data-stu-id="d9fda-415">Symmetric Binding</span></span>  
...
#### <a name="624-anonymousforcertificate"></a><span data-ttu-id="d9fda-416">6.2.4 AnonymousForCertificate</span><span class="sxs-lookup"><span data-stu-id="d9fda-416">6.2.4 AnonymousForCertificate</span></span>  
 <span data-ttu-id="d9fda-417">Con este modo de autenticación, el cliente es anónimo y el servicio se autentica utilizando un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-417">With this authentication mode the client is anonymous and the service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-418">El enlace utilizado es una instancia de enlace simétrico tal y como se describe en 6.4.2.</span><span class="sxs-lookup"><span data-stu-id="d9fda-418">The binding used is an instance of symmetric binding as described in 6.4.2.</span></span>  
  
 <span data-ttu-id="d9fda-419">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-419">Policy</span></span>  
  
 <span data-ttu-id="d9fda-420">Vea "Directiva" en 6.2.3 más arriba para obtener detalles sobre enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-420">See "Policy" in 6.2.3 above for binding details</span></span>  
  
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-421">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-421">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-422">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-422">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-423">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-423">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-424">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-424">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-425">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-425">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-426">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-426">Response</span></span>  
...
#### <a name="625-usernameforcertificate"></a><span data-ttu-id="d9fda-427">6.2.5 UserNameForCertificate</span><span class="sxs-lookup"><span data-stu-id="d9fda-427">6.2.5 UserNameForCertificate</span></span>  
 <span data-ttu-id="d9fda-428">Con este modo de autenticación el cliente se autentica en el servicio utilizando un token de nombre de usuario que aparece en la capa SOAP como un token auxiliar firmado.</span><span class="sxs-lookup"><span data-stu-id="d9fda-428">With this authentication mode the client authenticates to the service using a Username Token which appears at the SOAP layer as a signed supporting token.</span></span> <span data-ttu-id="d9fda-429">El servicio autentica al cliente utilizando un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-429">The service authenticates to the client using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-430">El enlace utilizado es un enlace simétrico donde el token de protección es una clave generada por el cliente, cifrada con la clave pública del servicio.</span><span class="sxs-lookup"><span data-stu-id="d9fda-430">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="d9fda-431">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-431">Policy</span></span>  
  
 <span data-ttu-id="d9fda-432">Vea "Directiva" en 6.2.3 más arriba para obtener detalles sobre enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-432">See "Policy" in 6.2.3 above for binding details</span></span>  
  
 <span data-ttu-id="d9fda-433">Token auxiliar firmado</span><span class="sxs-lookup"><span data-stu-id="d9fda-433">Signed Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-434">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-434">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-435">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-435">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-436">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-436">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-437">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-437">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-438">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-438">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-439">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-439">Response</span></span>  
...
#### <a name="626-mutualcertificate-wss-11"></a><span data-ttu-id="d9fda-440">6.2.6 MutualCertificate (WSS 1.1)</span><span class="sxs-lookup"><span data-stu-id="d9fda-440">6.2.6 MutualCertificate (WSS 1.1)</span></span>  
 <span data-ttu-id="d9fda-441">Con este modo de autenticación el cliente se autentica mediante un certificado X.509 que aparece en la capa SOAP como el token auxiliar de aprobación.</span><span class="sxs-lookup"><span data-stu-id="d9fda-441">With this authentication mode the client authenticates using an X.509 certificate which appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="d9fda-442">La autenticación del servicio también se realiza mediante un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-442">The service is also authenticated using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-443">El enlace utilizado es un enlace simétrico donde el token de protección es una clave generada por el cliente, cifrada con la clave pública del servicio.</span><span class="sxs-lookup"><span data-stu-id="d9fda-443">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="d9fda-444">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-444">Policy</span></span>  
  
 <span data-ttu-id="d9fda-445">Vea Directiva en 6.2.3 para obtener detalles sobre enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-445">See Policy in 6.2.3 for binding details</span></span>  
  
 <span data-ttu-id="d9fda-446">Aprobar token auxiliar</span><span class="sxs-lookup"><span data-stu-id="d9fda-446">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-447">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-447">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-448">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-448">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-449">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-449">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-450">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-450">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-451">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-451">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-452">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-452">Response</span></span>  
...
#### <a name="627-issuedtokenforcertificate"></a><span data-ttu-id="d9fda-453">6.2.7 IssuedTokenForCertificate</span><span class="sxs-lookup"><span data-stu-id="d9fda-453">6.2.7 IssuedTokenForCertificate</span></span>  
 <span data-ttu-id="d9fda-454">Con este modo de autenticación, el cliente no se autentica al servicio como tal; sino que, en su lugar, presenta un token emitido por un STS y demuestra que conoce una clave compartida.</span><span class="sxs-lookup"><span data-stu-id="d9fda-454">With this authentication mode the client does not authenticate to the service, as such, but instead presents a token issued by a STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="d9fda-455">El token emitido aparece en la capa de SOAP como un token auxiliar de aprobación.</span><span class="sxs-lookup"><span data-stu-id="d9fda-455">The issued token appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="d9fda-456">El servicio autentica al cliente utilizando un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-456">The service authenticates to the client using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-457">El enlace utilizado es un enlace simétrico donde el token de protección es una clave generada por el cliente, cifrada con la clave pública del servicio.</span><span class="sxs-lookup"><span data-stu-id="d9fda-457">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="d9fda-458">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-458">Policy</span></span>  
  
 <span data-ttu-id="d9fda-459">Vea Directiva en 6.2.3 más arriba para obtener detalles sobre enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-459">See Policy in 6.2.3 above for binding details</span></span>  
  
 <span data-ttu-id="d9fda-460">Aprobar token auxiliar</span><span class="sxs-lookup"><span data-stu-id="d9fda-460">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-461">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-461">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-462">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-462">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-463">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-463">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-464">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-464">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-465">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-465">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-466">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-466">Response</span></span>  
...
## <a name="63-kerberos"></a><span data-ttu-id="d9fda-467">6.3 Kerberos</span><span class="sxs-lookup"><span data-stu-id="d9fda-467">6.3 Kerberos</span></span>  
 <span data-ttu-id="d9fda-468">Con este modo de autenticación, el cliente se autentica en el servicio utilizando un tique de Kerberos.</span><span class="sxs-lookup"><span data-stu-id="d9fda-468">With this authentication mode the client authenticates to the service using a Kerberos ticket.</span></span> <span data-ttu-id="d9fda-469">Ese mismo vale también proporciona autenticación del servidor.</span><span class="sxs-lookup"><span data-stu-id="d9fda-469">That same ticket also provides server authentication.</span></span> <span data-ttu-id="d9fda-470">El enlace utilizado es un enlace simétrico con las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="d9fda-470">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="d9fda-471">Token de protección: Vale de Kerberos, modo de inclusión establecido en .../IncludeToken/Once</span><span class="sxs-lookup"><span data-stu-id="d9fda-471">Protection Token: Kerberos Ticket, inclusion mode is set to .../IncludeToken/Once</span></span>  
<span data-ttu-id="d9fda-472">Protección de tokens: False</span><span class="sxs-lookup"><span data-stu-id="d9fda-472">Token Protection: False</span></span>  
  
 <span data-ttu-id="d9fda-473">Encabezado completo y firmas de cuerpo: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-473">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="d9fda-474">Orden de protección: SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="d9fda-474">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="d9fda-475">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-475">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="d9fda-476">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-476">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-477">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-477">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-478">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-478">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-479">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-479">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-480">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-480">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-481">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-481">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-482">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-482">Response</span></span>  
...
#### <a name="64-issuedtoken"></a><span data-ttu-id="d9fda-483">6.4 IssuedToken</span><span class="sxs-lookup"><span data-stu-id="d9fda-483">6.4 IssuedToken</span></span>  
 <span data-ttu-id="d9fda-484">Con este modo de autenticación, el cliente no se autentica en el servicio como tal; sino que, en su lugar, presenta un token emitido por un STS y demuestra que conoce una clave compartida.</span><span class="sxs-lookup"><span data-stu-id="d9fda-484">With this authentication mode the client does not authenticate to the service, as such, rather the client presents a token issued by an STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="d9fda-485">El servicio no se autentica al cliente como tal, sino que, en su lugar, el STS cifra la clave compartida como parte del token emitido, de manera que solo el servicio puede descifrar la clave.</span><span class="sxs-lookup"><span data-stu-id="d9fda-485">The service is not authenticated to the client, as such, instead the STS encrypts the shared key as part of the issued token such that only the service can decrypt the key.</span></span> <span data-ttu-id="d9fda-486">El enlace utilizado es un enlace simétrico con las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="d9fda-486">The binding used is as symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="d9fda-487">Token de protección: Token emitido, modo de inclusión establecido en .../IncludeToken/AlwaysToRecipient</span><span class="sxs-lookup"><span data-stu-id="d9fda-487">Protection Token: Issued Token, inclusion mode is set to .../IncludeToken/AlwaysToRecipient</span></span>  
<span data-ttu-id="d9fda-488">Protección de tokens: False</span><span class="sxs-lookup"><span data-stu-id="d9fda-488">Token Protection: False</span></span>  
  
 <span data-ttu-id="d9fda-489">Encabezado completo y firmas de cuerpo: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-489">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="d9fda-490">Orden de protección: SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="d9fda-490">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="d9fda-491">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-491">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="d9fda-492">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-492">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-493">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-493">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-494">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-494">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-495">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-495">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-496">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-496">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-497">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-497">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-498">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-498">Response</span></span>  
...
### <a name="65-using-sslnegotiated-for-service-authentication"></a><span data-ttu-id="d9fda-499">6.5 Uso de SslNegotiated para la autenticación de servicio</span><span class="sxs-lookup"><span data-stu-id="d9fda-499">6.5 Using SslNegotiated for Service Authentication</span></span>  
 <span data-ttu-id="d9fda-500">En esta sección se describe un grupo de modos de autenticación que utilizan un enlace simétrico donde el token de protección es un token de contexto de seguridad por WS-SecureConversation (WS SC), cuyo valor de clave se negocia ejecutando el protocolo TLS sobre mensajes de RST/RSTR de WS-Trust (WS-T).</span><span class="sxs-lookup"><span data-stu-id="d9fda-500">This section describes a group of authentication modes that use a symmetric binding with the protection token being a Security Context Token per WS-SecureConversation (WS-SC) whose key value is negotiated by executing the TLS protocol over WS-Trust (WS-T) RST/RSTR messages.</span></span> <span data-ttu-id="d9fda-501">En TLSNEGO se describen los detalles de la implementación del protocolo de enlace de TLS mediante WS-Trust.</span><span class="sxs-lookup"><span data-stu-id="d9fda-501">Details of the TLS handshake implementation using WS-Trust are described in TLSNEGO.</span></span> <span data-ttu-id="d9fda-502">Aquí en los ejemplos de mensajes supondremos que SCT con un contexto de seguridad asociado ya se establece a través de un protocolo de enlace.</span><span class="sxs-lookup"><span data-stu-id="d9fda-502">Here in the message examples we will assume that SCT with an associated security context is already established through a handshake.</span></span>  
  
 <span data-ttu-id="d9fda-503">El enlace utilizado es un enlace simétrico con las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="d9fda-503">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="d9fda-504">Token de protección: SslContextToken, modo de inclusión establecido en .../IncludeToken/Never</span><span class="sxs-lookup"><span data-stu-id="d9fda-504">Protection Token: SslContextToken, inclusion mode is set to .../IncludeToken/Never</span></span>  
<span data-ttu-id="d9fda-505">Protección de tokens: False</span><span class="sxs-lookup"><span data-stu-id="d9fda-505">Token Protection: False</span></span>  
  
 <span data-ttu-id="d9fda-506">Encabezado completo y firmas de cuerpo: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-506">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="d9fda-507">Orden de protección: SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="d9fda-507">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="d9fda-508">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-508">Encrypt Signature: True</span></span>  
  
#### <a name="651-policy-for-sslnegotiated-service-authentication"></a><span data-ttu-id="d9fda-509">6.5.1 Directiva para la autenticación de servicio SslNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-509">6.5.1 Policy for SslNegotiated service authentication</span></span>  
 <span data-ttu-id="d9fda-510">La directiva para todos los modos de autenticación de esta sección es similar y solo difieren en los tokens auxiliares firmados o aprobados empleados.</span><span class="sxs-lookup"><span data-stu-id="d9fda-510">Policy for all authentication modes in this section are similar and differ only by specific signed supporting or endorsing tokens used.</span></span>  
...
#### <a name="652-anonymousforsslnegotiated"></a><span data-ttu-id="d9fda-511">6.5.2 AnonymousForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-511">6.5.2 AnonymousForSslNegotiated</span></span>  
 <span data-ttu-id="d9fda-512">Con este modo de autenticación, el cliente es anónimo y el servicio se autentica utilizando un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-512">With this authentication mode the client is anonymous and the service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-513">El enlace utilizado es una instancia de enlace simétrico tal y como se describe en 6.5.1 más arriba.</span><span class="sxs-lookup"><span data-stu-id="d9fda-513">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="d9fda-514">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-514">Policy</span></span>  
  
 <span data-ttu-id="d9fda-515">Vea Directiva en 6.5.1 más arriba para obtener detalles sobre enlaces.</span><span class="sxs-lookup"><span data-stu-id="d9fda-515">See Policy in 6.5.1 above for binding details.</span></span>  
  
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-516">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-516">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-517">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-517">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-518">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-518">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-519">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-519">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-520">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-520">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-521">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-521">Response</span></span>  
...
#### <a name="653-usernameforsslnegotiated"></a><span data-ttu-id="d9fda-522">6.5.3 UserNameForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-522">6.5.3 UserNameForSslNegotiated</span></span>  
 <span data-ttu-id="d9fda-523">Con este modo de autenticación el cliente se autentica el servicio utilizando un token de nombre de usuario que aparece en la capa SOAP como un token auxiliar firmado.</span><span class="sxs-lookup"><span data-stu-id="d9fda-523">With this authentication mode the client is authenticates using a Username Token which appears at the SOAP layer as a signed supporting token.</span></span> <span data-ttu-id="d9fda-524">La autenticación del servicio se realiza mediante un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-524">The service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-525">El enlace utilizado es una instancia de enlace simétrico tal y como se describe en 6.5.1.</span><span class="sxs-lookup"><span data-stu-id="d9fda-525">The binding used is an instance of symmetric binding as described in 6.5.1.</span></span>  
  
 <span data-ttu-id="d9fda-526">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-526">Policy</span></span>  
  
 <span data-ttu-id="d9fda-527">Vea la sección 6.5.1 anterior para obtener detalles sobre los enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-527">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="d9fda-528">Token auxiliar firmado</span><span class="sxs-lookup"><span data-stu-id="d9fda-528">Signed Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-529">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-529">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-530">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-530">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-531">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-531">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-532">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-532">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-533">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-533">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-534">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-534">Response</span></span>  
...
#### <a name="654-issuedtokenforsslnegotiated"></a><span data-ttu-id="d9fda-535">6.5.4 IssuedTokenForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-535">6.5.4 IssuedTokenForSslNegotiated</span></span>  
 <span data-ttu-id="d9fda-536">Con este modo de autenticación, el cliente no se autentica al servicio como tal; sino que, en su lugar, presenta un token emitido por un STS y demuestra que conoce una clave compartida.</span><span class="sxs-lookup"><span data-stu-id="d9fda-536">With this authentication mode the client does not authenticate to the service, as such, but instead presents a token issued by an STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="d9fda-537">El token emitido aparece en la capa de SOAP como un token auxiliar de aprobación.</span><span class="sxs-lookup"><span data-stu-id="d9fda-537">The issued token appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="d9fda-538">La autenticación del servicio se realiza mediante un certificado X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-538">The service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="d9fda-539">El enlace utilizado es una instancia de enlace simétrico tal y como se describe en 6.5.1 más arriba.</span><span class="sxs-lookup"><span data-stu-id="d9fda-539">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="d9fda-540">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-540">Policy</span></span>  
  
 <span data-ttu-id="d9fda-541">Vea la sección 6.5.1 anterior para obtener detalles sobre los enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-541">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="d9fda-542">Aprobar token auxiliar</span><span class="sxs-lookup"><span data-stu-id="d9fda-542">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-543">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-543">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-544">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-544">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-545">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-545">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-546">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-546">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-547">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-547">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-548">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-548">Response</span></span>  
...
#### <a name="655-mutualsslnegotiated"></a><span data-ttu-id="d9fda-549">6.5.5 MutualSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-549">6.5.5 MutualSslNegotiated</span></span>  
 <span data-ttu-id="d9fda-550">Con este modo de autenticación, el cliente y el servicio autentican utilizando los certificados X.509.</span><span class="sxs-lookup"><span data-stu-id="d9fda-550">With this authentication mode the client and the service authenticate using X.509 certificates.</span></span> <span data-ttu-id="d9fda-551">El enlace utilizado es una instancia de enlace simétrico tal y como se describe en 6.5.1 más arriba.</span><span class="sxs-lookup"><span data-stu-id="d9fda-551">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="d9fda-552">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-552">Policy</span></span>  
  
 <span data-ttu-id="d9fda-553">Vea la sección 6.5.1 anterior para obtener detalles sobre los enlaces</span><span class="sxs-lookup"><span data-stu-id="d9fda-553">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="d9fda-554">Aprobar token auxiliar</span><span class="sxs-lookup"><span data-stu-id="d9fda-554">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-555">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-555">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-556">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-556">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-557">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-557">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-558">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-558">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-559">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-559">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-560">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-560">Response</span></span>  
...
### <a name="66-sspinegotiated"></a><span data-ttu-id="d9fda-561">6.6 SspiNegotiated</span><span class="sxs-lookup"><span data-stu-id="d9fda-561">6.6 SspiNegotiated</span></span>  
 <span data-ttu-id="d9fda-562">Con este modo de autenticación, se usa un protocolo de negociación para realizar la autenticación del cliente y del servidor.</span><span class="sxs-lookup"><span data-stu-id="d9fda-562">With this authentication mode a negotiation protocol is used to perform client and server authentication.</span></span> <span data-ttu-id="d9fda-563">Se utiliza Kerberos si es posible; de lo contrario, se utiliza NTLM.</span><span class="sxs-lookup"><span data-stu-id="d9fda-563">Kerberos is used if possible, otherwise NTLM.</span></span> <span data-ttu-id="d9fda-564">El enlace utilizado es un enlace simétrico con las siguientes propiedades:</span><span class="sxs-lookup"><span data-stu-id="d9fda-564">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="d9fda-565">Token de protección: SpnegoContextToken, modo de inclusión establecido en .../IncludeToken/AlwaysToRecipient</span><span class="sxs-lookup"><span data-stu-id="d9fda-565">Protection Token: SpnegoContextToken, inclusion mode is set to .../IncludeToken/AlwaysToRecipient</span></span>  
<span data-ttu-id="d9fda-566">Protección de tokens: False</span><span class="sxs-lookup"><span data-stu-id="d9fda-566">Token Protection: False</span></span>  
  
 <span data-ttu-id="d9fda-567">Encabezado completo y firmas de cuerpo: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-567">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="d9fda-568">Orden de protección: SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="d9fda-568">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="d9fda-569">Cifrar firma: True</span><span class="sxs-lookup"><span data-stu-id="d9fda-569">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="d9fda-570">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-570">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-571">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-571">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-572">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-572">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-573">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-573">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-574">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-574">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-575">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-575">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-576">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-576">Response</span></span>  
...
### <a name="67-secureconversation"></a><span data-ttu-id="d9fda-577">6.7 SecureConversation</span><span class="sxs-lookup"><span data-stu-id="d9fda-577">6.7 SecureConversation</span></span>  
 <span data-ttu-id="d9fda-578">El enlace utilizado es un enlace simétrico donde el token de protección es un SCT por WS-SecureConversation (WS SC).</span><span class="sxs-lookup"><span data-stu-id="d9fda-578">The binding used is a symmetric binding with the protection token being a SCT per WS-SecureConversation (WS-SC).</span></span> <span data-ttu-id="d9fda-579">El SCT se negocia mediante WS-Trust (WS-Trust) o WS-SecureConversation (WS-SC) según un enlace anidado, que es en sí mismo un enlace simétrico que usa un protocolo de negociación.</span><span class="sxs-lookup"><span data-stu-id="d9fda-579">The SCT is negotiated using WS-Trust (WS-Trust) or WS-SecureConversation (WS-SC) according to a nested binding, which is itself a symmetric binding that uses a negotiation protocol.</span></span> <span data-ttu-id="d9fda-580">El protocolo de negociación utilizará Kerberos para realizar la autenticación de cliente y servidor si es posible.</span><span class="sxs-lookup"><span data-stu-id="d9fda-580">The negotiation protocol will use Kerberos to perform client and server authentication if possible.</span></span> <span data-ttu-id="d9fda-581">Si no se puede utilizar Kerberos, se volverá a NTLM.</span><span class="sxs-lookup"><span data-stu-id="d9fda-581">If Kerberos cannot be used, it will fall back to NTLM.</span></span>  
  
 <span data-ttu-id="d9fda-582">Directiva</span><span class="sxs-lookup"><span data-stu-id="d9fda-582">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="d9fda-583">Ejemplos de encabezado de seguridad: SignBeforeEncrypt, EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="d9fda-583">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="d9fda-584">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-584">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-585">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-585">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="d9fda-586">Ejemplos de encabezado de seguridad: EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="d9fda-586">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="d9fda-587">Request</span><span class="sxs-lookup"><span data-stu-id="d9fda-587">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="d9fda-588">Respuesta</span><span class="sxs-lookup"><span data-stu-id="d9fda-588">Response</span></span>  
