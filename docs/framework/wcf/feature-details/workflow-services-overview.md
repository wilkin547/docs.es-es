---
title: "Informaci&#243;n general de servicios de flujo de trabajo | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Implementar un servicio de flujo de trabajo  
...
## Hospedar un servicio de flujo de trabajo  
...
-   En un servicio Windows administrado.  
 ...
 Para hospedar un servicio de flujo de trabajo en IIS o WAS, coloque el archivo .xamlx que contiene la definición del servicio de flujo de trabajo en un directorio virtual.  Se crea automáticamente un extremo predeterminado \(mediante <xref:System.ServiceModel.BasicHttpBinding>\) [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Configuración simplificada](../../../../docs/framework/wcf/simplified-configuration.md).  También puede colocar un archivo Web.config en el directorio virtual para especificar sus propios extremos.  Si la definición de flujo de trabajo es en un ensamblado, puede colocar un archivo .svc en el directorio virtual y el ensamblado de flujo de trabajo en el directorio App\_Code.  El archivo .svc debe especificar el generador de host de servicio y la clase que implementa el servicio de flujo de trabajo.  En el siguiente ejemplo, se indica cómo especificar el generador de host de servicio y especificar la clase que implementa el servicio de flujo de trabajo.  
