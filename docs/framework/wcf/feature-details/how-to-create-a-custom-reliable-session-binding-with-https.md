...
---
# <a name="how-to-create-a-custom-reliable-session-binding-with-https"></a>Procedimiento Creación de un enlace personalizado de sesión confiable con HTTPS
...
1. Crear un *Web.config* archivo para configurar un punto de conexión para el `CalculatorService` con un enlace personalizado denominado `reliableSessionOverHttps` que utiliza una sesión confiable y el transporte HTTPS.
...
1. El cliente que se genera contiene el `ICalculator` interfaz que define el contrato de servicio que debe cumplir la implementación del cliente.

   [!code-csharp[C_HowTo_CreateReliableSessionHTTPS#1221](../../../../samples/snippets/csharp/VS_Snippets_CFX/c_howto_createreliablesessionhttps/cs/client.cs#1221)]

1. La aplicación de cliente generada también contiene la implementación de `ClientCalculator`. Tenga en cuenta que no se especifica la información de dirección y enlace dentro de la implementación del servicio. No es necesario escribir código para recuperar la información de dirección y el enlace del archivo de configuración.
