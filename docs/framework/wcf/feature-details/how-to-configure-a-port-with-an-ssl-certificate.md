---
title: "C&#243;mo: Configurar un puerto con un certificado SSL | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
1.  En [!INCLUDE[ws2003](../../../../includes/ws2003-md.md)] o [!INCLUDE[wxp](../../../../includes/wxp-md.md)], use la herramienta HttpCfg.exe para ver la configuración de puerto actual, mediante los modificadores **query** y **ssl**, como se muestra en el ejemplo siguiente.  
...
2.  En [!INCLUDE[ws2003](../../../../includes/ws2003-md.md)] o [!INCLUDE[wxp](../../../../includes/wxp-md.md)], use la herramienta HttpCfg.exe con las palabras clave **delete** y **ssl**.  Use el modificador **\-i** para especificar el número `IP`:`port` y el modificador **\-h** para especificar la huella digital.  
