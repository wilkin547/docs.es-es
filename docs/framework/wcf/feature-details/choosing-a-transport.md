...
> [!WARNING]
> Cuando se usa el transporte de canalización con nombre con una reserva de direcciones URL comodín no segura en varios sitios hospedados en IIS, puede producirse el siguiente error: Se produjo un error en el servicio de activación ' NetPipeActivator ' del protocolo ' net. Pipe ' al intentar escuchar el sitio ' 2 ', por lo que el protocolo está deshabilitado para el sitio temporalmente. Vea el mensaje de excepción para obtener más detalles. Dirección URL: WeakWildcard: net. Pipe:/\<nombre del equipo >/Estado: Excepción ConflictingRegistration:  Nombre del proceso: IDENTIFICADOR de proceso de SMSvcHost: 1076\  
