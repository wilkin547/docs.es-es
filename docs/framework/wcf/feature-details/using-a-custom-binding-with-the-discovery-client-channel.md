...
```  
 ...
 Para obtener más información sobre el uso del canal de cliente de detección, consulte Uso del canal de cliente de [detección](../../../../docs/framework/wcf/feature-details/using-the-discovery-client-channel.md).
