...
### <a name="integration-with-existing-security-infrastructures"></a>Integración con infraestructuras de seguridad existentes  
 ...
 Seguridad de WCF se integra con modelos de seguridad de transporte existentes y puede aprovechar la infraestructura existente para los modelos de seguridad de transferencia más recientes en función de seguridad del mensaje SOAP.  
...
### <a name="transfer-security"></a>Seguridad de la transferencia  
 La seguridad de la transferencia abarca tres funciones de seguridad principales: integridad, confidencialidad y autenticación. *Integridad* es la capacidad para detectar si un mensaje ha sido alterado. *Confidencialidad* es la capacidad de mantener un mensaje ilegible para cualquiera que no sea el destinatario previsto; Esto se consigue mediante criptografía. *Autenticación* es la capacidad para comprobar una identidad reivindicada. Juntas, estas tres funciones contribuyen a garantizar que los mensajes llegan de manera segura de un punto a otro.  
