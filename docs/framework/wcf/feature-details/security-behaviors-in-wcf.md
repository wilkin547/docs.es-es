...
### <a name="servicecertificate-element"></a>\<serviceCertificate > elemento  
 ...
 Para obtener más información acerca de cómo utilizar el elemento, consulte [How to: Specify Client Credential Values](../../../../docs/framework/wcf/how-to-specify-client-credential-values.md).  
...
#### <a name="clientcertifictate-element"></a>\<clientCertifictate > elemento  
 Establezca el certificado utilizado para autenticar al cliente con este elemento. Para obtener más información, consulte [How to: Specify Client Credential Values](../../../../docs/framework/wcf/how-to-specify-client-credential-values.md).  
