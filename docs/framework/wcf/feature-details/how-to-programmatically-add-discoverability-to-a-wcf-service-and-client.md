...
1. Abra la solución autohospedar en Visual Studio 2012. El ejemplo se encuentra en el directorio TechnologySamples\Basic\Service\Hosting\SelfHost.  
  
2. Agregue una referencia a `System.ServiceModel.Discovery.dll` al proyecto de servicio. Es posible que vea un mensaje de error que dice "System. ServiceModel.Discovery.dll, o uno de sus dependencias requiere una versión posterior de .NET Framework a la especificada en el proyecto..." Si ve este mensaje, haga clic en el proyecto en el Explorador de soluciones y elija **propiedades**. En el **las propiedades del proyecto** ventana, asegúrese de que el **.NET Framework de destino** es [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)].  
