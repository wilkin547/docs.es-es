...
## <a name="in-this-section"></a>En esta sección  
 [Información general de correlación](../../../../docs/framework/wcf/feature-details/correlation-overview.md)  
 Proporciona información general sobre los tipos de correlación disponibles en [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)].  
  
 [Intercambio de contexto](../../../../docs/framework/wcf/feature-details/context-exchange-correlation.md)  
 Describe la correlación de intercambio de contexto.  
