...
1. *Svcutil.exe* también genera la configuración para el cliente que utiliza el <xref:System.ServiceModel.WSHttpBinding> clase. Asignar nombre al archivo de configuración *App.config* al utilizar Visual Studio.
