...
## <a name="supported-peer-resolvers"></a>Resoluciones del mismo nivel compatibles  
 El canal del mismo nivel admite dos tipos de solucionadores: Protocolo de resolución de nombres de mismo nivel (PNRP) y servicios de resolución personalizados.  
