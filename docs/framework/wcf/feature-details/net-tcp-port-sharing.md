---
title: "Uso compartido de puertos Net.TCP | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "activación de puertos [WCF]"
  - "uso compartido de puertos [WCF]"
...
## Arquitectura de uso compartido de puertos  
 La arquitectura del uso compartido de puertos en [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] tiene tres componentes principales:  
  
-   Un proceso de trabajo: cualquier proceso que se comunica sobre net.tcp:\/\/ utilizando los puertos compartidos.  
  
-   El transporte TCP de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]: implementa el protocolo net.tcp:\/\/.  
...
## Uso del uso compartido de puertos Net.tcp en una aplicación  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] cómo hacerlo, vea [Cómo: Configurar un servicio WCF para utilizar la compartición de puertos](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md).  
...
## Vea también  
 ...
 [Cómo: Configurar un servicio WCF para utilizar la compartición de puertos](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md)   
