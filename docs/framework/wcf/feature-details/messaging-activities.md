...
## <a name="message-formatting-and-messaging-activities"></a>Formato de mensajes y las actividades de mensajería
...
## <a name="messaging-activity-templates"></a>Las plantillas de actividad de mensajería
...
## <a name="messaging-activities-and-transactions"></a>Las transacciones y las actividades de mensajería
