---
title: "Mecanismos de control de acceso | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Puede controlar el acceso de varias maneras con [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].Este tema aborda brevemente los diversos mecanismos y proporciona sugerencias sobre cuándo utilizar cada uno; está destinado a ayudarle a seleccionar el mecanismo correcto a utilizar.Las tecnologías de acceso están listadas por orden de complejidad.La más simple es <xref:System.Security.Permissions.PrincipalPermissionAttribute>; la más compleja es el modelo de identidad.  
 ...
 Además de estos mecanismos, la suplantación y delegación con [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] se explican en [Delegación y suplantación](../../../../docs/framework/wcf/feature-details/delegation-and-impersonation-with-wcf.md).  
...
## PrincipalPermissionAttribute  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] cómo usar el atributo, vea [Cómo restringir el acceso con la clase PrincipalPermissionAttribute](../../../../docs/framework/wcf/how-to-restrict-access-with-the-principalpermissionattribute-class.md).[!INCLUDE[crabout](../../../../includes/crabout-md.md)] la identidad, consulte [Identidad del servicio y autenticación](../../../../docs/framework/wcf/feature-details/service-identity-and-authentication.md).  
...
> [!NOTE]
>  Primero debe rellenar la base de datos utilizando la característica [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] antes de que un servicio [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] pueda utilizarla para los propósitos de la autorización.  
 ...
 Para [!INCLUDE[crabout](../../../../includes/crabout-md.md)] utilizar la característica de pertenencia en un servicio [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], vea [Cómo: Utilizar el proveedor de pertenencia de ASP.NET](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-membership-provider.md).  
...
## Proveedor de funciones ASP.NET  
 ...
 Para [!INCLUDE[crabout](../../../../includes/crabout-md.md)] utilizar la característica de proveedor de funciones, vea [Cómo: Utilizar el proveedor de funciones ASP.NET con un servicio](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-role-provider-with-a-service.md).  
...
## Administrador de autorización  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] AzMan y el proveedor de roles de [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)], vea [Cómo: Usar el Administrador de autorización \(AzMan\) con ASP.NET 2.0](http://go.microsoft.com/fwlink/?LinkId=88951).[!INCLUDE[crabout](../../../../includes/crabout-md.md)] cómo usar AzMan y el proveedor de roles para los servicios de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], vea [Cómo utilizar el proveedor de funciones del administrador de autorización de ASP.NET con un servicio](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-authorization-manager-role-provider-with-a-service.md).  
...
## Modelo de identidad  
 ...
 Un ejemplo donde puede beneficiarse del control de acceso basado en notificaciones del modelo de identidad es al usar credenciales de federación en el escenario de token emitido.[!INCLUDE[crabout](../../../../includes/crabout-md.md)] los tokens de federación y los tokens emitidos, vea [Federación y tokens emitidos](../../../../docs/framework/wcf/feature-details/federation-and-issued-tokens.md).  
  
 Para [!INCLUDE[crabout](../../../../includes/crabout-md.md)] el modelo de identidad, vea [Administración de notificaciones y autorización con el modelo de identidad](../../../../docs/framework/wcf/feature-details/managing-claims-and-authorization-with-the-identity-model.md).  
