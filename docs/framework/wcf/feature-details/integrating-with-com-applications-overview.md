---
title: "Integraci&#243;n con la informaci&#243;n general de las aplicaciones COM | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "COM [WCF], información general de integración"
...
---
# Integraci&#243;n con la informaci&#243;n general de las aplicaciones COM
...
## Parámetros admitidos por el moniker de servicio  
...
|`mexAddress`|Ubicación de la dirección URL del extremo de intercambio de metadatos \(MEX\) del servicio.|  
...
|`mexBindingConfiguration`|Instancia de enlace con nombre desde la que la sección de enlace con nombre se conecta con el extremo MEX.|  
...
|`mexUpnIdentity`|Identidad del nombre principal del usuario \(UPN\) que se va a utilizar para comunicarse con el extremo MEX.|  
|`mexDnsIdentity`|Identidad de DNS que se va a utilizar para comunicarse con el extremo MEX.|  
