...
```  
 ...
 Un <xref:System.ServiceModel.Activities.WorkflowService.DefinitionIdentity%2A> no es necesario, aunque solo una versión del servicio de flujo de trabajo puede tener un **null**<xref:System.ServiceModel.Activities.WorkflowService.DefinitionIdentity%2A>.  
