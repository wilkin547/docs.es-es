---
title: "Servicio de enrutamiento | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Actualmente, el servicio de enrutamiento no permite enrutar servicios de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] REST.  Para enrutar las llamadas a REST, puede usar <xref:System.Web.Routing> o el [Enrutamiento de solicitud de aplicaciones](http://go.microsoft.com/fwlink/?LinkId=164589) \(http:\/\/go.microsoft.com\/fwlink\/?LinkId\=164589\).  
...
-   Configuración dinámica  
 ...
 Para obtener más información sobre los filtros de mensajes y las tablas de filtros, vea [Introducción al enrutamiento](../../../../docs/framework/wcf/feature-details/routing-introduction.md) y [Filtros de mensajes](../../../../docs/framework/wcf/feature-details/message-filters.md).  
...
## Configuración dinámica  
 ...
 Para obtener más información sobre la configuración dinámica del servicio de enrutamiento, vea [Introducción al enrutamiento](../../../../docs/framework/wcf/feature-details/routing-introduction.md).  
...
## Procesamiento de SOAP  
 Un requisito de enrutamiento común es la capacidad de enrutar mensajes entre extremos con diferentes requisitos de SOAP.  Para permitir este requisito, el servicio de enrutamiento proporciona una clase <xref:System.ServiceModel.Routing.SoapProcessingBehavior> que crea automáticamente un nuevo **MessageVersion** que cumple los requisitos del extremo del destino antes de que el mensaje se enrute hacia él.  Este comportamiento también crea un nuevo **MessageVersion** para cualquier mensaje de respuesta antes de devolverlo a la aplicación cliente solicitante, con el fin de asegurarse de que el **MessageVersion** de la respuesta coincide con el de la solicitud original.  
  
 Para obtener más información sobre el procesamiento de SOAP, vea [Introducción al enrutamiento](../../../../docs/framework/wcf/feature-details/routing-introduction.md).  
