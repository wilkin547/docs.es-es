...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe la correspondencia entre las codificaciones de JavaScript Object Notation (JSON) y el conjunto de información XML, que se utiliza internamente por Windows Communication Foundation (WCF) para representar documentos y datos codificados por JSON.  
