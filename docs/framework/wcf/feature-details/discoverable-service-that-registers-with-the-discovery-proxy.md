...
---
# <a name="how-to-implement-a-discoverable-service-that-registers-with-the-discovery-proxy"></a>Filtrar Implementar un servicio reconocible que se registra con el Proxy de detección
