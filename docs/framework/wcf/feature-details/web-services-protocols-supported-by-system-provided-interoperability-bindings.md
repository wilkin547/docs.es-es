...
|Categoría|Protocolo|Especificación y uso|  
|--------------|--------------|-----------------------------|  
|Mensajería|SOAP 1.2|[Primer](http://go.microsoft.com/fwlink/?LinkId=48282)<br /><br /> [Marco de mensajería](http://go.microsoft.com/fwlink/?LinkId=94664)<br /><br /> [Adjuntos (incluido el enlace de HTTP)](http://go.microsoft.com/fwlink/?LinkId=95329)|  
