...
|Transacciones|WS-AtomicTransaction|[WS-AtomicTransaction](http://specs.xmlsoap.org/ws/2004/10/wsat/wsat.pdf)<br /><br /> Se usa para la comunicación entre administradores de transacciones. Los clientes y servicios de WCF siempre usan administradores de transacciones locales.|  
|Transacciones|WS-Coordination|[Coordinación de WS](https://docs.microsoft.com/previous-versions/ms951231(v=msdn.10))<br /><br /> Utilícese para hacer fluir el contexto de transacción cuando el atributo `flowTransactions` se establece en "Allowed" (Permitido) o "Required" (Obligatorio).<br /><br /> `<wsHttpBinding>   <binding transactionFlow="true"/> </wsHttpBinding>`|  
