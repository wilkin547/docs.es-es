...
-   "? x = 2 & x = 3": pares de nombre/valor dentro de una cadena de consulta deben ser únicos, incluso si son literales.  
...
-   /{} -Variables deben tener un nombre.  
...
### <a name="template-equivalence"></a>Equivalencia de plantillas  
 Se dice que dos plantillas *estructuralmente equivalentes* cuando todos los literales de las plantillas coinciden y tienen variables en los mismos segmentos. Por ejemplo, las siguientes plantillas son estructuralmente equivalentes:  
