---
title: "Control de mensajes dudosos | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## <a name="best-practice-handling-msmqpoisonmessageexception"></a>Procedimiento recomendado: Controlar MsmqPoisonMessageException  
 Cuando el servicio determina que un mensaje es dudoso, el transporte en cola arroja un <xref:System.ServiceModel.MsmqPoisonMessageException> que contiene el `LookupId` del mensaje dudoso.  
  
 Puede implementar una aplicación receptora los <xref:System.ServiceModel.Dispatcher.IErrorHandler> interfaz para controlar cualquier error que requiere la aplicación. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Extender el Control sobre la gestión y los informes de errores](../../../../docs/framework/wcf/samples/extending-control-over-error-handling-and-reporting.md).  
  
 La aplicación puede requerir algún tipo de control automatizado de mensajes dudosos que los aparte a una cola específica de manera que el servicio pueda tener acceso al resto de los mensajes de la cola. El único escenario para utilizar el mecanismo de tratamiento de errores para realizar escuchas de mensajes dudosos excepciones es cuando la <xref:System.ServiceModel.Configuration.MsmqBindingElementBase.ReceiveErrorHandling%2A> está configurada en <xref:System.ServiceModel.ReceiveErrorHandling>. El ejemplo de mensaje dudoso para Message Queuing 3.0 demuestra este comportamiento. A continuación se dibujan los pasos a realizar para controlar los mensajes dudosos, incluyendo los procedimientos recomendados:  
...
## <a name="see-also"></a>Vea también  
 ...
 [Especificar y gestionar errores en los contratos y servicios](../../../../docs/framework/wcf/specifying-and-handling-faults-in-contracts-and-services.md)