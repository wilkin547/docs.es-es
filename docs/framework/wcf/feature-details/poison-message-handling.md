...
## <a name="batching-and-poison-messages"></a>Procesamiento por lotes y mensajes dudosos  
 Si un mensaje se vuelve un mensaje dudoso y es parte de un lote, se deshace el lote completo y el canal vuelve a leer un mensaje cada vez. Para obtener más información sobre el procesamiento por lotes, consulte [mensajes por lotes en una transacción](batching-messages-in-a-transaction.md) .  
