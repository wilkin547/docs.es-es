---
title: "Integraci&#243;n en la informaci&#243;n general de las aplicaciones COM+ | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
3.  Use la herramienta de configuración del modelo de servicio COM\+ \(ComSvcConfig.exe\) para agregar un servicio web para la interfaz.  [!INCLUDE[crabout](../../../../includes/crabout-md.md)] cómo usar ComSvcConfig.exe, vea [Cómo: Utilizar la herramienta configuración de modelos de servicio COM\+](../../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md).  
  
4.  Configure las opciones de servicio adicionales en el archivo de configuración de la aplicación.  [!INCLUDE[crabout](../../../../includes/crabout-md.md)] cómo configurar un componente, vea [Cómo configurar los parámetros de los servicios COM\+](../../../../docs/framework/wcf/feature-details/how-to-configure-com-service-settings.md).  
