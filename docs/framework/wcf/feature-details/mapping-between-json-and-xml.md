...
-   La lista [children] no conserva ningún elemento de información personal de información (PI) (la \<? xml... > declaración de no se considera un elemento de información de PI)  
...
-   [en el ámbito de espacios de nombres] contiene el enlace de "xml" a "http://www.w3.org/XML/1998/namespace" como impuestas por la especificación de conjunto de información.  
