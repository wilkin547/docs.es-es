...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe cómo se hospeda un servicio de Windows Communication Foundation (WCF) en Internet Information Services o [Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Describe cómo se hospeda un servicio WCF mediante Windows Process Activation Service.  
 ...
 Describe cómo un servicio WCF se hospeda un servicio de Windows.  
  
 [Hospedaje en una aplicación administrada](../../../../docs/framework/wcf/feature-details/hosting-in-a-managed-application.md)  
 Describe cómo un servicio WCF se hospeda en una aplicación administrada.  
