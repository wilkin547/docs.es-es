...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe cómo se hospeda un servicio de Windows Communication Foundation (WCF) en Internet Information Services o [Windows Server AppFabric](https://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Describe cómo un servicio WCF se hospeda por Windows Process Activation Service.  
