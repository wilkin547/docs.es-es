...
```  
 ...
 Para obtener más información acerca de la correlación de solicitud y respuesta, consulte [solicitud-respuesta](../../../../docs/framework/wcf/feature-details/request-reply-correlation.md).  
...
```  
 ...
 Para obtener más información acerca de la correlación basada en contenido, consulte [basada en contenido](../../../../docs/framework/wcf/feature-details/content-based-correlation.md) y [correlacionado calculadora](../../../../docs/framework/windows-workflow-foundation/samples/correlated-calculator.md) ejemplo.
