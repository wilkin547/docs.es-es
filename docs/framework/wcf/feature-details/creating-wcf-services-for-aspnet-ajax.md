...
-   Agregue un extremo compatible con AJAX a un servicio de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] mediante configuración. Para obtener más información, consulte [Cómo: usar la configuración para agregar un extremo de AJAX de ASP.NET](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md).  
