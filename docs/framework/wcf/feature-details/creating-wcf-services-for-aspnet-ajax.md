...
-   Agregar un extremo con AJAX habilitado a un servicio WCF mediante la configuración. Para obtener más información, consulte [Cómo: utilizar la configuración para agregar un punto de conexión de AJAX de ASP.NET](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md).  
