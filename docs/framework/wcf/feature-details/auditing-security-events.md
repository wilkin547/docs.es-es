---
title: "Auditor&#237;a de eventos de seguridad | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "auditoría de eventos de seguridad [WCF]"
...
|<xref:System.ServiceModel.Description.ServiceSecurityAuditBehavior.SuppressAuditFailure%2A>|Especifica lo que pasa a la solicitud de cliente cuando se produce un error al auditar.Por ejemplo, cuando el servicio intenta escribir en el registro de seguridad, pero no tiene `SeAuditPrivilege`.El valor predeterminado de `true` indica que se pasan por alto los errores, y se procesa la solicitud de cliente como de costumbre.|  
 ...
 Para obtener un ejemplo de configurar una aplicación para que registre los eventos de auditoría, vea [Cómo: Auditar eventos de seguridad.](../../../../docs/framework/wcf/feature-details/how-to-audit-wcf-security-events.md).  
  
### Configuración  
 También puede utilizar la configuración para especificar el comportamiento de auditoría agregando un [\<serviceSecurityAudit\>](../../../../docs/framework/configure-apps/file-schema/wcf/servicesecurityaudit.md) bajo el [\<comportamientos\>](../../../../docs/framework/configure-apps/file-schema/wcf/behaviors.md).Debe agregar como el elemento bajo un [\<comportamiento\>](../../../../docs/framework/configure-apps/file-schema/wcf/behavior-of-endpointbehaviors.md) como se muestra en el código siguiente.  
...
|-------------|------------------------------|---------------------------|  
|[!INCLUDE[wxpsp2](../../../../includes/wxpsp2-md.md)] o posterior|Compatible|No compatible|  
