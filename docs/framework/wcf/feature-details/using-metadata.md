...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Generar a un cliente de WCF de metadatos de servicio](../../../../docs/framework/wcf/feature-details/generating-a-wcf-client-from-service-metadata.md)  
 Muestra cómo recuperar metadatos mediante Svcutil.exe y generar un cliente [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
