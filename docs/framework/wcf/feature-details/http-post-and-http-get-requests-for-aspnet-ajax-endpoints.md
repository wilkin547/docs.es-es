...
---
# <a name="how-to-choose-between-http-post-and-http-get-requests-for-aspnet-ajax-endpoints"></a>Procedimiento Elija entre HTTP POST y HTTP GET solicitudes para puntos de conexión de AJAX de ASP.NET
