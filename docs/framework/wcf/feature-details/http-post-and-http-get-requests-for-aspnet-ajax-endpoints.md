...
---
# <a name="how-to-choose-between-http-post-and-http-get-requests-for-aspnet-ajax-endpoints"></a>Filtrar para elegir entre solicitudes HTTP POST y HTTP GET para puntos de conexión AJAX de ASP.NET
