...
|<xref:System.IdentityModel.Policy.IAuthorizationComponent>|Una interfaz que proporciona una propiedad de cadena de solo lectura: Id. El valor de esta propiedad es único para cada instancia en el sistema que implementa esta interfaz.|  
...
|<xref:System.IdentityModel.Policy.IAuthorizationPolicy>|Una interfaz derivada de `IAuthorizationComponent` e implementada por clases de directivas de autorización.|  
