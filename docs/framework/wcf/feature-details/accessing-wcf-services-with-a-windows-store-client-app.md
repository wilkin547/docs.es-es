...
## <a name="see-also"></a>Vea también  
 [WCF en el Blog de aplicaciones de la tienda Windows](http://blogs.msdn.com/b/piyushjo/archive/2011/09/22/wcf-in-win8-metro-styled-apps-absolutely-supported.aspx)  
