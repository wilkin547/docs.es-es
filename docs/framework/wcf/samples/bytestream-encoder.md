...
2.  Inicie una nueva instancia del proyecto ByteStreamHttpBindingServer haciendo clic en el proyecto en el Explorador de soluciones y seleccionar **depurar**y, a continuación, **Iniciar nueva instancia** en el menú contextual.  
  
3.  Inicie una nueva instancia del proyecto ByteStreamHttpBindingClient haciendo clic en el proyecto en el Explorador de soluciones y seleccionar **depurar**, **Iniciar nueva instancia** en el menú contextual.
