...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo crear WCF y perfil de seguro confiable (RSP).  
 ...
 Muestra cómo limitar la cantidad de memoria utilizada para almacenar en búfer los mensajes grandes enviados con WCF.
