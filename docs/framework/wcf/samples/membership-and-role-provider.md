...
- <span data-ttu-id="b09eb-170">Crear el certificado de servidor.</span><span class="sxs-lookup"><span data-stu-id="b09eb-170">Creating the server certificate.</span></span>  
