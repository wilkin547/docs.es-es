---
title: "Seguridad de mensaje an&#243;nima | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 Las credenciales que se van a utilizar para la autenticación del servicio se especifican en [\<comportamiento\>](../../../../docs/framework/configure-apps/file-schema/wcf/behavior-of-endpointbehaviors.md).  El certificado de servidor debe contener el mismo valor para `SubjectName` que el valor especificado para el atributo `findValue` como se muestra en el código muestra siguiente.  
...
3.  Compruebe el acceso al servicio en un explorador utilizando la dirección http:\/\/localhost\/servicemodelsamples\/service.svc.  
