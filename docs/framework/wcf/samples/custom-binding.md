...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo escribir código imperativo para definir y utilizar los enlaces personalizados sin utilizar un archivo de configuración o un cliente generado por [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
