...
ms.locfileid: "70044740"
---
# <a name="service-debug-behavior"></a>Comportamiento de depuración de servicio

Este ejemplo muestra cómo se pueden configurar los valores del comportamiento de servicio de depuración. El ejemplo se basa en el [Introducción](../../../../docs/framework/wcf/samples/getting-started-sample.md), que implementa el contrato `ICalculator` de servicio. Este ejemplo define explícitamente el comportamiento de depuración de servicio en el archivo de configuración. También se puede hacer de forma imperiosa en el código.
...
serviceDebug > es el elemento de configuración que permite cambiar las propiedades de comportamiento de depuración del servicio. [ \<](../../../../docs/framework/configure-apps/file-schema/wcf/servicedebug.md) El usuario puede modificar este comportamiento para lograr lo siguiente:
