...
```  
 ...
 Para tener acceso a los metadatos del servicio mediante HTTP GET, apunte `http://localhost/servicemodelsamples/service.svc?wsdl`el explorador a.  
