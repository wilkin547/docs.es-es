...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Proveedor de tokens](../../../../docs/framework/wcf/samples/token-provider.md)  
 Muestra cómo implementar un proveedor de tokens personalizado.  
  
 [Validador de contraseña de nombre de usuario](../../../../docs/framework/wcf/samples/user-name-password-validator.md)  
 ...
 Muestra cómo agregar una implementación de token personalizada en una aplicación de Windows Communication Foundation (WCF).  
