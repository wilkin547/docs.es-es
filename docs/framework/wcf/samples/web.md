...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo implementar un servicio basado en HTTP, basado en RPC suele hacer referencia como "POX" (Plain Old XML) servicio, utilizando el [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] modelo de programación Web HTTP.  
