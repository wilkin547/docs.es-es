...
4. Mientras se ejecuta la aplicación de consola, vaya `http://localhost:8000/diagnostics/feed/?format=atom` a `http://localhost:8000/diagnostics/feed/?format=rss` o use un explorador compatible con RSS.  
