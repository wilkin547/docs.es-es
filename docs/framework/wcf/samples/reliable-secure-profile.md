...
1.  Abra el **ReliableSecureProfile** solución.  
  
2.  Haga clic en el **servicio** proyecto **el Explorador de soluciones**, seleccione **depurar**, **Iniciar nueva instancia** en el menú contextual. De esta forma se inicia el host de servicio.  
  
3.  Haga clic en el **cliente** proyecto **el Explorador de soluciones**, seleccione **depurar**, **Iniciar nueva instancia** en el menú contextual. De esta forma se inicia el cliente.  
