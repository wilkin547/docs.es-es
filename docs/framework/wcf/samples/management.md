...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo agregar sus propios eventos de seguimiento en la secuencia de los seguimientos analíticos que WCF escribe en ETW en [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)].  
 ...
 Muestra cómo extender la característica de seguimiento de WCF escribiendo las trazas de la actividad definida por el usuario en el código de cliente y el servicio.  
 ...
 Se muestra cómo obtener acceso a los contadores de rendimiento de WCF y cómo crear contadores de rendimiento definidos por el usuario.  
 ...
 Muestra cómo recopilar datos de servicios WCF en tiempo de ejecución mediante el proveedor de Instrumental de administración de Windows (WMI) que está integrado en WCF.
