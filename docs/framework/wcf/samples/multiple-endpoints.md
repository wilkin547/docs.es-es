---
title: "Varios extremos | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Varios extremos
El ejemplo de los extremos varios muestra cómo configurar varios extremos en un servicio y cómo comunicar con cada extremo de un cliente.Este ejemplo se basa en el [Introducción:](../../../../docs/framework/wcf/samples/getting-started-sample.md).La configuración de servicio se ha modificado para definir dos extremos que admiten el contrato `ICalculator`, pero cada uno en una dirección diferente utilizando un enlace diferente.La configuración y el código del cliente se han modificado para comunicarse con ambos de los extremos del servicio.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WCF\Basic\Services\MultipleEndpoints`  
