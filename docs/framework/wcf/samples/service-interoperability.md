...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo utilizar el moniker de servicio WCF para integrar los servicios Web en entornos de desarrollo basado en COM, como Microsoft Office Visual Basic para aplicaciones (Office VBA) o Visual Basic 6.0.  
