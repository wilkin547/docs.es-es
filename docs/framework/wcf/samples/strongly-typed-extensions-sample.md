...
```  
 ...
 El `<in-reply-to>` elemento especifica tres atributos necesarios (`ref`, `type` y `href`) mientras que permite también la presencia de atributos de extensión adicionales y elementos de extensión.  
