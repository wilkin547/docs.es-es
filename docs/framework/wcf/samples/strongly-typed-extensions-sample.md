---
title: "Ejemplo de extensiones fuertemente tipadas | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
El ejemplo utiliza la clase <xref:System.ServiceModel.Syndication.SyndicationFeed> para los fines del ejemplo.Sin embargo, los modelos mostrados en este ejemplo se pueden utilizar con todas las clases de distribución que admiten los datos de la extensión:  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WCF\Extensibility\Syndication\StronglyTypedExtensions`  
