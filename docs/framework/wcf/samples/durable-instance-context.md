---
title: "Contexto de instancia duradera | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Contexto de instancia duradera
...
```  
 ...
 Estas implementaciones del canal se agregan apropiadamente a continuación al tiempo de ejecución del canal [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] por la clase `DurableInstanceContextBindingElement` y la clase `DurableInstanceContextBindingElementSection`.Vea la documentación de ejemplo del canal [HttpCookieSession](../../../../docs/framework/wcf/samples/httpcookiesession.md) para obtener más detalles sobre los elementos de enlace y secciones de elemento de enlace.  
  
## Extensiones de la capa de modelo de servicio  
...
```  
 ...
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] permite que se extienda su componente en tiempo de ejecución InstanceContext agregando un nuevo estado y comportamiento utilizando su modelo de objeto extensible.El modelo de objeto extensible se utiliza en [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] para extender clases de tiempo de ejecución existentes con nueva funcionalidad o agregar nuevas características del estado a un objeto.Hay tres interfaces en el modelo de objeto extensible \- IExtensibleObject\<T\>, IExtension\<T\>e IExtensionCollection\<T\>:  
  
-   Objetos que permiten extensiones que personalicen su funcionalidad implementan la interfaz IExtensibleObject\<T\>.  
  
-   Objetos que son extensiones de clases de tipo T. implementan la interfaz IExtension \<T \>.  
  
-   La interfaz IExtensionCollection \<T \>es una colección de IExtensions que permite la recuperación de IExtensions por su tipo.  
...
> [!NOTE]
>  Debe estar ejecutando SQL Server 2005 o SQL Express 2005 para ejecutar este ejemplo.Si está ejecutando SQL Server 2005, debe modificar la configuración de la cadena de conexión del servicio.Al ejecutar un equipo cruzado, SQL Server solo se requiere en el equipo del servidor.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WCF\Extensibility\Instancing\Durable`  
