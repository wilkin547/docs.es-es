...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo especificar un algoritmo estándar o personalizado para proporcionar una implementación criptográfica y ágil en un cliente de WCF y el servicio.
