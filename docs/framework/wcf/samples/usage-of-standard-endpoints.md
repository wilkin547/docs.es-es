...
2. <span data-ttu-id="d71c0-127">Habilite varios proyectos para iniciarse.</span><span class="sxs-lookup"><span data-stu-id="d71c0-127">Enable multiple projects to start up.</span></span>
