---
title: "Utilizar DataContractSerializer y DataContractResolver para proporcionar la funcionalidad de NetDataContractSerializer | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Utilizar DataContractSerializer y DataContractResolver para proporcionar la funcionalidad de NetDataContractSerializer
...
2.  Haga clic con el botón secundario en el archivo de solución y elija **Propiedades**.  
  
3.  En el diálogo **Páginas de propiedades de solución**, en **Propiedades comunes**, **Proyecto de inicio**, seleccione **Proyectos de inicio múltiples**.  
  
4.  Junto al proyecto **DCSwithDCR**, seleccione **Iniciar** desde el menú desplegable **Acción**.  
  
5.  Junto al proyecto **NetDCS**, seleccione **Iniciar** desde el menú desplegable **Acción**.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WCF\Basic\Contract\Data\NetDcSasDcSwithDCR`  
