...
Esta sección contiene ejemplos que muestran los servicios de hospedaje de Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra la activación de servicios WCF sin necesidad de un archivo .svc.  
 ...
 Muestra cómo habilitar [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] modo de compatibilidad en WCF.  
