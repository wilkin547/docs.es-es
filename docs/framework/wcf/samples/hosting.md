---
title: "Hospedaje | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Hospedaje
Esta sección contiene ejemplos que muestran los servicios de [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] de hospedaje.  
...
## En esta sección  
 ...
 Muestra la activación de servicios de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] sin requerir un archivo .svc.  
 ...
 Muestra cómo habilitar el modo de compatibilidad [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] en [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
 ...
 Muestra un servicio [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] hospedado en un servicio Windows administrado.  
