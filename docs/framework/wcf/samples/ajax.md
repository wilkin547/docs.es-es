...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo usar WCF para crear un servicio XML (AJAX) y JavaScript asincrónico ASP.NET básico.  
 ...
 Muestra cómo utilizar WCF para crear un servicio ASP.NET JavaScript asincrónico y XML (AJAX) que crea instancias de tipos complejos.  
  
 [Servicio AJAX con JSON y XML](../../../../docs/framework/wcf/samples/ajax-service-with-json-and-xml-sample.md)  
 Muestra cómo usar WCF para crear un servicio JavaScript asincrónico y XML (AJAX) que devuelva datos JavaScript Object Notation (JSON) o XML.
