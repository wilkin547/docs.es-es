...
## <a name="in-this-section"></a>En esta sección  
 ...
 Muestra cómo permitir que los desarrolladores de software de [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] usen objetos JSON arbitrarios y deserializados sin crear tipos definidos por el usuario.  
