...
ms.locfileid: "44085996"
---
# <a name="what39s-new-in-windows-communication-foundation-45"></a>¿Qué&#39;s nuevo de Windows Communication Foundation 4.5
En este tema se describe las características nuevas a Windows Communication Foundation (WCF).  
...
|receiveTimeout|SMSvcHost.exe|30 segundos|[Configuración del servicio de uso compartido de puertos Net.TCP](https://msdn.microsoft.com/library/b6dd81fa-68b7-4e1b-868e-88e5901b7ea0)|  
