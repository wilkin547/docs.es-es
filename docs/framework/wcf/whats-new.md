...
4.  Desechar recursos  
 ...
 Para ayudar a reducir esta sobrecarga, WCF puede almacenar en caché los generadores de canal cuando se usa un proxy de cliente de WCF. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Generador y el almacenamiento en caché de canales](../../../docs/framework/wcf/feature-details/channel-factory-and-caching.md).  
