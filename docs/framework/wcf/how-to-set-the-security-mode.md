...
### <a name="using-transportwithmessagecredential"></a>Uso de TransportWithMessageCredential  
 ...
 Para obtener más información, consulte [Cómo: usar la seguridad de transporte y credenciales de mensaje](../../../docs/framework/wcf/feature-details/how-to-use-transport-security-and-message-credentials.md).  
