...
- <xref:System.ServiceModel.Activation.AspNetCompatibilityRequirementsAttribute>. Se aplica a un servicio WCF para indicar si ese servicio se puede ejecutar en modo de compatibilidad ASP.NET.  
