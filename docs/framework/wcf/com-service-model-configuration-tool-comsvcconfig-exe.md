...
> Debe ser un administrador en el equipo local para utilizar ComSvcConfig.exe.  
 ...
 Para obtener más información acerca de ComSvcConfig. exe [, consulte Cómo: Use la herramienta](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md)de configuración del modelo de servicio com+.  
...
- [Cómo: Usar la herramienta de configuración del modelo de servicio COM+](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md)
