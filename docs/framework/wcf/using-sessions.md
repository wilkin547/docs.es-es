...
- No hay ningún almacén de datos general asociado a una sesión de WCF.  
 ...
 Si está familiarizado con la clase de <xref:System.Web.SessionState.HttpSessionState?displayProperty=nameWithType> de aplicaciones de ASP.NET y la funcionalidad que proporciona, puede observar las siguientes diferencias entre ese tipo de sesión y las sesiones de WCF:  
