...
La sección [\<System. serviceModel >](../configure-apps/file-schema/wcf/system-servicemodel.md) describe los elementos que se usan para configurar los clientes y servicios de Windows Communication Foundation (WCF).
