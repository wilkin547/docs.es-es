...
- Programándolo en su código de cliente (mediante el método `SetCertificate` ).  
 ...
 Agregando una [ \<sección Behaviors >](../../../docs/framework/configure-apps/file-schema/wcf/behaviors.md) del archivo de configuración para el cliente y usando `clientCredentials` el elemento (se muestra a continuación).  
  
#### <a name="setting-a-clientcredentials-value-in-code"></a>Establecer un \<valor de > clientCredentials en el código  
 Para establecer un <xref:System.ServiceModel.ClientBase%601.ClientCredentials%2A> <xref:System.ServiceModel.ClientBase%601> [ \<valor de > clientCredentials](../../../docs/framework/configure-apps/file-schema/wcf/clientcredentials.md) en el código, debe tener acceso a la propiedad de la clase. La propiedad devuelve un objeto <xref:System.ServiceModel.Description.ClientCredentials> que permite el acceso a varios tipos de credenciales, tal y como se muestra en la tabla siguiente.  
...
#### <a name="setting-a-clientcredentials-value-in-configuration"></a>Establecer un \<valor de > clientCredentials en la configuración  
 Los valores de credenciales se especifican utilizando un comportamiento de punto de conexión como elementos secundarios del elemento de [ \<> clientCredentials](../../../docs/framework/configure-apps/file-schema/wcf/clientcredentials.md) . El elemento utilizado depende del tipo de credencial de cliente. Por ejemplo, en el ejemplo siguiente se muestra la configuración para establecer un certificado X. 509 mediante el <[\<clientCertificate >](../../../docs/framework/configure-apps/file-schema/wcf/clientcertificate-of-clientcredentials-element.md).  
...
```  
 ...
 Para establecer la credencial de cliente en la configuración, [ \<](../../../docs/framework/configure-apps/file-schema/wcf/endpointbehaviors.md) agregue un elemento > de endpointBehaviors al archivo de configuración. Además, el elemento `behaviorConfiguration` [ \<de comportamiento agregado se debe vincular al punto de conexión del servicio mediante el atributo del extremo > del elemento > de \<cliente](../configure-apps/file-schema/wcf/endpoint-of-client.md) como se muestra en el ejemplo siguiente. El valor del atributo `behaviorConfiguration` debe coincidir con el valor del atributo `name` del comportamiento.  
...
> Algunos de los valores de credenciales de cliente no se pueden establecer utilizando los archivos de configuración de la aplicación, por ejemplo, el nombre de usuario y la contraseña, o los valores de usuario y contraseña de Windows. Tales valores de credenciales solo se pueden especificarse mediante código.  
 ...
 Para obtener más información acerca de cómo establecer las credenciales del cliente, consulte [cómo: Especifique los valores](../../../docs/framework/wcf/how-to-specify-client-credential-values.md)de credencial de cliente.  
...
- [Cómo: Especificar valores de credencial de cliente](../../../docs/framework/wcf/how-to-specify-client-credential-values.md)
