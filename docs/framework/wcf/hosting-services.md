...
|IIS 5.1, [!INCLUDE[iis601](../../../includes/iis601-md.md)]|: Ejecución de WCF del servicio side-by-side con [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] contenido en Internet mediante el protocolo HTTP.|-Reciclaje de procesos.<br />-Apagado inactivo.<br />-Supervisión del estado de proceso.<br />-Basada en mensajes de activación.<br />-Sólo HTTP.|  
...
|IIS 7.0|: Ejecución de WCF del servicio con [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] contenido.<br />-Ejecutar un servicio WCF en Internet utilizando varios protocolos de transporte.|-ERA ventajas.<br />-Integrada con [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] y el contenido IIS.|  
