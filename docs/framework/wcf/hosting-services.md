...
- [Procedimiento para hospedar un servicio WCF en WAS](./feature-details/how-to-host-a-wcf-service-in-was.md)
- [Procedimiento para hospedar un servicio WCF en un servicio administrado de Windows](./feature-details/how-to-host-a-wcf-service-in-a-managed-windows-service.md)
