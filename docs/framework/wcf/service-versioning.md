---
title: "Control de versiones del servicio | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Cuatro categorías de cambios del servicio  
...
## Orientación del servicio y control de las versiones  
...
### Control estricto de las versiones  
...
### Control de versiones lax  
 ...
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)], servicios Web ASP.NET, y muchas otras pilas de servicio Web admiten *el control lax de versiones*: es decir, no producir las excepciones para los nuevos miembros de datos desconocidos en los datos recibidos.  
 ...
 Para obtener instrucciones detalladas tanto para el control lax como el control estricto de las versiones, consulte [Procedimientos recomendados: Creación de versiones de contratos de datos](../../../docs/framework/wcf/best-practices-data-contract-versioning.md).  
...
## Control de las versiones del contrato de servicios  
...
### Agregar parámetros y operaciones  
...
### Cambiar el parámetro de operación o los tipos de valor devuelto  
...
### Bibliotecas de contratos de servicios  
