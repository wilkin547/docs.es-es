# [Mediante Instrumental de administración de Windows para diagnósticos](index.md)
## [Referencia de clase WMI](wmi-class-reference.md)
...
### [Tracelistenerargument](msmqbindingelementbase.md)
...
### [Operation (clase)](operation-class.md)
