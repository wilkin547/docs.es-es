# [Traza analítica con ETW](index.md)
...
## [Configuración del seguimiento de flujo de mensajes](configuring-message-flow-tracing.md)
## [Referencia de eventos de traza analítica](analytic-trace-event-reference.md)
...
### [605 - a IncrementBusyCount](605-incrementbusycount.md)
### [606 - a DecrementBusyCount](606-decrementbusycount.md)
...
## [Supervisión de errores de operación de servicio](monitoring-service-operation-failures.md)
