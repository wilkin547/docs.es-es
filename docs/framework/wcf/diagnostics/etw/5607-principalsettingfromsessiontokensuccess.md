...
## <a name="description"></a>Descripción  
 Se genera este evento cuando la configuración principal del token de sesión se ha realizado con éxito.  
  
## <a name="message"></a>Mensaje  
 La configuración principal de token de sesión se realizó correctamente.  
