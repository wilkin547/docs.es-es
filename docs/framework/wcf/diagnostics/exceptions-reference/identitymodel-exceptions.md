---
title: "Excepciones de IdentityModel | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|SAMLUnableToLoadAdvice|No se cargó el elemento \<saml:advice\>.|  
...
|SAMLUnableToLoadAssertion|No se pudo cargar el elemento \<saml:assertion\>.|  
...
|SAMLUnableToLoadCondtions|No se pudo cargar el elemento \<saml:conditions\>.|  
...
|SAMLUnableToLoadCondtion|No se pudo cargar el elemento \<saml:conditions\>.|  
...
|TraceCodeSecuritySessionRequestorOperationFailure|Error en la operación de sesión de seguridad de cliente.|  
...
|IncorrectUserNameFormat|El formato del nombre de usuario no es válido.El formato del nombre de usuario debe estar en el formato "nombre de usuario' o ‘dominio\\\\nombredeusuario’.|  
