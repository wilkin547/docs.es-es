...
La instancia de servicio se liberó al completarse la transacción '{0}' porque el ReleaseServiceInstanceOnTransactionComplete ServiceBehaviorAttribute se estableció en true.  
