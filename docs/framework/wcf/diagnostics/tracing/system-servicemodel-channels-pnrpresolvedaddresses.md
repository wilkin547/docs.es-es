...
Pnrp Resolver completó una operación de resolución.  
  
## <a name="description"></a>Descripción  
 Este seguimiento de advertencia indica que la Pnrp Resolver no pudo encontrar ninguna dirección. Este seguimiento se produce durante una operación de resolución realizada por PNRP Resolver.  
