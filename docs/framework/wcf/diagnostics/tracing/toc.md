...
## [Configuración del seguimiento](configuring-tracing.md)
## [Seguimiento to-End](end-to-end-tracing.md)
### [Actividad](activity.md)
### [Transferencia](transfer.md)
### [Propagación](propagation.md)
### [Resumen de tipos de seguimiento](trace-type-summary.md)
## [Uso del seguimiento para solucionar problemas de la aplicación](using-tracing-to-troubleshoot-your-application.md)
...
### [Escenarios de seguimiento de extremo a extremo](end-to-end-tracing-scenarios.md)
#### [Lista de actividades](activity-list.md)
#### [Propagación de Id. de actividad.](activity-id-propagation.md)
#### [Escenarios sincrónicos utilizando HTTP, TCP o canalizaciones con nombre](synchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Escenarios asincrónicos utiliza HTTP, TCP o canalizaciones con nombre](asynchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Seguimiento de la actividad en la seguridad de mensaje](activity-tracing-in-message-security.md)
#### [MSMQ](msmq.md)
#### [COM +](com.md)
### [Seguimientos significativos](significant-traces.md)
### [Depuración en el cliente](debugging-on-the-client.md)
### [Emisión de trazas del código de usuario](emitting-user-code-traces.md)
## [Configuración recomendada para el seguimiento y registro de mensajes](recommended-settings-for-tracing-and-message-logging.md)
## [Cuestiones de seguridad y sugerencias útiles para el seguimiento](security-concerns-and-useful-tips-for-tracing.md)
## [Referencia de seguimientos](traces-reference.md)
