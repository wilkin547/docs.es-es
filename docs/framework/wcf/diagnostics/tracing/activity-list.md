...
En este tema se enumera todas las actividades definidas por Windows Communication Foundation (WCF).  
  
> [!NOTE]
>  También puede definir las actividades mediante programación para agrupar los seguimientos del usuario. Para obtener más información, consulte [emisión de trazas del código de usuario](../../../../../docs/framework/wcf/diagnostics/tracing/emitting-user-code-traces.md).  
