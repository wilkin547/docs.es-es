...
## <a name="description"></a>Descripción  
 Se recibió un mensaje de respuesta, pero no hay ninguna solicitud pendiente esperando a este mensaje. El mensaje se está quitando mediante el tiempo de ejecución de Windows Communication Foundation (WCF).  
