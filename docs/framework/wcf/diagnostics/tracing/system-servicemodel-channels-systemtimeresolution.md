...
## <a name="description"></a>Descripción  
 Se detectó la resolución del temporizador del sistema operativo como *n* tics, lo que es aproximadamente *m* milisegundos. Donde *n* y *m* son valores numéricos.  
