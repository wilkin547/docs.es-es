...
Se creó recientemente la transacción especificada para la operación especificada.  
  
## <a name="description"></a>Descripción  
 Seguido si la transacción puesta a disposición del código de usuario fue creada recientemente por la infraestructura.  
