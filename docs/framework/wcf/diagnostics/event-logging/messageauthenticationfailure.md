...
## <a name="description"></a>Descripción  
 Este evento indica que se produce un error en la autenticación de mensajes. El evento hace una lista del servicio, acción, identidad del cliente e id. de actividad.  
