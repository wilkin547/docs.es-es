...
## <a name="description"></a>Descripción  
 Este evento indica que no se pudo validar un certificado de identidad con la huella digital especificada. El evento enumera el nombre y el id. de proceso.  
