...
## <a name="description"></a>Descripción  
 Este evento indica que una aserción invariable es falsa. El evento enumera el mensaje, el nombre del proceso y el identificador del proceso.  
