...
## <a name="types-of-performance-counters"></a>Tipos de contadores de rendimiento  
 Contadores de rendimiento se limitan a tres niveles diferentes: Servicio, extremo y operación.  
