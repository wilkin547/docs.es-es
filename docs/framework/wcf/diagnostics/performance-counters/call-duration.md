...
ms.locfileid: "33472858"
---
# <a name="call-duration"></a>Duración de la llamada
...
> [!WARNING]
>  Cuando se utiliza en un servicio WCF asincrónico, el contador de duración de la llamada siempre devuelve -1.  
