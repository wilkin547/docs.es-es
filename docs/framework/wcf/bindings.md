...
## <a name="in-this-section"></a>En esta sección  
 ...
 Una lista de enlaces incluida con [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]. Estos enlaces cubren la mayoría de requisitos de patrones de seguridad y mensajes.  
