...
> [!IMPORTANT]
>  Consulte "Uso de XML de forma segura" en [consideraciones de seguridad para datos](../../../docs/framework/wcf/feature-details/security-considerations-for-data.md) para obtener más información acerca de cómo proteger los datos.  
