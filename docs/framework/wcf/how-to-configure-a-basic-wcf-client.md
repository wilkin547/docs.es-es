...
---
# <a name="how-to-configure-a-basic-windows-communication-foundation-client"></a>Filtrar Configurar a un cliente básico de Windows Communication Foundation
