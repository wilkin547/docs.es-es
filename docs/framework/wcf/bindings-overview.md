...
-   <xref:System.ServiceModel.NetMsmqBinding>: Utiliza el [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] para crear conexiones de mensajes en cola con otros extremos WCF.  
  
 Para obtener una lista completa, con descripciones de todos los enlaces proporcionados por WCF, vea [enlaces proporcionados](../../../docs/framework/wcf/system-provided-bindings.md).  
