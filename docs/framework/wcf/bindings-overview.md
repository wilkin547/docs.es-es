---
title: "Informaci&#243;n general de enlaces de Windows Communication Foundation | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "enlaces [WCF], información general"
...
-   <xref:System.ServiceModel.NetMsmqBinding>: Utiliza [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] para crear las conexiones de mensajes en cola con otros extremos [!INCLUDE[indigo2](../../../includes/indigo2-md.md)].  
 ...
 Para obtener una lista completa de todos los enlaces proporcionados por el sistema [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] con descripciones, consulte [Enlaces proporcionados por el sistema](../../../docs/framework/wcf/system-provided-bindings.md).  
  
## Utilizar sus propios enlaces  
 Si ninguno de los enlaces proporcionados por el sistema incluidos tiene la combinación correcta de características que requiere una aplicación de servicio, puede crear su propio enlace.  Existen dos formas de lograr esto.  Puede crear un nuevo enlace a partir de elementos de enlace ya existentes mediante un objeto <xref:System.ServiceModel.Channels.CustomBinding> o puede crear un enlace completamente definido por el usuario derivando del enlace <xref:System.ServiceModel.Channels.Binding>.  [!INCLUDE[crabout](../../../includes/crabout-md.md)] cómo crear su propio enlace mediante estos dos enfoques, vea [Enlaces personalizados](../../../docs/framework/wcf/extending/custom-bindings.md) y [Creación de enlaces definidos por el usuario](../../../docs/framework/wcf/extending/creating-user-defined-bindings.md).  
