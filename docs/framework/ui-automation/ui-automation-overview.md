...
|-------------|--------------------|--------------|  
|[Aspectos básicos](../../../docs/framework/ui-automation/index.md) de la automatización de la interfaz de usuario (esta sección)|Amplias introducciones a los conceptos.|Todos.|  
