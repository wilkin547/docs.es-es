...
ms.locfileid: "76789438"
---
# <a name="ui-automation-support-for-the-menuitem-control-type"></a>Compatibilidad de la automatización de la interfaz de usuario para el tipo de control MenuItem
...
|La propiedad|{2&gt;Value&lt;2}|Descripción|
|--------------|-----------|-----------------|
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|Verdadero|El control de elemento de menú nunca se incluye en la vista de contenido del árbol [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] .|
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|Verdadero|El control de elemento de menú se debe incluir siempre en la vista de control del árbol [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] .|
...
|Propiedad de patrón de control|Compatibilidad con|Notas|
|------------------------------|-------------|-----------|
...
|Event|Compatibilidad con|Explicación|
|-----------|-------------|-----------------|
