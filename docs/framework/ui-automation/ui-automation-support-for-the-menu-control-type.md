...
|------------------|------------------|  
|Menú<br /><br /> - MenuItem (1 o muchos)|No aplicable (a menos que el control de menú sea un menú contextual que sea un elemento primario de un objeto que no sea un elemento de menú)<br /><br /> - MenuItem (1 o muchos)|  
