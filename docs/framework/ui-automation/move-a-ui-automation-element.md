...
## Ejemplo  
 En el ejemplo siguiente se usa los patrones de control <xref:System.Windows.Automation.WindowPattern> y <xref:System.Windows.Automation.TransformPattern> para mover mediante programación una aplicación de destino [!INCLUDE[TLA#tla_win32](../../../includes/tlasharptla-win32-md.md)] a ubicaciones discretas de pantalla y realizar un seguimiento de <xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> <xref:System.Windows.Automation.AutomationElement.AutomationPropertyChangedEvent>.  
...
## Vea también  
 [WindowPattern Sample](http://msdn.microsoft.com/es-es/598b695c-8baf-406e-bbfb-2a1c7842a1de)