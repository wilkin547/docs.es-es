...
|||  
|-|-|  
|Agregue las referencias de automatización de interfaz de usuario.|Aquí se muestran las dll [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] necesarias para los clientes de automatización de la interfaz de usuario.<br /><br /> -   UIAutomationClient.dll ofrece acceso a las API de lado de cliente [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)].<br />-   UIAutomationClientSideProvider.dll ofrece la capacidad de automatizar controles [!INCLUDE[TLA2#tla_win32](../../../includes/tla2sharptla-win32-md.md)]. Vea [UI Automation Support for Standard Controls](../../../docs/framework/ui-automation/ui-automation-support-for-standard-controls.md).<br />-   UIAutomationTypes.dll ofrece acceso a los tipos específicos definidos en [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)].|  
...
|Busque controles de interés|Los scripts de pruebas automatizadas localizan elementos de automatización de la interfaz de usuario que representan controles de interés dentro del árbol de automatización.<br /><br /> Hay varias maneras de obtener elementos de automatización de interfaz de usuario con código.<br /><br /> -   Consulta el [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)] mediante una instrucción <xref:System.Windows.Automation.Condition>. Normalmente es donde se usa <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> independiente del lenguaje. **Note:**  Un <xref:System.Windows.Automation.AutomationElement.AutomationIdProperty> se puede obtener mediante una herramienta como Inspect.exe que es capaz de detallar las propiedades [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] de un control. <br /><br /> -   Use la clase <xref:System.Windows.Automation.TreeWalker> para recorrer todo el árbol [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] o un subconjunto de los mismos.<br />-   Realice un seguimiento del enfoque.<br />-   Use el hWnd del control.<br />-   Utilice la ubicación de la pantalla, como la ubicación del cursor del mouse.<br /><br /> Vea [Obtaining UI Automation Elements](../../../docs/framework/ui-automation/obtaining-ui-automation-elements.md)|  
...
-   Inspect.exe es una aplicación [!INCLUDE[TLA#tla_gui](../../../includes/tlasharptla-gui-md.md)] que se puede usar para recopilar información [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] para la depuración y el desarrollo del proveedor y el cliente.Inspect.exe se incluye en [!INCLUDE[TLA#tla_winfxsdk](../../../includes/tlasharptla-winfxsdk-md.md)].  
