...
-   Inspect.exe es un [!INCLUDE[TLA#tla_gui](../../../includes/tlasharptla-gui-md.md)] aplicación que puede usar para recopilar [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] información de proveedor y el cliente de desarrollo y depuración. Inspect.exe se incluye en el [!INCLUDE[TLA#tla_winfxsdk](../../../includes/tlasharptla-winfxsdk-md.md)].  
