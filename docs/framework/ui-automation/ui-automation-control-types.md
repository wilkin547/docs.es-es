...
Esta sección contiene información sobre la compatibilidad con los tipos [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)]de control en.
