...
## <a name="pane-control-type-example"></a>Ejemplo de tipo de control de panel  
 ...
 ![Captura de pantalla de la ventana de applet con dos paneles](../../../docs/framework/ui-automation/media/uiauto-pane.GIF "uiauto_pane")  
