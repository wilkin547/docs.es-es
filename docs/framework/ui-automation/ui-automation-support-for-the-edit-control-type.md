...
## Patrones de control de automatización de interfaz de usuario necesarios  
...
|<xref:System.Windows.Automation.Provider.IValueProvider.Value%2A>|Vea las notas.|Esta propiedad devolverá el contenido textual del control de edición. Si la `IsPasswordProperty` se establece en `true`, esta propiedad debe provocar una `InvalidOpertaionException` cuando se solicite.|  
