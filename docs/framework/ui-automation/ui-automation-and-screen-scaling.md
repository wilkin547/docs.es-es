...
> [!CAUTION]
>  No use <xref:System.Windows.Forms.Cursor.Position%2A?displayProperty=fullName>. El comportamiento de esta propiedad fuera de las ventanas de cliente en un entorno de escala es indefinido.  
...
## Vea también  
 [Highlighter Sample](http://msdn.microsoft.com/es-es/19ba4577-753e-4efd-92cc-c02ee67c1b69)