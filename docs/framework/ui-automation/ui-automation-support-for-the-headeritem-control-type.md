...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LabeledByProperty>|`Null`Operador|Los controles de elemento de encabezado no tienen una etiqueta de texto estático.|  
