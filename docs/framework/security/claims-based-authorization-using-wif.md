...
### <a name="iprincipalisinrole-method"></a>Método IPrincipal.IsInRole  
 Para implementar el enfoque RBAC en las aplicaciones para notificaciones, use el método **IsInRole ()** en la interfaz **IPrincipal** , tal como lo haría en aplicaciones no compatibles con notificaciones. Existen varias formas de usar el método **IsInRole()** :  
