---
title: "WSTrustChannelFactory y WSTrustChannel | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.reviewer: ""
ms.suite: ""
...
-   Mediante WIF solo para obtener un token del STS y habilitar a continuación un cliente WCF para autenticar con este token.  Para obtener más información, vea el ejemplo de [ClaimsAwareWebService](http://go.microsoft.com/fwlink/?LinkID=248406).  
...
>   
>  WIF solo admite tokens de seguridad, cifrados o no cifrados, como un elemento secundario directo de \<wst:OnBehalfOf\>.  
...
## Comunicación directa con un emisor y uso del token emitido para autenticar  
