...
1. Presione **F5** para compilar y ejecutar la aplicación. Debe estar presente en una ventana de consola y el texto siguiente: **Presione la tecla ENTRAR para invocar el servicio, cualquier otra tecla para salir de la aplicación:**  
