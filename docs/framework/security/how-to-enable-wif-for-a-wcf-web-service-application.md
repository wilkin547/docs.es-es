...
4. En la ventana **Agregar referencia de servicio**, haga clic en la flecha desplegable del botón **Detectar** y en **Servicios de la solución**. La **Dirección** se rellenará automáticamente con el servicio WCF que ha creado anteriormente y el **Espacio de nombres** se establecerá en **ServiceReference1**. Haga clic en **OK**.
...
1. Presione **F5** para compilar y ejecutar la aplicación. Debe aparecer una ventana de consola y el texto siguiente: **Presione la tecla entrar para invocar el servicio, cualquier otra tecla para salir de la aplicación:**
