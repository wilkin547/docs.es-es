...
-   [ClaimsBasedAuthorization](https://go.microsoft.com/fwlink/?LinkID=248410): en estos ejemplos se muestra cómo usar las clases CLaimsAuthorizationManager y ClaimsAuthorizationModule para aplicar sus propias directivas de autorización.  
