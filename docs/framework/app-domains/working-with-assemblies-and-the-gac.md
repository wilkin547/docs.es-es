---
title: "Trabajar con ensamblados y la memoria cach&#233; global de ensamblados | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "GAC (caché global de ensamblados), ventajas"
  - "caché global de ensamblados, ventajas"
...
---
# Trabajar con ensamblados y la memoria cach&#233; global de ensamblados
...
## En esta sección  
 ...
 Explica cómo usar [Gacutil.exe \(Global Assembly Cache Tool\)](../../../docs/framework/tools/gacutil-exe-gac-tool.md) para ver el contenido de la caché global de ensamblados.  
 ...
 Explica cómo utilizar [Gacutil.exe \(Global Assembly Cache Tool\)](../../../docs/framework/tools/gacutil-exe-gac-tool.md) para quitar un ensamblado de la caché global de ensamblados.  
...
## Secciones relacionadas  
 ...
 Explica cómo utilizar [Ildasm.exe \(IL Disassembler\)](../../../docs/framework/tools/ildasm-exe-il-disassembler.md) para ver la información del Lenguaje intermedio de Microsoft \(MSIL\) de un ensamblado.  
