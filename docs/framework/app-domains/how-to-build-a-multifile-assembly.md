---
title: "Cómo: Compilar un ensamblado de varios archivos | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
2.  Compile los módulos restantes, usando las opciones de compilador necesarias para indicar los otros módulos a los que hace referencia el código. En este paso se usa la opción del compilador **/addmodule**.  
...
3.  Use la [herramienta Assembly Linker (Al.exe)](../../../docs/framework/tools/al-exe-assembly-linker.md) para crear el archivo de salida que contendrá el manifiesto del ensamblado. Este archivo contiene información de referencia de todos los módulos o recursos que forman parte del ensamblado.  
