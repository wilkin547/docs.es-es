...
2. Cree un conjunto de conmutadores. Para más información, vea [Cómo: Configurar modificadores de seguimiento](how-to-create-initialize-and-configure-trace-switches.md).  
