...
> [!NOTE]
> En el caso de la versión 1.0 de .NET Framework, el compilador de Microsoft Visual C++ agrega el atributo **DebuggableAttribute** cuando se especifican las opciones del compilador **/clr** y **/Zi**. En la versión 1.1 de .NET Framework, debe agregar el **DebuggableAttribute** manualmente en el código o use el **/ASSEMBLYDEBUG** opción del vinculador.
