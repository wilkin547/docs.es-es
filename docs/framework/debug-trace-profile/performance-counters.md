...
---
# <a name="performance-counters-in-the-net-framework"></a>Contadores de rendimiento en .NET Framework

En este tema se proporciona una lista de contadores de rendimiento que puede encontrar en el Monitor de rendimiento de [Windows.](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc749249%28v=ws.11%29)  
...
|**Número total de bytes confirmados**|Muestra la cantidad de memoria virtual en bytes confirmada actualmente por el recolector de elementos no utilizados. La memoria asignada es la memoria física para la que se reservó espacio en el archivo de paginación de disco.|  
...
|**Tamaño del montón del objeto grande**|Muestra el tamaño actual, en bytes, del montón de objetos grandes. Los objetos que son mayores que aproximadamente 85.000 bytes son tratados como objetos grandes por el recolector de elementos no utilizados y se asignan directamente en un montón especial. No se promueven a través de las generaciones. Este contador se actualiza al final de una recolección de elementos no utilizados, no durante cada asignación.|  
