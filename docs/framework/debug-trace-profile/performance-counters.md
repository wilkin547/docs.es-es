...
En este tema se proporciona una lista de los contadores de rendimiento que se puede encontrar en el [monitor de rendimiento](http://technet.microsoft.com/library/cc749249.aspx).  
...
-   [Cargar contadores de rendimiento](#loading)  
...
<a name="interop"></a>   
## Contadores de rendimiento interoperativos  
...
<a name="loading"></a>   
## Cargar contadores de rendimiento  
...
|**Número de bytes totales reservados**|Muestra la cantidad de memoria virtual en bytes reservada actualmente por el recolector de elementos no utilizados.  La memoria reservada es el espacio de memoria virtual reservado para la aplicación cuando no se usaron páginas de disco o de la memoria principal.|  
...
|**Id. de proceso**|Muestra el identificador de proceso de la instancia de proceso CLR que se está supervisando.|  
...
-   «Redes de ".NET CLR 4.0.0.0» \- Todos los contadores de socket anteriores más los nuevos contadores de rendimiento compatibles con .NET Framework versión 4 y versiones posteriores.  Estos nuevos contadores proporcionan información de rendimiento sobre los objetos <xref:System.Net.HttpWebRequest>.  
 ...
 Para obtener más información sobre el acceso y la administración de los contadores de rendimiento en una aplicación, consulte [Performance Counters](../../../docs/framework/debug-trace-profile/performance-counters.md).  
  
<a name="security"></a>   
## Contadores de rendimiento de seguridad  
