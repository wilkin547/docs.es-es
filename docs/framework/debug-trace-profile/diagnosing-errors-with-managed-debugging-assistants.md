...
|[raceOnRCWCleanup](raceonrcwcleanup-mda.md)|[entrar](reentrancy-mda.md)|
...
De forma predeterminada, .NET Framework activa un subconjunto de MDA para todos los depuradores administrados. Para ver el conjunto predeterminado en Visual Studio, elija **Windows**  >  **configuración de excepciones** de Windows en el menú **depurar** y, a continuación, expanda la lista **asistentes para la depuración administrada** .
...
> [!TIP]
> En lugar de deshabilitar los MDA, puede impedir que Visual Studio muestre el cuadro de diálogo MDA cada vez que se reciba una notificación de MDA. Para ello, elija **Windows**  >  **configuración de excepciones** de Windows en el menú **depurar** , expanda la lista asistentes para la **depuración administrada** y, a continuación, Active o desactive la casilla **interrumpir cuando se produzca** la activación del MDA individual.
