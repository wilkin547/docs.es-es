...
```  
 ...
 Para obtener más información, vea [Habilitar y deshabilitar MDA utilizando valores de configuración específicos de la aplicación](#appConfig).  La variable de entorno COMPLUS\_MDA puede invalidar la configuración del Registro.  Vea [Habilitar y deshabilitar MDA utilizando una variable de entorno](#envVariable) para obtener más información.  
