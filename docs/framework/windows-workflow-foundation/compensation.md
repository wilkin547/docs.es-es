---
title: "Compensaci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Compensación en comparación conTransacciones  
...
> [!NOTE]
>  Este tema trata la compensación en flujos de trabajo.[!INCLUDE[crabout](../../../includes/crabout-md.md)] las transacciones en flujos de trabajo, vea [Transacciones](../../../docs/framework/windows-workflow-foundation//workflow-transactions.md) y <xref:System.Activities.Statements.TransactionScope>.[!INCLUDE[crabout](../../../includes/crabout-md.md)] transacciones, vea <xref:System.Transactions?displayProperty=fullName> y <xref:System.Transactions.Transaction?displayProperty=fullName>.  
...
> [!NOTE]
>  Cuando una clase <xref:System.Activities.Statements.CompensableActivity> se *confirma*, ya no se podrá invocar la compensación para la actividad.El proceso de confirmación se describe más adelante en esta sección.  
