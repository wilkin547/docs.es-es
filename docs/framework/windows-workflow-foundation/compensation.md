...
Compensación en Windows Workflow Foundation (WF) es el mecanismo mediante el cual el trabajo completado previamente se puede deshacer o compensar (siguiendo la lógica definida por la aplicación) cuando se produce un error posterior. Esta sección describe cómo usar la compensación en los flujos de trabajo.  
...
> [!NOTE]
> Este tema trata la compensación en flujos de trabajo. Para obtener más información acerca de las <xref:System.Activities.Statements.TransactionScope>transacciones en flujos de trabajo, vea [Transacciones](workflow-transactions.md) y . Para obtener más información <xref:System.Transactions?displayProperty=nameWithType> acerca <xref:System.Transactions.Transaction?displayProperty=nameWithType>de las transacciones, consulte y .  
...
**ManagerApproval: Aprobación** del gerente recibida. 
 **PurchaseFlight: Se compra el billete.** 
 **Flujo de trabajo completado correctamente con el estado: Cerrado.**
> [!NOTE]
...
> [!NOTE]
> Cuando <xref:System.Activities.Statements.CompensableActivity> se *confirma*a , ya no se puede invocar la compensación por la actividad. El proceso de confirmación se describe más adelante en esta sección.  
 ...
 **ReserveFlight: Ticket is reserved.**  
**SimulatedErrorCondition: iniciar una excepción ApplicationException.** 
 ...
 **Flujo de trabajo completado correctamente con el estado: Cancelado.**
 ...
 **Flujo de trabajo completado correctamente con el estado: Cancelado.**  Para obtener más información acerca de la cancelación, consulte [Cancelación](modeling-cancellation-behavior-in-workflows.md).  
