...
> [!NOTE]
>  Este tema trata la compensación en flujos de trabajo. Para obtener más información acerca de las transacciones en flujos de trabajo, consulte [transacciones](workflow-transactions.md) y <xref:System.Activities.Statements.TransactionScope>. Para obtener más información acerca de las transacciones, vea <xref:System.Transactions?displayProperty=nameWithType> y <xref:System.Transactions.Transaction?displayProperty=nameWithType>.  
...
**Ha completado correctamente con el estado de flujo de trabajo: Se canceló.**  Para obtener más información sobre la cancelación, vea [cancelación](modeling-cancellation-behavior-in-workflows.md).  
