...
> [!NOTE]
> Este tema trata la compensación en flujos de trabajo. Para obtener más información sobre las transacciones en flujos de trabajo, vea [Transacciones](workflow-transactions.md) y <xref:System.Activities.Statements.TransactionScope> Para obtener más información acerca de las <xref:System.Transactions?displayProperty=nameWithType> transacciones <xref:System.Transactions.Transaction?displayProperty=nameWithType>, vea y.  
 ...
 **ReserveFlight: El vale está reservado.**  
**ManagerApproval: Aprobación del administrador recibida.**    
**PurchaseFlight: Se compra el vale.**    
**El flujo de trabajo se completó correctamente con el estado: Subtítulos.**    
> [!NOTE]
...
> [!NOTE]
> Cuando se <xref:System.Activities.Statements.CompensableActivity> *confirma*un, ya no se puede invocar la compensación de la actividad. El proceso de confirmación se describe más adelante en esta sección.  
 ...
 **ChargeCreditCard: Cargar la tarjeta de crédito del vuelo.**  
**SimulatedErrorCondition: Producir una excepción ApplicationException.**    
**Excepción no controlada del flujo de trabajo:**    
**System.ApplicationException: Condición de error simulada en el flujo de trabajo.**    
**CancelCreditCard: Cancele los cargos de la tarjeta de crédito.**    
...
**ConfirmFlight: Se ha tomado el vuelo, no es posible realizar ninguna compensación.**    
**El flujo de trabajo se completó correctamente con el estado: Subtítulos.**   
