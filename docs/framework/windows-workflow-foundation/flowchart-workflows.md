...
## <a name="flowchart-workflow-structure"></a>Estructura del flujo de trabajo de diagrama
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>Crear un modificador exclusivo con un nodo FlowSwitch
