...
ms.locfileid: "33514587"
---
# <a name="persistence"></a>Persistencia
Esta sección contiene ejemplos que muestran cómo guardar flujos de trabajo en un medio duradero en Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Este ejemplo proporciona una solución integral que incluye la característica Promoción de <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore> directamente en el flujo de trabajo que crea la experiencia.
