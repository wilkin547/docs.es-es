...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Programación de almacén de metadatos](../../../../docs/framework/windows-workflow-foundation/samples/metadata-store-programmability.md)  
 ...
 [Con la edición de ámbito](../../../../docs/framework/windows-workflow-foundation/samples/using-editing-scope.md)  
