---
title: "Actividad de promoci&#243;n de propiedad | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Actividad de promoci&#243;n de propiedad
...
> [!NOTE]
>  Los ejemplos se proporcionan exclusivamente con fines educativos.No están pensados para un entorno de producción y no se han probado en un entorno de producción.Microsoft no proporciona soporte técnico para estos ejemplos.  
...
-   El proyecto **PropertyPromotionActivity** contiene archivos que pertenecen a los elementos de configuración específicos de la promoción, las actividades de flujo de trabajo y las extensiones de flujo de trabajo.  
  
-   El proyecto **CounterServiceApplication** contiene un flujo de trabajo de ejemplo que utiliza el proyecto **SqlWorkflowInstanceStorePromotion**.  
...
-   **PropertyPromotionActivity** es una biblioteca de clases que contiene elementos de configuración, actividades de flujo de trabajo y extensiones de flujo de trabajo que usa **CounterServiceApplication**.  
...
#### Utilizar el elemento de configuración SqlWorkflowInstanceStorePromotion  
...
#### Utilizar la actividad PromoteValue  
...
```  
 ...
 Name \(string\)  
 El nombre que representa a esta propiedad.Debería coincidir con el atributo de nombre de un elemento \<promotedValue\> de la configuración.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WF\Basic\Persistence\PropertyPromotionActivity`  
