...
## <a name="discussion"></a>Discusión  
 ...
 La segunda parte del ejemplo usa la clase <xref:System.Activities.WorkflowApplication>. <xref:System.Activities.WorkflowApplication> le permite tener más control sobre cada instancia, incluida la capacidad de interactuar con el flujo de trabajo y para ejecutar el flujo de trabajo de forma asincrónica.  
