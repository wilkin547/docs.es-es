---
title: "Retraso absoluto | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Retraso absoluto
El escenario principal de este ejemplo es el retraso hasta un valor de <xref:System.DateTime> especificado utilizando temporizadores duraderos en una aplicación de flujo de trabajo.Esto es diferente a utilizar la actividad <xref:System.Activities.Statements.Delay> integrada, ya que en este caso solo se permitirá el retraso para un valor de <xref:Sysem.TimeSpan> \(o número de minutos\/segundos\) determinado.  
...
7.  Seleccione **Compilar**, **Compilar solución** para compilar la solución.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WF\Basic\Services\AbsoluteDelay`