---
title: "Host RedLIne WorkflowApplication | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Host RedLIne WorkflowApplication
...
7.  Presione el botón de puntos suspensivos situado al lado del botón **Ejecutar** para buscar un flujo de trabajo definido en un archivo XAML  
  
     En la carpeta SampleWorkflows se pueden encontrar dos ejemplos.El ejemplo parallel1.xaml pasa a estado inactivo.  
  
8.  Una vez seleccionado un ejemplo, presione el botón **Ejecutar**.  
  
9. Si el flujo de trabajo pasa a estado inactivo, o el momento en que pasa a ese estado, el cuadro combinado **Marcadores** se rellena con los marcadores disponibles.  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WF\Basic\Execution\ControllingWorkflowApplications`  
