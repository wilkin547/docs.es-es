...
## <a name="in-this-section"></a>En esta sección  
 ...
 [LINQ a la actividad de objetos](../../../../docs/framework/windows-workflow-foundation/samples/linq-to-objects-activity.md)  
 Muestra cómo crear una actividad para utilizar LINQ to Objects para consultar elementos de una colección.  
  
 [LINQ to SQL ejemplo](../../../../docs/framework/windows-workflow-foundation/samples/linq-to-sql-sample.md)  
 ...
 [Para la actividad](../../../../docs/framework/windows-workflow-foundation/samples/for-activity.md)  
 ...
 [Parallel ForEach limitada](../../../../docs/framework/windows-workflow-foundation/samples/throttled-parallel-foreach.md)  
 ...
 [Actividades de acceso de base de datos](../../../../docs/framework/windows-workflow-foundation/samples/database-access-activities.md)  
 Muestra cómo crear actividades que permiten tener acceso a las bases de datos para recuperar o modificar la información y usar [ADO.NET](http://go.microsoft.com/fwlink/?LinkId=166081) para tener acceso a la base de datos.  
 ...
 Muestra cómo la actividad ExternalizedPolicy4 permite ejecutar objetos [!INCLUDE[wf2](../../../../includes/wf2-md.md)] de [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] en <xref:System.Workflow.Activities.Rules.RuleSet> (WF 3.5) directamente en [!INCLUDE[wf2](../../../../includes/wf2-md.md)] en [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] (WF 4.5) utilizando el motor de reglas que se distribuye con WF 3.5.  
 ...
 [Obtener WorkflowInstanceId](../../../../docs/framework/windows-workflow-foundation/samples/get-workflowinstanceid.md)  
