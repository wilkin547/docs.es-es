---
title: "Actividad Externalized Policy en .NET Framework 4.5 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|ExternalizedPolicy4|Contiene la actividad ExternalizedPolicy4 y su diseñador de WF 4.5.|**ExternalizedPolicy4.cs**: definición de la actividad.<br /><br /> **ExternalizedPolicy4Designer.xaml**: el diseñador personalizado de la actividad ExternalizedPolicy4.Utiliza el editor de reglas \(<xref:System.Workflow.Activities.Rules.Design.RuleSetDialog>\) del motor de reglas de WF 3.5.|  
...
#### Para ejecutar la aplicación ImperativeCodeClientSample  
...
#### Para ejecutar la aplicación DesignerClientSample  
...
>   
>  `<unidadDeInstalación>:\WF_WCF_Samples\WF\Scenario\ActivityLibrary\Rules-ExternalizedPolicy4`