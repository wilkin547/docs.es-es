...
## <a name="in-this-section"></a>En esta sección  
 ...
 En este ejemplo se muestra cómo definir y utilizar una propiedad de ejecución en una actividad personalizada.  
 ...
 [Actividad personalizada Hola mundo](../../../../docs/framework/windows-workflow-foundation/samples/hello-world-custom-activity.md)  
 Este ejemplo muestra varias características fundamentales de Windows Workflow Foundation (WF), incluido cómo crear una actividad personalizada simple.  
  
 [Argumentos dinámicos](../../../../docs/framework/windows-workflow-foundation/samples/dynamic-arguments.md)  
 En este ejemplo se muestra cómo implementar una actividad para la que define los argumentos el consumidor de la actividad y no su autor.
