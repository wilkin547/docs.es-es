...
## <a name="demonstrates"></a>Muestra
 <xref:System.ServiceModel.WorkflowServiceHost>con <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionBehavior> <xref:System.ServiceModel.Activities.WorkflowControlEndpoint> y en Windows Workflow Foundation (WF).
...
2. Configure la base de datos de SQL Server.
    ...
    1. Desde un símbolo del sistema de Visual Studio 2010, ejecute "setup.cmd" desde el directorio de ejemplo SuspendedInstanceManagement, que hace lo siguiente:
