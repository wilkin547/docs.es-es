...
## <a name="in-this-section"></a>En esta sección  
 [Cómo: Crear un flujo de trabajo secuencial](how-to-create-a-sequential-workflow.md)  
 Describe cómo crear un flujo de trabajo secuencial usando la actividad <xref:System.Activities.Statements.Sequence>.  
  
 [Cómo: Crear un flujo de trabajo de diagrama de flujo](how-to-create-a-flowchart-workflow.md)  
