...
## <a name="tracking-participant-event-data"></a>Datos de eventos del participante de seguimiento  
 ...
 Los tipos complejos en variables, argumentos y elementos de datos personalizados se serializan en el registro de eventos de ETW mediante la <xref:System.Runtime.Serialization.NetDataContractSerializer> clase. Esta clase incluye información de tipo CLR en la secuencia XML serializada.  
