...
-   [Opción de codificación de instancias](../../../docs/framework/windows-workflow-foundation/instance-encoding-option.md)  
  
-   [Acción de finalización de instancias](../../../docs/framework/windows-workflow-foundation/instance-completion-action.md)  
  
-   [Acción de excepción de instancias bloqueadas](../../../docs/framework/windows-workflow-foundation/instance-locked-exception-action.md)  
  
-   [Período de renovación del bloqueo de host](../../../docs/framework/windows-workflow-foundation/host-lock-renewal-period.md)  
  
-   [Período de detección de instancias ejecutables](../../../docs/framework/windows-workflow-foundation/runnable-instances-detection-period.md)  
