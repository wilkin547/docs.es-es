...
## <a name="workflow-versioning"></a><a name="BKMK_Versioning"></a> Control de versiones de flujo de trabajo
...
## <a name="activities"></a><a name="BKMK_NewActivities"></a> Operaciones

La biblioteca integrada de actividades contiene nuevas actividades y características para las actividades existentes.

### <a name="nopersist-scope"></a><a name="BKMK_NoPersistScope"></a> Ámbito de nopersist
...
### <a name="new-flowchart-capabilities"></a><a name="BKMK_NewFlowchartCapabilities"></a> Nuevas capacidades de diagrama de flujo
...
4. Los autores de actividades deben invalidar <xref:System.Activities.Activity.CacheMetadata%2A> para que el runtime del flujo de trabajo ejecute la reflexión automáticamente en el tipo. Los argumentos y las actividades secundarias no deben ser NULL y se debe llamar a <xref:System.Activities.ActivityMetadata.Bind%2A> explícitamente. Para obtener más información sobre la invalidación <xref:System.Activities.Activity.CacheMetadata%2A> , vea [exponer datos con CacheMetadata](exposing-data-with-cachemetadata.md). Además, se deben crear explícitamente instancias de argumentos de un tipo que sea `internal` o **privado** en  <xref:System.Activities.Activity.CacheMetadata%2A> para evitar que se creen mediante reflexión.
...
8. No se puede usar un solo ensamblado que use la [transparencia de nivel 2](../misc/security-transparent-code-level-2.md) en .NET Framework 4, [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] en plena confianza y [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] en confianza parcial.

## <a name="new-designer-capabilities"></a><a name="BKMK_NewDesignerCapabilites"></a> Nuevas capacidades del diseñador

### <a name="designer-search"></a><a name="BKMK_DesignerSearch"></a> Búsqueda en el diseñador
...
#### <a name="quick-find"></a><a name="BKMK_QuickFind"></a> Búsqueda rápida
...
#### <a name="find-in-files"></a><a name="BKMK_FindInFiles"></a> Buscar en archivos
...
### <a name="delete-context-menu-item-in-variable-and-argument-designer"></a><a name="BKMK_VariableDeleteContextMenu"></a> Eliminar elemento de menú contextual en el diseñador de variables y argumentos
...
### <a name="pan-mode"></a><a name="BKMK_PanMode"></a> Modo panorámico
...
### <a name="multi-select"></a><a name="BKMK_MultiSelect"></a> Selección múltiple
...
### <a name="c-expressions"></a><a name="BKMK_CSharpExpressions"></a> Expresiones de C#
...
### <a name="more-control-of-visibility-of-shell-bar-and-header-items"></a><a name="BKMK_Visibility"></a> Mayor control de la visibilidad de los elementos de encabezado y de barra de Shell
...
### <a name="auto-connect-and-auto-insert-in-flowchart-and-state-machine-workflows"></a><a name="BKMK_AutoConnect"></a> Conexión automática e inserción automática en los flujos de trabajo del equipo de diagrama de flujo y estado
...
### <a name="designer-annotations"></a><a name="BKMK_Annotations"></a> Anotaciones del diseñador
...
### <a name="define-and-consume-activitydelegate-objects-in-the-designer"></a><a name="BKMK_ActivityDelegates"></a> Definir y utilizar objetos ActivityDelegate en el diseñador
...
### <a name="build-time-validation"></a><a name="BKMK_BuildTimeValidation"></a> Validación en tiempo de compilación
...
### <a name="design-time-background-validation"></a><a name="BKMK_DesignTimeValidation"></a> Validación en segundo plano en tiempo de diseño
...
### <a name="view-state-located-in-a-separate-location-in-xaml-files"></a><a name="BKMK_ViewState"></a> Estado de vista ubicado en una ubicación independiente en archivos XAML
...
### <a name="expression-extensibility"></a><a name="BKMK_ExpressionExtensibility"></a> Extensibilidad de expresiones
...
### <a name="opt-in-for-workflow-45-features-in-rehosted-designer"></a><a name="BKMK_BackwardCompatRehostedDesigner"></a> Participación en las características de Workflow 4,5 en el diseñador rehospedado
...
## <a name="new-workflow-development-models"></a><a name="BKMK_NewWFModels"></a> Nuevos modelos de desarrollo de flujo de trabajo
...
### <a name="state-machine-workflows"></a><a name="BKMK_StateMachine"></a> Flujos de trabajo de equipo de estado
...
### <a name="contract-first-workflow-development"></a><a name="BKMK_ContractFirst"></a> Desarrollo de flujos de trabajo de contrato primero
