---
title: "Flujos de trabajo de m&#225;quina de estados | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   <xref:System.Activities.Statements.Transition>  
 ...
 Para crear un flujo de trabajo de máquina de estados, los estados se agregan a una actividad <xref:System.Activities.Statements.StateMachine> y las transiciones se usan para controlar el flujo entre estados.La captura de pantalla siguiente, del paso [Crear un flujo de trabajo de máquina de estados](../../../docs/framework/windows-workflow-foundation//how-to-create-a-state-machine-workflow.md) de [Tutorial de introducción](../../../docs/framework/windows-workflow-foundation//getting-started-tutorial.md), muestra un flujo de trabajo de máquina de estados con tres estados y tres transiciones.**Inicializar destino** es el estado inicial y representa el primer estado del flujo de trabajo.Esto lo designa la línea que conduce a él desde el nodo **Iniciar**.El estado final del flujo de trabajo se denomina **FinalState** y representa el punto en el que se completa el flujo de trabajo.  
...
## Crear y configurar transiciones  
 ...
 Para agregar un <xref:System.Activities.Statements.State> y crear una transición en un paso, arrastre una actividad **State** desde la sección **Máquina de estados** del **Cuadro de herramientas** y mantenga el mouse sobre otro estado en el diseñador de flujo de trabajo.Cuando el <xref:System.Activities.Statements.State> arrastrado está sobre a otro <xref:System.Activities.Statements.State>, aparecerán cuatro triángulos alrededor del otro <xref:System.Activities.Statements.State>.Si <xref:System.Activities.Statements.State> se coloca sobre uno de los cuatro triángulos, se agrega a la máquina de estados y se crea una transición desde el <xref:System.Activities.Statements.State> de origen al <xref:System.Activities.Statements.State> de destino colocado.Para obtener más información, vea [Diseñadores de actividad de transición](../Topic/Transition%20Activity%20Designer.md).  
...
>  Tenga en cuenta que si la condición <xref:System.Activities.Statements.Transition.Condition%2A> de una transición se evalúa en `False` \(o todas las condiciones de una transición de desencadenador compartido se evalúan en `False`\), la transición no se producirá y se reprogramarán todos los desencadenadores para todas las transiciones desde el estado.  
 ...
 Para obtener más información sobre cómo crear flujos de trabajo de máquina de estados, vea [Crear un flujo de trabajo de máquina de estados](../../../docs/framework/windows-workflow-foundation//how-to-create-a-state-machine-workflow.md), [Diseñador de actividades StateMachine](../Topic/StateMachine%20Activity%20Designer.md), [Diseñador de actividad State](../Topic/State%20Activity%20Designer.md), [Diseñador de actividad FinalState](../Topic/FinalState%20Activity%20Designer.md) y [Diseñadores de actividad de transición](../Topic/Transition%20Activity%20Designer.md).  
...
## Vea también  
 ...
 [Diseñador de actividades StateMachine](../Topic/StateMachine%20Activity%20Designer.md)   
 [Diseñador de actividad State](../Topic/State%20Activity%20Designer.md)   
 [Diseñador de actividad FinalState](../Topic/FinalState%20Activity%20Designer.md)   
 [Diseñadores de actividad de transición](../Topic/Transition%20Activity%20Designer.md)