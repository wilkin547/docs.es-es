...
```  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)]Windows Workflow Foundation [validación](../../../docs/framework/windows-workflow-foundation/samples/validation.md) ejemplos.  
