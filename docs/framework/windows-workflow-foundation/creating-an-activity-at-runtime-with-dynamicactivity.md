...
2. Seleccione **archivo**, **nuevo**, **proyecto**. Seleccione **flujo de trabajo 4,0** en  **C# visual** en la ventana **tipos de proyecto** y seleccione el nodo **V2010** . Seleccione **aplicación de consola de flujos de trabajo** en la ventana **plantillas** . Proporcione el nombre siguiente al nuevo proyecto: DynamicActivitySample.  
...
7. Ejecute la aplicación. Una ventana de consola con el texto "Hola mundo!" parece.  
