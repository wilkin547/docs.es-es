 ...
 **Sequence**  
 **WriteLine**  
 **Literal\<cadena >** para recuperar una actividad específica en lugar de enumerar todas las actividades, <xref:System.Activities.WorkflowInspectionServices.Resolve%2A> se utiliza. 
