...
```  
 ...
 Para obtener más información sobre las expresiones, vea [expresiones](../../../docs/framework/windows-workflow-foundation/expressions.md).  
