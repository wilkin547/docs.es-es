---
title: "&#193;mbito y visibilidad de la definici&#243;n de actividad | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
1.  Al determinar los miembros \(<xref:System.Activities.Argument>, objetos <xref:System.Activities.ActivityDelegate> y <xref:System.Activities.Variable>, y actividades secundarias\) una actividad se expone a sus usuarios.  
...
## Definición y uso  
 Un flujo de trabajo se escribe creando nuevas actividades al heredarlas de las clases de actividad base y utilizando las actividades desde [Biblioteca de actividades integrada](../../../docs/framework/windows-workflow-foundation//net-framework-4-5-built-in-activity-library.md).Para utilizar una actividad, el autor de actividad debe configurar la visibilidad de cada componente de su definición.  
