...
## <a name="in-this-section"></a>En esta sección  
 [Cómo crear un diseñador de actividad personalizado](../../../docs/framework/windows-workflow-foundation/how-to-create-a-custom-activity-designer.md)  
 ...
 [Cómo crear una plantilla de actividad personalizada](../../../docs/framework/windows-workflow-foundation/how-to-create-a-custom-activity-template.md)  
 ...
 [Uso del contexto de edición de ModelItem](../../../docs/framework/windows-workflow-foundation/using-the-modelitem-editing-context.md)  
 ...
 [Enlace de una propiedad de actividad personalizada a un control de diseñador](../../../docs/framework/windows-workflow-foundation/binding-a-custom-activity-property-to-a-designer-control.md)  
