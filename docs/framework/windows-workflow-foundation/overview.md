---
title: "Informaci&#243;n general de Windows Workflow | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Un flujo de trabajo es un conjunto de unidades elementales llamadas *actividades* que están almacenadas como un modelo que describe un proceso real.Los flujos de trabajo proporcionan una manera de describir el orden de ejecución y las relaciones de dependencia entre las partes de trabajo de ejecución corta o prolongada.Este trabajo pasa a través del modelo desde el principio hasta el final y las actividades pueden ser ejecutadas por personas o por funciones de sistema.  
...
-   Una clase <xref:System.ServiceModel.WorkflowServiceHost> para las interacciones basadas en mensajes en escenarios de varias instancias.  
 ...
 ![Componentes de flujo de trabajo del proceso de host](../../../docs/framework/windows-workflow-foundation//media/44c79d1d-178b-4487-87ed-3e33015a3842.png "44c79d1d\-178b\-4487\-87ed\-3e33015a3842")  
...
-   Una actividad personalizada que se deriva de la clase abstracta <xref:System.Activities.CodeActivity>.<xref:System.Activities.CodeActivity> puede tener acceso a características del runtime \(como el seguimiento y las propiedades\) usando el <xref:System.Activities.CodeActivityContext> que está disponible como parámetro del método <xref:System.Activities.CodeActivity.Execute%2A>.[!INCLUDE[crabout](../../../includes/crabout-md.md)] estas características en tiempo de ejecución, vea [Seguimiento y traza del flujo de trabajo](../../../docs/framework/windows-workflow-foundation//workflow-tracking-and-tracing.md) y [Propiedades de ejecución del flujo de trabajo](../../../docs/framework/windows-workflow-foundation//workflow-execution-properties.md).  
  
## Vea también  
 [¿BizTalk Server 2006 o WF? Elegir la herramienta de flujo de trabajo adecuada para su proyecto](http://go.microsoft.com/fwlink/?LinkId=154901)