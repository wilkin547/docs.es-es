...
|AsyncPattern|No|Indica que una operación se implementa de forma asincrónica utilizando un inicio\<nombreDeMétodo > y End\<methodName > par de métodos en un contrato de servicio.|(No disponible)|  
