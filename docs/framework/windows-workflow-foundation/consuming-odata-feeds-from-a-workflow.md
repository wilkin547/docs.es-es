...
> [!NOTE]
> Para obtener más información acerca de la paginación en Servicios de datos de WCF, consulte [Cómo: cargar resultados paginados (servicios de datos de WCF)](../data/wcf/how-to-load-paged-results-wcf-data-services.md).
