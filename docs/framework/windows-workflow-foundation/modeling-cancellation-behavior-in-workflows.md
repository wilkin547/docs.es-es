...
> [!NOTE]
>  Para obtener más información sobre las transacciones y compensación, consulte [transacciones](../../../docs/framework/windows-workflow-foundation/workflow-transactions.md) y [compensación](../../../docs/framework/windows-workflow-foundation/compensation.md).  
