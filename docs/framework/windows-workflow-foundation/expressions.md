...
> [!NOTE]
>  Compatibilidad con C# expresiones en proyectos de flujo de trabajo se introdujo en .NET Framework 4.5. Para obtener más información, consulte [ C# expresiones](csharp-expressions.md).  
