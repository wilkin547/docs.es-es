---
title: "Procedimientos recomendados de persistencia | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Procedimientos recomendados de persistencia
...
## Diseño e implementación de flujos de trabajo duraderos  
 ...
 Windows Server App Fabric simplifica mucho la configuración y el uso de la persistencia.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Persistencia de Windows Server App Fabric](http://go.microsoft.com/fwlink/?LinkID=201200&clcid=0x409)  
  
## Configuración de los parámetros de escalabilidad  
...
### Escenario: un número pequeño de instancias de flujo de trabajo que requieren un tiempo de respuesta óptimo  
...
### Escenario: las instancias de flujo de trabajo reciben varios mensajes en un período de tiempo corto  
...
### Escenario: el flujo de trabajo utiliza las actividades de retraso con duraciones cortas  
...
## Configurar el Almacén de instancias de flujo de trabajo de SQL  
