---
title: "Perfiles de seguimiento | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  CustomTrackingRecords emitidos a partir de la implementación de actividad no se filtran por el valor implementationVisibility.  
 ...
 La funcionalidad de `implementationVisibility` se especifica como <xref:System.Activities.Tracking.ImplementationVisibility> en el perfil de seguimiento en código de la siguiente forma:  
...
```  
 ...
 La funcionalidad de `implementationVisibility` se especifica como <xref:System.Activities.Tracking.ImplementationVisibility> en el perfil de seguimiento en un archivo de configuración de la siguiente manera:  
...
-   <xref:System.Activities.Tracking.CancelRequestedQuery>: úsela para realizar un seguimiento de las solicitudes para cancelar una actividad secuncaria mediante la actividad primaria.La consulta es necesaria para que <xref:System.Activities.Tracking.TrackingParticipant> se suscriba a los objetos <xref:System.Activities.Tracking.CancelRequestedRecord>.  
     ...
     La configuración y el código que se usen para suscribirse a registros relacionados con la cancelación de actividades mediante <xref:System.Activities.Tracking.CancelRequestedQuery> se muestran en el ejemplo siguiente.  
...
## Vea también  
 ...
 [Conceptos de seguimiento](http://go.microsoft.com/fwlink/?LinkId=201273)   
 [Seguimiento de aplicaciones](http://go.microsoft.com/fwlink/?LinkId=201275)