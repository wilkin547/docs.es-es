...
Sin embargo, si el atributo `implementationVisibility` del perfil de seguimiento está establecido en `All`, los registros de seguimiento se emiten no solo para la *actividad*, sino también para las actividades *Activity1* y *Activity2*.
