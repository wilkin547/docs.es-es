...
-   [Uso de expresiones de C# en flujos de trabajo XAML](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md#XamlWorkflows)

    -   [Xaml compilado](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md#CompiledXaml)

    -   [El lenguaje Xaml flexible](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md#LooseXaml)

-   [Uso de expresiones de C# en servicios de flujo de trabajo XAMLX](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md#WFServices)
...
> [!NOTE]
>  Expresiones de C# solo se admiten en Visual Studio y no se admiten en el Diseñador de flujo de trabajo rehospedado. Para obtener más información sobre las nuevas características WF45 admitidas en el diseñador rehospedado, vea [compatibilidad con nuevas características de flujo de trabajo Foundation 4.5 en el Diseñador de flujo de trabajo Rehospedados](../../../docs/framework/windows-workflow-foundation/wf-features-in-the-rehosted-workflow-designer.md).
...
> [!NOTE]
>  Si no se compilan las expresiones de C#, un <xref:System.NotSupportedException> se produce cuando se invoca el flujo de trabajo con un mensaje similar al siguiente: `Expression Activity type 'CSharpValue`1' requiere compilación para ejecutarse.  Asegúrese de que se ha compilado el flujo de trabajo. "
...
-   Se llama a `CompiledExpressionInvoker.SetCompiledExpressionRootForImplementation` en lugar de a `CompiledExpressionInvoker.SetCompiledExpressionRoot`.
 ...
 Para obtener más información sobre cómo trabajar con expresiones en el código, consulte [creación de flujos de trabajo, actividades y expresiones mediante código imperativo](../../../docs/framework/windows-workflow-foundation/authoring-workflows-activities-and-expressions-using-imperative-code.md).
...
```
 ...
 Para obtener más información sobre cómo trabajar con flujos de trabajo XAML, vea [serializar flujos de trabajo y actividades a y desde XAML](../../../docs/framework/windows-workflow-foundation/serializing-workflows-and-activities-to-and-from-xaml.md).
