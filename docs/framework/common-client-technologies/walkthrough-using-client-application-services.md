---
title: "Tutorial: Usar servicios de aplicaciones cliente | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "host de servicios de aplicación [servicios de aplicación cliente]"
  - "servicios de aplicaciones cliente, guías"
...
-   Cree una aplicación de Windows Forms y use el diseñador de proyectos [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] para habilitar y configurar servicios de aplicaciones cliente.  
...
#### Para crear una aplicación cliente y habilitar servicios de aplicaciones cliente  
  
1.  En [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)], seleccione la opción de menú **Archivo &#124; Nuevo &#124; Proyecto**.  
  
2.  En el cuadro de diálogo **Nuevo proyecto**, en el panel **Tipos de proyectos**, expanda el nodo **Visual Basic** o **Visual C\#** y seleccione el tipo de proyecto de **Windows**  
...
4.  Cambie el valor de **Nombre** del proyecto a `ClientAppServicesDemo` y haga clic en **Aceptar**.  
     ...
     Se abre un nuevo proyecto de Windows Forms en [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)].  
...
2.  En el cuadro de diálogo **Agregar nuevo proyecto**, en el panel **Tipos de proyectos**, expanda el nodo **Visual Basic** o **Visual C\#** y seleccione el tipo de proyecto **Web**  
...
10. Agregue el siguiente marcado antes de la etiqueta `<system.web>`.  
    ...
    > [!NOTE]
    >  En el código de producción, siempre debería acceder al servicio de autenticación a través de la capa de sockets seguros \(SSL, mediante el protocolo HTTPS\). Para obtener información sobre cómo configurar SSL, consulte [Configurar la capa de sockets seguros](http://go.microsoft.com/fwlink/?LinkId=91844).  
...
#### Para configurar la pertenencia y los roles  
...
## Agregar la autenticación mediante formularios  
...
2.  Seleccione el archivo Form1 y, a continuación, seleccione **Vista &#124; Código** desde el menú principal de [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)].  
...
## Agregar un formulario de inicio de sesión como proveedor de credenciales  
...
##### Para crear un cuadro de diálogo de inicio de sesión como proveedor de credenciales en Visual Basic  
...
5.  En la ventana **Propiedades**, especifique un valor **\(Nombre\)**`rememberMeCheckBox` y un valor **Texto**`&Remember me`.  
  
6.  Seleccione **Vista &#124; Código** en el menú principal [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)].  
...
##### Para crear un cuadro de diálogo de inicio de sesión como proveedor de credenciales en C\#  
...
## Agregar funcionalidad basada en roles  
...
#### Para cambiar la interfaz de usuario en función del rol de usuario  
  
1.  En el **Explorador de soluciones**, en el proyecto ClientAppServicesDemo, seleccione Form1 y, a continuación, seleccione **Vista &#124; Diseñador** en el menú principal de [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)].  
...
#### Para usar la configuración web en la interfaz de usuario  
...
5.  En el **Explorador de soluciones**, en el proyecto ClientAppServicesDemo, seleccione Form1 y, a continuación, seleccione **Vista &#124; Diseñador** en el menú principal de [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)].  
  
6.  En el diseñador, agregue un control <xref:System.Windows.Forms.TextBox> al formulario.  
  
7.  En la ventana **Propiedades**, especifique `webSettingsTestTextBox` como valor de **\(Nombre\)**.  
