...
---
# Full Code Listings
Este tema contiene la lista de código completa para una aplicación que utiliza los procesadores [Manipulations and Inertia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md).  
  
## GamePiece \(Clase\)  
 En el ejemplo de código siguiente se muestra la clase **GamePiece** completa.  
...
## GamePieceCollection \(Clase\)  
 En el ejemplo de código siguiente se muestra la clase **GamePieceCollection** completa.  
...
## Game1 \(Clase\)  
 En el ejemplo de código siguiente se muestra la clase **Game1** completa.  
