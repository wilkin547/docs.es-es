---
title: Listas de código completas
ms.date: 03/30/2017
...
ms.locfileid: "32742028"
---
# <a name="full-code-listings"></a>Listas de código completas
Este tema contiene una lista de código completa para las aplicaciones que usan procesadores [manipulaciones e inercia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md).  
  
## <a name="gamepiece-class"></a>Clase GamePiece  
 En el siguiente código, se muestra la clase **GamePiece** completa.  
...
## <a name="gamepiececollection-class"></a>Clase GamePieceCollection  
 En el siguiente código, se muestra la clase **GamePieceCollection** completa.  
...
## <a name="game1-class"></a>Clase Game1  
 En el siguiente código, se muestra la clase **Game1** completa.  
