...
- [Tipos obsoletos en .NET Framework 4](/previous-versions/dotnet/netframework-4.0/ee461503(v=vs.100))
- [Miembros obsoletos en .NET Framework 4](/previous-versions/dotnet/netframework-4.0/ee471421(v=vs.100))
- [Lista de API obsoletas en .NET Framework 3.5](/previous-versions/cc835481(v=msdn.10))
- [Lista de API obsoletas en .NET Framework 2.0](/previous-versions/aa497286(v=msdn.10))
