...
## <a name="edit-and-continue"></a>Editar y continuar  
 ...
 En Visual C# Studio, no puede usar editar y continuar en cualquier código en un método que contenga una consulta LINQ to DataSet.  
