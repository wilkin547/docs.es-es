---
title: "Agrupaci&#243;n de conexiones OLE DB, ODBC y Oracle | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 Para obtener más información acerca de la agrupación de sesiones o de recursos OLE DB, y de cómo deshabilitar la agrupación invalidando los valores predeterminados del servicio del proveedor OLE DB, vea la [guía del programador de OLE DB](http://go.microsoft.com/fwlink/?linkid=45232) en MSDN Library.  
...
## Agrupación de conexiones para ODBC  
 ...
 Para obtener más información acerca de la agrupación de conexiones ODBC, vea [INFORMACIÓN: Preguntas más frecuentes acerca de la agrupación de conexiones ODBC](http://support.microsoft.com/kb/169470) en MSDN Library.  
