...
---
# <a name="how-to-implement-copytodatatablet-where-the-generic-type-t-is-not-a-datarow"></a>Procedimiento Implementar CopyToDataTable\<T > donde el tipo genérico t no es DataRow
