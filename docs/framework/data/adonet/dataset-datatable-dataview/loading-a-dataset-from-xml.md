...
> [!NOTE]
>  Si el esquema XSD para su <xref:System.Data.DataSet> incluye un **targetNamespace**, no se pueden leer los datos y se produzcan excepciones al llamar a **ReadXml** para cargar el <xref:System.Data.DataSet> con XML que contiene elementos con un espacio de nombres sin calificación. Para leer elementos incompletos en este caso, establezca **elementFormDefault** igual a "qualified" en el esquema XSD. Por ejemplo:  
