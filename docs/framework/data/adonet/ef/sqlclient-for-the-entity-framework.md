...
## <a name="providermanifesttoken-schema-attribute"></a>Atributo ProviderManifestToken de Schema  
 ...
 SqlClient se puede usar como un proveedor de datos para diferentes versiones de SQL Server. Estas versiones tienen capacidades distintas. Por ejemplo, no es compatible con SQL Server 2000 `varchar(max)` y `nvarchar(max)` tipos que se introdujeron con SQL Server 2005.  
