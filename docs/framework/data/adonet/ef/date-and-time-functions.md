---
title: "Funciones de fecha y hora | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|`MONTH(` `date` `)`|Devuelve el mes de la fecha especificada como un número entero.<br /><br /> **Argumentos**<br /><br /> `date`:expresión de tipo `DateTime` o `DateTimeOffset` con precisión \= 0\-7.<br /><br /> **Valor devuelto**<br /><br /> Mes de la fecha especificada como un `Int32`.<br /><br /> **Ejemplo**<br /><br /> `SqlServer.MONTH(cast('6/9/2006' as DateTime))`|  
