...
---
# <a name="csdl-ssdl-and-msl-specifications"></a>Especificaciones CSDL, SSDL MSL
El [msdn.microsoft.com/data/ef](https://msdn.microsoft.com/data/ef) sitio ahora es la ubicación principal para el contenido de Entity Framework.  
 ...
 El contenido de este tema está disponible en la página siguiente: [archivo EDMX](https://msdn.microsoft.com/data/jj650889).
