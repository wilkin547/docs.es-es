...
> [!NOTE]
> La expresión `Employee` especificada debe ser un subtipo `Person`del tipo de datos especificado o el tipo de datos debe ser un subtipo de la expresión. De lo contrario, la expresión producirá un error en tiempo de compilación.  
