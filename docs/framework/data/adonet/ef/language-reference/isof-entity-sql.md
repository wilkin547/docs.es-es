...
## <a name="return-value"></a>Valor devuelto  
 `true` Si `expression` es de tipo T y T es un tipo base o un tipo derivado de `type`; null si `expression` es null en tiempo de ejecución; en caso contrario, `false`.  
