...
## <a name="remarks"></a>Comentarios  
 En la tabla siguiente se muestran las funciones [!INCLUDE[esql](../../../../../../includes/esql-md.md)] canónicas de fecha y hora. `datetime`es un <xref:System.DateTime> valor.  
...
|`Year(expression)`|Devuelve la parte del año `expression` de como `Int32` un `YYYY`.<br /><br /> **Argumentos**<br /><br /> `DateTime` y `DateTimeOffset`.<br /><br /> **Valor devuelto**<br /><br /> Una clase `Int32`.<br /><br /> **Ejemplo**<br /><br /> `-- The following example returns 1998.`<br /><br /> `Year(cast('03/12/1998' as DateTime))`|  
