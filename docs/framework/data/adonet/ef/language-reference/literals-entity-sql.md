---
title: "Literales (Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Null  
 ...
 Los valores null con tipo se pueden crear realizando una conversión de un literal null.  Para obtener más información, consulta [CAST](../../../../../../docs/framework/data/adonet/ef/language-reference/cast-entity-sql.md).  
  
 Para conocer las reglas que determinan dónde se pueden usar literales null flotantes, vea [Literales NULL e inferencia de tipos](../../../../../../docs/framework/data/adonet/ef/language-reference/null-literals-and-type-inference-entity-sql.md).  
...
## Guid  
 Un literal `GUID` representa un identificador único global.  Es una secuencia formada por la palabra clave `GUID` seguida de dígitos hexadecimales con un formato conocido como formato de *registro*: 8\-4\-4\-4\-12 encerrados entre comillas simples.  Los dígitos hexadecimales no distinguen mayúsculas de minúsculas.  
