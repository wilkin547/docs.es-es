...
|`Contains(string, target)`|Devuelve `true` si `target` está incluida en `string`.<br /><br /> **Argumentos**<br /><br /> `string`: Cadena que se va a buscar.<br /><br /> `target`: La cadena de destino que se va a buscar.<br /><br /> **Valor devuelto**<br /><br /> `true` Si `target` se encuentra en `string`; de lo contrario `false`.<br /><br /> **Ejemplo**<br /><br /> `-- The following example returns true.`<br /><br /> `Contains('abc', 'bc')`|  
|`EndsWith(string, target)`|Devuelve `true` si la cadena `target` está situada al final de la cadena `string`.<br /><br /> **Argumentos**<br /><br /> `string`: Cadena que se va a buscar.<br /><br /> `target`: La cadena de destino que se busca al final de `string`.<br /><br /> **Valor devuelto**<br /><br /> `True` Si `string` termina con `target`; de lo contrario `false`.<br /><br /> **Ejemplo**<br /><br /> `-- The following example returns true.`<br /><br /> `EndsWith('abc', 'bc')` ***Nota:**  Si está utilizando el proveedor de datos de SQL Server, esta función devuelve `false` si la cadena se almacena en una columna de cadena de longitud fija y `target` es una constante.IEn este caso, se buscará en toda la cadena, incluyendo los espacios finales de relleno que pueda haber.AUna posible solución alternativa es recortar los datos en la cadena de longitud fija, como en el ejemplo siguiente:`EndsWith(TRIM(string), target)`|  
