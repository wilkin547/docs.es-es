...
## <a name="remarks"></a>Comentarios  
 ...
 Para obtener más información, vea [Cómo: Llamar a una función](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/dd490951(v=vs.100))definida por el usuario.  
