---
title: "Ejemplos de sintaxis de consulta basada en m&#233;todos: Filtrado | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Ejemplos de sintaxis de consulta basada en m&#233;todos: Filtrado
Los ejemplos de este tema muestran cómo se utilizan los métodos `Where` y `Where…Contains` para consultar el [modelo AdventureWorks Sales](http://msdn.microsoft.com/es-es/f16cd988-673f-4376-b034-129ca93c7832) utilizando la sintaxis de consulta basada en métodos.  Tenga en cuenta que Where…`Contains` no se puede utilizar como parte de una [consulta compilada](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md).  
