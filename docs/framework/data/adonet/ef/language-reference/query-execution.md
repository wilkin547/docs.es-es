---
title: "Ejecuci&#243;n de la consulta | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Ejecución en el almacén  
 ...
 En esta sección se describen los escenarios en que el código se ejecuta localmente en el cliente.  Para obtener más información sobre qué tipos de expresiones se ejecutan localmente, vea [Expresiones en consultas de LINQ to Entities](../../../../../../docs/framework/data/adonet/ef/language-reference/expressions-in-linq-to-entities-queries.md).  
