...
> [!TIP]
> Para obtener un breve resumen de los operadores de consulta en formato de tabla, lo que permite identificar rápidamente el comportamiento de ejecución de un operador, consulte [clasificación de operadores deC#consulta estándar por modo de ejecución ()](../../../../../csharp/programming-guide/concepts/linq/classification-of-standard-query-operators-by-manner-of-execution.md).
