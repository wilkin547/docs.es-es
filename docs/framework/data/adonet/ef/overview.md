...
ms.locfileid: "32759899"
---
# <a name="entity-framework-overview"></a>Información general sobre Entity Framework
...
-   [Obtener acceso y cambiar datos de la entidad](#AccessingData)  
...
## <a name="giving-life-to-models"></a>Dar vida a los modelos  
...
-   El lenguaje de especificación de asignaciones (MSL) define las asignaciones entre los modelos conceptual y de almacenamiento. La extensión de archivo es .msl.  
 ...
 El [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] utiliza estos modelos y asignación de archivos para crear, leer, actualizar y eliminar las entidades y relaciones en el modelo conceptual a las operaciones equivalentes en el origen de datos. El [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] incluso permite asignar las entidades del modelo conceptual a los procedimientos almacenados en el origen de datos. Para obtener más información, consulte [CSDL, SSDL y MSL especificaciones](../../../../../docs/framework/data/adonet/ef/language-reference/csdl-ssdl-and-msl-specifications.md).  
  
<a name="MappingObjectsToData"></a>   
## <a name="mapping-objects-to-data"></a>Asignar objetos a datos  
...
-   [!INCLUDE[esql](../../../../../includes/esql-md.md)]. Un dialecto independiente del almacenamiento de SQL que trabaja directamente con las entidades del modelo conceptual y que admite [!INCLUDE[adonet_edm](../../../../../includes/adonet-edm-md.md)] conceptos. [!INCLUDE[esql](../../../../../includes/esql-md.md)] se utiliza con las consultas de objeto y las consultas que se ejecutan utilizando el proveedor de EntityClient. Para obtener más información, consulte [Entity SQL Overview](../../../../../docs/framework/data/adonet/ef/language-reference/entity-sql-overview.md).  
  
 El [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] incluye el proveedor de datos de EntityClient. Este proveedor administra las conexiones, traduce las consultas de entidad en consultas específicas del origen de datos y devuelve un lector de datos que [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] usa para materializar los datos de la entidad en los objetos. Cuando no se requiere la materialización de objetos, el proveedor de EntityClient también puede utilizarse como un estándar [!INCLUDE[vstecado](../../../../../includes/vstecado-md.md)] proveedor de datos habilitando las aplicaciones se ejecuten [!INCLUDE[esql](../../../../../includes/esql-md.md)] consultas y usar el lector de datos devueltos de solo lectura. Para obtener más información, consulte [proveedor de EntityClient para Entity Framework](../../../../../docs/framework/data/adonet/ef/entityclient-provider-for-the-entity-framework.md).  
...
## <a name="entity-data-model-tools"></a>Herramientas de Entity Data Model  
 Junto con el tiempo de ejecución de [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)], [!INCLUDE[vs_current_long](../../../../../includes/vs-current-long-md.md)] incluye herramientas de asignación y modelado. Para obtener más información, consulte [de modelado y asignación](../../../../../docs/framework/data/adonet/ef/modeling-and-mapping.md).  
...
## <a name="learning-more"></a>Obtener más información  
 ...
 Proporcionan información sobre cómo desarrollar y ejecutar rápidamente, utilice la [inicio rápido](http://msdn.microsoft.com/library/0bc534be-789f-4819-b9f6-76e51d961675), que muestra cómo crear un sencillo [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] aplicación.  
