...
#### <a name="return-the-correct-amount-of-data"></a>Devolver la cantidad correcta de datos  
 ...
 Para evitar devolver demasiados datos en una sola consulta, considere la posibilidad de paginar los resultados de la consulta en grupos que sean más fáciles de administrar. Para obtener más información, vea [Cómo: Página a través de](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb738702(v=vs.100))los resultados de la consulta.  
...
#### <a name="consider-opening-the-database-connection-manually"></a>Considerar la posibilidad de abrir manualmente la conexión de la base de datos  
 Cuando la aplicación ejecuta una serie de consultas de objeto o llamadas <xref:System.Data.Objects.ObjectContext.SaveChanges%2A> con frecuencia para conservar las operaciones de creación, actualización y eliminación en el origen de datos, el Entity Framework debe abrir y cerrar continuamente la conexión al origen de datos. En estos casos, considere la posibilidad de abrir manualmente la conexión al comienzo de estas operaciones y cerrarla o eliminarla una vez finalizadas dichas operaciones. Para obtener más información, consulte [Administración de conexiones y transacciones](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb896325(v=vs.100)).  
