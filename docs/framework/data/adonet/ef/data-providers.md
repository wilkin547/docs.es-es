...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe el [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] proveedor de datos que admita la [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] para su uso con una base de datos de SQL Server.  
