...
|ColumName|DataType|Descripción|  
|----------------|--------------|-----------------|  
|CONSTRAINT_CATALOG|Cadena|Catálogo al que pertenece la restricción.|  
|CONSTRAINT_SCHEMA|Cadena|Esquema que contiene la restricción.|  
|CONSTRAINT_NAME|Cadena|Nombre.|  
|TABLE_CATALOG|Cadena|Nombre de la tabla de la que forma parte la restricción.|  
|TABLE_SCHEMA|Cadena|Esquema que contiene la tabla.|  
|TABLE_NAME|Cadena|Nombre de la tabla|  
|CONSTRAINT_TYPE|Cadena|Tipo de restricción. Sólo se permite "FOREIGN KEY".|  
|IS_DEFERRABLE|Cadena|Especifica si la restricción es aplazable. Devuelve NO.|  
|INITIALLY_DEFERRED|Cadena|Especifica si la restricción es inicialmente aplazable. Devuelve NO.|  
...
|ColumName|DataType|Descripción|  
|----------------|--------------|-----------------|  
|SPECIFIC_CATALOG|Cadena|Nombre específico del catálogo.|  
|SPECIFIC_SCHEMA|Cadena|Nombre específico del esquema.|  
|SPECIFIC_NAME|Cadena|Nombre específico del catálogo.|  
|ROUTINE_CATALOG|Cadena|Catálogo al que pertenece el procedimiento almacenado.|  
|ROUTINE_SCHEMA|Cadena|Esquema que contiene el procedimiento almacenado.|  
|ROUTINE_NAME|Cadena|Nombre del procedimiento almacenado.|  
|ROUTINE_TYPE|Cadena|Devuelve PROCEDURE en el caso de los procedimientos almacenados y FUNCTION en el caso de las funciones.|  
...
|PARAMETER_MODE|Cadena|Devuelve IN si es un parámetro de entrada, OUT si es un parámetro de salida e INOUT si es un parámetro de entrada y salida.|  
|IS_RESULT|Cadena|Devuelve YES si indica que el resultado del procedimiento es una función. De lo contrario, devuelve NO.|  
|AS_LOCATOR|Cadena|Devuelve YES si se declara como localizador. De lo contrario, devuelve NO.|  
|PARAMETER_NAME|Cadena|Nombre del parámetro. NULL si corresponde al valor devuelto de una función.|  
|DATA_TYPE|Cadena|Tipo de datos suministrado por el sistema.|  
...
|COLLATION_NAME|Cadena|Nombre de la intercalación del parámetro. Si no es uno de los tipos de caracteres, devuelve NULL.|  
|CHARACTER_SET_CATALOG|Cadena|Nombre de catálogo del juego de caracteres del parámetro. Si no es uno de los tipos de caracteres, devuelve NULL.|  
|CHARACTER_SET_SCHEMA|Cadena|Siempre devuelve NULL.|  
|CHARACTER_SET_NAME|Cadena|Nombre del juego de caracteres del parámetro. Si no es uno de los tipos de caracteres, devuelve NULL.|  
...
|INTERVAL_TYPE|Cadena|NULL. Reservado por SQL Server para uso futuro.|  
...
|ColumName|DataType|Descripción|  
|----------------|--------------|-----------------|  
|TABLE_CATALOG|Cadena|Catálogo de la tabla.|  
|TABLE_SCHEMA|Cadena|Esquema que contiene la tabla.|  
|TABLE_NAME|Cadena|Nombre de la tabla.|  
|TABLE_TYPE|Cadena|Tipo de tabla. Puede ser VIEW o BASE TABLE.|  
...
|COLUMN_DEFAULT|Cadena|Valor predeterminado de la columna.|  
|IS_NULLABLE|Cadena|Capacidad de la columna de admitir valores NULL. Si esta columna permite NULL, devuelve YES. De lo contrario, devuelve NO.|  
|DATA_TYPE|Cadena|Tipo de datos suministrado por el sistema.|  
...
|CHARACTER_SET_CATALOG|Cadena|Devuelve Master, para indicar la base de datos en la que se encuentra el juego de caracteres, si la columna es del tipo de datos de caracteres o de texto. De lo contrario, devuelve NULL.|  
|CHARACTER_SET_SCHEMA|Cadena|Siempre devuelve NULL.|  
|CHARACTER_SET_NAME|Cadena|Devuelve el nombre único del juego de caracteres si esta columna es del tipo de datos de caracteres o de texto. De lo contrario, devuelve NULL.|  
|COLLATION_CATALOG|Cadena|Devuelve Master, para indicar la base de datos en la que se define la intercalación, si la columna es del tipo de datos de caracteres o de texto. De lo contrario, esta columna es NULL.|  
...
|user_name|Cadena|Nombre de usuario o nombre del grupo, único en esta base de datos.|  
...
|ColumName|DataType|Descripción|  
|----------------|--------------|-----------------|  
|TABLE_CATALOG|Cadena|Catálogo de la vista.|  
|TABLE_SCHEMA|Cadena|Esquema que contiene la vista.|  
|TABLE_NAME|Cadena|Nombre de la vista.|  
|CHECK_OPTION|Cadena|Tipo de WITH CHECK OPTION. Es CASCADE si la vista original se creó mediante WITH CHECK OPTION. De lo contrario, se devuelve NONE.|  
|IS_UPDATABLE|Cadena|Especifica si la vista se puede actualizar. Siempre devuelve NO.|  
  
## <a name="viewcolumns"></a>ViewColumns  
  
|ColumName|DataType|Descripción|  
|----------------|--------------|-----------------|  
|VIEW_CATALOG|Cadena|Catálogo de la vista.|  
|VIEW_SCHEMA|Cadena|Esquema que contiene la vista.|  
|VIEW_NAME|Cadena|Nombre de la vista.|  
|TABLE_CATALOG|Cadena|Catálogo de la tabla asociada con esta vista.|  
|TABLE_SCHEMA|Cadena|Esquema que contiene la tabla asociada con esta vista.|  
|TABLE_NAME|Cadena|Nombre de la tabla asociada con esta vista. Tabla base.|  
|COLUMN_NAME|String|Nombre de columna.|  
...
|udt_name|Cadena|Nombre de clase del ensamblado.|  
...
|Permission_set_desc|Cadena|Nombre descriptivo del conjunto de permisos y nivel de seguridad del ensamblado.|  
