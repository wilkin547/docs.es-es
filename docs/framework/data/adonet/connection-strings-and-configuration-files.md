...
### <a name="webconfig-example"></a>Ejemplo de Web.config  
 ...
 Para obtener más información sobre cómo proteger las aplicaciones de ASP.NET, consulte [protección de sitios web de ASP.net](/previous-versions/aspnet/91f66yxt(v=vs.100)).  
