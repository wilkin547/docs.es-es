...
---
# <a name="method-based-query-syntax-examples-projection-linq-to-dataset"></a>Ejemplos de sintaxis de consultas basadas en métodos: Proyección (LINQ to DataSet)
