...
```  
 ...
 No se admite el establecimiento de ANSI\_NULLS en OFF en un `DataSet`, ya que siempre sigue el estándar ANSI SQL\-92 para el tratamiento de valores NULL en <xref:System.Data.SqlTypes>.  
