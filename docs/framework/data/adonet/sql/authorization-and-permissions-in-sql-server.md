---
title: "Autorizaci&#243;n y permisos en SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Recurso|Descripción|  
|-------------|-----------------|  
|[Permisos](http://msdn.microsoft.com/library/ms191291.aspx) en los Libros en pantalla de SQL Server.|Contiene temas que describen la jerarquía de permisos, las vistas de catálogo y permisos de servidores fijos y roles de bases de datos.|  
