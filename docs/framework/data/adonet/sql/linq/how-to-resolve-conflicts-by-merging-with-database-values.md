---
title: Procedimiento Resolver conflictos de combinación con los valores de la base de datos
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54744133"
---
# <a name="how-to-resolve-conflicts-by-merging-with-database-values"></a>Procedimiento Resolver conflictos de combinación con los valores de la base de datos
Para conciliar las diferencias entre los valores de base de datos esperados y reales antes de intentar reenviar los cambios, puede utilizar <xref:System.Data.Linq.RefreshMode.KeepChanges> para fusionar mediante combinación los valores de base de datos con los valores de miembro de cliente actuales. Para obtener más información, consulte [simultaneidad optimista: Información general sobre](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md).  
