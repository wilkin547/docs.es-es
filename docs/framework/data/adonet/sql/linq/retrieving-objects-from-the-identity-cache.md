---
title: "Recuperar objetos de la memoria cach&#233; de identidad | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Recuperar objetos de la memoria cach&#233; de identidad
...
> [!NOTE]
>  Las consultas precompiladas no devolverán objetos desde la memoria caché de identidad.  Para obtener más información acerca de las consultas precompiladas, vea <xref:System.Data.Linq.CompiledQuery> y [Cómo: Almacenar y volver a usar consultas](../../../../../../docs/framework/data/adonet/sql/linq/how-to-store-and-reuse-queries.md).  
