...
|--------------|----------|-------------|-----------------|  
|<xref:System.Data.Linq.Mapping.DatabaseAttribute.Name%2A>|Cadena|Consulta <xref:System.Data.Linq.Mapping.DatabaseAttribute.Name%2A>.|Cuando se usa con su propiedad <xref:System.Data.Linq.Mapping.DatabaseAttribute.Name%2A>, especifica el nombre de la base de datos.|  
...
|<xref:System.Data.Linq.Mapping.AssociationAttribute.DeleteRule%2A>|Cadena|None|Agrega comportamiento de eliminación a una asociación.|  
...
|<xref:System.Data.Linq.Mapping.InheritanceMappingAttribute.Type%2A>|Type|Ninguno. El valor debe suministrarse.|Especifica el tipo de la clase en la jerarquía.|  
...
|Propiedad|Type|Valor predeterminado|DESCRIPCIÓN|  
|--------------|----------|-------------|-----------------|  
|<xref:System.Data.Linq.Mapping.ParameterAttribute.DbType%2A>|Cadena|None|Especifica el tipo de base de datos.|  
...
|Propiedad|Type|Valor predeterminado|DESCRIPCIÓN|  
|--------------|----------|-------------|-----------------|  
|<xref:System.Data.Linq.Mapping.ResultTypeAttribute.Type%2A>|Type|(Ninguno)|Se utiliza en los métodos asignados a los procedimientos almacenados que devuelven <xref:System.Data.Linq.IMultipleResults>. Declara las asignaciones de tipos válidas o esperadas para el procedimiento almacenado.|  
