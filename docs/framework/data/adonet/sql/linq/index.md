...
> Los datos relacionales se muestran como una colección de tablas bidimensionales (*relaciones* o *archivos sin formato*), donde las columnas comunes relacionan las tablas entre sí. Para utilizar [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] con eficacia, debe estar un poco familiarizado con los principios subyacentes de las bases de datos relacionales.  
 ...
 Los desarrolladores que usan Visual Studio suelen usar el Object Relational Designer, que proporciona una interfaz de usuario para implementar muchas de [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]las características de.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Muestras](samples.md)  
 Proporciona vínculos a Visual Basic y C# ejemplos.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Describe [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)] las tecnologías para Visual Basic usuarios.  
 ...
 Describe cómo <xref:System.Web.UI.WebControls.LinqDataSource> [!INCLUDE[vbteclinqext](../../../../../../includes/vbteclinqext-md.md)] expone el control a los desarrolladores web a través de la arquitectura de control de código fuente de datos ASP.net.
