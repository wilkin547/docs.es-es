...
## <a name="in-this-section"></a>En esta sección  
 Versión de Visual Basic de la solución SampleQueries  
 [Ejemplos de consultas (Visual Basic)](~/docs/visual-basic/programming-guide/language-features/linq/introduction-to-linq.md)  
