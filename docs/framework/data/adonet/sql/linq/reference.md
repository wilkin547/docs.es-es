...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe cómo las construcciones de Common Language Runtime (CLR) tienen expresiones correspondientes en SQL solo [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] donde ha proporcionado explícitamente una conversión en el motor de traducción.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Proporciona portales para [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)] los temas.  
 ...
 Describe cómo <xref:System.Web.UI.WebControls.LinqDataSource> [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)] expone el control a los desarrolladores web a través de la arquitectura de control de código fuente de datos ASP.net.
