...
Las siguientes secciones dan respuesta a algunos problemas comunes que podría encontrar al implementar [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)].  
 ...
 En [Solución de problemas](../../../../../../docs/framework/data/adonet/sql/linq/troubleshooting.md) se tratan otros posibles problemas que puedan surgir.  
  
## No se puede conectar  
 P.  No puedo conectarme a mi base de datos.  
  
 Un archivo .  Asegúrese de que su cadena de conexión es correcta y de que su instancia de [!INCLUDE[ssNoVersion](../../../../../../includes/ssnoversion-md.md)] se está ejecutando.  También tenga en cuenta que [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] requiere que el protocolo Canalizaciones con nombre esté habilitado.  Para obtener más información, consulte [Aprender mediante tutoriales](../../../../../../docs/framework/data/adonet/sql/linq/learning-by-walkthroughs.md).  
...
-   Opciones de la cadena de conexión; por ejemplo, habilitar conjuntos de resultados activos múltiples \(MARS\).  Para obtener más información, consulte [Varios conjuntos de resultados activos \(MARS\)](../../../../../../docs/framework/data/adonet/sql/multiple-active-result-sets-mars.md).  
...
-   Especificando explícitamente un parámetro de salida.  
 ...
 Para obtener más información, consulte [Personalizar las operaciones mediante procedimientos almacenados exclusivamente](../../../../../../docs/framework/data/adonet/sql/linq/customizing-operations-by-using-stored-procedures.md).  
...
## Errores de serialización  
 ...
 Un archivo .  La generación de código en [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] admite serialización <xref:System.Runtime.Serialization.DataContractSerializer>.  No admite <xref:System.Xml.Serialization.XmlSerializer> o <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter>.  Para obtener más información, consulte [Serialización](../../../../../../docs/framework/data/adonet/sql/linq/serialization.md).  
  
## Múltiples archivos DBML  
 P.  Cuando tengo varios archivos DBML que comparten algunas tablas, obtengo un error del compilador.  
  
 Un archivo .  Establezca las propiedades **Espacio de nombres del contexto** y **Espacio de nombres de la entidad** de [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)] en un valor distinto para cada archivo DBML.  Este enfoque elimina la colisión entre nombres o espacios de nombres.  
...
3.  Revise el valor predeterminado de <xref:System.Data.Linq.Mapping.UpdateCheck> \(<xref:System.Data.Linq.Mapping.UpdateCheck>\) para determinar si ése es el valor correcto para su aplicación.  
...
## APTCA  
 ...
 El principal escenario de [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] para permitir llamadores que no son de plena confianza es habilitar el ensamblado de [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] desde aplicaciones web, cuya configuración de *confianza* es Media.  
...
## Agrupación de conexiones  
 ...
 Puede seguir utilizando agrupamiento de conexiones [!INCLUDE[vstecado](../../../../../../includes/vstecado-md.md)] subyacente.  Para obtener más información, consulte [Agrupación de conexiones en SQL Server \(ADO.NET\)](../../../../../../docs/framework/data/adonet/sql-server-connection-pooling.md).  
