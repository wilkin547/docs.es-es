...
## <a name="see-also"></a>Vea también  
 ...
 [Cómo: reutilizar una conexión entre un comando de ADO.NET y una clase DataContext](../../../../../../docs/framework/data/adonet/sql/linq/how-to-reuse-a-connection-between-an-ado-net-command-and-a-datacontext.md)
