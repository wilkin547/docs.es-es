---
title: "Niveles de LINQ to SQL con servicios Web | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Seguimiento de cambios para actualizaciones y eliminaciones  
 ...
 Para obtener más información, consulta [Recuperación de datos y operaciones CUD en aplicaciones de niveles N \(LINQ to SQL\)](../../../../../../docs/framework/data/adonet/sql/linq/data-retrieval-and-cud-operations-in-n-tier-applications.md).  
...
## Vea también  
 ...
 [NIB: LinqDataSource Web Server Control Overview](http://msdn.microsoft.com/es-es/104cfc3f-7385-47d3-8a51-830dfa791136)