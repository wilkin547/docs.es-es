...
## <a name="example"></a>Ejemplo  
 ...
 En este ejemplo <xref:System.Linq.Queryable.Intersect%2A> se usa para devolver una secuencia de todos los países o regiones en los que `Customers` y `Employees` Live.  
