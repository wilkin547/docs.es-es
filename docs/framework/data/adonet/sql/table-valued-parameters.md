---
title: "Par&#225;metros con valores de tabla | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Recurso|Descripción|  
|-------------|-----------------|  
|[Parámetros con valores de tabla \(motor de base de datos\)](http://go.microsoft.com/fwlink/?LinkId=98363) en [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] los Libros en pantalla.|Describe cómo se crean y se usan los parámetros con valores de tabla.|  
|[Tipos definidos por el usuario](http://go.microsoft.com/fwlink/?LinkId=98364) en [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] los Libros en pantalla.|Describe los tipos de tabla definidos por el usuario que se usan para declarar parámetros con valores de tabla.|  
|La sección del [Motor de base de datos de Microsoft SQL Server](http://go.microsoft.com/fwlink/?LinkId=120507) de [CodePlex](http://go.microsoft.com/fwlink/?LinkID=67739)|Contiene ejemplos que muestran el uso de las características y la funcionalidad de [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)].|  
  
## Pasar varias filas de versiones previas de SQL Server  
...
## Modificar datos con parámetros con valores de tabla \(Transact\-SQL\)  
...
## Limitaciones de los parámetros con valores de tabla  
 Existen varias limitaciones en los parámetros con valores de tabla:  
  
-   No puede pasar parámetros con valores de tabla en las [funciones CLR definidas por el usuario](http://msdn.microsoft.com/library/ms131077.aspx).  
...
## Configurar un ejemplo de SqlParameter  
 <xref:System.Data.SqlClient> admite rellenar parámetros con valores de tabla desde objetos<xref:System.Data.DataTable>, <xref:System.Data.Common.DbDataReader> o System.Collections.Generic.IEnumerable\<<xref:Microsoft.SqlServer.Server.SqlDataRecord>\> \(<xref:System.Collections.Generic.IEnumerable%601>?qualifyHint=False&autoUpgrade=True).  Debe especificar un nombre de tipo para el parámetro con valores de tabla mediante la propiedad <xref:System.Data.SqlClient.SqlParameter.TypeName%2A> de una clase <xref:System.Data.SqlClient.SqlParameter>.  El valor de `TypeName` debe coincidir con el nombre de un tipo compatible previamente creado en el servidor.  El fragmento de código siguiente muestra cómo se configura <xref:System.Data.SqlClient.SqlParameter> para insertar datos.  
...
### Pasar un parámetro con valores de tabla a una instrucción SQL con parámetros  
...
> [!NOTE]
>  Si proporciona un valor para una columna de identidad de un parámetro con valores de tabla, debe emitir la instrucción SET IDENTITY\_INSERT de la sesión.  
...
## Transmitir filas por secuencias con un DataReader  
