---
title: "Varias operaciones de copia masiva | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Se pueden realizar varias operaciones de copia masiva con una única instancia de una clase <xref:System.Data.SqlClient.SqlBulkCopy>.  Si los parámetros de la operación varían de una copia a otra \(por ejemplo, el nombre de la tabla de destino\), deberá actualizarlos antes de las subsiguientes llamadas a los métodos **WriteToServer**, como se demuestra en el ejemplo siguiente.  A menos que se cambien explícitamente, todos los valores de propiedades permanecen igual que estaban en la operación anterior de copia masiva de una determinada instancia.  
