---
title: "Conceder permisos por filas en SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Conceder permisos por filas en SQL Server
...
## Implementación de filtros por filas  
...
-   Habilite el filtrado por filas:  
    ...
    -   Si usa SQL Server 2016 o posterior, o la [Base de datos SQL de Azure](https://azure.microsoft.com/documentation/services/sql-database/), cree una directiva de seguridad que agregue un predicado en la tabla restringiendo las filas devueltas a aquellas que coinciden con el usuario de base de datos actual \(mediante la función integrada CURRENT\_USER\(\)\) o el nombre de inicio de sesión actual \(mediante la función integrada de SUSER\_SNAME\(\)\):  
...
## Vea también  
 [Seguridad por filas](https://msdn.microsoft.com/library/dn765131.aspx)   
