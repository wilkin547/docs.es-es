---
title: "Reflejo de bases de datos en SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Reflejo de bases de datos en SQL Server
...
|Recurso|Descripción|  
|-------------|-----------------|  
|[Creación de reflejo de la base de datos](http://msdn.microsoft.com/library/bb934127.aspx) en los Libros en pantalla de SQL Server.|Describe cómo establecer y configurar la creación de reflejos en SQL Server.|  
