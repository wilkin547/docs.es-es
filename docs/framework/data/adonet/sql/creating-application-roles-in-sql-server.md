...
|Recurso|Descripción|  
|--------------|-----------------|  
|[Roles de aplicación](http://msdn.microsoft.com/library/ms190998.aspx) en libros en pantalla de SQL Server|Describe cómo crear y usar roles de aplicación en SQL Server 2008.|  
