...
---
# faceta
Una *faceta* se utiliza para agregar detalle a una definición de propiedad del tipo primitivo.  Una definición de [propiedad](../../../../docs/framework/data/adonet/property.md) contiene información sobre el tipo de propiedad, pero a menudo es necesario especificar más detalles.  Por ejemplo, un tipo de entidad en un modelo conceptual podría tener una propiedad de tipo `String` cuyo valor no se puede establecer en NULL.  Las facetas permiten especificar este nivel de detalle.  
