...
## <a name="sql-server-decimal-type"></a>Tipo decimal de SQL Server  
 ...
 ADO.net 2,0 presentó compatibilidad <xref:System.Data.SqlTypes> mejorada con `DataSet`en. Para obtener más información, consulta [SqlTypes and the DataSet](./sql/sqltypes-and-the-dataset.md).  
