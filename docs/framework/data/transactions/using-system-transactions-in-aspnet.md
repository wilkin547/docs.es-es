...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] , consulte [Elemento securityPolicy (Esquema de configuración de ASP.NET)](http://msdn.microsoft.com/en-us/469d8d22-d263-46bb-8400-40d8d027faba).  
...
```  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [Elemento add aplicado a assemblies para compilation (Esquema de configuración de ASP.NET)](http://msdn.microsoft.com/en-us/602197e8-108d-4249-b752-ba2a318f75e4).  
