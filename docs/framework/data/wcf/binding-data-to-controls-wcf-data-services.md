...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Enlazar datos a elementos de Windows Presentation Foundation  
 ...
 Para obtener más información, vea [Cómo: Enlazar datos a elementos](bind-data-to-wpf-elements-wcf-data-services.md)de Windows Presentation Foundation.  
...
## <a name="binding-paged-data"></a>Enlazar datos paginados  
 ...
 Los objetos relacionados se cargan de una manera similar. Para obtener más información, consulte [Cómo Enlazar datos a elementos](bind-data-to-wpf-elements-wcf-data-services.md)de Windows Presentation Foundation.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] no realiza ninguna validación de los comportamientos personalizados que implementa el usuario en estos delegados.  
 ...
 Para obtener más información, vea [Cómo: Personalizar comportamientos](how-to-customize-data-binding-behaviors-wcf-data-services.md)de enlace de datos.  
...
- [Procedimientos: Generar manualmente clases del servicio de datos del cliente](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
