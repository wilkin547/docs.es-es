...
---
# <a name="how-to-create-a-data-service-using-a-linq-to-sql-data-source-wcf-data-services"></a>Filtrar Crear un servicio de datos mediante LINQ al origen de datos SQL (WCF Data Services)
