...
Los temas de introducción de [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] se pueden encontrar en las ubicaciones siguientes. Muchos de estos temas también contienen vínculos a temas relacionados que contienen información más detallada.  
 ...
 Describe cómo diseñar y tener acceso a un servicio de datos mediante [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)], tal y como se muestra en el [inicio rápido](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md).  
 ...
 [Visual Studio y glosario de .NET Framework](http://msdn.microsoft.com/library/6529d7c6-7e25-4426-a120-d57b239ca4eb)  
 Incluye términos usados en [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] y [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] documentación.  
  
## <a name="external-resources"></a>Recursos externos  
 Los recursos externos siguientes proporcionan información adicional y soporte técnico para la creación [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] aplicaciones que exponen y consumen [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] fuentes de distribución.  
  
 [Foro de servicios de datos WCF](http://go.microsoft.com/fwlink/?LinkId=150512)  
 ...
 [Sitio Web de OData](http://go.microsoft.com/fwlink/?LinkID=184554)  
 ...
 Contiene servicios de ejemplo, ejemplos y bibliotecas de programación que permiten trabajar con [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] fuentes de distribución.  
 ...
 [Acceso a datos y el centro de desarrolladores de almacenamiento](http://go.microsoft.com/fwlink/?LinkId=91903)  
 Ubicación central para buscar información y recursos para trabajar con datos.  
  
 [Plataforma de datos ¿cómo puedo? Vídeos: Serie de WCF Data Services](http://go.microsoft.com/fwlink/?LinkId=124600)  
 ...
 [Información general: WCF Data Services](http://go.microsoft.com/fwlink/?LinkID=131074)  
 Notas del producto que proporcionan información general sobre las ventajas de [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)].  
  
 [Usar Microsoft WCF Data Services](http://go.microsoft.com/fwlink/?LinkID=131075)  
 ...
 [El modelo entidad-relación: Hacia una vista unificada de los datos](http://go.microsoft.com/fwlink/?LinkId=91909) por Peter Pin-Shan Chen, Massachusetts Institute of Technology  
