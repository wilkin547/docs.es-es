---
title: "C&#243;mo: Interceptar mensajes del servicio de datos (WCF Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Con [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)], puede interceptar mensajes de solicitud, lo que le permitirá agregar lógica personalizada a una operación.  Para interceptar un mensaje, se usan métodos con atributos especiales con el servicio de datos.  Para obtener más información, consulta [Interceptores](../../../../docs/framework/data/wcf/interceptors-wcf-data-services.md).  
  
 En el ejemplo de este tema se usa el servicio de datos de ejemplo Northwind.  Este servicio se crea cuando se completa el [Tutorial rápido de WCF Data Services](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md).  
