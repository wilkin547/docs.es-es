...
- <xref:System.Data.Services.Client.DataServiceContext.BeginExecute%2A> Al tener acceso al servicio de datos de forma asincrónica, debe utilizar los / <xref:System.Data.Services.Client.DataServiceContext.EndExecute%2A> métodos asincrónicos <xref:System.Data.Services.Client.DataServiceContext> equivalentes <xref:System.Data.Services.Client.DataServiceQuery%601.BeginExecute%2A> en o <xref:System.Data.Services.Client.DataServiceQuery%601>los / <xref:System.Data.Services.Client.DataServiceQuery%601.EndExecute%2A> métodos de.  
...
- Cuando se usa <xref:System.Data.Services.Client.DataServiceContext.CreateQuery%2A> para llamar a una operación de servicio, la biblioteca de cliente convierte automáticamente en caracteres <xref:System.Data.Services.Client.DataServiceQuery%601.AddQueryOption%2A> de escape los caracteres proporcionados al mediante la codificación porcentual de caracteres reservados, como la y comercial (&), y el escape de comillas simples en String. Sin embargo, al llamar a uno de los métodos *Execute* para llamar a una operación de servicio, debe recordar realizar este escape de cualquier valor de cadena proporcionado por el usuario. Las comillas simples de los URI se pasan como pares de comillas simples.  
...
- [Llamar a una operación de servicio que no devuelve datos](calling-service-operations-wcf-data-services.md#ExecuteVoid)  
  
- [Llamar a una operación de servicio de forma asincrónica](calling-service-operations-wcf-data-services.md#ExecuteAsync)  
