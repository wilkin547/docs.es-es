...
Servicios de datos de WCF admite un conjunto básico de escenarios para exponer y consumir datos como fuentes Open Data Protocol (OData). Este tema remite a los temas importantes en estos escenarios.
...
- [Cómo: Enlazar datos del servicio de datos a controles (Cliente de Silverlight)](/previous-versions/dotnet/wcf-data-services/ee681614(v=vs.103))
...
- [OData: formato de notación de objetos JavaScript (JSON)](https://www.odata.org/developers/protocols/json-format/)
...
- [Procedimiento para ejecutar consultas asincrónicas de servicios de datos](how-to-execute-asynchronous-data-service-queries-wcf-data-services.md)
...
- [Procedimiento para enlazar datos mediante un origen de datos del proyecto](how-to-bind-data-using-a-project-data-source-wcf-data-services.md)
...
- [Procedimiento para interceptar mensajes de servicios de datos](how-to-intercept-data-service-messages-wcf-data-services.md)
