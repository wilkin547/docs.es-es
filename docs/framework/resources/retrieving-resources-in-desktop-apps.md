---
title: "Recuperar recursos de aplicaciones de escritorio | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "localización"
  - "controlar la versión de los ensamblados satélite"
  - "recuperar recursos localizados"
  - "recursos de la aplicación, implementar"
  - "empaquetar recursos de la aplicación"
  - "controlar la versión de los recursos"
  - "traducir recursos"
  - "adaptar recursos"
...
### Dos ejemplos de recuperación de datos de objeto  
...
## Vea también  
 ...
 [Crear y recuperar recursos en aplicaciones de la Tienda Windows](http://go.microsoft.com/fwlink/p/?LinkID=241674)