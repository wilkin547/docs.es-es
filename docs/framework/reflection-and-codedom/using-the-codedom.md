...
### Compilar un modelo de código fuente para el programa de ejemplo Hola a todos  
 En el siguiente tutorial se muestra un ejemplo de cómo compilar un gráfico de objetos CodeDOM que representa el código de una aplicación Hola a todos sencilla.  Para obtener el código fuente completo de este código de ejemplo, vea el tema <xref:System.CodeDom.Compiler.CodeDomProvider?displayProperty=fullName>.  
...
#### Definir un espacio de nombres  
 Para definir un espacio de nombres, cree un objeto <xref:System.CodeDom.CodeNamespace> y asígnele un nombre utilizando el constructor correspondiente o estableciendo su propiedad **Name**.  
...
#### Vincular elementos de código al gráfico de objetos  
 ...
 La siguiente instrucción agrega el espacio de nombres **CodeNamespace** denominado `samples` a la propiedad de colección **Namespaces** del objeto raíz **CodeCompileUnit**.  
...
#### Definir un tipo  
 Para declarar una clase, estructura, interfaz o enumeración utilizando CodeDOM, cree un nuevo objeto <xref:System.CodeDom.CodeTypeDeclaration> y asígnele un nombre.  En el siguiente ejemplo se muestra cómo asignar un nombre mediante una sobrecarga de constructor para establecer la propiedad **Name**:  
...
#### Definir un método de punto de entrada de código para un archivo ejecutable  
...
### Más información sobre la forma de compilar un gráfico CodeDOM.  
 ...
 Para ver un gráfico que localice rápidamente el elemento de CodeDOM que representa un tipo específico de elemento de código, vea [Referencia rápida de CodeDOM](http://msdn.microsoft.com/es-es/c77b8bfd-0a32-4e36-b59a-4f687f32c524).