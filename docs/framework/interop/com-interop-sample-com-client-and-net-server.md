...
---
# <a name="com-interop-sample-com-client-and-net-server"></a><span data-ttu-id="ea258-102">Ejemplo de interoperabilidad COM: Cliente COM y servidor .NET</span><span class="sxs-lookup"><span data-stu-id="ea258-102">COM Interop Sample: COM Client and .NET Server</span></span>
<span data-ttu-id="ea258-103">En este ejemplo se muestra la interoperación de un [cliente COM](#cpconcominteropsamplecomclientnetserveranchor1) y un [servidor .NET](#cpconcominteropsamplecomclientnetserveranchor2) que realiza cálculos de hipotecas.</span><span class="sxs-lookup"><span data-stu-id="ea258-103">This sample demonstrates the interoperation of a [COM Client](#cpconcominteropsamplecomclientnetserveranchor1) and a [.NET Server](#cpconcominteropsamplecomclientnetserveranchor2) that performs mortgage calculations.</span></span> <span data-ttu-id="ea258-104">En este ejemplo, el cliente crea y llama a una instancia de la clase administrada `Loan`, pasa cuatro argumentos (uno de ellos igual a cero) a la instancia y muestra los cálculos.</span><span class="sxs-lookup"><span data-stu-id="ea258-104">In this example, the client creates and calls an instance of the managed `Loan` class, passes four arguments (one of those four being equal to zero) to the instance, and displays the computations.</span></span> <span data-ttu-id="ea258-105">A lo largo de esta sección aparecen ejemplos de código de este ejemplo.</span><span class="sxs-lookup"><span data-stu-id="ea258-105">Code examples from this sample appear throughout this section.</span></span>  
  
<a name="cpconcominteropsamplecomclientnetserveranchor1"></a>   
## <a name="com-client"></a><span data-ttu-id="ea258-106">Cliente COM</span><span class="sxs-lookup"><span data-stu-id="ea258-106">COM Client</span></span>  
...
## <a name="net-server"></a><span data-ttu-id="ea258-107">Servidor .NET</span><span class="sxs-lookup"><span data-stu-id="ea258-107">.NET Server</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ea258-108">Vea también</span><span class="sxs-lookup"><span data-stu-id="ea258-108">See also</span></span>

- [<span data-ttu-id="ea258-109">Exponer componentes de .NET Framework en COM</span><span class="sxs-lookup"><span data-stu-id="ea258-109">Exposing .NET Framework Components to COM</span></span>](../../../docs/framework/interop/exposing-dotnet-components-to-com.md)
