...
Si necesita enumerar un directorio específico, simplemente agréguelo al final del URI que se usa en el método <xref:System.Net.WebRequest.Create%2A?displayProperty=nameWithType>:
