...
---
# <a name="how-to-configure-network-tracing"></a>Procedimientos para: configurar el seguimiento de red
...
El archivo de configuración del equipo, machine.config, se almacena en la carpeta %windir%\Microsoft.NET\Framework. Hay un archivo machine.config independiente en las carpetas en %Windir%\Microsoft.NET\Framework para cada versión de .NET Framework instalada en el equipo, por ejemplo:
