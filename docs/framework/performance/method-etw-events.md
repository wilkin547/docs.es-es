...
|------------------------------------------|-----------|  
|Proveedor de runtime `JITKeyword` \(0x10\)|Informativo \(4\)|  
|Proveedor de runtime `NGenKeyword` \(0x20\)|Informativo \(4\)|  
|Proveedor de detención `JitRundownKeyword` \(0x10\)|Informativo \(4\)|  
|Proveedor de detención `NGENRundownKeyword` \(0x20\)|Informativo \(4\)|  
...
|Palabra clave para generar el evento|Nivel|  
|------------------------------------------|-----------|  
|Proveedor de detención `AppDomainResourceManagementRundownKeyword` \(0x800\)|Informativo \(4\)|  
|Proveedor de detención `JitRundownKeyword` \(0x10\)|Informativo \(4\)|  
|Proveedor de detención `NGENRundownKeyword` \(0x20\)|Informativo \(4\)|  
...
|Proveedor de runtime `NGenKeyword` \(0x20\)|Detallado \(5\)|  
