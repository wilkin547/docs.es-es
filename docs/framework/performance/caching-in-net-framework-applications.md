...
- [Tutorial: Almacenar en caché datos de la aplicación en una aplicación de WPF](/dotnet/desktop/wpf/advanced/walkthrough-caching-application-data-in-a-wpf-application)
- [Tutorial: Almacenar en caché datos de la aplicación en ASP.NET](/previous-versions/ff477235(v=vs.100))
