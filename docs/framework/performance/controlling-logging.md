...
## Capturar eventos ETW de CLR  
 Puede utilizar las herramientas de línea de comandos [Logman](http://go.microsoft.com/fwlink/?LinkId=150916) y [Xperf](http://msdn.microsoft.com/library/windows/hardware/hh162920.aspx) para capturar eventos ETW y las herramientas [Tracerpt](http://go.microsoft.com/fwlink/?LinkId=150919) y [Xperf](http://msdn.microsoft.com/library/windows/hardware/hh162920.aspx) para descodificar eventos de seguimiento.  
...
## Ver eventos ETW de CLR  
 Utilice los comandos enumerados a continuación para ver los eventos ETW de CLR.  Para obtener una descripción de los eventos, vea [CLR ETW Events](../../../docs/framework/performance/clr-etw-events.md).  
