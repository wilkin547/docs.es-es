...
## Servicios disponibles desde el contexto de servicio XAML de .NET Framework  
 ...
 **Relevante para:** operación básica de una infraestructura basada en servicios en .NET Framework para que se puede llamar a <xref:System.IServiceProvider.GetService%2A?displayProperty=fullName>.  
