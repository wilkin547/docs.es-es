...
## Comentarios  
 `x:Key` es compatible con el concepto de diccionario de recursos XAML.  XAML como lenguaje no define una implementación de diccionario de recursos, que se deja para los marcos de IU.  Para obtener más información sobre cómo se implementan los diccionarios de recursos XAML en WPF, vea [Recursos XAML](../../../docs/framework/wpf/advanced/xaml-resources.md).  
