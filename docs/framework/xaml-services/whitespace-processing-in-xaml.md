...
## <a name="white-space-definition"></a>Definición de espacio en blanco  
 Coherente con XML, los caracteres de espacio en blanco en [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] son el espacio, el avance de barra y la tabulación. Se corresponden con los valores Unicode 0020, 000A y 0009, respectivamente.  
