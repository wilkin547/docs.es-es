...
---
# <a name="clear-element-for-connectionmanagement-network-settings"></a>\<borrar el elemento > de connectionManagement (configuración de red)
...
## <a name="example"></a>Ejemplo  
 En el siguiente ejemplo se borra la lista de administración de conexiones y, después, se agregan nuevas entradas de administración de conexiones para el servidor `www.contoso.com` y los demás hosts de red.  
