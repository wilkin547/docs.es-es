...
Al ejecutar el ejemplo en .NET Framework 3.5 o una versión anterior, muestra el siguiente resultado:
...
Sin embargo, si agrega el siguiente archivo de configuración para el directorio de ejemplo y, a continuación, ejecute el ejemplo en el .NET Framework 4 o una versión posterior, el resultado es idéntico al producido por el ejemplo, cuando se ejecuta en .NET Framework 3.5.
