...
Puede configurar una aplicación de ASP.NET para usar la configuración de compatibilidad agregando un [\<Add>](../appsettings/add-element-for-appsettings.md) elemento a la [\<appSettings>](../appsettings/index.md) sección del archivo Web. config.
