...
|---------------|-----------------|  
|type|El nombre del tipo CLR del controlador de token que se va a quitar. Para obtener más información sobre cómo especificar el `type` atributo, vea [referencias de tipos personalizado](https://docs.microsoft.com/previous-versions/windows-identity-foundation/gg638728(v=msdn.10)#custom-type-references). Obligatorio.|  
