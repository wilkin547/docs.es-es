...
# [Esquema de configuración de Windows Workflow Foundation](index.md)
...
# [<comportamiento> de <serviceBehaviors>](behavior-of-servicebehaviors-of-workflow.md)
...
# [Usar la anotación en las consultas](using-annotation-in-queries.md)
