...
|-------------|-----------------|  
|[\<argumento >](../../../../../docs/framework/configure-apps/file-schema/windows-workflow-foundation/argument.md)|Un argumento asociado a una consulta de estado de actividad.|  
