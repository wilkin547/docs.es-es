...
---
# <a name="message-of-nethttpbinding"></a>\<mensaje > de \<netHttpBinding >
...
|-------------|-----------------|  
|<`security`> elemento de <`netHttpBinding`>|Define las funciones de seguridad de la <`netHttpBinding`> elemento.|  
