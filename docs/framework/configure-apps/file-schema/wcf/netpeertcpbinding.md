...
## Ejemplo  
 El ejemplo siguiente muestra cómo utilizar el enlace NetPeerTcpBinding, que proporciona comunicación multipartidaria mediante un canal del mismo nivel.  Para un escenario detallado sobre la utilización de este enlace, vea [Net Peer TCP](http://msdn.microsoft.com/es-es/31f4db66-edb2-40a6-b92a-14098e92acae).  
...
## Vea también  
 ...
 [Net Peer TCP](http://msdn.microsoft.com/es-es/31f4db66-edb2-40a6-b92a-14098e92acae)   
