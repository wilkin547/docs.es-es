...
## <a name="remarks"></a>Comentarios  
 ...
 La seguridad está desactivada de forma predeterminada, pero se puede Agregar estableciendo el atributo de modo del elemento secundario [ \<> de seguridad](security-of-basichttpbinding.md) en `None`un valor distinto de. De forma predeterminada, usa una codificación de mensajes "Text" y codificación de texto UTF-8.  
