...
### <a name="attributes"></a><span data-ttu-id="e1b2e-109">Atributos</span><span class="sxs-lookup"><span data-stu-id="e1b2e-109">Attributes</span></span>  
