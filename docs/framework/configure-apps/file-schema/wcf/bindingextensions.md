...
En el ejemplo siguiente se usa el elemento `add`, así como el atributo `name` para agregar una extensión de enlace a la sección `bindingExtensions` del archivo de configuración:
