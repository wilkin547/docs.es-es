...
|deadLetterQueue|Especifica el tipo de cola de mensajes con problemas de entrega que se va a usar.<br /><br /> Los valores válidos incluyen<br /><br /> -   Personalizada: cola de mensajes con problemas de entrega personalizada.<br />-   Ninguna: no se usará ninguna cola de mensajes con problemas de entrega.<br />-   Sistema: use la cola de mensajes con problemas de entrega del sistema.<br /><br /> Este atributo es del tipo DeadLetterQueue.|  
