---
title: "&lt;scopedCertificates&gt; (elemento) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|--------------|-----------------|  
|[\<agregar\>](../../../../../docs/framework/configure-apps/file-schema/wcf/add-of-scopedcertificates-element.md)|Agrega un certificado X.509 a la colección de certificados con ámbito.|  
...
## Ejemplo  
 El siguiente ejemplo especifica primero un certificado de servicio para que el cliente lo utilice al comunicarse con extremos cuyo nombre de dominio es http:\/\/www.contoso.com sobre el protocolo HTTP.  
...
## Vea también  
 ...
 [\<agregar\>](../../../../../docs/framework/configure-apps/file-schema/wcf/add-of-scopedcertificates-element.md)   
