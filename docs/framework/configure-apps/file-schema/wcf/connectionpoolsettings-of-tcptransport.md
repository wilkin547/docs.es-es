...
|`leaseTimeout`|<xref:System.TimeSpan> que especifica el tiempo después del que se cierra una conexión activa. El valor predeterminado es 00:05:00.<br /><br /> Se cierra una conexión después de que se haya devuelto a la conexión caché y no durante la transmisión activa. La caché de conexión utilizada por el transporte TCP crea conexiones nuevas, según sea necesario para cada punto de conexión, hasta el límite del caché establecido por `maxOutboundConnectionsPerEndpoint.`|  
