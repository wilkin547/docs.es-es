...
|`textEncoding`|Especifica el codificador del juego de caracteres que se va a usar para emitir los mensajes en el enlace. Los valores válidos son los siguientes:<br /><br /> -   `UnicodeFffeTextEncoding`: codificación Big Endian de Unicode.<br />-   `Utf16TextEncoding`: codificación de 16 bits.<br />-   `Utf8TextEncoding`: codificación de 8 bits.<br /><br /> De manera predeterminada, es `Utf8TextEncoding`.<br /><br /> Este atributo es del tipo <xref:System.Text.Encoding>.|  
...
|[\<readerQuotas >](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ms731325(v=vs.100))|Obtiene las restricciones de la complejidad de los mensajes SOAP que pueden procesar los extremos configurados con este enlace. Este elemento es del tipo <xref:System.ServiceModel.Configuration.XmlDictionaryReaderQuotasElement>.|  
