...
|`textEncoding`|Especifica el codificador del juego de caracteres que se va a usar para emitir los mensajes en el enlace. Los valores válidos son los siguientes:<br /><br /> -   `UnicodeFffeTextEncoding`: Unicode Big Endian de codificación.<br />-   `Utf16TextEncoding`: codificación de 16 bits.<br />-   `Utf8TextEncoding`: codificación de 8 bits.<br /><br /> De manera predeterminada, es `Utf8TextEncoding`.<br /><br /> Este atributo es del tipo <xref:System.Text.Encoding>.|  
...
|[\<readerQuotas>](https://msdn.microsoft.com/library/3e5e42ff-cef8-478f-bf14-034449239bfd)|Obtiene las restricciones de la complejidad de los mensajes SOAP que pueden procesar los puntos de conexión configurados con este enlace. Este elemento es del tipo <xref:System.ServiceModel.Configuration.XmlDictionaryReaderQuotasElement>.|  
