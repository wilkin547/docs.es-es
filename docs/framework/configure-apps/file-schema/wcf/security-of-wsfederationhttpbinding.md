...
---
# <a name="security-of-wsfederationhttpbinding"></a>\<> de seguridad \<de wsFederationHttpBinding >
Define la configuración de seguridad de la [ \<> wsFederationHttpBinding](wsfederationhttpbinding.md).  
