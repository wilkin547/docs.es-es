...
|---------------|-----------------|  
|dirección|Necesario. Cadena que especifica la dirección del punto de conexión. La dirección debe ser un URI absoluto. El valor predeterminado es una cadena vacía.|  
