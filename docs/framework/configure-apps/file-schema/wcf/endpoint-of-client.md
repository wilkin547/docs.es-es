...
|kind|Cadena que especifica el tipo de extremo estándar aplicado. El tipo se debe registrar en la `<extensions>` sección o en Machine. config. Si no se especifica nada, se crea un extremo de canal común.|  
