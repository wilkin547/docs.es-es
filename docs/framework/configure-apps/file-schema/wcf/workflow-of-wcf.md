...
---
# <a name="workflow-of-wcf"></a>\<> de flujo de trabajo de WCF
...
|Elemento|DESCRIPCIÓN|  
|-------------|-----------------|  
|[\<participantes >](../windows-workflow-foundation/participants.md)|Una lista de los participantes de seguimiento|  
