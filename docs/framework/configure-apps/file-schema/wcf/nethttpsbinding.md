...
|-------------|-----------------|  
|[> de seguridad de \<](security-of-nethttpbinding.md)|Define la configuración de seguridad del enlace. Este elemento es del tipo <xref:System.ServiceModel.Configuration.BasicHttpsSecurityElement>. |  
