...
## <a name="see-also"></a>Vea también  
 ...
 [Utilización de ServiceThrottlingBehavior para controlar el rendimiento de servicio WCF](../../../../../docs/framework/wcf/feature-details/using-servicethrottlingbehavior-to-control-wcf-service-performance.md)
