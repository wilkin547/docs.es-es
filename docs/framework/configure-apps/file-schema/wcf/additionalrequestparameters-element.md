...
---
# <a name="ltadditionalrequestparametersgt-element"></a>&lt;additionalRequestParameters&gt; (elemento)
Contiene una colección de elementos de configuración que especifican los parámetros de solicitud adicionales.  
