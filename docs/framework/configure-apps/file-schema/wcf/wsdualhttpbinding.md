...
|-------------|-----------------|  
|[> de seguridad de \<](security-of-wsdualhttpbinding.md)|Define la configuración de seguridad del enlace. Este elemento es del tipo <xref:System.ServiceModel.Configuration.WSDualHttpSecurityElement>.|  
