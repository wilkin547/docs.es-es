...
|-------------|------------|------------|-----------|  
|Serialización de <xref:System.Collections.Concurrent.ConcurrentDictionary%602?displayProperty=fullName>|Un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> serializado en .NET Framework 4.5 con el <xref:System.Runtime.Serialization.NetDataContractSerializer> no se puede deserializar en .NET Framework 4.5.1 y 4.5.2 solo debido a cambios internos de tipo.<br /><br /> Este cambio *no* se aplica a los siguientes escenarios:<br /><br /> Un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> serializado en .NET Framework 4.5 y deserializado en el [!INCLUDE[net_v46](../../../includes/net-v46-md.md)]. El <xref:System.Runtime.Serialization.NetDataContractSerializer> en el [!INCLUDE[net_v46](../../../includes/net-v46-md.md)] es capaz de deserializar el objeto.<br /><br /> Un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> serializado en una versión posterior de .NET Framework y deserializado en .NET Framework 4.5. El <xref:System.Runtime.Serialization.NetDataContractSerializer> en .NET Framework 4.5 es capaz de deserializar el objeto.<br /><br /> Serialización y deserialización entre versiones de un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> entre cualquier versión de .NET Framework posterior a .NET Framework 4.5. Este cambio *solo* se aplica a los objetos serializados con .NET Framework 4.5.|Hay disponibles dos soluciones si es necesario serializar un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> en .NET Framework 4.5 y deserializarlo en una versión posterior de .NET Framework:<br /><br /> Use un serializador alternativo, como el <xref:System.Runtime.Serialization.DataContractSerializer> o el <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter>.<br /><br /> Actualice a [!INCLUDE[net_v46](../../../includes/net-v46-md.md)], que admite la deserialización de un objeto <xref:System.Collections.Concurrent.ConcurrentDictionary%602> serializado con .NET Framework 4.5.|Secundaria|  
|Clase <xref:System.Diagnostics.Tracing.EventListener?displayProperty=fullName>|<xref:System.Diagnostics.Tracing.EventListener> trunca las cadenas con valores NULL incrustados. Los caracteres NULL no son compatibles con la clase <xref:System.Diagnostics.Tracing.EventSource>.|El cambio solo afecta a las aplicaciones que usan <xref:System.Diagnostics.Tracing.EventListener> para leer datos <xref:System.Diagnostics.Tracing.EventSource> en proceso y que utilizan caracteres NULL como delimitadores.|Avanzado|  
|Clase <xref:System.Diagnostics.Tracing.EventSource?displayProperty=fullName>|El runtime ahora aplica el contrato que especifica lo siguiente: una clase derivada de <xref:System.Diagnostics.Tracing.EventSource> que define un método de evento ETW debe llamar al método <xref:System.Diagnostics.Tracing.EventSource.WriteEvent%2A?displayProperty=fullName> de la clase base con el identificador de evento seguido de los mismos argumentos que se pasaron al método de evento ETW.|Se produce una excepción <xref:System.IndexOutOfRangeException> si un objeto <xref:System.Diagnostics.Tracing.EventListener> lee datos <xref:System.Diagnostics.Tracing.EventSource> en proceso para un origen de eventos que infringe este contrato.<br /><br /> Consulte [Mitigación: Llamadas al método EventSource.WriteEvent](../../../docs/framework/migration-guide/mitigation-eventsource-writeevent-method-calls.md).|Secundaria|  
