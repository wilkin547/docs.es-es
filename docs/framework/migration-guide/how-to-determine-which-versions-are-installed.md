...
3. En el Editor del Registro, abra la subclave siguiente:
    ...
    |Solo en sistemas Windows 10: 393295<br /><br /> En las demás versiones del sistema operativo: 393297|[!INCLUDE[net_v46](../../../includes/net-v46-md.md)]|
    ...
    |Solo en Windows 10 Creators Update: 460798<br/><br/> En las demás versiones del sistema operativo: 460805 | .NET Framework 4.7 |
    ...
    |Solo en la Actualización de abril de 2018 de Windows 10: 461808<br/><br/> En las demás versiones del sistema operativo, incluida la Actualización de octubre de 2018 de Windows 10: 461814| .NET Framework 4.7.2 |
...
2. Compruebe el valor de la palabra clave `Release` para determinar la versión instalada. Para que sea compatible con el reenvío, puede buscar un valor mayor o igual que los valores que se muestran en la tabla. Estas son las versiones de .NET Framework y las palabras clave de `Release` asociadas.
    ...
    |.NET Framework 4.7.2 instalado en Windows 10 Fall Creators Update y en versiones anteriores del sistema operativo|461814|
