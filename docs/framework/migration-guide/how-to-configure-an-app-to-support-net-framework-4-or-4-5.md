---
title: "C&#243;mo: Configurar una aplicaci&#243;n para admitir .NET Framework 4 o 4.5 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  Se recomienda probar siempre la aplicación en cada versión de .NET Framework admitida.  Vea [Compatibilidad de versiones](../../../docs/framework/migration-guide/version-compatibility.md) para obtener información sobre cómo actualizar la aplicación para admitir versiones posteriores de .NET Framework.  
 ...
 Para obtener información sobre cómo modificar las aplicaciones de .NET Framework 1.1 y 1.1 para admitir Windows 7 y Windows 8, vea [Migrar de .NET Framework 1.1](../../../docs/framework/migration-guide/migrating-from-the-net-framework-1-1.md).  
  
### Para configurar la aplicación para que se ejecute en .NET Framework 4 o 4.5  
...
1.  Agregue o busque el archivo de configuración del proyecto de .NET Framework.  El archivo de configuración de una aplicación está en el mismo directorio y tiene el mismo nombre que la aplicación, pero su extensión es .config.  Por ejemplo, en el caso de una aplicación denominada MiEjecutable.exe, el nombre del archivo de configuración sería MiEjecutable.exe.config.  
     ...
     Para agregar un archivo de configuración, en la barra de menús de Visual Studio, elija **Proyecto**, **Agregar nuevo elemento**.  Elija **General** en el panel izquierdo y elija **Archivo de configuración**.  Asigne al archivo de configuración el nombre *appName*.exe.config.  Estas opciones de menú no están disponibles para los proyectos de aplicaciones de la Tienda Windows o Windows Phone, ya que no se puede cambiar la directiva de activación de estas plataformas.  
...
## Vea también  
 ...
 [Guía de migración](../Topic/Migration%20Guide%20to%20the%20.NET%20Framework%204.6%20and%204.5%20.md)