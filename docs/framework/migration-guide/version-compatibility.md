...
Para más información, consulte [Cómo: Configurar una aplicación para admitir .NET Framework 4 o 4.x](../migration-guide/how-to-configure-an-app-to-support-net-framework-4-or-4-5.md).
