---
title: "Compatibilidad de versiones en .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 4.5, compatibilidad con versiones anteriores"
  - "versiones de .NET Framework, compatibilidad"
  - ".NET Framework, compatibilidad de versiones"
...
## Compatibilidad de versiones de las aplicaciones  
 ...
 Para definir las versiones concretas en las que se ejecuta la aplicación, agregue uno o varios elementos de [\<runtimeCompatible\>](../../../docs/framework/configure-apps/file-schema/startup/supportedruntime-element.md) al archivo de configuración de la aplicación.  Cada elemento `<supportedRuntime>` muestra una versión compatible del runtime; el primer elemento especifica la versión de mayor preferencia y el último, la de menor preferencia.  Para obtener más información, vea [Cómo: Configurar una aplicación para admitir .NET Framework 4 o 4.5](../../../docs/framework/migration-guide/how-to-configure-an-app-to-support-net-framework-4-or-4-5.md).  
...
## Compatibilidad con versiones anteriores de .NET Framework 4.5  
 .NET Framework 4.5 y sus versiones secundarias son compatibles con las aplicaciones que se crearon con versiones anteriores de .NET Framework.  En otras palabras, las aplicaciones y los componentes creados con versiones anteriores de .NET Framework funcionarán sin tener que modificarlas en .NET Framework 4.5.  Sin embargo, de forma predeterminada, las aplicaciones se ejecutan en la versión de Common Language Runtime para las que se desarrollaron, por lo que puede tener que proporcionar un archivo de configuración para permitir que la aplicación se ejecute en .NET Framework 4.5.  Para obtener más información, vea la sección [Compatibilidad de versiones de las aplicaciones](#Apps) anteriormente en este artículo.  
 ...
 Si su aplicación o componente no funciona como se esperaba en .NET Framework 4.5, 4.5.1, 4.5.2 o 4.6, use las listas de comprobación siguientes:  
...
-   Si está recompilando código fuente existente para ejecutarlo en .NET Framework 4.5 o está desarrollando una nueva versión de una aplicación o componente que tiene como destino la versión 4.5 a partir de una base de código fuente existente, consulte en [Lo obsoleto en la biblioteca de clases](../../../docs/framework/whats-new/whats-obsolete.md) los miembros y tipos obsoletos y aplique las soluciones descritas.  \(El código compilado previamente seguirá ejecutándose con los tipos y miembros que se han marcado como obsoletos\).  
  
-   Si considera que un cambio de [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] dañó la aplicación, consulte [Esquema de la configuración de Common Language Runtime](../../../docs/framework/configure-apps/file-schema/runtime/index.md) para determinar si puede usar en tiempo de ejecución un valor en el archivo de configuración de la aplicación para restaurar el comportamiento anterior.  
  
-   Si detecta un problema que no está documentado, envíe un informe de errores de [Microsoft Connect](http://go.microsoft.com/fwlink/?LinkID=154815) y póngase en contacto con [netfxcf@microsoft.com](mailto:netfxcf@microsoft.com) \(recuerde indicar el número de error\).  
  
## Compatibilidad y ejecución en paralelo  
 Si no puede encontrar una solución conveniente para su problema, recuerde que .NET Framework 4.5 se ejecuta en paralelo con las versiones 1.1, 2.0 y 3.5, y es una actualización en contexto que reemplaza la versión 4.  En el caso de las aplicaciones dirigidas a las versiones 1.1, 2.0 y 3.5, puede instalar la versión adecuada de .NET Framework en el equipo de destino para ejecutar la aplicación en su entorno más conveniente.  Para obtener más información acerca de la ejecución en paralelo, vea [Ejecución simultánea](../../../docs/framework/deployment/side-by-side-execution.md).  
...
## Vea también  
 ...
 [Directiva del ciclo de vida de soporte técnico de Microsoft .NET Framework](http://go.microsoft.com/fwlink/p/?LinkId=248212)   
 [Problemas de migración de .NET Framework 4](http://go.microsoft.com/fwlink/p/?LinkId=248212)