---
title: Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.6.2
description: Busque información sobre los problemas de compatibilidad de aplicaciones que podrían afectar a la aplicación al migrar de .NET Framework 4.5.2 a 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444240"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="ac336-103">Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="ac336-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="ac336-104">Si va a migrar desde .NET Framework 4.5.2 a 4.6.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="ac336-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ac336-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ac336-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="ac336-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="ac336-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="ac336-107">Principal</span><span class="sxs-lookup"><span data-stu-id="ac336-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ac336-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ac336-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="ac336-109">JIT</span><span class="sxs-lookup"><span data-stu-id="ac336-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="ac336-110">Redes</span><span class="sxs-lookup"><span data-stu-id="ac336-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="ac336-111">Seguridad</span><span class="sxs-lookup"><span data-stu-id="ac336-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ac336-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ac336-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="ac336-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="ac336-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ac336-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ac336-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="ac336-115">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="ac336-115">XML, XSLT</span></span>
