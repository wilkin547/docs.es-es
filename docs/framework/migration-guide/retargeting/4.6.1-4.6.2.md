...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="be6fe-102">Cambios de redestinación para la migración desde .NET Framework 4.6.1 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="be6fe-102">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="be6fe-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="be6fe-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="be6fe-105">Principal</span><span class="sxs-lookup"><span data-stu-id="be6fe-105">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="be6fe-106">Seguridad</span><span class="sxs-lookup"><span data-stu-id="be6fe-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="be6fe-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="be6fe-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="be6fe-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="be6fe-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="be6fe-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="be6fe-109">Windows Presentation Foundation (WPF)</span></span>
