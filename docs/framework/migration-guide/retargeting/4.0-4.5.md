...
ms.locfileid: "37072568"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="a2d71-102">Cambios de redestinación para la migración desde .NET Framework 4.0 a 4.5</span><span class="sxs-lookup"><span data-stu-id="a2d71-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="a2d71-103">Si va a migrar desde .NET Framework 4.0 a 4.5, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="a2d71-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a2d71-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a2d71-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="a2d71-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="a2d71-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="a2d71-106">Principal</span><span class="sxs-lookup"><span data-stu-id="a2d71-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a2d71-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a2d71-107">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a2d71-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a2d71-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a2d71-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a2d71-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a2d71-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a2d71-110">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a2d71-111">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a2d71-111">XML, XSLT</span></span>
