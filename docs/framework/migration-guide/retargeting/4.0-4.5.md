---
title: Cambios de redestinación para la migración desde .NET Framework 4.0 a 4.5
description: Busque información sobre los problemas de compatibilidad de aplicaciones que podrían afectar a la aplicación al migrar de .NET Framework 4.0 a 4.5.
ms.date: 07/10/2019
...
ms.locfileid: "91609621"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="2470a-103">Cambios de redestinación para la migración desde .NET Framework 4.0 a 4.5</span><span class="sxs-lookup"><span data-stu-id="2470a-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="2470a-104">Si va a migrar desde .NET Framework 4.0 a 4.5, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="2470a-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="2470a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2470a-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="2470a-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="2470a-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="2470a-107">Principal</span><span class="sxs-lookup"><span data-stu-id="2470a-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="2470a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="2470a-108">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="2470a-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="2470a-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2470a-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2470a-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2470a-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2470a-111">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="2470a-112">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="2470a-112">XML, XSLT</span></span>
