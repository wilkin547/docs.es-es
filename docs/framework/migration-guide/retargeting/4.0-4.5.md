...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a>Cambios de redestinación para la migración desde .NET Framework 4.0 a la versión 4.5
