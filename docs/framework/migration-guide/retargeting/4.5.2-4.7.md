...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-47"></a>Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Si va a migrar desde .NET Framework 4.5.2 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
