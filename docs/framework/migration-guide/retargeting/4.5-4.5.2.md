...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-452"></a>Cambios de redestinación para la migración desde .NET Framework 4.5 para 4.5.2

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Si va a migrar desde .NET Framework 4.5 a 4.5.2, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
