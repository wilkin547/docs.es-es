...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="c26a0-102">Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="c26a0-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="c26a0-103">Si va a migrar desde .NET Framework 4.5.2 a 4.7.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="c26a0-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c26a0-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c26a0-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="c26a0-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="c26a0-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="c26a0-106">Principal</span><span class="sxs-lookup"><span data-stu-id="c26a0-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c26a0-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c26a0-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="c26a0-108">JIT</span><span class="sxs-lookup"><span data-stu-id="c26a0-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c26a0-109">Redes</span><span class="sxs-lookup"><span data-stu-id="c26a0-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c26a0-110">Seguridad</span><span class="sxs-lookup"><span data-stu-id="c26a0-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c26a0-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c26a0-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c26a0-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="c26a0-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c26a0-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c26a0-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c26a0-114">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c26a0-114">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c26a0-115">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="c26a0-115">XML, XSLT</span></span>
