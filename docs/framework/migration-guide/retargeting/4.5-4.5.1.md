...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="de0b3-102">Cambios de redestinación para la migración desde .NET Framework 4.5 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="de0b3-102">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="de0b3-103">Si va a migrar desde .NET Framework 4.5 a 4.5.1, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="de0b3-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="de0b3-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="de0b3-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="de0b3-105">Principal</span><span class="sxs-lookup"><span data-stu-id="de0b3-105">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="de0b3-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="de0b3-106">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="de0b3-107">MSBuild</span><span class="sxs-lookup"><span data-stu-id="de0b3-107">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="de0b3-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="de0b3-108">Windows Presentation Foundation (WPF)</span></span>
