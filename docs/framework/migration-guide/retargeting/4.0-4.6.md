...
ms.locfileid: "59769065"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-46"></a><span data-ttu-id="6c6d1-102">Cambios de redestinación para la migración desde .NET Framework 4.0 a 4.6</span><span class="sxs-lookup"><span data-stu-id="6c6d1-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="6c6d1-103">Si va a migrar desde .NET Framework 4.0 a 4.6, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="6c6d1-103">If you are migrating from the .NET Framework 4.0 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="6c6d1-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="6c6d1-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="6c6d1-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="6c6d1-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="6c6d1-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="6c6d1-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="6c6d1-107">Principal</span><span class="sxs-lookup"><span data-stu-id="6c6d1-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="6c6d1-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="6c6d1-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="6c6d1-109">JIT</span><span class="sxs-lookup"><span data-stu-id="6c6d1-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="6c6d1-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="6c6d1-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="6c6d1-111">Redes</span><span class="sxs-lookup"><span data-stu-id="6c6d1-111">Networking</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="6c6d1-112">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="6c6d1-112">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="6c6d1-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="6c6d1-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="6c6d1-114">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="6c6d1-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6c6d1-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6c6d1-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="6c6d1-116">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="6c6d1-116">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="6c6d1-117">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="6c6d1-117">XML, XSLT</span></span>
