...
ms.locfileid: "59770235"
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="37ccc-102">Cambios de redestinación para la migración desde .NET Framework 4.6.1 a 4.7</span><span class="sxs-lookup"><span data-stu-id="37ccc-102">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="37ccc-103">Si va a migrar desde .NET Framework 4.6.1 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="37ccc-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="37ccc-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="37ccc-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="37ccc-105">Principal</span><span class="sxs-lookup"><span data-stu-id="37ccc-105">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="37ccc-106">Redes</span><span class="sxs-lookup"><span data-stu-id="37ccc-106">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="37ccc-107">Seguridad</span><span class="sxs-lookup"><span data-stu-id="37ccc-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="37ccc-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="37ccc-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="37ccc-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="37ccc-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="37ccc-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="37ccc-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="37ccc-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="37ccc-111">Windows Workflow Foundation (WF)</span></span>
