...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="16495-102">Cambios de redestinación para la migración desde .NET Framework 4.6 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="16495-102">Retargeting Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="16495-103">Si va a migrar desde .NET Framework 4.6 a 4.6.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="16495-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="16495-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="16495-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="16495-105">Principal</span><span class="sxs-lookup"><span data-stu-id="16495-105">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="16495-106">Seguridad</span><span class="sxs-lookup"><span data-stu-id="16495-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="16495-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="16495-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="16495-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="16495-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="16495-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="16495-109">Windows Presentation Foundation (WPF)</span></span>
