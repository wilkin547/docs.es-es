---
title: Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.6.1
description: Busque información sobre los problemas de compatibilidad de aplicaciones que podrían afectar a la aplicación al migrar de .NET Framework 4.5.2 a 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443772"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="73724-103">Cambios de redestinación para la migración desde .NET Framework 4.5.2 a 4.6.1</span><span class="sxs-lookup"><span data-stu-id="73724-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="73724-104">Si va a migrar desde .NET Framework 4.5.2 a 4.6.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="73724-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="73724-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="73724-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="73724-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="73724-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="73724-107">Principal</span><span class="sxs-lookup"><span data-stu-id="73724-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="73724-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="73724-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="73724-109">JIT</span><span class="sxs-lookup"><span data-stu-id="73724-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="73724-110">Redes</span><span class="sxs-lookup"><span data-stu-id="73724-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="73724-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="73724-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="73724-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="73724-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="73724-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="73724-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="73724-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="73724-114">XML, XSLT</span></span>
