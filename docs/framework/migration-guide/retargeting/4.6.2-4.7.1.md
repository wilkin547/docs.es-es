...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-471"></a><span data-ttu-id="d27f9-103">Cambios de redestinación para la migración desde .NET Framework 4.6.2 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="d27f9-103">Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="d27f9-104">Si va a migrar desde .NET Framework 4.6.2 a 4.7.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="d27f9-104">If you are migrating from the .NET Framework 4.6.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="d27f9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d27f9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d27f9-106">Principal</span><span class="sxs-lookup"><span data-stu-id="d27f9-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="d27f9-107">Redes</span><span class="sxs-lookup"><span data-stu-id="d27f9-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="d27f9-108">Seguridad</span><span class="sxs-lookup"><span data-stu-id="d27f9-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d27f9-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d27f9-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="d27f9-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="d27f9-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d27f9-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d27f9-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="d27f9-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="d27f9-112">Windows Workflow Foundation (WF)</span></span>
