...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-472"></a>Cambios de redestinación para la migración desde .NET Framework 4.6 a 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Si va a migrar desde .NET Framework 4.6 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
