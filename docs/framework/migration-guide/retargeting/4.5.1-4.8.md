---
title: Cambios de redestinación para la migración de .NET Framework 4.5.1 a 4.8
description: Busque información sobre los problemas de compatibilidad de aplicaciones que podrían afectar a la aplicación al migrar de .NET Framework 4.5.1 a 4.8.
ms.date: 07/10/2019
...
ms.locfileid: "86444318"
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-48"></a><span data-ttu-id="c3c10-103">Cambios de redestinación para la migración de .NET Framework 4.5.1 a 4.8</span><span class="sxs-lookup"><span data-stu-id="c3c10-103">Retargeting Changes for Migration from .NET Framework 4.5.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="c3c10-104">Si se va a migrar de .NET Framework 4.5.1 a 4.8, revise los temas siguientes para ver las incidencias de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="c3c10-104">If you are migrating from the .NET Framework 4.5.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c3c10-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c3c10-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="c3c10-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="c3c10-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="c3c10-107">Principal</span><span class="sxs-lookup"><span data-stu-id="c3c10-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c3c10-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c3c10-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="c3c10-109">JIT</span><span class="sxs-lookup"><span data-stu-id="c3c10-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c3c10-110">Redes</span><span class="sxs-lookup"><span data-stu-id="c3c10-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c3c10-111">Seguridad</span><span class="sxs-lookup"><span data-stu-id="c3c10-111">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="c3c10-112">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="c3c10-112">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c3c10-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c3c10-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c3c10-114">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="c3c10-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c3c10-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c3c10-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c3c10-116">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c3c10-116">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c3c10-117">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="c3c10-117">XML, XSLT</span></span>
