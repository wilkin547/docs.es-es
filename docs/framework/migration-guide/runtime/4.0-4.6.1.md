---
title: "Cambios en tiempo de ejecución para la migración desde .NET Framework 4.0 para 4.6.1"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-461"></a><span data-ttu-id="a9ea2-102">Cambios en tiempo de ejecución para la migración desde .NET Framework 4.0 para 4.6.1</span><span class="sxs-lookup"><span data-stu-id="a9ea2-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a9ea2-103">Si va a migrar desde .NET Framework 4.0 a 4.6.1, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="a9ea2-103">If you are migrating from the .NET Framework 4.0 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a9ea2-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a9ea2-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a9ea2-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a9ea2-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a9ea2-106">Principal</span><span class="sxs-lookup"><span data-stu-id="a9ea2-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a9ea2-107">Datos</span><span class="sxs-lookup"><span data-stu-id="a9ea2-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a9ea2-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a9ea2-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="a9ea2-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="a9ea2-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="a9ea2-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="a9ea2-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="a9ea2-111">Redes</span><span class="sxs-lookup"><span data-stu-id="a9ea2-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="a9ea2-112">Impresión</span><span class="sxs-lookup"><span data-stu-id="a9ea2-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a9ea2-113">Serialización</span><span class="sxs-lookup"><span data-stu-id="a9ea2-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a9ea2-114">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="a9ea2-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a9ea2-115">Herramientas</span><span class="sxs-lookup"><span data-stu-id="a9ea2-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="a9ea2-116">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="a9ea2-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a9ea2-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a9ea2-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a9ea2-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a9ea2-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a9ea2-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a9ea2-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a9ea2-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a9ea2-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a9ea2-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a9ea2-121">XML, XSLT</span></span>
