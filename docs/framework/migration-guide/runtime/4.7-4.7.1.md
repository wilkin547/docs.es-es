...
ms.locfileid: "68237763"
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="4960f-102">Cambios de runtime para la migración desde .NET Framework 4.7 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="4960f-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="4960f-103">Si va a migrar desde .NET Framework 4.7 a 4.7.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="4960f-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="4960f-104">JIT</span><span class="sxs-lookup"><span data-stu-id="4960f-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="4960f-105">Seguridad</span><span class="sxs-lookup"><span data-stu-id="4960f-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4960f-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4960f-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4960f-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4960f-107">Windows Presentation Foundation (WPF)</span></span>
