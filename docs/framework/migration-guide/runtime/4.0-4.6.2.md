...
ms.locfileid: "58760565"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-462"></a><span data-ttu-id="3f4dc-102">Cambios de runtime para la migración desde .NET Framework 4.0 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="3f4dc-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3f4dc-103">Si va a migrar desde .NET Framework 4.0 a 4.6.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="3f4dc-103">If you are migrating from the .NET Framework 4.0 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3f4dc-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3f4dc-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3f4dc-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3f4dc-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3f4dc-106">Principal</span><span class="sxs-lookup"><span data-stu-id="3f4dc-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3f4dc-107">Datos</span><span class="sxs-lookup"><span data-stu-id="3f4dc-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3f4dc-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3f4dc-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3f4dc-109">Globalización</span><span class="sxs-lookup"><span data-stu-id="3f4dc-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="3f4dc-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="3f4dc-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="3f4dc-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="3f4dc-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="3f4dc-112">Redes</span><span class="sxs-lookup"><span data-stu-id="3f4dc-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="3f4dc-113">Impresión</span><span class="sxs-lookup"><span data-stu-id="3f4dc-113">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="3f4dc-114">Seguridad</span><span class="sxs-lookup"><span data-stu-id="3f4dc-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3f4dc-115">Serialización</span><span class="sxs-lookup"><span data-stu-id="3f4dc-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="3f4dc-116">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="3f4dc-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="3f4dc-117">Herramientas</span><span class="sxs-lookup"><span data-stu-id="3f4dc-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="3f4dc-118">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="3f4dc-118">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3f4dc-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3f4dc-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3f4dc-120">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3f4dc-120">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3f4dc-121">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3f4dc-121">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3f4dc-122">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3f4dc-122">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3f4dc-123">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3f4dc-123">XML, XSLT</span></span>
