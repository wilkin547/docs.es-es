...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a>Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5.2 para 4.6.1
