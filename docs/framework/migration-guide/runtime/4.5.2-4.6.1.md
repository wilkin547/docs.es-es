...
ms.locfileid: "59768766"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="cb310-102">Cambios de runtime para la migración desde .NET Framework 4.5.2 a 4.6.1</span><span class="sxs-lookup"><span data-stu-id="cb310-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cb310-103">Si va a migrar desde .NET Framework 4.5.2 a 4.6.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="cb310-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="cb310-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cb310-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cb310-105">Principal</span><span class="sxs-lookup"><span data-stu-id="cb310-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cb310-106">Datos</span><span class="sxs-lookup"><span data-stu-id="cb310-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="cb310-107">instantáneas</span><span class="sxs-lookup"><span data-stu-id="cb310-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="cb310-108">Redes</span><span class="sxs-lookup"><span data-stu-id="cb310-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cb310-109">Serialización</span><span class="sxs-lookup"><span data-stu-id="cb310-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="cb310-110">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="cb310-110">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="cb310-111">Herramientas</span><span class="sxs-lookup"><span data-stu-id="cb310-111">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cb310-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cb310-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cb310-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cb310-113">Windows Presentation Foundation (WPF)</span></span>
