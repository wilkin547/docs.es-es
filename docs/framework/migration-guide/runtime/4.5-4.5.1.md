---
title: "Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5 a 4.5.1"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="cdeec-102">Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="cdeec-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cdeec-103">Si va a migrar desde .NET Framework 4.5 a 4.5.1, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="cdeec-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="cdeec-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="cdeec-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cdeec-105">Principal</span><span class="sxs-lookup"><span data-stu-id="cdeec-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cdeec-106">Serialización</span><span class="sxs-lookup"><span data-stu-id="cdeec-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cdeec-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cdeec-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cdeec-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cdeec-108">Windows Presentation Foundation (WPF)</span></span>
