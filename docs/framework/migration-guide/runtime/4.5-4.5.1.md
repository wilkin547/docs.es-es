...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="600bf-102">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="600bf-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>
...
## <a name="adonet"></a><span data-ttu-id="600bf-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="600bf-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="600bf-105">Principal</span><span class="sxs-lookup"><span data-stu-id="600bf-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="600bf-106">Serialización</span><span class="sxs-lookup"><span data-stu-id="600bf-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="600bf-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="600bf-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="600bf-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="600bf-108">Windows Presentation Foundation (WPF)</span></span>
