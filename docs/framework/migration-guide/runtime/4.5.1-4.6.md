...
ms.locfileid: "33390317"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="ceeef-102">Cambios de runtime para la migración desde .NET Framework 4.5.1 a 4.6</span><span class="sxs-lookup"><span data-stu-id="ceeef-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="ceeef-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ceeef-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ceeef-105">Principal</span><span class="sxs-lookup"><span data-stu-id="ceeef-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ceeef-106">Datos</span><span class="sxs-lookup"><span data-stu-id="ceeef-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ceeef-107">instantáneas</span><span class="sxs-lookup"><span data-stu-id="ceeef-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ceeef-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ceeef-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="ceeef-109">Redes</span><span class="sxs-lookup"><span data-stu-id="ceeef-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ceeef-110">Serialización</span><span class="sxs-lookup"><span data-stu-id="ceeef-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ceeef-111">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="ceeef-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ceeef-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ceeef-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ceeef-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ceeef-113">Windows Presentation Foundation (WPF)</span></span>
