...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="43014-102">Cambios de runtime para la migración desde .NET Framework 4.6 a 4.7</span><span class="sxs-lookup"><span data-stu-id="43014-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="43014-103">Si va a migrar desde .NET Framework 4.6 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="43014-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="43014-104">Datos</span><span class="sxs-lookup"><span data-stu-id="43014-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="43014-105">Globalización</span><span class="sxs-lookup"><span data-stu-id="43014-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="43014-106">JIT</span><span class="sxs-lookup"><span data-stu-id="43014-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="43014-107">Seguridad</span><span class="sxs-lookup"><span data-stu-id="43014-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="43014-108">Herramientas</span><span class="sxs-lookup"><span data-stu-id="43014-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="43014-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="43014-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="43014-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="43014-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="43014-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="43014-111">Windows Workflow Foundation (WF)</span></span>
