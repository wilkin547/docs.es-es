---
title: Cambios de runtime para la migración desde .NET Framework 4.6 a 4.7
description: Busque información sobre los problemas de compatibilidad de aplicaciones de los cambios de runtime que podrían afectar a la aplicación al migrar de .NET Framework 4.6 a 4.7.
ms.date: 07/10/2019
...
ms.locfileid: "86444032"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="9229c-103">Cambios de runtime para la migración desde .NET Framework 4.6 a 4.7</span><span class="sxs-lookup"><span data-stu-id="9229c-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="9229c-104">Si va a migrar desde .NET Framework 4.6 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="9229c-104">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="9229c-105">Datos</span><span class="sxs-lookup"><span data-stu-id="9229c-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9229c-106">Globalización</span><span class="sxs-lookup"><span data-stu-id="9229c-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="9229c-107">JIT</span><span class="sxs-lookup"><span data-stu-id="9229c-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="9229c-108">Seguridad</span><span class="sxs-lookup"><span data-stu-id="9229c-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="9229c-109">Herramientas</span><span class="sxs-lookup"><span data-stu-id="9229c-109">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9229c-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9229c-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9229c-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9229c-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9229c-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9229c-112">Windows Workflow Foundation (WF)</span></span>
