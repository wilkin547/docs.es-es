...
ms.locfileid: "33389192"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="628d6-102">Cambios de runtime para la migración desde .NET Framework 4.5.2 a 4.6</span><span class="sxs-lookup"><span data-stu-id="628d6-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="628d6-103">Si va a migrar desde .NET Framework 4.5.2 a 4.6, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="628d6-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="628d6-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="628d6-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="628d6-105">Principal</span><span class="sxs-lookup"><span data-stu-id="628d6-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="628d6-106">Datos</span><span class="sxs-lookup"><span data-stu-id="628d6-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="628d6-107">instantáneas</span><span class="sxs-lookup"><span data-stu-id="628d6-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="628d6-108">Redes</span><span class="sxs-lookup"><span data-stu-id="628d6-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="628d6-109">Serialización</span><span class="sxs-lookup"><span data-stu-id="628d6-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="628d6-110">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="628d6-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="628d6-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="628d6-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="628d6-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="628d6-112">Windows Presentation Foundation (WPF)</span></span>
