...
ms.locfileid: "37070857"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-472"></a><span data-ttu-id="f3ee8-102">Cambios de runtime para la migración desde .NET Framework 4.5.2 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="f3ee8-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="f3ee8-103">Si va a migrar desde .NET Framework 4.5.2 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="f3ee8-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f3ee8-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f3ee8-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f3ee8-105">Principal</span><span class="sxs-lookup"><span data-stu-id="f3ee8-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f3ee8-106">Datos</span><span class="sxs-lookup"><span data-stu-id="f3ee8-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f3ee8-107">instantáneas</span><span class="sxs-lookup"><span data-stu-id="f3ee8-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="f3ee8-108">Globalización</span><span class="sxs-lookup"><span data-stu-id="f3ee8-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="f3ee8-109">Redes</span><span class="sxs-lookup"><span data-stu-id="f3ee8-109">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="f3ee8-110">Tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="f3ee8-110">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="f3ee8-111">Seguridad</span><span class="sxs-lookup"><span data-stu-id="f3ee8-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f3ee8-112">Serialización</span><span class="sxs-lookup"><span data-stu-id="f3ee8-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="f3ee8-113">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="f3ee8-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="f3ee8-114">Herramientas</span><span class="sxs-lookup"><span data-stu-id="f3ee8-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="f3ee8-115">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="f3ee8-115">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f3ee8-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f3ee8-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f3ee8-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f3ee8-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f3ee8-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f3ee8-118">Windows Workflow Foundation (WF)</span></span>
