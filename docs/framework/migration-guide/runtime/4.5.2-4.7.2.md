...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-472"></a>Cambios de runtime para la migración desde .NET Framework 4.5.2 a 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si va a migrar desde .NET Framework 4.5.2 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
