...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a>Cambios de runtime para la migración desde .NET Framework 4.0 a 4.5.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si va a migrar desde .NET Framework 4.0 a 4.5.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
