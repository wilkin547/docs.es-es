...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a>Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5 para 4.5.2
