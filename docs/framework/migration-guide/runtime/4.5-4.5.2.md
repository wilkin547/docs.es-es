---
title: Cambios de runtime para la migración desde .NET Framework 4.5 a 4.5.2
description: Busque información sobre los problemas de compatibilidad de aplicaciones de los cambios de runtime que podrían afectar a la aplicación al migrar de .NET Framework 4.5.a 4.5.2.
ms.date: 07/10/2019
...
ms.locfileid: "97009129"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="80e52-103">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.5.2</span><span class="sxs-lookup"><span data-stu-id="80e52-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="80e52-104">Si va a migrar desde .NET Framework 4.5 a 4.5.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="80e52-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="80e52-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="80e52-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="80e52-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="80e52-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="80e52-107">Principal</span><span class="sxs-lookup"><span data-stu-id="80e52-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="80e52-108">Datos</span><span class="sxs-lookup"><span data-stu-id="80e52-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="80e52-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="80e52-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="80e52-110">Serialización</span><span class="sxs-lookup"><span data-stu-id="80e52-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="80e52-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="80e52-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="80e52-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="80e52-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="80e52-113">XML</span><span class="sxs-lookup"><span data-stu-id="80e52-113">XML</span></span>
