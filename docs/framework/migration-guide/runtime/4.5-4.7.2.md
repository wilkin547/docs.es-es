...
ms.locfileid: "34549716"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-472"></a><span data-ttu-id="e7aab-102">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="e7aab-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e7aab-103">Si va a migrar desde .NET Framework 4.5 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="e7aab-103">If you are migrating from the .NET Framework 4.5 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e7aab-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e7aab-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e7aab-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e7aab-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e7aab-106">Principal</span><span class="sxs-lookup"><span data-stu-id="e7aab-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e7aab-107">Datos</span><span class="sxs-lookup"><span data-stu-id="e7aab-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e7aab-108">instantáneas</span><span class="sxs-lookup"><span data-stu-id="e7aab-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e7aab-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e7aab-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="e7aab-110">Globalización</span><span class="sxs-lookup"><span data-stu-id="e7aab-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="e7aab-111">Redes</span><span class="sxs-lookup"><span data-stu-id="e7aab-111">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="e7aab-112">Tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="e7aab-112">Runtime</span></span>

[!include[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="e7aab-113">Seguridad</span><span class="sxs-lookup"><span data-stu-id="e7aab-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e7aab-114">Serialización</span><span class="sxs-lookup"><span data-stu-id="e7aab-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e7aab-115">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="e7aab-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e7aab-116">Herramientas</span><span class="sxs-lookup"><span data-stu-id="e7aab-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="e7aab-117">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="e7aab-117">Web Applications</span></span>

[!include["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e7aab-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e7aab-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e7aab-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e7aab-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e7aab-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e7aab-120">Windows Workflow Foundation (WF)</span></span>
