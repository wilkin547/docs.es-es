...
ms.locfileid: "91608015"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-472"></a><span data-ttu-id="40eaa-103">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="40eaa-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="40eaa-104">Si va a migrar desde .NET Framework 4.5 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="40eaa-104">If you are migrating from the .NET Framework 4.5 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="40eaa-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="40eaa-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="40eaa-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="40eaa-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="40eaa-107">Principal</span><span class="sxs-lookup"><span data-stu-id="40eaa-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="40eaa-108">Datos</span><span class="sxs-lookup"><span data-stu-id="40eaa-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="40eaa-109">instantáneas</span><span class="sxs-lookup"><span data-stu-id="40eaa-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="40eaa-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="40eaa-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="40eaa-111">Globalización</span><span class="sxs-lookup"><span data-stu-id="40eaa-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="40eaa-112">Redes</span><span class="sxs-lookup"><span data-stu-id="40eaa-112">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="40eaa-113">Tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="40eaa-113">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="40eaa-114">Seguridad</span><span class="sxs-lookup"><span data-stu-id="40eaa-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="40eaa-115">Serialización</span><span class="sxs-lookup"><span data-stu-id="40eaa-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="40eaa-116">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="40eaa-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="40eaa-117">Herramientas</span><span class="sxs-lookup"><span data-stu-id="40eaa-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="40eaa-118">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="40eaa-118">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="40eaa-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="40eaa-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="40eaa-120">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="40eaa-120">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="40eaa-121">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="40eaa-121">Windows Workflow Foundation (WF)</span></span>
