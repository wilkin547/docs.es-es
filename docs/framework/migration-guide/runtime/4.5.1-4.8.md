...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-48"></a>Cambios de entorno de ejecución para la migración de .NET Framework 4.5.1 a 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si se va a migrar de .NET Framework 4.5.1 a 4.8, revise los temas siguientes para ver las incidencias de compatibilidad de aplicaciones que pueden afectar a la aplicación:
