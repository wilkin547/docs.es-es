...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a>Cambios de runtime para la migración desde .NET Framework 4.6.1 a 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si va a migrar desde .NET Framework 4.6.1 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
