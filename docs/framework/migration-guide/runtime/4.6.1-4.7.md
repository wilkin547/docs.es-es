...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a>Cambios en tiempo de ejecución para la migración desde .NET Framework 4.6.1 a 4.7

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Si va a migrar desde .NET Framework 4.6.1 a 4.7, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
