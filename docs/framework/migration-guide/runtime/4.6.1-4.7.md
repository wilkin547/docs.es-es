...
ms.locfileid: "59224252"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="3c3fe-102">Cambios de runtime para la migración desde .NET Framework 4.6.1 a 4.7</span><span class="sxs-lookup"><span data-stu-id="3c3fe-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>
...
## <a name="data"></a><span data-ttu-id="3c3fe-104">Datos</span><span class="sxs-lookup"><span data-stu-id="3c3fe-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3c3fe-105">Globalización</span><span class="sxs-lookup"><span data-stu-id="3c3fe-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="3c3fe-106">JIT</span><span class="sxs-lookup"><span data-stu-id="3c3fe-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="3c3fe-107">Seguridad</span><span class="sxs-lookup"><span data-stu-id="3c3fe-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3c3fe-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3c3fe-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3c3fe-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3c3fe-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3c3fe-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3c3fe-110">Windows Workflow Foundation (WF)</span></span>
