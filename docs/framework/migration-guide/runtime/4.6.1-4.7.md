---
title: "Cambios en tiempo de ejecución para la migración desde .NET Framework 4.6.1 a 4.7"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="80899-102">Cambios en tiempo de ejecución para la migración desde .NET Framework 4.6.1 a 4.7</span><span class="sxs-lookup"><span data-stu-id="80899-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="80899-103">Si va a migrar desde .NET Framework 4.6.1 a 4.7, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="80899-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="80899-104">Principal</span><span class="sxs-lookup"><span data-stu-id="80899-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="80899-105">Datos</span><span class="sxs-lookup"><span data-stu-id="80899-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="80899-106">Globalización</span><span class="sxs-lookup"><span data-stu-id="80899-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="80899-107">JIT</span><span class="sxs-lookup"><span data-stu-id="80899-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="80899-108">Seguridad</span><span class="sxs-lookup"><span data-stu-id="80899-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="80899-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="80899-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="80899-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="80899-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="80899-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="80899-111">Windows Workflow Foundation (WF)</span></span>
