...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a>Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5.1 para 4.6.2
