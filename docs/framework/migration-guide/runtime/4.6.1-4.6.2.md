...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="795f1-102">Cambios de runtime para la migración desde .NET Framework 4.6.1 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="795f1-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="795f1-103">Si va a migrar desde .NET Framework 4.6.1 a 4.6.2, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="795f1-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="795f1-104">data</span><span class="sxs-lookup"><span data-stu-id="795f1-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="795f1-105">Globalización</span><span class="sxs-lookup"><span data-stu-id="795f1-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="795f1-106">Seguridad</span><span class="sxs-lookup"><span data-stu-id="795f1-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="795f1-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="795f1-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="795f1-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="795f1-108">Windows Presentation Foundation (WPF)</span></span>
