---
title: "Cambios en tiempo de ejecución para la migración desde .NET Framework 4.6 para 4.6.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="b04e7-102">Cambios en tiempo de ejecución para la migración desde .NET Framework 4.6 para 4.6.2</span><span class="sxs-lookup"><span data-stu-id="b04e7-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b04e7-103">Si va a migrar desde .NET Framework 4.6 a 4.6.2, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="b04e7-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="b04e7-104">Principal</span><span class="sxs-lookup"><span data-stu-id="b04e7-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b04e7-105">Datos</span><span class="sxs-lookup"><span data-stu-id="b04e7-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b04e7-106">Globalización</span><span class="sxs-lookup"><span data-stu-id="b04e7-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="b04e7-107">Seguridad</span><span class="sxs-lookup"><span data-stu-id="b04e7-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="b04e7-108">Herramientas</span><span class="sxs-lookup"><span data-stu-id="b04e7-108">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b04e7-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b04e7-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b04e7-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b04e7-110">Windows Presentation Foundation (WPF)</span></span>
