...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a>Cambios en tiempo de ejecución para la migración desde .NET Framework 4.0 para 4.7.1

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Si va a migrar desde .NET Framework 4.0 a 4.7.1, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:
