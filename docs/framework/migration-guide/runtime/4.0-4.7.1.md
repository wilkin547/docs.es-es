...
ms.locfileid: "86443317"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="3a99b-103">Cambios de runtime para la migración desde .NET Framework 4.0 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="3a99b-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="3a99b-104">Si va a migrar desde .NET Framework 4.0 a 4.7.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="3a99b-104">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3a99b-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3a99b-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3a99b-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3a99b-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3a99b-107">Principal</span><span class="sxs-lookup"><span data-stu-id="3a99b-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3a99b-108">Datos</span><span class="sxs-lookup"><span data-stu-id="3a99b-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3a99b-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3a99b-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3a99b-110">Globalización</span><span class="sxs-lookup"><span data-stu-id="3a99b-110">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="3a99b-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="3a99b-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="3a99b-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="3a99b-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="3a99b-113">Redes</span><span class="sxs-lookup"><span data-stu-id="3a99b-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="3a99b-114">Impresión</span><span class="sxs-lookup"><span data-stu-id="3a99b-114">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="3a99b-115">Seguridad</span><span class="sxs-lookup"><span data-stu-id="3a99b-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3a99b-116">Serialización</span><span class="sxs-lookup"><span data-stu-id="3a99b-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="3a99b-117">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="3a99b-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="3a99b-118">Herramientas</span><span class="sxs-lookup"><span data-stu-id="3a99b-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="3a99b-119">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="3a99b-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3a99b-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3a99b-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3a99b-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3a99b-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3a99b-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3a99b-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3a99b-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3a99b-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3a99b-124">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3a99b-124">XML, XSLT</span></span>
