---
title: "Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5 a 4.6.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="994a9-102">Cambios en tiempo de ejecución para la migración desde .NET Framework 4.5 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="994a9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="994a9-103">Si va a migrar desde .NET Framework 4.5 a 4.6.2, revise los temas siguientes para problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="994a9-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="994a9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="994a9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="994a9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="994a9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="994a9-106">Principal</span><span class="sxs-lookup"><span data-stu-id="994a9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="994a9-107">Datos</span><span class="sxs-lookup"><span data-stu-id="994a9-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="994a9-108">Depurador</span><span class="sxs-lookup"><span data-stu-id="994a9-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="994a9-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="994a9-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="994a9-110">Globalización</span><span class="sxs-lookup"><span data-stu-id="994a9-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="994a9-111">Redes</span><span class="sxs-lookup"><span data-stu-id="994a9-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="994a9-112">Seguridad</span><span class="sxs-lookup"><span data-stu-id="994a9-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="994a9-113">Serialización</span><span class="sxs-lookup"><span data-stu-id="994a9-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="994a9-114">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="994a9-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="994a9-115">Herramientas</span><span class="sxs-lookup"><span data-stu-id="994a9-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="994a9-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="994a9-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="994a9-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="994a9-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="994a9-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="994a9-118">Windows Presentation Foundation (WPF)</span></span>
