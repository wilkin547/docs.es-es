...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="7bc37-102">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.7</span><span class="sxs-lookup"><span data-stu-id="7bc37-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7bc37-103">Si va a migrar desde .NET Framework 4.5 a 4.7, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="7bc37-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7bc37-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7bc37-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7bc37-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7bc37-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7bc37-106">Principal</span><span class="sxs-lookup"><span data-stu-id="7bc37-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7bc37-107">Datos</span><span class="sxs-lookup"><span data-stu-id="7bc37-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="7bc37-108">instantáneas</span><span class="sxs-lookup"><span data-stu-id="7bc37-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7bc37-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7bc37-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7bc37-110">Globalización</span><span class="sxs-lookup"><span data-stu-id="7bc37-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="7bc37-111">JIT</span><span class="sxs-lookup"><span data-stu-id="7bc37-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="7bc37-112">Redes</span><span class="sxs-lookup"><span data-stu-id="7bc37-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="7bc37-113">Seguridad</span><span class="sxs-lookup"><span data-stu-id="7bc37-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7bc37-114">Serialización</span><span class="sxs-lookup"><span data-stu-id="7bc37-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7bc37-115">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="7bc37-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="7bc37-116">Herramientas</span><span class="sxs-lookup"><span data-stu-id="7bc37-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7bc37-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7bc37-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7bc37-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7bc37-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7bc37-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="7bc37-119">Windows Workflow Foundation (WF)</span></span>
