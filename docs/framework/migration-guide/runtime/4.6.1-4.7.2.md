...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-472"></a><span data-ttu-id="9b9e5-102">Cambios de runtime para la migración desde .NET Framework 4.6.1 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="9b9e5-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9b9e5-103">Si va a migrar desde .NET Framework 4.6.1 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="9b9e5-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="9b9e5-104">Principal</span><span class="sxs-lookup"><span data-stu-id="9b9e5-104">Core</span></span>

[!include[Allow Unicode in URIs that resemble UNC shares](~/includes/migration-guide/runtime/core/allow-unicode-uris-that-resemble-unc-shares.md)]

[!include[Support special relative URI notation when Unicode is present](~/includes/migration-guide/runtime/core/support-special-relative-uri-notation-when-unicode-present.md)]

## <a name="data"></a><span data-ttu-id="9b9e5-105">Datos</span><span class="sxs-lookup"><span data-stu-id="9b9e5-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9b9e5-106">Globalización</span><span class="sxs-lookup"><span data-stu-id="9b9e5-106">Globalization</span></span>
...
## <a name="runtime"></a><span data-ttu-id="9b9e5-107">Tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="9b9e5-107">Runtime</span></span>

[!include[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="9b9e5-108">Seguridad</span><span class="sxs-lookup"><span data-stu-id="9b9e5-108">Security</span></span>
...
## <a name="web-application"></a><span data-ttu-id="9b9e5-109">Aplicación web</span><span class="sxs-lookup"><span data-stu-id="9b9e5-109">Web Application</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9b9e5-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9b9e5-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9b9e5-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9b9e5-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9b9e5-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9b9e5-112">Windows Workflow Foundation (WF)</span></span>
