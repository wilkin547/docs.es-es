...
ms.locfileid: "58760591"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="d0667-102">Cambios de runtime para la migración desde .NET Framework 4.0 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="d0667-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="d0667-103">Si va a migrar desde .NET Framework 4.0 a 4.7.2, revise los siguientes temas para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="d0667-103">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="d0667-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="d0667-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="d0667-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d0667-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d0667-106">Principal</span><span class="sxs-lookup"><span data-stu-id="d0667-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="d0667-107">Datos</span><span class="sxs-lookup"><span data-stu-id="d0667-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="d0667-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="d0667-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="d0667-109">Globalización</span><span class="sxs-lookup"><span data-stu-id="d0667-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="d0667-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="d0667-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="d0667-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="d0667-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="d0667-112">Redes</span><span class="sxs-lookup"><span data-stu-id="d0667-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="d0667-113">Impresión</span><span class="sxs-lookup"><span data-stu-id="d0667-113">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="d0667-114">Tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="d0667-114">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="d0667-115">Seguridad</span><span class="sxs-lookup"><span data-stu-id="d0667-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="d0667-116">Serialización</span><span class="sxs-lookup"><span data-stu-id="d0667-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="d0667-117">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="d0667-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="d0667-118">Herramientas</span><span class="sxs-lookup"><span data-stu-id="d0667-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="d0667-119">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="d0667-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d0667-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d0667-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="d0667-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="d0667-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d0667-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d0667-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="d0667-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="d0667-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="d0667-124">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="d0667-124">XML, XSLT</span></span>
