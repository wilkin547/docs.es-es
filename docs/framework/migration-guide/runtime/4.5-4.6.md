...
ms.locfileid: "86443005"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="4693f-103">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.6</span><span class="sxs-lookup"><span data-stu-id="4693f-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4693f-104">Si va a migrar desde .NET Framework 4.5 a 4.6, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="4693f-104">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4693f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4693f-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4693f-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4693f-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4693f-107">Principal</span><span class="sxs-lookup"><span data-stu-id="4693f-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4693f-108">Datos</span><span class="sxs-lookup"><span data-stu-id="4693f-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4693f-109">instantáneas</span><span class="sxs-lookup"><span data-stu-id="4693f-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4693f-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="4693f-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="4693f-111">Redes</span><span class="sxs-lookup"><span data-stu-id="4693f-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4693f-112">Serialización</span><span class="sxs-lookup"><span data-stu-id="4693f-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4693f-113">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="4693f-113">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4693f-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4693f-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4693f-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4693f-115">Windows Presentation Foundation (WPF)</span></span>
