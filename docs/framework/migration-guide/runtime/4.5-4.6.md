---
title: Cambios de runtime para la migración desde .NET Framework 4.5 a 4.6
description: Busque información sobre los problemas de compatibilidad de aplicaciones de los cambios de runtime que podrían afectar a la aplicación al migrar de .NET Framework 4.5 a 4.6.
ms.date: 07/10/2019
...
ms.locfileid: "97009285"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="15921-103">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.6</span><span class="sxs-lookup"><span data-stu-id="15921-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="15921-104">Si va a migrar desde .NET Framework 4.5 a 4.6, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="15921-104">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="15921-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="15921-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="15921-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="15921-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="15921-107">Principal</span><span class="sxs-lookup"><span data-stu-id="15921-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="15921-108">Datos</span><span class="sxs-lookup"><span data-stu-id="15921-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="15921-109">instantáneas</span><span class="sxs-lookup"><span data-stu-id="15921-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="15921-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="15921-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="15921-111">Redes</span><span class="sxs-lookup"><span data-stu-id="15921-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="15921-112">Serialización</span><span class="sxs-lookup"><span data-stu-id="15921-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="15921-113">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="15921-113">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="15921-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="15921-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="15921-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="15921-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="15921-116">XML</span><span class="sxs-lookup"><span data-stu-id="15921-116">XML</span></span>
