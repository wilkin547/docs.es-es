---
title: Cambios de runtime para la migración desde .NET Framework 4.0 a 4.5.1
description: Busque información sobre los problemas de compatibilidad de aplicaciones de los cambios de runtime que podrían afectar a la aplicación al migrar de .NET Framework 4.0 a 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443707"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="9273d-103">Cambios de runtime para la migración desde .NET Framework 4.0 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="9273d-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="9273d-104">Si va a migrar desde .NET Framework 4.0 a 4.5.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="9273d-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="9273d-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="9273d-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="9273d-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="9273d-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="9273d-107">Principal</span><span class="sxs-lookup"><span data-stu-id="9273d-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="9273d-108">Datos</span><span class="sxs-lookup"><span data-stu-id="9273d-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="9273d-109">instantáneas</span><span class="sxs-lookup"><span data-stu-id="9273d-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="9273d-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="9273d-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="9273d-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="9273d-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="9273d-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="9273d-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="9273d-113">Redes</span><span class="sxs-lookup"><span data-stu-id="9273d-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="9273d-114">Impresión</span><span class="sxs-lookup"><span data-stu-id="9273d-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="9273d-115">Serialización</span><span class="sxs-lookup"><span data-stu-id="9273d-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="9273d-116">Aplicaciones Web</span><span class="sxs-lookup"><span data-stu-id="9273d-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9273d-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9273d-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="9273d-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="9273d-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9273d-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9273d-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9273d-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9273d-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="9273d-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="9273d-121">XML, XSLT</span></span>
