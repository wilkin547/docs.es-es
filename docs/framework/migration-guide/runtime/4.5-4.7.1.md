...
ms.locfileid: "66379348"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="37d3e-102">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="37d3e-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>
...
## <a name="adonet"></a><span data-ttu-id="37d3e-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="37d3e-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="37d3e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="37d3e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="37d3e-106">Principal</span><span class="sxs-lookup"><span data-stu-id="37d3e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="37d3e-107">Datos</span><span class="sxs-lookup"><span data-stu-id="37d3e-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="37d3e-108">instantáneas</span><span class="sxs-lookup"><span data-stu-id="37d3e-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="37d3e-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="37d3e-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="37d3e-110">Globalización</span><span class="sxs-lookup"><span data-stu-id="37d3e-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="37d3e-111">Redes</span><span class="sxs-lookup"><span data-stu-id="37d3e-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="37d3e-112">Seguridad</span><span class="sxs-lookup"><span data-stu-id="37d3e-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="37d3e-113">Serialización</span><span class="sxs-lookup"><span data-stu-id="37d3e-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="37d3e-114">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="37d3e-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="37d3e-115">Herramientas</span><span class="sxs-lookup"><span data-stu-id="37d3e-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="37d3e-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="37d3e-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="37d3e-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="37d3e-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="37d3e-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="37d3e-118">Windows Workflow Foundation (WF)</span></span>
