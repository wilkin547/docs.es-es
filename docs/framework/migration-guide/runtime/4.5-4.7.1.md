...
ms.locfileid: "91608020"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="0a411-103">Cambios de runtime para la migración desde .NET Framework 4.5 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="0a411-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0a411-104">Si va a migrar desde .NET Framework 4.5 a 4.7.1, revise los temas siguientes para ver los problemas de compatibilidad de aplicaciones que pueden afectar a la aplicación:</span><span class="sxs-lookup"><span data-stu-id="0a411-104">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0a411-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0a411-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0a411-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0a411-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0a411-107">Principal</span><span class="sxs-lookup"><span data-stu-id="0a411-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0a411-108">Datos</span><span class="sxs-lookup"><span data-stu-id="0a411-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="0a411-109">instantáneas</span><span class="sxs-lookup"><span data-stu-id="0a411-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0a411-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0a411-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0a411-111">Globalización</span><span class="sxs-lookup"><span data-stu-id="0a411-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="0a411-112">Redes</span><span class="sxs-lookup"><span data-stu-id="0a411-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="0a411-113">Seguridad</span><span class="sxs-lookup"><span data-stu-id="0a411-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0a411-114">Serialización</span><span class="sxs-lookup"><span data-stu-id="0a411-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0a411-115">Instalación e implementación</span><span class="sxs-lookup"><span data-stu-id="0a411-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0a411-116">Herramientas</span><span class="sxs-lookup"><span data-stu-id="0a411-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0a411-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0a411-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0a411-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0a411-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0a411-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0a411-119">Windows Workflow Foundation (WF)</span></span>
